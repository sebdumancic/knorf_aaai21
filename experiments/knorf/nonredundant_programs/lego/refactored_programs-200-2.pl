...
redpred_3(A,B) :- place1(A,C),p50(C,B)
redpred_4(A,B) :- right(A,C),p13(C,B)
redpred_5(A,B) :- p50(A,C),p50(C,B)
redpred_6(A,B) :- p13(A,C),p50(C,B)
redpred_7(A,B) :- p50(A,C),p13(C,B)
redpred_8(A,B) :- right(A,C),p50(C,B)
redpred_9(A,B) :- place1(A,C),p13(C,B)
redpred_10(A,B) :- p13(A,C),p99(C,B)
redpred_11(A,B) :- p13(A,C),p127(C,B)
redpred_12(A,B) :- p38(A,C),p154(C,B)
redpred_13(A,B) :- p171(A,C),p13(C,B)
redpred_14(A,B) :- p50(A,C),p141(C,B)
redpred_15(A,B) :- p154(A,C),p142(C,B)
redpred_16(A,B) :- p13(A,C),p114(C,B)
redpred_17(A,B) :- place1(A,C),p114(C,B)
redpred_18(A,B) :- p73(A,C),p141(C,B)
redpred_19(A,B) :- p142(A,C),p154(C,B)
redpred_20(A,B) :- place1(A,C),p154(C,B)
redpred_21(A,B) :- place1(A,C),p7(C,B)
redpred_22(A,B) :- p73(A,C),p99(C,B)
