...
redpred_3(A,B) :- p26(A,C),p3(C,B)
redpred_4(A,B) :- right(A,C),p3(C,B)
redpred_5(A,B) :- p3(A,C),p26(C,B)
...
redpred_10(A,B) :- p26(A,C),p4(C,B)
redpred_11(A,B) :- p38(A,C),p121(C,B)
redpred_12(A,B) :- p4(A,C),p59(C,B)
redpred_13(A,B) :- p172(A,C),p4(C,B)
redpred_14(A,B) :- place1(A,C),p101(C,B)
redpred_15(A,B) :- p85(A,C),p85(C,B)
redpred_16(A,B) :- p4(A,C),p85(C,B)
redpred_17(A,B) :- p59(A,C),p0_1(C,B)
redpred_18(A,B) :- p38(A,C),p1(C,B)
redpred_19(A,B) :- p85(A,C),p0_1(C,B)
redpred_20(A,B) :- p89(A,C),p172(C,B)
redpred_21(A,B) :- place1(A,C),p0(C,B)
redpred_22(A,B) :- p3(A,C),p14(C,B)
redpred_23(A,B) :- p4(A,C),p0_1(C,B)
redpred_24(A,B) :- p85(A,C),p89_1(C,B)
redpred_25(A,B) :- place1(A,C),p38(C,B)
redpred_26(A,B) :- p172(A,C),p85(C,B)
redpred_27(A,B) :- p172(A,C),p1(C,B)
redpred_28(A,B) :- p172(A,C),p0_1(C,B)
redpred_29(A,B) :- place1(A,C),p89(C,B)
redpred_30(A,B) :- p4(A,C),p11(C,B)
redpred_31(A,B) :- p85(A,C),p10(C,B)
redpred_32(A,B) :- right(A,C),p101(C,B)
redpred_33(A,B) :- p355(A,C),p0_1(C,B)
redpred_34(A,B) :- p14(A,C),p4(C,B)
redpred_35(A,B) :- p3(A,C),p89(C,B)
redpred_36(A,B) :- p59(A,C),p121(C,B)
redpred_37(A,B) :- p172(A,C),p101(C,B)
redpred_38(A,B) :- p173(A,C),p107(C,B)
redpred_39(A,B) :- place1(A,C),p53(C,B)
redpred_40(A,B) :- p89(A,C),p173(C,B)
redpred_41(A,B) :- p3(A,C),p11(C,B)
redpred_42(A,B) :- place1(A,C),p4(C,B)
redpred_43(A,B) :- place1(A,C),p14(C,B)
...
p231_1(A,B) :- redpred_7(A,B)
p232(A,B) :- redpred_8(A,B)
p235(A,B) :- p3(A,C),p235_1(C,B)
p235_1(A,B) :- redpred_7(A,B)
...
p135_1(A,B) :- redpred_34(A,B)
p136(A,B) :- redpred_31(A,B)
p137(A,B) :- redpred_14(A,B)
p138(A,B) :- redpred_24(A,B)
...
p210(A,B) :- redpred_23(A,B)
p214(A,B) :- p355(A,C),p4(C,B)
p215(A,B) :- redpred_42(A,B)
...
p260_1(A,B) :- redpred_27(A,B)
p265(A,B) :- redpred_30(A,B)
