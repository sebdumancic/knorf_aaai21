...
redpred_10(A,B) :- not_empty(A),copy1(A,B)
...
redpred_15(A,B) :- p467(A,C),p7(C,B)
redpred_16(A,B) :- p32(A,C),p18(C,B)
redpred_17(A,B) :- skip1(A,C),p20(C,B)
redpred_18(A,B) :- skip1(A,C),p32(C,B)
redpred_19(A,B) :- skip1(A,C),p7(C,B)
redpred_20(A,B) :- copy1(A,C),p7(C,B)
redpred_21(A,B) :- mk_lowercase(A,C),p7(C,B)
redpred_22(A,B) :- p18(A,C),p32(C,B)
redpred_23(A,B) :- p7(A,C),p32(C,B)
redpred_24(A,B) :- mk_lowercase(A,C),p467(C,B)
redpred_25(A,B) :- p7(A,C),p18(C,B)
redpred_26(A,B) :- p470(A,C),p470(C,B)
redpred_27(A,B) :- p32(A,C),p7(C,B)
redpred_28(A,B) :- p470(A,C),p7(C,B)
redpred_29(A,B) :- skip1(A,C),p11(C,B)
redpred_30(A,B) :- copy1(A,C),p32(C,B)
redpred_31(A,B) :- copy1(A,C),p20(C,B)
redpred_32(A,B) :- p18(A,C),p7(C,B)
redpred_33(A,B) :- p20(A,C),p32(C,B)
redpred_34(A,B) :- skip1(A,C),p467(C,B)
redpred_35(A,B) :- p32(A,C),p20(C,B)
redpred_36(A,B) :- p32(A,C),p32(C,B)
redpred_37(A,B) :- p7(A,C),p470(C,B)
redpred_38(A,B) :- skip1(A,C),p43(C,B)
redpred_39(A,B) :- skip1(A,C),p415(C,B)
redpred_40(A,B) :- p7(A,C),p43(C,B)
redpred_41(A,B) :- p7(A,C),p7(C,B)
redpred_42(A,B) :- p32(A,C),p333(C,B)
redpred_43(A,B) :- skip1(A,C),p18(C,B)
redpred_44(A,B) :- p467(A,C),p32(C,B)
redpred_45(A,B) :- mk_uppercase(A,C),p7(C,B)
redpred_46(A,B) :- p32(A,C),p440(C,B)
redpred_47(A,B) :- copy1(A,C),p470(C,B)
redpred_48(A,B) :- p11(A,C),p32(C,B)
redpred_49(A,B) :- p440(A,C),p7(C,B)
redpred_50(A,B) :- skip1(A,C),p470(C,B)
redpred_51(A,B) :- mk_lowercase(A,C),p32(C,B)
redpred_52(A,B) :- p18(A,C),p467(C,B)
redpred_53(A,B) :- p32(A,C),p467(C,B)
redpred_54(A,B) :- p43(A,C),p32(C,B)
redpred_55(A,B) :- p11(A,C),p43(C,B)
redpred_56(A,B) :- p470(A,C),p32(C,B)
redpred_57(A,B) :- p20(A,C),p333(C,B)
redpred_58(A,B) :- p18(A,C),p20(C,B)
redpred_59(A,B) :- copy1(A,C),p18(C,B)
redpred_60(A,B) :- p20(A,C),p470(C,B)
redpred_61(A,B) :- p32(A,C),p470(C,B)
redpred_62(A,B) :- copy1(A,C),p467(C,B)
redpred_63(A,B) :- p20(A,C),p7(C,B)
redpred_64(A,B) :- mk_lowercase(A,C),p18(C,B)
redpred_65(A,B) :- p43(A,C),p7(C,B)
redpred_66(A,B) :- skip1(A,C),p146(C,B)
redpred_67(A,B) :- copy1(A,C),p15(C,B)
redpred_68(A,B) :- skip1(A,C),p15(C,B)
redpred_69(A,B) :- p23(A,C),p8(C,B)
redpred_70(A,B) :- skip1(A,C),p17(C,B)
redpred_71(A,B) :- copy1(A,C),p146(C,B)
redpred_72(A,B) :- p34_1(A,C),p152(C,B)
redpred_73(A,B) :- p102(A,C),mk_uppercase(C,B)
redpred_74(A,B) :- p83(A,C),p80(C,B)
redpred_75(A,B) :- skip1(A,C),p89(C,B)
redpred_76(A,B) :- p222(A,C),copy1(C,B)
redpred_77(A,B) :- p18(A,C),p15_1(C,B)
redpred_78(A,B) :- p80(A,C),p222_1(C,B)
redpred_79(A,B) :- copy1(A,C),p17(C,B)
redpred_80(A,B) :- p222(A,C),p7(C,B)
redpred_81(A,B) :- copy1(A,C),p758(C,B)
redpred_82(A,B) :- p7(A,C),p15(C,B)
redpred_83(A,B) :- p319(A,C),p7(C,B)
redpred_84(A,B) :- p11(A,C),p102(C,B)
redpred_85(A,B) :- skip1(A,C),p342(C,B)
redpred_86(A,B) :- p319(A,C),copy1(C,B)
redpred_87(A,B) :- p15(A,C),mk_uppercase(C,B)
...
p467(A,B) :- redpred_13(A,B)
p470(A,B) :- redpred_14(A,B)
p472(A,B) :- redpred_8(A,B)
p492(A,B) :- redpred_7(A,B)
...
p481_1(A,B) :- redpred_38(A,B)
p486(A,B) :- redpred_62(A,B)
...
p511_1(A,B) :- redpred_50(A,B)
p513(A,B) :- skip1(A,C),p513_1(C,B)
p513_1(A,B) :- redpred_65(A,B)
...
p929_1(A,B) :- redpred_28(A,B)
p930(A,B) :- redpred_62(A,B)
p931(A,B) :- copy1(A,C),p931_1(C,B)
p931_1(A,B) :- redpred_42(A,B)
...
p53(A,B) :- redpred_69(A,B)
p55(A,B) :- p11(A,C),p55_1(C,B)
p55_1(A,B) :- redpred_70(A,B)
...
p277(A,B) :- redpred_72(A,B)
p280(A,B) :- redpred_79(A,B)
...
p336_1(A,B) :- redpred_80(A,B)
p338(A,B) :- p199_1(A,C),p391(C,B)
p339(A,B) :- redpred_81(A,B)
p344(A,B) :- mk_uppercase(A,C),p344_1(C,B)
p344_1(A,B) :- redpred_68(A,B)
p345(A,B) :- p504(A,C),p345_1(C,B)
p345_1(A,B) :- redpred_76(A,B)
...
p399_1(A,B) :- redpred_70(A,B)
p401(A,B) :- redpred_82(A,B)
...
p662_1(A,B) :- redpred_80(A,B)
p663(A,B) :- skip1(A,C),p663_1(C,B)
p663_1(A,B) :- redpred_76(A,B)
...
p999_1(A,B) :- redpred_87(A,B)
p1000(A,B) :- redpred_68(A,B)
