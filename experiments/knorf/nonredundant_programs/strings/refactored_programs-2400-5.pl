...
redpred_16(A,B) :- mk_uppercase(A,C),p51(C,B)
redpred_17(A,B) :- p8(A,C),p8(C,B)
redpred_18(A,B) :- p3(A,C),p51(C,B)
redpred_19(A,B) :- copy1(A,C),p55(C,B)
redpred_20(A,B) :- copy1(A,C),p8(C,B)
redpred_21(A,B) :- p51(A,C),p82(C,B)
redpred_22(A,B) :- p3(A,C),p55(C,B)
redpred_23(A,B) :- p150(A,C),p3(C,B)
redpred_24(A,B) :- mk_lowercase(A,C),p8(C,B)
redpred_25(A,B) :- p150(A,C),p55(C,B)
redpred_26(A,B) :- p51(A,C),p109(C,B)
redpred_27(A,B) :- skip1(A,C),p55(C,B)
redpred_28(A,B) :- copy1(A,C),p109(C,B)
redpred_29(A,B) :- p658(A,C),p3(C,B)
redpred_30(A,B) :- skip1(A,C),p3(C,B)
redpred_31(A,B) :- p8(A,C),p109(C,B)
redpred_32(A,B) :- copy1(A,C),p485(C,B)
redpred_33(A,B) :- p82(A,C),p3(C,B)
redpred_34(A,B) :- p3(A,C),p3(C,B)
redpred_35(A,B) :- p3(A,C),p8(C,B)
redpred_36(A,B) :- p3(A,C),p34(C,B)
redpred_37(A,B) :- skip1(A,C),p8(C,B)
redpred_38(A,B) :- skip1(A,C),p34(C,B)
redpred_39(A,B) :- mk_uppercase(A,C),p3(C,B)
redpred_40(A,B) :- p8(A,C),p658(C,B)
redpred_41(A,B) :- copy1(A,C),p150(C,B)
redpred_42(A,B) :- p82(A,C),p51(C,B)
redpred_43(A,B) :- p8(A,C),p82(C,B)
redpred_44(A,B) :- p150(A,C),p109(C,B)
redpred_45(A,B) :- p109(A,C),p3(C,B)
redpred_46(A,B) :- skip1(A,C),p51(C,B)
redpred_47(A,B) :- p55(A,C),p3(C,B)
redpred_48(A,B) :- p8(A,C),p3(C,B)
redpred_49(A,B) :- skip1(A,C),p658(C,B)
redpred_50(A,B) :- p8(A,C),p51(C,B)
redpred_51(A,B) :- p109(A,C),p8(C,B)
redpred_52(A,B) :- p82(A,C),p55(C,B)
redpred_53(A,B) :- skip1(A,C),p109(C,B)
redpred_54(A,B) :- skip1(A,C),p150(C,B)
redpred_55(A,B) :- p34(A,C),p82(C,B)
redpred_56(A,B) :- copy1(A,C),p658(C,B)
redpred_57(A,B) :- p55(A,C),p8(C,B)
redpred_58(A,B) :- p152(A,C),p658(C,B)
redpred_59(A,B) :- p51(A,C),p3(C,B)
redpred_60(A,B) :- p658(A,C),p8(C,B)
redpred_61(A,B) :- p8(A,C),p55(C,B)
redpred_62(A,B) :- p3(A,C),p150(C,B)
redpred_63(A,B) :- mk_lowercase(A,C),p658(C,B)
redpred_64(A,B) :- skip1(A,C),p485(C,B)
redpred_65(A,B) :- copy1(A,C),p3(C,B)
redpred_66(A,B) :- p8(A,C),p150(C,B)
redpred_67(A,B) :- p51(A,C),p150(C,B)
redpred_68(A,B) :- p55(A,C),p34(C,B)
redpred_69(A,B) :- copy1(A,C),p34(C,B)
redpred_70(A,B) :- p3(A,C),p658(C,B)
redpred_71(A,B) :- p51(A,C),p8(C,B)
redpred_72(A,B) :- mk_uppercase(A,C),p109(C,B)
redpred_73(A,B) :- mk_uppercase(A,C),p55(C,B)
redpred_74(A,B) :- p150(A,C),p8(C,B)
redpred_75(A,B) :- p109(A,C),p82(C,B)
redpred_76(A,B) :- p82(A,C),p82(C,B)
redpred_77(A,B) :- skip1(A,C),p152(C,B)
redpred_78(A,B) :- copy1(A,C),p51(C,B)
redpred_79(A,B) :- copy1(A,C),p82(C,B)
redpred_80(A,B) :- p34(A,C),p3(C,B)
redpred_81(A,B) :- p82(A,C),p8(C,B)
redpred_82(A,B) :- p1076(A,C),p150(C,B)
redpred_83(A,B) :- skip1(A,C),p1076(C,B)
redpred_84(A,B) :- p150(A,C),p150(C,B)
redpred_85(A,B) :- mk_lowercase(A,C),p109(C,B)
redpred_86(A,B) :- skip1(A,C),p82(C,B)
redpred_87(A,B) :- p82(A,C),p658(C,B)
redpred_88(A,B) :- p3(A,C),p152(C,B)
redpred_89(A,B) :- p55(A,C),p109(C,B)
redpred_90(A,B) :- p8(A,C),p485(C,B)
redpred_91(A,B) :- mk_uppercase(A,C),p485(C,B)
redpred_92(A,B) :- p55(A,C),p51(C,B)
redpred_93(A,B) :- p658(A,C),p51(C,B)
redpred_94(A,B) :- p51(A,C),p55(C,B)
redpred_95(A,B) :- p658(A,C),p658(C,B)
redpred_96(A,B) :- p109(A,C),p109(C,B)
redpred_97(A,B) :- p150(A,C),p82(C,B)
redpred_98(A,B) :- mk_lowercase(A,C),p3(C,B)
redpred_99(A,B) :- p3(A,C),p109(C,B)
redpred_100(A,B) :- p3(A,C),p82(C,B)
redpred_101(A,B) :- mk_uppercase(A,C),p8(C,B)
redpred_102(A,B) :- p8(A,C),p152(C,B)
redpred_103(A,B) :- p3(A,C),p485(C,B)
redpred_104(A,B) :- p109(A,C),p150(C,B)
redpred_105(A,B) :- mk_lowercase(A,C),p82(C,B)
redpred_106(A,B) :- p658(A,C),p82(C,B)
redpred_107(A,B) :- mk_lowercase(A,C),p55(C,B)
redpred_108(A,B) :- mk_lowercase(A,C),p51(C,B)
redpred_109(A,B) :- p150(A,C),p51(C,B)
redpred_110(A,B) :- skip1(A,C),p892(C,B)
redpred_111(A,B) :- p3(A,C),p2008(C,B)
redpred_112(A,B) :- p91_1(A,C),p236(C,B)
redpred_113(A,B) :- skip1(A,C),p1483(C,B)
redpred_114(A,B) :- copy1(A,C),p676(C,B)
redpred_115(A,B) :- mk_uppercase(A,C),p1185(C,B)
redpred_116(A,B) :- p236(A,C),p674(C,B)
redpred_117(A,B) :- skip1(A,C),p879(C,B)
redpred_118(A,B) :- skip1(A,C),p676(C,B)
redpred_119(A,B) :- skip1(A,C),p1185(C,B)
redpred_120(A,B) :- skip1(A,C),p819(C,B)
redpred_121(A,B) :- p1544(A,C),p154_1(C,B)
redpred_122(A,B) :- p3(A,C),p1185(C,B)
redpred_123(A,B) :- p7(A,C),p108(C,B)
redpred_124(A,B) :- p8(A,C),p892(C,B)
redpred_125(A,B) :- copy1(A,C),p786(C,B)
redpred_126(A,B) :- p682(A,C),p485(C,B)
redpred_127(A,B) :- p802(A,C),p365(C,B)
redpred_128(A,B) :- skip1(A,C),p222(C,B)
redpred_129(A,B) :- p1185(A,C),p676(C,B)
redpred_130(A,B) :- p3(A,C),p771(C,B)
redpred_131(A,B) :- skip1(A,C),p1235(C,B)
redpred_132(A,B) :- p86_1(A,C),p1124_1(C,B)
redpred_133(A,B) :- p91_1(A,C),p147_1(C,B)
redpred_134(A,B) :- p676(A,C),p1165(C,B)
redpred_135(A,B) :- p261(A,C),p74(C,B)
redpred_136(A,B) :- copy1(A,C),p1722(C,B)
redpred_137(A,B) :- p3(A,C),p233(C,B)
redpred_138(A,B) :- copy1(A,C),p154(C,B)
redpred_139(A,B) :- p17(A,C),p422(C,B)
redpred_140(A,B) :- p91_1(A,C),p736(C,B)
redpred_141(A,B) :- skip1(A,C),p393(C,B)
redpred_142(A,B) :- copy1(A,C),p1185(C,B)
redpred_143(A,B) :- p18(A,C),p2079(C,B)
redpred_144(A,B) :- p51(A,C),p1185(C,B)
redpred_145(A,B) :- skip1(A,C),p739(C,B)
redpred_146(A,B) :- p286(A,C),mk_uppercase(C,B)
redpred_147(A,B) :- p1238(A,C),p1185(C,B)
redpred_148(A,B) :- p105(A,C),p1560(C,B)
redpred_149(A,B) :- p682(A,C),p8(C,B)
redpred_150(A,B) :- p1185(A,C),p155_1(C,B)
redpred_151(A,B) :- p1185(A,C),p64(C,B)
redpred_152(A,B) :- copy1(A,C),p1235(C,B)
redpred_153(A,B) :- p994(A,C),p3(C,B)
redpred_154(A,B) :- copy1(A,C),p892(C,B)
redpred_155(A,B) :- p150(A,C),p892(C,B)
redpred_156(A,B) :- skip1(A,C),p647(C,B)
redpred_157(A,B) :- p51(A,C),p879(C,B)
redpred_158(A,B) :- p1185(A,C),p105(C,B)
redpred_159(A,B) :- p261(A,C),p51(C,B)
redpred_160(A,B) :- p3(A,C),p72(C,B)
redpred_161(A,B) :- mk_lowercase(A,C),p676(C,B)
redpred_162(A,B) :- skip1(A,C),p233(C,B)
redpred_163(A,B) :- p74(A,C),p1185(C,B)
redpred_164(A,B) :- p658(A,C),p676(C,B)
redpred_165(A,B) :- p1514(A,C),p342(C,B)
redpred_166(A,B) :- p1185(A,C),p261(C,B)
redpred_167(A,B) :- p55(A,C),p1840(C,B)
redpred_168(A,B) :- p1185(A,C),p122(C,B)
redpred_169(A,B) :- p563(A,C),p105(C,B)
redpred_170(A,B) :- skip1(A,C),p606(C,B)
redpred_171(A,B) :- p1185(A,C),p18(C,B)
redpred_172(A,B) :- mk_lowercase(A,C),p422(C,B)
redpred_173(A,B) :- p91(A,C),p91_1(C,B)
redpred_174(A,B) :- p1185(A,C),p1185(C,B)
redpred_175(A,B) :- skip1(A,C),p1546(C,B)
redpred_176(A,B) :- p91_1(A,C),p252(C,B)
redpred_177(A,B) :- copy1(A,C),p233(C,B)
redpred_178(A,B) :- p3(A,C),p739(C,B)
redpred_179(A,B) :- p8(A,C),p1185(C,B)
redpred_180(A,B) :- p105(A,C),p953(C,B)
redpred_181(A,B) :- copy1(A,C),p276(C,B)
redpred_182(A,B) :- p1185(A,C),p143(C,B)
redpred_183(A,B) :- copy1(A,C),p739(C,B)
redpred_184(A,B) :- skip1(A,C),p2053(C,B)
redpred_185(A,B) :- skip1(A,C),p1791(C,B)
...
p142(A,B) :- redpred_11(A,B)
p150(A,B) :- redpred_12(A,B)
p152(A,B) :- redpred_13(A,B)
...
p1463(A,B) :- redpred_15(A,B)
p1464(A,B) :- redpred_2(A,B)
p1465(A,B) :- redpred_10(A,B)
...
p2329(A,B) :- redpred_15(A,B)
p2333(A,B) :- redpred_5(A,B)
p2338(A,B) :- redpred_5(A,B)
p2339(A,B) :- redpred_12(A,B)
p2348(A,B) :- redpred_1(A,B)
p2349(A,B) :- redpred_11(A,B)
...
p1025_1(A,B) :- redpred_17(A,B)
p1029(A,B) :- redpred_39(A,B)
p1031(A,B) :- redpred_27(A,B)
p1034(A,B) :- redpred_65(A,B)
p1035(A,B) :- redpred_37(A,B)
p1037(A,B) :- skip1(A,C),p1037_1(C,B)
p1037_1(A,B) :- redpred_80(A,B)
p1040(A,B) :- redpred_17(A,B)
p1041(A,B) :- redpred_65(A,B)
p1043(A,B) :- p51(A,C),p1043_1(C,B)
p1043_1(A,B) :- redpred_62(A,B)
p1048(A,B) :- skip1(A,C),p1048_1(C,B)
p1048_1(A,B) :- redpred_48(A,B)
...
p158(A,B) :- redpred_123(A,B)
p159(A,B) :- p91(A,C),p1102(C,B)
p160(A,B) :- redpred_124(A,B)
...
p195(A,B) :- redpred_127(A,B)
p196(A,B) :- redpred_128(A,B)
p200(A,B) :- redpred_124(A,B)
p201(A,B) :- p8(A,C),p201_1(C,B)
p201_1(A,B) :- redpred_129(A,B)
p205(A,B) :- mk_lowercase(A,C),p205_1(C,B)
p205_1(A,B) :- redpred_129(A,B)
...
p438(A,B) :- redpred_139(A,B)
p442(A,B) :- redpred_130(A,B)
p443(A,B) :- redpred_140(A,B)
p444(A,B) :- p1157(A,C),p953(C,B)
p445(A,B) :- p150(A,C),p445_1(C,B)
p445_1(A,B) :- redpred_141(A,B)
p447(A,B) :- p963_1(A,C),p340(C,B)
p451(A,B) :- p1238(A,C),p1368(C,B)
p454(A,B) :- redpred_120(A,B)
p455(A,B) :- redpred_142(A,B)
...
p1110_1(A,B) :- redpred_119(A,B)
p1113(A,B) :- p82(A,C),p1637(C,B)
p1114(A,B) :- redpred_164(A,B)
...
p1141(A,B) :- redpred_119(A,B)
p1143(A,B) :- copy1(A,C),p1143_1(C,B)
p1143_1(A,B) :- redpred_118(A,B)
p1144(A,B) :- redpred_161(A,B)
...
p1590_1(A,B) :- redpred_118(A,B)
p1591(A,B) :- p127(A,C),p676(C,B)
p1592(A,B) :- p143(A,C),p676(C,B)
p1594(A,B) :- p485(A,C),p72(C,B)
p1596(A,B) :- redpred_178(A,B)
p1604(A,B) :- p2344(A,C),p2344(C,B)
p1606(A,B) :- redpred_173(A,B)
p1609(A,B) :- skip1(A,C),p1544(C,B)
p1617(A,B) :- redpred_174(A,B)
p1619(A,B) :- redpred_179(A,B)
p1630(A,B) :- redpred_180(A,B)
...
p1797_1(A,B) :- redpred_118(A,B)
p1798(A,B) :- redpred_138(A,B)
...
p1818_1(A,B) :- redpred_149(A,B)
p1823(A,B) :- p3(A,C),p1823_1(C,B)
p1823_1(A,B) :- redpred_110(A,B)
...
p2097_1(A,B) :- redpred_165(A,B)
p2098(A,B) :- redpred_182(A,B)
p2099(A,B) :- p18(A,C),p739(C,B)
p2101(A,B) :- redpred_183(A,B)
...
p2146(A,B) :- redpred_111(A,B)
p2151(A,B) :- skip1(A,C),p2151_1(C,B)
p2151_1(A,B) :- redpred_170(A,B)
...
p78(A,B) :- redpred_184(A,B)
p85(A,B) :- redpred_184(A,B)
