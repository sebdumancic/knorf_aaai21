...
redpred_12(A,B) :- skip1(A,C),p5(C,B)
redpred_13(A,B) :- copy1(A,C),p5(C,B)
redpred_14(A,B) :- p296(A,C),mk_lowercase(C,B)
redpred_15(A,B) :- p5(A,C),mk_lowercase(C,B)
redpred_16(A,B) :- copy1(A,C),p142(C,B)
redpred_17(A,B) :- copy1(A,C),p96(C,B)
redpred_18(A,B) :- p142(A,C),p5(C,B)
redpred_19(A,B) :- p5(A,C),p142(C,B)
redpred_20(A,B) :- p142(A,C),p27(C,B)
redpred_21(A,B) :- p27(A,C),p5(C,B)
redpred_22(A,B) :- p96(A,C),p5(C,B)
redpred_23(A,B) :- p5(A,C),p5(C,B)
redpred_24(A,B) :- skip1(A,C),p142(C,B)
redpred_25(A,B) :- p5(A,C),p96(C,B)
redpred_26(A,B) :- p27(A,C),p97(C,B)
redpred_27(A,B) :- p96(A,C),mk_uppercase(C,B)
redpred_28(A,B) :- p97(A,C),p27(C,B)
redpred_29(A,B) :- skip1(A,C),p753(C,B)
redpred_30(A,B) :- p27(A,C),p142(C,B)
redpred_31(A,B) :- skip1(A,C),p27(C,B)
redpred_32(A,B) :- p142(A,C),p120(C,B)
redpred_33(A,B) :- p5(A,C),p296(C,B)
redpred_34(A,B) :- p142(A,C),p142(C,B)
redpred_35(A,B) :- skip1(A,C),p36(C,B)
redpred_36(A,B) :- p36(A,C),p142(C,B)
redpred_37(A,B) :- p36(A,C),p5(C,B)
redpred_38(A,B) :- mk_uppercase(A,C),p142(C,B)
redpred_39(A,B) :- p142(A,C),mk_lowercase(C,B)
redpred_40(A,B) :- skip1(A,C),p96(C,B)
redpred_41(A,B) :- p5(A,C),p27(C,B)
redpred_42(A,B) :- p142(A,C),p574(C,B)
redpred_43(A,B) :- copy1(A,C),p36(C,B)
redpred_44(A,B) :- mk_lowercase(A,C),p5(C,B)
redpred_45(A,B) :- p5(A,C),p36(C,B)
redpred_46(A,B) :- skip1(A,C),p97(C,B)
redpred_47(A,B) :- p97(A,C),p5(C,B)
redpred_48(A,B) :- p142(A,C),p296(C,B)
redpred_49(A,B) :- skip1(A,C),p296(C,B)
redpred_50(A,B) :- copy1(A,C),p753(C,B)
redpred_51(A,B) :- copy1(A,C),p35(C,B)
redpred_52(A,B) :- p128(A,C),p142(C,B)
redpred_53(A,B) :- p774(A,C),p359(C,B)
redpred_54(A,B) :- mk_lowercase(A,C),p35(C,B)
redpred_55(A,B) :- skip1(A,C),p359(C,B)
redpred_56(A,B) :- p100_1(A,C),p34_1(C,B)
redpred_57(A,B) :- p1_1(A,C),p44(C,B)
redpred_58(A,B) :- p59_1(A,C),p17(C,B)
redpred_59(A,B) :- skip1(A,C),p774(C,B)
redpred_60(A,B) :- p35(A,C),p24_1(C,B)
redpred_61(A,B) :- skip1(A,C),p35(C,B)
redpred_62(A,B) :- p35(A,C),p34_1(C,B)
redpred_63(A,B) :- p648(A,C),p1_1(C,B)
redpred_64(A,B) :- p1(A,C),mk_uppercase(C,B)
...
p219_1(A,B) :- redpred_36(A,B)
p222(A,B) :- p36(A,C),p222_1(C,B)
p222_1(A,B) :- redpred_37(A,B)
p223(A,B) :- redpred_21(A,B)
...
p421_1(A,B) :- redpred_27(A,B)
p430(A,B) :- redpred_38(A,B)
p432(A,B) :- redpred_15(A,B)
...
p463_1(A,B) :- redpred_59(A,B)
p465(A,B) :- redpred_62(A,B)
...
p630(A,B) :- redpred_61(A,B)
p634(A,B) :- redpred_64(A,B)
