...
redpred_14(A,B) :- p32(A,C),p31(C,B)
redpred_15(A,B) :- skip1(A,C),p187(C,B)
redpred_16(A,B) :- mk_uppercase(A,C),p49(C,B)
redpred_17(A,B) :- p49(A,C),p1(C,B)
redpred_18(A,B) :- skip1(A,C),p49(C,B)
redpred_19(A,B) :- copy1(A,C),p1(C,B)
redpred_20(A,B) :- copy1(A,C),p181(C,B)
redpred_21(A,B) :- p14(A,C),p14(C,B)
redpred_22(A,B) :- p14(A,C),p63(C,B)
redpred_23(A,B) :- skip1(A,C),p1(C,B)
redpred_24(A,B) :- p14(A,C),p49(C,B)
redpred_25(A,B) :- mk_uppercase(A,C),p14(C,B)
redpred_26(A,B) :- skip1(A,C),p63(C,B)
redpred_27(A,B) :- p49(A,C),p187(C,B)
redpred_28(A,B) :- skip1(A,C),p32(C,B)
redpred_29(A,B) :- p14(A,C),p32(C,B)
redpred_30(A,B) :- skip1(A,C),p181(C,B)
redpred_31(A,B) :- copy1(A,C),p49(C,B)
redpred_32(A,B) :- skip1(A,C),p31(C,B)
redpred_33(A,B) :- p49(A,C),p14(C,B)
redpred_34(A,B) :- p49(A,C),p49(C,B)
redpred_35(A,B) :- p19(A,C),p14(C,B)
redpred_36(A,B) :- skip1(A,C),p14(C,B)
redpred_37(A,B) :- p19(A,C),p32(C,B)
redpred_38(A,B) :- p14(A,C),p1(C,B)
redpred_39(A,B) :- p63(A,C),p49(C,B)
redpred_40(A,B) :- skip1(A,C),p964(C,B)
redpred_41(A,B) :- p49(A,C),p63(C,B)
redpred_42(A,B) :- p1(A,C),p187(C,B)
redpred_43(A,B) :- mk_lowercase(A,C),p49(C,B)
redpred_44(A,B) :- p187(A,C),p49(C,B)
redpred_45(A,B) :- copy1(A,C),p14(C,B)
redpred_46(A,B) :- p32(A,C),p14(C,B)
redpred_47(A,B) :- p32(A,C),p187(C,B)
redpred_48(A,B) :- p19(A,C),p49(C,B)
redpred_49(A,B) :- copy1(A,C),p187(C,B)
redpred_50(A,B) :- mk_uppercase(A,C),p187(C,B)
redpred_51(A,B) :- p1(A,C),p14(C,B)
redpred_52(A,B) :- p1(A,C),p19(C,B)
redpred_53(A,B) :- p14(A,C),p187(C,B)
redpred_54(A,B) :- skip1(A,C),p19(C,B)
redpred_55(A,B) :- p49(A,C),p19(C,B)
redpred_56(A,B) :- p1(A,C),p49(C,B)
redpred_57(A,B) :- skip1(A,C),p725(C,B)
redpred_58(A,B) :- p49(A,C),p596(C,B)
redpred_59(A,B) :- p14(A,C),p19(C,B)
redpred_60(A,B) :- copy1(A,C),p32(C,B)
redpred_61(A,B) :- copy1(A,C),p63(C,B)
redpred_62(A,B) :- copy1(A,C),p31(C,B)
redpred_63(A,B) :- p1(A,C),p32(C,B)
redpred_64(A,B) :- p63(A,C),p19(C,B)
redpred_65(A,B) :- p187(A,C),p1(C,B)
redpred_66(A,B) :- p31(A,C),p63(C,B)
redpred_67(A,B) :- copy1(A,C),p19(C,B)
redpred_68(A,B) :- copy1(A,C),p106(C,B)
redpred_69(A,B) :- p32(A,C),p241(C,B)
redpred_70(A,B) :- p23(A,C),p18_1(C,B)
redpred_71(A,B) :- skip1(A,C),p291(C,B)
redpred_72(A,B) :- p14(A,C),p18(C,B)
redpred_73(A,B) :- p18(A,C),p45(C,B)
redpred_74(A,B) :- p27(A,C),p18_1(C,B)
redpred_75(A,B) :- p589(A,C),p104(C,B)
redpred_76(A,B) :- p284(A,C),p919(C,B)
redpred_77(A,B) :- p241(A,C),p175(C,B)
redpred_78(A,B) :- skip1(A,C),p18(C,B)
redpred_79(A,B) :- p241(A,C),p14(C,B)
redpred_80(A,B) :- skip1(A,C),p882(C,B)
redpred_81(A,B) :- p49(A,C),p189(C,B)
redpred_82(A,B) :- p284(A,C),p20(C,B)
redpred_83(A,B) :- p20(A,C),p45(C,B)
redpred_84(A,B) :- p20(A,C),p115(C,B)
redpred_85(A,B) :- copy1(A,C),p241(C,B)
redpred_86(A,B) :- p284(A,C),p408_1(C,B)
redpred_87(A,B) :- p394(A,C),p187(C,B)
redpred_88(A,B) :- skip1(A,C),p580(C,B)
redpred_89(A,B) :- skip1(A,C),p241(C,B)
redpred_90(A,B) :- p284(A,C),p45(C,B)
redpred_91(A,B) :- p18(A,C),p48_1(C,B)
redpred_92(A,B) :- p207(A,C),p48_1(C,B)
redpred_93(A,B) :- p241(A,C),p284(C,B)
redpred_94(A,B) :- skip1(A,C),p106(C,B)
redpred_95(A,B) :- p698(A,C),mk_lowercase(C,B)
redpred_96(A,B) :- p424_1(A,C),mk_uppercase(C,B)
...
p316_1(A,B) :- redpred_28(A,B)
p318(A,B) :- p964(A,C),p318_1(C,B)
p318_1(A,B) :- redpred_30(A,B)
p320(A,B) :- redpred_36(A,B)
p328(A,B) :- redpred_37(A,B)
p332(A,B) :- skip1(A,C),p332_1(C,B)
p332_1(A,B) :- redpred_47(A,B)
p337(A,B) :- redpred_18(A,B)
p339(A,B) :- mk_lowercase(A,C),p339_1(C,B)
p339_1(A,B) :- redpred_48(A,B)
...
p381_1(A,B) :- redpred_51(A,B)
p382(A,B) :- p31(A,C),p382_1(C,B)
p382_1(A,B) :- redpred_52(A,B)
...
p503(A,B) :- redpred_18(A,B)
p509(A,B) :- p14(A,C),p509_1(C,B)
p509_1(A,B) :- redpred_32(A,B)
...
p621_1(A,B) :- redpred_59(A,B)
p623(A,B) :- skip1(A,C),p623_1(C,B)
p623_1(A,B) :- redpred_34(A,B)
p627(A,B) :- redpred_60(A,B)
...
p740_1(A,B) :- redpred_18(A,B)
p741(A,B) :- p31(A,C),p741_1(C,B)
p741_1(A,B) :- redpred_34(A,B)
...
p30(A,B) :- redpred_68(A,B)
p33(A,B) :- mk_lowercase(A,C),p33_1(C,B)
p33_1(A,B) :- redpred_69(A,B)
...
p62(A,B) :- redpred_70(A,B)
p64(A,B) :- p45(A,C),p394(C,B)
p65(A,B) :- redpred_71(A,B)
p68(A,B) :- redpred_72(A,B)
p71(A,B) :- redpred_73(A,B)
p72(A,B) :- p159(A,C),p644(C,B)
p75(A,B) :- p104(A,C),p75_1(C,B)
p75_1(A,B) :- skip1(A,C),p959(C,B)
p76(A,B) :- redpred_68(A,B)
p77(A,B) :- p175(A,C),p197(C,B)
p79(A,B) :- redpred_74(A,B)
...
p276(A,B) :- redpred_83(A,B)
p282(A,B) :- p674(A,C),p37_1(C,B)
p283(A,B) :- redpred_84(A,B)
p296(A,B) :- redpred_85(A,B)
...
p424_1(A,B) :- redpred_89(A,B)
p426(A,B) :- p63(A,C),p106(C,B)
p427(A,B) :- redpred_88(A,B)
...
p999_1(A,B) :- redpred_95(A,B)
p52(A,B) :- p277(A,C),p52_1(C,B)
p52_1(A,B) :- redpred_96(A,B)
