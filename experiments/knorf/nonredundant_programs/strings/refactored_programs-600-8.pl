...
redpred_13(A,B) :- not_empty(A),mk_uppercase(A,B)
redpred_14(A,B) :- copy1(A,C),mk_uppercase(C,B)
redpred_15(A,B) :- mk_uppercase(A,C),copy1(C,B)
redpred_16(A,B) :- mk_uppercase(A,C),p46(C,B)
redpred_17(A,B) :- p94(A,C),p46(C,B)
redpred_18(A,B) :- p16(A,C),p288(C,B)
redpred_19(A,B) :- p46(A,C),p16(C,B)
redpred_20(A,B) :- copy1(A,C),p46(C,B)
redpred_21(A,B) :- copy1(A,C),p69(C,B)
redpred_22(A,B) :- copy1(A,C),p288(C,B)
redpred_23(A,B) :- p46(A,C),p46(C,B)
redpred_24(A,B) :- skip1(A,C),p46(C,B)
redpred_25(A,B) :- p69(A,C),p46(C,B)
redpred_26(A,B) :- p46(A,C),p69(C,B)
redpred_27(A,B) :- p16(A,C),p46(C,B)
redpred_28(A,B) :- skip1(A,C),p10(C,B)
redpred_29(A,B) :- p16(A,C),p345(C,B)
redpred_30(A,B) :- copy1(A,C),p16(C,B)
redpred_31(A,B) :- skip1(A,C),p2(C,B)
redpred_32(A,B) :- skip1(A,C),p205(C,B)
redpred_33(A,B) :- skip1(A,C),p16(C,B)
redpred_34(A,B) :- p16(A,C),p16(C,B)
redpred_35(A,B) :- p46(A,C),p345(C,B)
redpred_36(A,B) :- p46(A,C),p2(C,B)
redpred_37(A,B) :- mk_lowercase(A,C),p16(C,B)
redpred_38(A,B) :- p16(A,C),p205(C,B)
redpred_39(A,B) :- skip1(A,C),p31(C,B)
redpred_40(A,B) :- p16(A,C),p2(C,B)
redpred_41(A,B) :- p345(A,C),p16(C,B)
redpred_42(A,B) :- mk_uppercase(A,C),p16(C,B)
redpred_43(A,B) :- skip1(A,C),p288(C,B)
redpred_44(A,B) :- p69(A,C),p10(C,B)
redpred_45(A,B) :- p46(A,C),p10(C,B)
redpred_46(A,B) :- p46(A,C),p205(C,B)
redpred_47(A,B) :- mk_lowercase(A,C),p46(C,B)
redpred_48(A,B) :- p205(A,C),p345(C,B)
redpred_49(A,B) :- copy1(A,C),p2(C,B)
redpred_50(A,B) :- p16(A,C),p10(C,B)
redpred_51(A,B) :- p25(A,C),p46(C,B)
redpred_52(A,B) :- p69(A,C),p16(C,B)
redpred_53(A,B) :- p2(A,C),p46(C,B)
redpred_54(A,B) :- skip1(A,C),p69(C,B)
redpred_55(A,B) :- p69(A,C),mk_uppercase(C,B)
redpred_56(A,B) :- skip1(A,C),p93_1(C,B)
redpred_57(A,B) :- p46(A,C),p377(C,B)
redpred_58(A,B) :- p10(A,C),p100_1(C,B)
redpred_59(A,B) :- skip1(A,C),p563(C,B)
redpred_60(A,B) :- skip1(A,C),p342(C,B)
redpred_61(A,B) :- mk_lowercase(A,C),p563(C,B)
redpred_62(A,B) :- p301_1(A,C),mk_uppercase(C,B)
redpred_63(A,B) :- p16(A,C),p100(C,B)
redpred_64(A,B) :- p43_1(A,C),p76(C,B)
redpred_65(A,B) :- p93(A,C),p16(C,B)
redpred_66(A,B) :- copy1(A,C),p563(C,B)
redpred_67(A,B) :- p563(A,C),p46(C,B)
redpred_68(A,B) :- p10(A,C),p338(C,B)
redpred_69(A,B) :- skip1(A,C),p504(C,B)
redpred_70(A,B) :- skip1(A,C),p143(C,B)
redpred_71(A,B) :- skip1(A,C),p9_1(C,B)
...
p226_1(A,B) :- redpred_24(A,B)
p229(A,B) :- p16(A,C),p229_1(C,B)
p229_1(A,B) :- redpred_31(A,B)
...
p434(A,B) :- redpred_20(A,B)
p435(A,B) :- p16(A,C),p435_1(C,B)
p435_1(A,B) :- redpred_34(A,B)
...
p98_1(A,B) :- redpred_70(A,B)
p113(A,B) :- p18(A,C),p113_1(C,B)
p113_1(A,B) :- redpred_71(A,B)
...
p144_1(A,B) :- redpred_71(A,B)
p145(A,B) :- redpred_70(A,B)
