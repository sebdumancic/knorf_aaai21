...
redpred_16(A,B) :- skip1(A,C),p95(C,B)
redpred_17(A,B) :- p33(A,C),p47(C,B)
redpred_18(A,B) :- copy1(A,C),p47(C,B)
redpred_19(A,B) :- skip1(A,C),p220(C,B)
redpred_20(A,B) :- p220(A,C),p33(C,B)
redpred_21(A,B) :- p47(A,C),p33(C,B)
redpred_22(A,B) :- p33(A,C),p33(C,B)
redpred_23(A,B) :- p33(A,C),p220(C,B)
redpred_24(A,B) :- p364(A,C),p33(C,B)
redpred_25(A,B) :- skip1(A,C),p47(C,B)
redpred_26(A,B) :- p315(A,C),p78(C,B)
redpred_27(A,B) :- skip1(A,C),p33(C,B)
redpred_28(A,B) :- copy1(A,C),p220(C,B)
redpred_29(A,B) :- p95(A,C),p95(C,B)
redpred_30(A,B) :- p78(A,C),p95(C,B)
redpred_31(A,B) :- p364(A,C),p218(C,B)
redpred_32(A,B) :- copy1(A,C),p621(C,B)
redpred_33(A,B) :- p95(A,C),p143(C,B)
redpred_34(A,B) :- skip1(A,C),p218(C,B)
redpred_35(A,B) :- copy1(A,C),p315(C,B)
redpred_36(A,B) :- p95(A,C),p33(C,B)
redpred_37(A,B) :- mk_lowercase(A,C),p315(C,B)
redpred_38(A,B) :- copy1(A,C),p95(C,B)
redpred_39(A,B) :- p400(A,C),p95(C,B)
redpred_40(A,B) :- p78(A,C),p364(C,B)
redpred_41(A,B) :- p95(A,C),p78(C,B)
redpred_42(A,B) :- p218(A,C),p220(C,B)
redpred_43(A,B) :- p220(A,C),p95(C,B)
redpred_44(A,B) :- mk_uppercase(A,C),p33(C,B)
redpred_45(A,B) :- p621(A,C),p33(C,B)
redpred_46(A,B) :- p78(A,C),p33(C,B)
redpred_47(A,B) :- copy1(A,C),p143(C,B)
redpred_48(A,B) :- skip1(A,C),p143(C,B)
redpred_49(A,B) :- p218(A,C),p33(C,B)
redpred_50(A,B) :- p95(A,C),p220(C,B)
redpred_51(A,B) :- p33(A,C),p95(C,B)
redpred_52(A,B) :- mk_lowercase(A,C),p33(C,B)
redpred_53(A,B) :- p218(A,C),p95(C,B)
redpred_54(A,B) :- p315(A,C),p33(C,B)
redpred_55(A,B) :- copy1(A,C),p218(C,B)
redpred_56(A,B) :- mk_lowercase(A,C),p95(C,B)
redpred_57(A,B) :- p143(A,C),p95(C,B)
redpred_58(A,B) :- p78(A,C),p218(C,B)
redpred_59(A,B) :- skip1(A,C),p78(C,B)
redpred_60(A,B) :- p47(A,C),p315(C,B)
redpred_61(A,B) :- p174(A,C),p33(C,B)
redpred_62(A,B) :- p218(A,C),p47(C,B)
redpred_63(A,B) :- p95(A,C),p315(C,B)
redpred_64(A,B) :- skip1(A,C),p315(C,B)
redpred_65(A,B) :- p95(A,C),p218(C,B)
redpred_66(A,B) :- mk_lowercase(A,C),p78(C,B)
redpred_67(A,B) :- p315(A,C),p143(C,B)
redpred_68(A,B) :- p33(A,C),p143(C,B)
redpred_69(A,B) :- p218(A,C),p218(C,B)
redpred_70(A,B) :- p33(A,C),p315(C,B)
redpred_71(A,B) :- copy1(A,C),p33(C,B)
redpred_72(A,B) :- skip1(A,C),p364(C,B)
redpred_73(A,B) :- mk_uppercase(A,C),p143(C,B)
redpred_74(A,B) :- skip1(A,C),p400(C,B)
redpred_75(A,B) :- p33(A,C),p78(C,B)
redpred_76(A,B) :- mk_lowercase(A,C),p47(C,B)
redpred_77(A,B) :- p143(A,C),p33(C,B)
redpred_78(A,B) :- p400(A,C),p218(C,B)
redpred_79(A,B) :- p220(A,C),p315(C,B)
redpred_80(A,B) :- skip1(A,C),p621(C,B)
redpred_81(A,B) :- mk_uppercase(A,C),p315(C,B)
redpred_82(A,B) :- copy1(A,C),p78(C,B)
redpred_83(A,B) :- p95(A,C),p47(C,B)
redpred_84(A,B) :- p78(A,C),p47(C,B)
redpred_85(A,B) :- p78(A,C),p220(C,B)
redpred_86(A,B) :- p143(A,C),p47(C,B)
redpred_87(A,B) :- p47(A,C),p78(C,B)
redpred_88(A,B) :- skip1(A,C),p174(C,B)
redpred_89(A,B) :- p218(A,C),p78(C,B)
redpred_90(A,B) :- p315(A,C),p315(C,B)
redpred_91(A,B) :- p47(A,C),p95(C,B)
redpred_92(A,B) :- p621(A,C),p95(C,B)
redpred_93(A,B) :- p143(A,C),p315(C,B)
redpred_94(A,B) :- copy1(A,C),p174(C,B)
redpred_95(A,B) :- p174(A,C),p315(C,B)
redpred_96(A,B) :- p364(A,C),p47(C,B)
redpred_97(A,B) :- p78(A,C),p315(C,B)
redpred_98(A,B) :- mk_uppercase(A,C),p95(C,B)
redpred_99(A,B) :- p47(A,C),p143(C,B)
redpred_100(A,B) :- skip1(A,C),p231(C,B)
redpred_101(A,B) :- copy1(A,C),p32(C,B)
redpred_102(A,B) :- copy1(A,C),p1(C,B)
redpred_103(A,B) :- copy1(A,C),p72(C,B)
redpred_104(A,B) :- skip1(A,C),p32(C,B)
redpred_105(A,B) :- skip1(A,C),p1539(C,B)
redpred_106(A,B) :- p337(A,C),p231(C,B)
redpred_107(A,B) :- p124(A,C),p218(C,B)
redpred_108(A,B) :- skip1(A,C),p788(C,B)
redpred_109(A,B) :- skip1(A,C),p1(C,B)
redpred_110(A,B) :- p72(A,C),p94(C,B)
redpred_111(A,B) :- p94(A,C),p46_1(C,B)
redpred_112(A,B) :- p167_1(A,C),p32(C,B)
redpred_113(A,B) :- p93(A,C),p148(C,B)
redpred_114(A,B) :- p212_1(A,C),p404(C,B)
redpred_115(A,B) :- p20_1(A,C),p276_1(C,B)
redpred_116(A,B) :- p725(A,C),p167_1(C,B)
redpred_117(A,B) :- copy1(A,C),p231(C,B)
redpred_118(A,B) :- skip1(A,C),p961(C,B)
redpred_119(A,B) :- p220(A,C),p751(C,B)
redpred_120(A,B) :- p143(A,C),p32(C,B)
redpred_121(A,B) :- skip1(A,C),p279(C,B)
redpred_122(A,B) :- p388(A,C),p337(C,B)
redpred_123(A,B) :- skip1(A,C),p145(C,B)
redpred_124(A,B) :- p709(A,C),p143(C,B)
redpred_125(A,B) :- copy1(A,C),p751(C,B)
redpred_126(A,B) :- p46(A,C),p46_1(C,B)
redpred_127(A,B) :- p751(A,C),p151_1(C,B)
redpred_128(A,B) :- p33(A,C),p725(C,B)
redpred_129(A,B) :- p95(A,C),p231(C,B)
redpred_130(A,B) :- skip1(A,C),p572(C,B)
redpred_131(A,B) :- p33(A,C),p32(C,B)
redpred_132(A,B) :- p337(A,C),p32(C,B)
redpred_133(A,B) :- copy1(A,C),p46(C,B)
redpred_134(A,B) :- copy1(A,C),p926(C,B)
redpred_135(A,B) :- skip1(A,C),p273_1(C,B)
redpred_136(A,B) :- skip1(A,C),p207(C,B)
...
p144_1(A,B) :- redpred_33(A,B)
p145(A,B) :- p145_1(A,C),p145_1(C,B)
p145_1(A,B) :- redpred_38(A,B)
...
p409(A,B) :- redpred_54(A,B)
p411(A,B) :- p47(A,C),p411_1(C,B)
p411_1(A,B) :- redpred_27(A,B)
p413(A,B) :- p413_1(A,C),p413_1(C,B)
p413_1(A,B) :- redpred_36(A,B)
...
p438_1(A,B) :- redpred_64(A,B)
p443(A,B) :- copy1(A,C),p443_1(C,B)
p443_1(A,B) :- redpred_59(A,B)
...
p454_1(A,B) :- redpred_77(A,B)
p455(A,B) :- p33(A,C),p455_1(C,B)
p455_1(A,B) :- redpred_25(A,B)
p465(A,B) :- redpred_51(A,B)
p467(A,B) :- redpred_64(A,B)
p470(A,B) :- redpred_36(A,B)
p471(A,B) :- p220(A,C),p47(C,B)
p472(A,B) :- p472_1(A,C),p472_1(C,B)
p472_1(A,B) :- redpred_16(A,B)
p473(A,B) :- p33(A,C),p473_1(C,B)
p473_1(A,B) :- redpred_34(A,B)
p476(A,B) :- copy1(A,C),p476_1(C,B)
p476_1(A,B) :- redpred_78(A,B)
p479(A,B) :- p33(A,C),p479_1(C,B)
p479_1(A,B) :- redpred_36(A,B)
p482(A,B) :- redpred_19(A,B)
p484(A,B) :- redpred_16(A,B)
...
p943_1(A,B) :- redpred_16(A,B)
p947(A,B) :- redpred_85(A,B)
...
p961_1(A,B) :- redpred_25(A,B)
p965(A,B) :- redpred_22(A,B)
p966(A,B) :- redpred_91(A,B)
p969(A,B) :- redpred_27(A,B)
p970(A,B) :- p95(A,C),p970_1(C,B)
p970_1(A,B) :- redpred_34(A,B)
p973(A,B) :- redpred_62(A,B)
p977(A,B) :- redpred_57(A,B)
p981(A,B) :- mk_lowercase(A,C),p981_1(C,B)
p981_1(A,B) :- redpred_62(A,B)
p982(A,B) :- redpred_28(A,B)
...
p1223_1(A,B) :- redpred_64(A,B)
p1228(A,B) :- mk_lowercase(A,C),p1228_1(C,B)
p1228_1(A,B) :- redpred_16(A,B)
p1231(A,B) :- redpred_38(A,B)
p1233(A,B) :- skip1(A,C),p1233_1(C,B)
p1233_1(A,B) :- redpred_16(A,B)
p1236(A,B) :- p33(A,C),p1236_1(C,B)
p1236_1(A,B) :- redpred_16(A,B)
...
p107_1(A,B) :- redpred_104(A,B)
p116(A,B) :- redpred_105(A,B)
...
p445_1(A,B) :- redpred_104(A,B)
p448(A,B) :- p47(A,C),p448_1(C,B)
p448_1(A,B) :- redpred_109(A,B)
...
p468_1(A,B) :- redpred_118(A,B)
p469(A,B) :- p767(A,C),p218(C,B)
p475(A,B) :- p95(A,C),p475_1(C,B)
p475_1(A,B) :- redpred_109(A,B)
p481(A,B) :- redpred_120(A,B)
...
p891(A,B) :- redpred_127(A,B)
p893(A,B) :- redpred_101(A,B)
p896(A,B) :- copy1(A,C),p896_1(C,B)
p896_1(A,B) :- redpred_104(A,B)
p899(A,B) :- redpred_119(A,B)
p900(A,B) :- redpred_117(A,B)
p902(A,B) :- p811(A,C),p902_1(C,B)
p902_1(A,B) :- p364(A,C),p138_1(C,B)
p903(A,B) :- redpred_112(A,B)
...
p1429(A,B) :- redpred_103(A,B)
p1430(A,B) :- redpred_106(A,B)
p1434(A,B) :- p557(A,C),p192_1(C,B)
p1436(A,B) :- redpred_101(A,B)
...
p1563(A,B) :- redpred_134(A,B)
p1565(A,B) :- redpred_132(A,B)
p1571(A,B) :- p20_1(A,C),p719(C,B)
p1573(A,B) :- p1(A,C),p80(C,B)
p1574(A,B) :- redpred_128(A,B)
