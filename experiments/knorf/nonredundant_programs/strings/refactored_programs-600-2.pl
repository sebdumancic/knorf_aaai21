...
redpred_13(A,B) :- p113(A,C),p37(C,B)
redpred_14(A,B) :- p37(A,C),p8(C,B)
redpred_15(A,B) :- skip1(A,C),p239(C,B)
redpred_16(A,B) :- p104(A,C),p8(C,B)
redpred_17(A,B) :- p37(A,C),p37(C,B)
redpred_18(A,B) :- copy1(A,C),p239(C,B)
redpred_19(A,B) :- p239(A,C),p37(C,B)
redpred_20(A,B) :- p8(A,C),p37(C,B)
redpred_21(A,B) :- copy1(A,C),p104(C,B)
redpred_22(A,B) :- skip1(A,C),p37(C,B)
redpred_23(A,B) :- skip1(A,C),p8(C,B)
redpred_24(A,B) :- skip1(A,C),p90(C,B)
redpred_25(A,B) :- copy1(A,C),p8(C,B)
redpred_26(A,B) :- p8(A,C),p309(C,B)
redpred_27(A,B) :- p309(A,C),p8(C,B)
redpred_28(A,B) :- mk_lowercase(A,C),p37(C,B)
redpred_29(A,B) :- skip1(A,C),p107(C,B)
redpred_30(A,B) :- p37(A,C),p239(C,B)
redpred_31(A,B) :- skip1(A,C),p240(C,B)
redpred_32(A,B) :- skip1(A,C),p309(C,B)
redpred_33(A,B) :- p107(A,C),p37(C,B)
redpred_34(A,B) :- p240(A,C),p8(C,B)
redpred_35(A,B) :- p37(A,C),p113(C,B)
redpred_36(A,B) :- p240(A,C),p37(C,B)
redpred_37(A,B) :- p37(A,C),p432(C,B)
redpred_38(A,B) :- p8(A,C),p189(C,B)
redpred_39(A,B) :- copy1(A,C),p240(C,B)
redpred_40(A,B) :- p113(A,C),p239(C,B)
redpred_41(A,B) :- p8(A,C),p8(C,B)
redpred_42(A,B) :- skip1(A,C),p189(C,B)
redpred_43(A,B) :- copy1(A,C),p37(C,B)
redpred_44(A,B) :- p37(A,C),p104(C,B)
redpred_45(A,B) :- skip1(A,C),p104(C,B)
redpred_46(A,B) :- mk_lowercase(A,C),p107(C,B)
redpred_47(A,B) :- p240(A,C),p309(C,B)
redpred_48(A,B) :- p37(A,C),p240(C,B)
redpred_49(A,B) :- skip1(A,C),p206(C,B)
redpred_50(A,B) :- copy1(A,C),p136(C,B)
redpred_51(A,B) :- p39_1(A,C),p206(C,B)
redpred_52(A,B) :- p422(A,C),p37(C,B)
redpred_53(A,B) :- p46(A,C),p38(C,B)
redpred_54(A,B) :- p422(A,C),p24_1(C,B)
redpred_55(A,B) :- p322(A,C),copy1(C,B)
redpred_56(A,B) :- skip1(A,C),p69(C,B)
redpred_57(A,B) :- skip1(A,C),p73(C,B)
redpred_58(A,B) :- skip1(A,C),p308(C,B)
redpred_59(A,B) :- skip1(A,C),p257_1(C,B)
redpred_60(A,B) :- skip1(A,C),p278(C,B)
redpred_61(A,B) :- skip1(A,C),p39(C,B)
redpred_62(A,B) :- p33(A,C),p136(C,B)
...
p598_1(A,B) :- redpred_41(A,B)
p599(A,B) :- copy1(A,C),p599_1(C,B)
p599_1(A,B) :- redpred_23(A,B)
p1(A,B) :- p8(A,C),p39(C,B)
p2(A,B) :- redpred_50(A,B)
p7(A,B) :- p322(A,C),p7_1(C,B)
p7_1(A,B) :- redpred_51(A,B)
