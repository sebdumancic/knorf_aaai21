...
redpred_16(A,B) :- p27(A,C),p121(C,B)
redpred_17(A,B) :- p27(A,C),p27(C,B)
redpred_18(A,B) :- p5(A,C),p67(C,B)
redpred_19(A,B) :- skip1(A,C),p27(C,B)
redpred_20(A,B) :- skip1(A,C),p51(C,B)
redpred_21(A,B) :- p48(A,C),p5(C,B)
redpred_22(A,B) :- skip1(A,C),p121(C,B)
redpred_23(A,B) :- p27(A,C),p5(C,B)
redpred_24(A,B) :- mk_lowercase(A,C),p102(C,B)
redpred_25(A,B) :- p67(A,C),p169(C,B)
redpred_26(A,B) :- copy1(A,C),p5(C,B)
redpred_27(A,B) :- p121(A,C),p27(C,B)
redpred_28(A,B) :- p5(A,C),p94(C,B)
redpred_29(A,B) :- copy1(A,C),p27(C,B)
redpred_30(A,B) :- p48(A,C),p27(C,B)
redpred_31(A,B) :- skip1(A,C),p67(C,B)
redpred_32(A,B) :- copy1(A,C),p102(C,B)
redpred_33(A,B) :- p102(A,C),p27(C,B)
redpred_34(A,B) :- p67(A,C),p67(C,B)
redpred_35(A,B) :- copy1(A,C),p407(C,B)
redpred_36(A,B) :- p67(A,C),p407(C,B)
redpred_37(A,B) :- mk_lowercase(A,C),p48(C,B)
redpred_38(A,B) :- copy1(A,C),p48(C,B)
redpred_39(A,B) :- p27(A,C),p48(C,B)
redpred_40(A,B) :- p27(A,C),p102(C,B)
redpred_41(A,B) :- p169(A,C),p67(C,B)
redpred_42(A,B) :- p5(A,C),p48(C,B)
redpred_43(A,B) :- p5(A,C),p27(C,B)
redpred_44(A,B) :- copy1(A,C),p51(C,B)
redpred_45(A,B) :- skip1(A,C),p5(C,B)
redpred_46(A,B) :- skip1(A,C),p169(C,B)
redpred_47(A,B) :- p27(A,C),p94(C,B)
redpred_48(A,B) :- p5(A,C),p5(C,B)
redpred_49(A,B) :- p102(A,C),p5(C,B)
redpred_50(A,B) :- copy1(A,C),p67(C,B)
redpred_51(A,B) :- skip1(A,C),p407(C,B)
redpred_52(A,B) :- mk_lowercase(A,C),p121(C,B)
redpred_53(A,B) :- p102(A,C),p121(C,B)
redpred_54(A,B) :- p5(A,C),p169(C,B)
redpred_55(A,B) :- p27(A,C),p67(C,B)
redpred_56(A,B) :- p27(A,C),p407(C,B)
redpred_57(A,B) :- mk_lowercase(A,C),p5(C,B)
redpred_58(A,B) :- p407(A,C),p27(C,B)
redpred_59(A,B) :- p27(A,C),p169(C,B)
redpred_60(A,B) :- copy1(A,C),p94(C,B)
redpred_61(A,B) :- p5(A,C),p102(C,B)
redpred_62(A,B) :- skip1(A,C),p701(C,B)
redpred_63(A,B) :- copy1(A,C),p121(C,B)
redpred_64(A,B) :- skip1(A,C),p102(C,B)
redpred_65(A,B) :- skip1(A,C),p48(C,B)
redpred_66(A,B) :- mk_uppercase(A,C),p27(C,B)
redpred_67(A,B) :- p121(A,C),p48(C,B)
redpred_68(A,B) :- p121(A,C),p5(C,B)
redpred_69(A,B) :- copy1(A,C),p169(C,B)
redpred_70(A,B) :- mk_uppercase(A,C),p48(C,B)
redpred_71(A,B) :- p102(A,C),p102(C,B)
redpred_72(A,B) :- p51(A,C),p67(C,B)
redpred_73(A,B) :- p5(A,C),p121(C,B)
redpred_74(A,B) :- p67(A,C),p27(C,B)
redpred_75(A,B) :- p5(A,C),p407(C,B)
redpred_76(A,B) :- p67(A,C),p94(C,B)
redpred_77(A,B) :- mk_uppercase(A,C),p407(C,B)
redpred_78(A,B) :- p169(A,C),p27(C,B)
redpred_79(A,B) :- p169(A,C),p5(C,B)
redpred_80(A,B) :- p701(A,C),p27(C,B)
redpred_81(A,B) :- p67(A,C),p102(C,B)
redpred_82(A,B) :- mk_lowercase(A,C),p27(C,B)
redpred_83(A,B) :- mk_uppercase(A,C),p5(C,B)
redpred_84(A,B) :- p121(A,C),p102(C,B)
redpred_85(A,B) :- p94(A,C),p5(C,B)
redpred_86(A,B) :- skip1(A,C),p1093(C,B)
redpred_87(A,B) :- copy1(A,C),p261(C,B)
redpred_88(A,B) :- skip1(A,C),p124(C,B)
redpred_89(A,B) :- p407(A,C),p215(C,B)
redpred_90(A,B) :- skip1(A,C),p215(C,B)
redpred_91(A,B) :- p67(A,C),p364(C,B)
redpred_92(A,B) :- skip1(A,C),p767(C,B)
redpred_93(A,B) :- p124_1(A,C),p129(C,B)
redpred_94(A,B) :- p102(A,C),p364(C,B)
redpred_95(A,B) :- copy1(A,C),p124(C,B)
redpred_96(A,B) :- p67(A,C),p162(C,B)
redpred_97(A,B) :- skip1(A,C),p640(C,B)
redpred_98(A,B) :- p335(A,C),p151(C,B)
redpred_99(A,B) :- p27(A,C),p323(C,B)
redpred_100(A,B) :- p395(A,C),p124(C,B)
redpred_101(A,B) :- p674(A,C),p27(C,B)
redpred_102(A,B) :- copy1(A,C),p215(C,B)
redpred_103(A,B) :- copy1(A,C),p1243(C,B)
redpred_104(A,B) :- p6(A,C),p215(C,B)
redpred_105(A,B) :- p124(A,C),p61(C,B)
redpred_106(A,B) :- skip1(A,C),p474(C,B)
redpred_107(A,B) :- p67(A,C),p433(C,B)
redpred_108(A,B) :- p421(A,C),p5(C,B)
redpred_109(A,B) :- skip1(A,C),p329(C,B)
redpred_110(A,B) :- copy1(A,C),p1107(C,B)
redpred_111(A,B) :- p36(A,C),p76(C,B)
redpred_112(A,B) :- p40(A,C),mk_uppercase(C,B)
...
p244_1(A,B) :- redpred_58(A,B)
p252(A,B) :- redpred_50(A,B)
p253(A,B) :- p5(A,C),p253_1(C,B)
p253_1(A,B) :- redpred_45(A,B)
p255(A,B) :- redpred_37(A,B)
...
p301_1(A,B) :- redpred_23(A,B)
p305(A,B) :- redpred_58(A,B)
p306(A,B) :- redpred_26(A,B)
...
p759(A,B) :- redpred_64(A,B)
p761(A,B) :- redpred_29(A,B)
p764(A,B) :- redpred_38(A,B)
p767(A,B) :- skip1(A,C),p767_1(C,B)
p767_1(A,B) :- redpred_17(A,B)
...
p903_1(A,B) :- redpred_34(A,B)
p904(A,B) :- redpred_26(A,B)
p905(A,B) :- redpred_61(A,B)
...
p962_1(A,B) :- redpred_43(A,B)
p963(A,B) :- redpred_63(A,B)
p973(A,B) :- copy1(A,C),p973_1(C,B)
p973_1(A,B) :- redpred_45(A,B)
p974(A,B) :- redpred_26(A,B)
...
p1151_1(A,B) :- redpred_42(A,B)
p1153(A,B) :- redpred_65(A,B)
p1155(A,B) :- redpred_46(A,B)
p1157(A,B) :- redpred_26(A,B)
p1159(A,B) :- redpred_45(A,B)
p1161(A,B) :- mk_lowercase(A,C),p1161_1(C,B)
p1161_1(A,B) :- redpred_22(A,B)
p1162(A,B) :- redpred_61(A,B)
p1165(A,B) :- mk_lowercase(A,C),p1165_1(C,B)
p1165_1(A,B) :- redpred_45(A,B)
p1166(A,B) :- skip1(A,C),p1166_1(C,B)
p1166_1(A,B) :- redpred_19(A,B)
...
p1267_1(A,B) :- redpred_81(A,B)
p1268(A,B) :- copy1(A,C),p1268_1(C,B)
p1268_1(A,B) :- redpred_40(A,B)
...
p1276(A,B) :- redpred_45(A,B)
p1277(A,B) :- redpred_70(A,B)
p1278(A,B) :- redpred_38(A,B)
p1279(A,B) :- redpred_26(A,B)
p1280(A,B) :- p5(A,C),p1280_1(C,B)
p1280_1(A,B) :- redpred_33(A,B)
p1282(A,B) :- skip1(A,C),p1282_1(C,B)
p1282_1(A,B) :- redpred_58(A,B)
p1284(A,B) :- mk_lowercase(A,C),p1284_1(C,B)
p1284_1(A,B) :- redpred_23(A,B)
p1285(A,B) :- redpred_23(A,B)
p1292(A,B) :- copy1(A,C),p1292_1(C,B)
p1292_1(A,B) :- redpred_68(A,B)
p1295(A,B) :- redpred_23(A,B)
p1296(A,B) :- redpred_69(A,B)
p1298(A,B) :- redpred_26(A,B)
p1300(A,B) :- redpred_45(A,B)
p1302(A,B) :- copy1(A,C),p1302_1(C,B)
p1302_1(A,B) :- redpred_48(A,B)
...
p277(A,B) :- redpred_96(A,B)
p280(A,B) :- p14(A,C),p108(C,B)
p281(A,B) :- redpred_97(A,B)
...
p414(A,B) :- redpred_100(A,B)
p415(A,B) :- redpred_95(A,B)
...
p766(A,B) :- redpred_92(A,B)
p770(A,B) :- redpred_91(A,B)
...
p874(A,B) :- redpred_99(A,B)
p877(A,B) :- p11_1(A,C),p1098(C,B)
p878(A,B) :- redpred_108(A,B)
...
p676_1(A,B) :- redpred_112(A,B)
p752(A,B) :- copy1(A,C),p752_1(C,B)
p752_1(A,B) :- redpred_112(A,B)
