...
redpred_14(A,B) :- copy1(A,C),p4(C,B)
redpred_15(A,B) :- p283(A,C),p30(C,B)
redpred_16(A,B) :- skip1(A,C),p4(C,B)
redpred_17(A,B) :- p30(A,C),p4(C,B)
redpred_18(A,B) :- skip1(A,C),p30(C,B)
redpred_19(A,B) :- p4(A,C),p4(C,B)
redpred_20(A,B) :- p198(A,C),p220(C,B)
redpred_21(A,B) :- p126(A,C),p4(C,B)
redpred_22(A,B) :- skip1(A,C),p283(C,B)
redpred_23(A,B) :- p42(A,C),p4(C,B)
redpred_24(A,B) :- skip1(A,C),p198(C,B)
redpred_25(A,B) :- p126(A,C),p96(C,B)
redpred_26(A,B) :- p30(A,C),p30(C,B)
redpred_27(A,B) :- skip1(A,C),p220(C,B)
redpred_28(A,B) :- mk_uppercase(A,C),p4(C,B)
redpred_29(A,B) :- copy1(A,C),p220(C,B)
redpred_30(A,B) :- p220(A,C),p4(C,B)
redpred_31(A,B) :- copy1(A,C),p30(C,B)
redpred_32(A,B) :- p4(A,C),p181(C,B)
redpred_33(A,B) :- p30(A,C),p42(C,B)
redpred_34(A,B) :- p4(A,C),p42(C,B)
redpred_35(A,B) :- p42(A,C),mk_uppercase(C,B)
redpred_36(A,B) :- p30(A,C),p220(C,B)
redpred_37(A,B) :- mk_lowercase(A,C),p198(C,B)
redpred_38(A,B) :- p283(A,C),p4(C,B)
redpred_39(A,B) :- p4(A,C),p283(C,B)
redpred_40(A,B) :- p4(A,C),p30(C,B)
redpred_41(A,B) :- p283(A,C),p198(C,B)
redpred_42(A,B) :- skip1(A,C),p126(C,B)
redpred_43(A,B) :- p4(A,C),p198(C,B)
redpred_44(A,B) :- mk_lowercase(A,C),p30(C,B)
redpred_45(A,B) :- p30(A,C),p283(C,B)
redpred_46(A,B) :- p4(A,C),p126(C,B)
redpred_47(A,B) :- p96(A,C),p30(C,B)
redpred_48(A,B) :- p220(A,C),p283(C,B)
redpred_49(A,B) :- p42(A,C),p30(C,B)
redpred_50(A,B) :- p96(A,C),p283(C,B)
redpred_51(A,B) :- p220(A,C),p198(C,B)
redpred_52(A,B) :- copy1(A,C),p42(C,B)
redpred_53(A,B) :- mk_lowercase(A,C),mk_lowercase(C,B)
redpred_54(A,B) :- p30(A,C),p126(C,B)
redpred_55(A,B) :- p96(A,C),mk_uppercase(C,B)
redpred_56(A,B) :- p126(A,C),p30(C,B)
redpred_57(A,B) :- skip1(A,C),p96(C,B)
redpred_58(A,B) :- p283(A,C),p42(C,B)
redpred_59(A,B) :- mk_uppercase(A,C),p126(C,B)
redpred_60(A,B) :- p482(A,C),p493(C,B)
redpred_61(A,B) :- p16(A,C),p79(C,B)
redpred_62(A,B) :- p66(A,C),p4(C,B)
redpred_63(A,B) :- p63(A,C),p394(C,B)
redpred_64(A,B) :- skip1(A,C),p428(C,B)
redpred_65(A,B) :- skip1(A,C),p520(C,B)
redpred_66(A,B) :- skip1(A,C),p66(C,B)
redpred_67(A,B) :- p20(A,C),p21_1(C,B)
redpred_68(A,B) :- p38(A,C),p198(C,B)
redpred_69(A,B) :- p277(A,C),p221(C,B)
redpred_70(A,B) :- p96(A,C),p63(C,B)
redpred_71(A,B) :- skip1(A,C),p309_1(C,B)
redpred_72(A,B) :- skip1(A,C),p75_1(C,B)
redpred_73(A,B) :- skip1(A,C),p280(C,B)
redpred_74(A,B) :- skip1(A,C),p739_1(C,B)
...
p718(A,B) :- redpred_9(A,B)
p720(A,B) :- redpred_11(A,B)
...
p48(A,B) :- redpred_28(A,B)
p63(A,B) :- copy1(A,C),p63_1(C,B)
p63_1(A,B) :- redpred_16(A,B)
p66(A,B) :- skip1(A,C),p66_1(C,B)
p66_1(A,B) :- redpred_18(A,B)
p68(A,B) :- mk_uppercase(A,C),p68_1(C,B)
p68_1(A,B) :- redpred_18(A,B)
...
p123_1(A,B) :- redpred_36(A,B)
p127(A,B) :- p283(A,C),p181(C,B)
p136(A,B) :- redpred_16(A,B)
...
p547(A,B) :- redpred_14(A,B)
p553(A,B) :- redpred_27(A,B)
p557(A,B) :- redpred_18(A,B)
p558(A,B) :- redpred_59(A,B)
p563(A,B) :- redpred_16(A,B)
p565(A,B) :- redpred_42(A,B)
p568(A,B) :- p4(A,C),p568_1(C,B)
p568_1(A,B) :- redpred_25(A,B)
...
p587_1(A,B) :- redpred_16(A,B)
p589(A,B) :- redpred_31(A,B)
p591(A,B) :- p30(A,C),p591_1(C,B)
p591_1(A,B) :- redpred_16(A,B)
p592(A,B) :- redpred_27(A,B)
p594(A,B) :- p4(A,C),p594_1(C,B)
p594_1(A,B) :- p220(A,C),p126(C,B)
p596(A,B) :- skip1(A,C),p596_1(C,B)
p596_1(A,B) :- redpred_27(A,B)
p600(A,B) :- copy1(A,C),p600_1(C,B)
p600_1(A,B) :- redpred_19(A,B)
p611(A,B) :- redpred_24(A,B)
p618(A,B) :- p4(A,C),p618_1(C,B)
p618_1(A,B) :- redpred_18(A,B)
p620(A,B) :- redpred_14(A,B)
p622(A,B) :- skip1(A,C),p622_1(C,B)
p622_1(A,B) :- redpred_47(A,B)
p623(A,B) :- redpred_31(A,B)
p624(A,B) :- p30(A,C),p624_1(C,B)
p624_1(A,B) :- redpred_16(A,B)
p625(A,B) :- copy1(A,C),p625_1(C,B)
p625_1(A,B) :- redpred_16(A,B)
p628(A,B) :- skip1(A,C),p628_1(C,B)
p628_1(A,B) :- redpred_38(A,B)
p631(A,B) :- skip1(A,C),p631_1(C,B)
p631_1(A,B) :- redpred_40(A,B)
...
p644_1(A,B) :- redpred_48(A,B)
p648(A,B) :- copy1(A,C),p648_1(C,B)
p648_1(A,B) :- redpred_56(A,B)
p658(A,B) :- p198(A,C),p658_1(C,B)
p658_1(A,B) :- redpred_45(A,B)
p661(A,B) :- redpred_59(A,B)
p668(A,B) :- redpred_16(A,B)
...
p703_1(A,B) :- redpred_22(A,B)
p710(A,B) :- copy1(A,C),p710_1(C,B)
p710_1(A,B) :- redpred_42(A,B)
...
p730_1(A,B) :- redpred_55(A,B)
p731(A,B) :- mk_lowercase(A,C),p731_1(C,B)
p731_1(A,B) :- redpred_19(A,B)
p735(A,B) :- p220(A,C),p735_1(C,B)
p735_1(A,B) :- redpred_16(A,B)
...
p62(A,B) :- redpred_60(A,B)
p64(A,B) :- p775(A,C),mk_lowercase(C,B)
p67(A,B) :- redpred_61(A,B)
...
p740(A,B) :- redpred_70(A,B)
p744(A,B) :- p4(A,C),p396(C,B)
p745(A,B) :- p30(A,C),p745_1(C,B)
p745_1(A,B) :- redpred_64(A,B)
p749(A,B) :- redpred_69(A,B)
...
p795_1(A,B) :- redpred_66(A,B)
p796(A,B) :- mk_uppercase(A,C),p796_1(C,B)
p796_1(A,B) :- redpred_61(A,B)
