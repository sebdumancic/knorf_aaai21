...
redpred_17(A,B) :- p112(A,C),p11(C,B)
redpred_18(A,B) :- p11(A,C),p6(C,B)
redpred_19(A,B) :- p13(A,C),p202(C,B)
redpred_20(A,B) :- copy1(A,C),p13(C,B)
redpred_21(A,B) :- copy1(A,C),p11(C,B)
redpred_22(A,B) :- p13(A,C),p11(C,B)
redpred_23(A,B) :- p118(A,C),p11(C,B)
redpred_24(A,B) :- mk_uppercase(A,C),p13(C,B)
redpred_25(A,B) :- skip1(A,C),p118(C,B)
redpred_26(A,B) :- p6(A,C),p112(C,B)
redpred_27(A,B) :- skip1(A,C),p11(C,B)
redpred_28(A,B) :- p13(A,C),p26(C,B)
redpred_29(A,B) :- p13(A,C),p13(C,B)
redpred_30(A,B) :- mk_uppercase(A,C),p11(C,B)
redpred_31(A,B) :- p118(A,C),p202(C,B)
redpred_32(A,B) :- p202(A,C),p11(C,B)
redpred_33(A,B) :- skip1(A,C),p6(C,B)
redpred_34(A,B) :- copy1(A,C),p523(C,B)
redpred_35(A,B) :- p202(A,C),p6(C,B)
redpred_36(A,B) :- skip1(A,C),p202(C,B)
redpred_37(A,B) :- mk_lowercase(A,C),p118(C,B)
redpred_38(A,B) :- copy1(A,C),p26(C,B)
redpred_39(A,B) :- skip1(A,C),p220(C,B)
redpred_40(A,B) :- p11(A,C),p26(C,B)
redpred_41(A,B) :- copy1(A,C),p118(C,B)
redpred_42(A,B) :- skip1(A,C),p13(C,B)
redpred_43(A,B) :- p11(A,C),p220(C,B)
redpred_44(A,B) :- skip1(A,C),p112(C,B)
redpred_45(A,B) :- p11(A,C),p11(C,B)
redpred_46(A,B) :- p26(A,C),p11(C,B)
redpred_47(A,B) :- p11(A,C),p13(C,B)
redpred_48(A,B) :- p220(A,C),p26(C,B)
redpred_49(A,B) :- p112(A,C),p26(C,B)
redpred_50(A,B) :- copy1(A,C),p112(C,B)
redpred_51(A,B) :- p13(A,C),p118(C,B)
redpred_52(A,B) :- p11(A,C),p270(C,B)
redpred_53(A,B) :- p202(A,C),p112(C,B)
redpred_54(A,B) :- mk_lowercase(A,C),p13(C,B)
redpred_55(A,B) :- p220(A,C),p112(C,B)
redpred_56(A,B) :- p6(A,C),p13(C,B)
redpred_57(A,B) :- p220(A,C),p202(C,B)
redpred_58(A,B) :- mk_lowercase(A,C),p112(C,B)
redpred_59(A,B) :- p26(A,C),p523(C,B)
redpred_60(A,B) :- p118(A,C),p118(C,B)
redpred_61(A,B) :- mk_lowercase(A,C),p11(C,B)
redpred_62(A,B) :- skip1(A,C),p523(C,B)
redpred_63(A,B) :- p112(A,C),p13(C,B)
redpred_64(A,B) :- p11(A,C),p118(C,B)
redpred_65(A,B) :- p202(A,C),p13(C,B)
redpred_66(A,B) :- p280(A,C),p11(C,B)
redpred_67(A,B) :- p112(A,C),p118(C,B)
redpred_68(A,B) :- skip1(A,C),p26(C,B)
redpred_69(A,B) :- mk_uppercase(A,C),p6(C,B)
redpred_70(A,B) :- copy1(A,C),p1531(C,B)
redpred_71(A,B) :- p118(A,C),p13(C,B)
redpred_72(A,B) :- p11(A,C),p523(C,B)
redpred_73(A,B) :- p13(A,C),p270(C,B)
redpred_74(A,B) :- p6(A,C),p11(C,B)
redpred_75(A,B) :- p11(A,C),p112(C,B)
redpred_76(A,B) :- copy1(A,C),p202(C,B)
redpred_77(A,B) :- p280(A,C),p13(C,B)
redpred_78(A,B) :- mk_uppercase(A,C),p220(C,B)
redpred_79(A,B) :- p202(A,C),p202(C,B)
redpred_80(A,B) :- skip1(A,C),p280(C,B)
redpred_81(A,B) :- p220(A,C),p11(C,B)
redpred_82(A,B) :- p270(A,C),p202(C,B)
redpred_83(A,B) :- copy1(A,C),p220(C,B)
redpred_84(A,B) :- p13(A,C),p220(C,B)
redpred_85(A,B) :- p11(A,C),p202(C,B)
redpred_86(A,B) :- p26(A,C),p6(C,B)
redpred_87(A,B) :- p118(A,C),p112(C,B)
redpred_88(A,B) :- copy1(A,C),p6(C,B)
redpred_89(A,B) :- p13(A,C),p6(C,B)
redpred_90(A,B) :- p6(A,C),p118(C,B)
redpred_91(A,B) :- p118(A,C),p220(C,B)
redpred_92(A,B) :- p6(A,C),p1531(C,B)
redpred_93(A,B) :- p26(A,C),p220(C,B)
redpred_94(A,B) :- p270(A,C),p13(C,B)
redpred_95(A,B) :- p523(A,C),p26(C,B)
redpred_96(A,B) :- p220(A,C),p220(C,B)
redpred_97(A,B) :- p26(A,C),p13(C,B)
redpred_98(A,B) :- mk_uppercase(A,C),p26(C,B)
redpred_99(A,B) :- p202(A,C),p118(C,B)
redpred_100(A,B) :- p26(A,C),p202(C,B)
redpred_101(A,B) :- p523(A,C),p112(C,B)
redpred_102(A,B) :- p220(A,C),p1531(C,B)
redpred_103(A,B) :- skip1(A,C),p270(C,B)
redpred_104(A,B) :- p26(A,C),p280(C,B)
redpred_105(A,B) :- p270(A,C),p11(C,B)
redpred_106(A,B) :- mk_uppercase(A,C),p112(C,B)
redpred_107(A,B) :- mk_lowercase(A,C),p6(C,B)
redpred_108(A,B) :- p220(A,C),p13(C,B)
redpred_109(A,B) :- copy1(A,C),p280(C,B)
redpred_110(A,B) :- mk_lowercase(A,C),p202(C,B)
redpred_111(A,B) :- skip1(A,C),p1531(C,B)
redpred_112(A,B) :- mk_lowercase(A,C),p220(C,B)
redpred_113(A,B) :- p1531(A,C),p11(C,B)
redpred_114(A,B) :- mk_uppercase(A,C),p202(C,B)
redpred_115(A,B) :- skip1(A,C),p256(C,B)
redpred_116(A,B) :- copy1(A,C),p90(C,B)
redpred_117(A,B) :- p751(A,C),p322(C,B)
redpred_118(A,B) :- p146_1(A,C),p90(C,B)
redpred_119(A,B) :- skip1(A,C),p19(C,B)
redpred_120(A,B) :- skip1(A,C),p1463(C,B)
redpred_121(A,B) :- p12(A,C),p272_1(C,B)
redpred_122(A,B) :- p2086(A,C),p180(C,B)
redpred_123(A,B) :- copy1(A,C),p1250(C,B)
redpred_124(A,B) :- skip1(A,C),p90(C,B)
redpred_125(A,B) :- p472(A,C),p146_1(C,B)
redpred_126(A,B) :- copy1(A,C),p1972(C,B)
redpred_127(A,B) :- p355(A,C),p90(C,B)
redpred_128(A,B) :- skip1(A,C),p1139(C,B)
redpred_129(A,B) :- skip1(A,C),p1631(C,B)
redpred_130(A,B) :- mk_lowercase(A,C),p41(C,B)
redpred_131(A,B) :- p112(A,C),p670(C,B)
redpred_132(A,B) :- copy1(A,C),p95(C,B)
redpred_133(A,B) :- skip1(A,C),p1133(C,B)
redpred_134(A,B) :- p12(A,C),p745(C,B)
redpred_135(A,B) :- skip1(A,C),p555(C,B)
redpred_136(A,B) :- p11(A,C),p19(C,B)
redpred_137(A,B) :- skip1(A,C),p1972(C,B)
redpred_138(A,B) :- p256(A,C),p135_1(C,B)
redpred_139(A,B) :- p256(A,C),p44(C,B)
redpred_140(A,B) :- p145(A,C),p41_1(C,B)
redpred_141(A,B) :- p212(A,C),p13(C,B)
redpred_142(A,B) :- p1905(A,C),p12(C,B)
redpred_143(A,B) :- p11(A,C),p80(C,B)
redpred_144(A,B) :- p11(A,C),p226(C,B)
redpred_145(A,B) :- p256(A,C),p6(C,B)
redpred_146(A,B) :- copy1(A,C),p256(C,B)
redpred_147(A,B) :- mk_lowercase(A,C),p2123(C,B)
redpred_148(A,B) :- skip1(A,C),p80(C,B)
redpred_149(A,B) :- skip1(A,C),p496(C,B)
redpred_150(A,B) :- p145(A,C),p12(C,B)
redpred_151(A,B) :- skip1(A,C),p1611(C,B)
redpred_152(A,B) :- p12(A,C),p95(C,B)
redpred_153(A,B) :- p95(A,C),p118(C,B)
redpred_154(A,B) :- copy1(A,C),p1139(C,B)
redpred_155(A,B) :- p95(A,C),mk_uppercase(C,B)
redpred_156(A,B) :- p13(A,C),p751(C,B)
redpred_157(A,B) :- p11(A,C),p1422(C,B)
redpred_158(A,B) :- skip1(A,C),p1598(C,B)
redpred_159(A,B) :- mk_uppercase(A,C),p585(C,B)
redpred_160(A,B) :- copy1(A,C),p2123(C,B)
redpred_161(A,B) :- p11(A,C),p2123(C,B)
redpred_162(A,B) :- p256(A,C),p77_1(C,B)
redpred_163(A,B) :- copy1(A,C),p80(C,B)
redpred_164(A,B) :- p41_1(A,C),p146(C,B)
redpred_165(A,B) :- p16(A,C),p924(C,B)
redpred_166(A,B) :- p13(A,C),p1133(C,B)
redpred_167(A,B) :- p13(A,C),p2051(C,B)
redpred_168(A,B) :- p16(A,C),p1631(C,B)
redpred_169(A,B) :- mk_lowercase(A,C),p256(C,B)
redpred_170(A,B) :- copy1(A,C),p1464(C,B)
redpred_171(A,B) :- copy1(A,C),p699(C,B)
redpred_172(A,B) :- copy1(A,C),p19(C,B)
redpred_173(A,B) :- skip1(A,C),p199(C,B)
redpred_174(A,B) :- skip1(A,C),p142(C,B)
redpred_175(A,B) :- mk_uppercase(A,C),p256(C,B)
redpred_176(A,B) :- p95(A,C),p435(C,B)
redpred_177(A,B) :- skip1(A,C),p95(C,B)
redpred_178(A,B) :- p11(A,C),p1250(C,B)
redpred_179(A,B) :- p472(A,C),p105(C,B)
redpred_180(A,B) :- p670(A,C),p135_1(C,B)
redpred_181(A,B) :- p26(A,C),p80(C,B)
redpred_182(A,B) :- p12(A,C),p19(C,B)
redpred_183(A,B) :- skip1(A,C),p450(C,B)
redpred_184(A,B) :- p202(A,C),p234(C,B)
redpred_185(A,B) :- skip1(A,C),p164(C,B)
redpred_186(A,B) :- p13(A,C),p1422(C,B)
redpred_187(A,B) :- p19_1(A,C),p1631(C,B)
redpred_188(A,B) :- copy1(A,C),p593(C,B)
redpred_189(A,B) :- skip1(A,C),p1458(C,B)
...
p523(A,B) :- redpred_15(A,B)
p524(A,B) :- redpred_7(A,B)
...
p1093(A,B) :- redpred_12(A,B)
p1099(A,B) :- redpred_12(A,B)
...
p1576(A,B) :- redpred_8(A,B)
p1578(A,B) :- redpred_14(A,B)
...
p1743(A,B) :- redpred_15(A,B)
p1745(A,B) :- redpred_1(A,B)
p1748(A,B) :- redpred_4(A,B)
p1751(A,B) :- redpred_16(A,B)
...
p2090(A,B) :- redpred_12(A,B)
p2100(A,B) :- redpred_1(A,B)
p2103(A,B) :- redpred_12(A,B)
...
p1186_1(A,B) :- redpred_39(A,B)
p1190(A,B) :- redpred_33(A,B)
p1197(A,B) :- skip1(A,C),p1197_1(C,B)
p1197_1(A,B) :- redpred_45(A,B)
p1198(A,B) :- skip1(A,C),p1198_1(C,B)
p1198_1(A,B) :- redpred_39(A,B)
p1202(A,B) :- redpred_42(A,B)
p1204(A,B) :- skip1(A,C),p1204_1(C,B)
p1204_1(A,B) :- redpred_45(A,B)
p1205(A,B) :- redpred_39(A,B)
p1210(A,B) :- redpred_45(A,B)
p1212(A,B) :- redpred_98(A,B)
p1214(A,B) :- skip1(A,C),p1214_1(C,B)
p1214_1(A,B) :- redpred_25(A,B)
p1220(A,B) :- redpred_20(A,B)
...
p1348(A,B) :- redpred_47(A,B)
p1351(A,B) :- mk_uppercase(A,C),p1351_1(C,B)
p1351_1(A,B) :- redpred_32(A,B)
p1352(A,B) :- copy1(A,C),p1352_1(C,B)
p1352_1(A,B) :- redpred_22(A,B)
p1354(A,B) :- redpred_67(A,B)
p1357(A,B) :- redpred_101(A,B)
...
p1707(A,B) :- redpred_103(A,B)
p1708(A,B) :- redpred_20(A,B)
p1709(A,B) :- copy1(A,C),p1709_1(C,B)
p1709_1(A,B) :- redpred_79(A,B)
p1712(A,B) :- skip1(A,C),p1712_1(C,B)
p1712_1(A,B) :- redpred_46(A,B)
p1714(A,B) :- mk_lowercase(A,C),p523(C,B)
p1715(A,B) :- p11(A,C),p1715_1(C,B)
p1715_1(A,B) :- redpred_42(A,B)
p1717(A,B) :- redpred_76(A,B)
...
p1863(A,B) :- redpred_29(A,B)
p1864(A,B) :- redpred_69(A,B)
p1865(A,B) :- redpred_78(A,B)
p1866(A,B) :- redpred_21(A,B)
p1870(A,B) :- p118(A,C),p1870_1(C,B)
p1870_1(A,B) :- redpred_111(A,B)
p1875(A,B) :- redpred_93(A,B)
p1876(A,B) :- redpred_103(A,B)
p1881(A,B) :- redpred_70(A,B)
p1883(A,B) :- redpred_62(A,B)
p1884(A,B) :- mk_lowercase(A,C),p1884_1(C,B)
p1884_1(A,B) :- redpred_36(A,B)
p1886(A,B) :- redpred_112(A,B)
p1888(A,B) :- redpred_100(A,B)
...
p2337_1(A,B) :- redpred_111(A,B)
p2342(A,B) :- skip1(A,C),p2342_1(C,B)
p2342_1(A,B) :- redpred_32(A,B)
p2344(A,B) :- redpred_21(A,B)
p2345(A,B) :- p11(A,C),p2345_1(C,B)
p2345_1(A,B) :- redpred_18(A,B)
p2346(A,B) :- redpred_109(A,B)
p2347(A,B) :- redpred_85(A,B)
p2348(A,B) :- p11(A,C),p2348_1(C,B)
p2348_1(A,B) :- redpred_27(A,B)
p2349(A,B) :- p220(A,C),p2349_1(C,B)
p2349_1(A,B) :- redpred_26(A,B)
p2350(A,B) :- copy1(A,C),p2350_1(C,B)
p2350_1(A,B) :- redpred_42(A,B)
p2353(A,B) :- redpred_22(A,B)
p2356(A,B) :- skip1(A,C),p2356_1(C,B)
p2356_1(A,B) :- redpred_44(A,B)
p2361(A,B) :- p13(A,C),p2361_1(C,B)
p2361_1(A,B) :- redpred_40(A,B)
p2365(A,B) :- redpred_22(A,B)
p2366(A,B) :- p270(A,C),p2366_1(C,B)
p2366_1(A,B) :- redpred_39(A,B)
p2367(A,B) :- redpred_88(A,B)
p2370(A,B) :- redpred_25(A,B)
p2374(A,B) :- p6(A,C),p2374_1(C,B)
p2374_1(A,B) :- redpred_71(A,B)
p2378(A,B) :- copy1(A,C),p2378_1(C,B)
p2378_1(A,B) :- redpred_42(A,B)
p2381(A,B) :- redpred_47(A,B)
p2384(A,B) :- p26(A,C),p2384_1(C,B)
p2384_1(A,B) :- redpred_36(A,B)
p2387(A,B) :- redpred_46(A,B)
p2391(A,B) :- redpred_18(A,B)
p2398(A,B) :- redpred_50(A,B)
...
p170_1(A,B) :- redpred_124(A,B)
p172(A,B) :- redpred_132(A,B)
p173(A,B) :- skip1(A,C),p173_1(C,B)
p173_1(A,B) :- p95(A,C),p220(C,B)
p176(A,B) :- redpred_133(A,B)
p181(A,B) :- redpred_134(A,B)
...
p228(A,B) :- redpred_137(A,B)
p231(A,B) :- p13(A,C),p231_1(C,B)
p231_1(A,B) :- redpred_138(A,B)
...
p336(A,B) :- redpred_144(A,B)
p338(A,B) :- redpred_145(A,B)
p339(A,B) :- redpred_146(A,B)
...
p376(A,B) :- redpred_149(A,B)
p381(A,B) :- redpred_144(A,B)
...
p443(A,B) :- redpred_152(A,B)
p444(A,B) :- p1117(A,C),p118(C,B)
p448(A,B) :- redpred_153(A,B)
p449(A,B) :- redpred_154(A,B)
...
p772_1(A,B) :- redpred_162(A,B)
p776(A,B) :- redpred_169(A,B)
p777(A,B) :- p19(A,C),p135_1(C,B)
p778(A,B) :- redpred_118(A,B)
p784(A,B) :- p2345(A,C),p227(C,B)
p787(A,B) :- redpred_141(A,B)
...
p805(A,B) :- redpred_150(A,B)
p808(A,B) :- p157(A,C),p1559(C,B)
p811(A,B) :- redpred_170(A,B)
...
p872(A,B) :- redpred_171(A,B)
p873(A,B) :- p19_1(A,C),p2173(C,B)
p874(A,B) :- redpred_171(A,B)
...
p910(A,B) :- redpred_134(A,B)
p914(A,B) :- redpred_172(A,B)
...
p963_1(A,B) :- redpred_119(A,B)
p966(A,B) :- p164_1(A,C),p1617(C,B)
p969(A,B) :- redpred_174(A,B)
...
p1627(A,B) :- redpred_157(A,B)
p1638(A,B) :- p472(A,C),p435(C,B)
p1639(A,B) :- redpred_148(A,B)
...
p1842(A,B) :- redpred_167(A,B)
p1844(A,B) :- p145(A,C),p316(C,B)
p1845(A,B) :- redpred_119(A,B)
...
p1953(A,B) :- redpred_130(A,B)
p1957(A,B) :- p135(A,C),p322(C,B)
p1963(A,B) :- redpred_177(A,B)
p1964(A,B) :- redpred_121(A,B)
