...
redpred_13(A,B) :- skip1(A,C),p126(C,B)
redpred_14(A,B) :- skip1(A,C),p149(C,B)
redpred_15(A,B) :- skip1(A,C),p21(C,B)
redpred_16(A,B) :- p30(A,C),p21(C,B)
redpred_17(A,B) :- p21(A,C),p30(C,B)
redpred_18(A,B) :- copy1(A,C),p30(C,B)
redpred_19(A,B) :- skip1(A,C),p113(C,B)
redpred_20(A,B) :- p315(A,C),p182(C,B)
redpred_21(A,B) :- skip1(A,C),p30(C,B)
redpred_22(A,B) :- p30(A,C),mk_uppercase(C,B)
redpred_23(A,B) :- skip1(A,C),p175(C,B)
redpred_24(A,B) :- p30(A,C),p30(C,B)
redpred_25(A,B) :- skip1(A,C),p182(C,B)
redpred_26(A,B) :- skip1(A,C),p68(C,B)
redpred_27(A,B) :- copy1(A,C),p21(C,B)
redpred_28(A,B) :- p21(A,C),p315(C,B)
redpred_29(A,B) :- copy1(A,C),p149(C,B)
redpred_30(A,B) :- mk_lowercase(A,C),p21(C,B)
redpred_31(A,B) :- p68(A,C),mk_uppercase(C,B)
redpred_32(A,B) :- mk_uppercase(A,C),p21(C,B)
redpred_33(A,B) :- p113(A,C),p21(C,B)
redpred_34(A,B) :- p21(A,C),mk_uppercase(C,B)
redpred_35(A,B) :- copy1(A,C),p182(C,B)
redpred_36(A,B) :- skip1(A,C),p348(C,B)
redpred_37(A,B) :- p62_1(A,C),p24(C,B)
redpred_38(A,B) :- p62(A,C),p21(C,B)
redpred_39(A,B) :- p36(A,C),p315(C,B)
redpred_40(A,B) :- mk_uppercase(A,C),p181(C,B)
redpred_41(A,B) :- p36(A,C),p113(C,B)
redpred_42(A,B) :- skip1(A,C),p10(C,B)
redpred_43(A,B) :- p246(A,C),p30(C,B)
redpred_44(A,B) :- p62(A,C),copy1(C,B)
...
p36_1(A,B) :- redpred_21(A,B)
p40(A,B) :- skip1(A,C),p40_1(C,B)
p40_1(A,B) :- redpred_22(A,B)
...
p204_1(A,B) :- redpred_31(A,B)
p211(A,B) :- skip1(A,C),p211_1(C,B)
p211_1(A,B) :- redpred_25(A,B)
p213(A,B) :- p182(A,C),p213_1(C,B)
p213_1(A,B) :- redpred_13(A,B)
p220(A,B) :- redpred_32(A,B)
...
p333(A,B) :- redpred_21(A,B)
p335(A,B) :- skip1(A,C),p335_1(C,B)
p335_1(A,B) :- redpred_24(A,B)
...
p363(A,B) :- redpred_13(A,B)
p365(A,B) :- redpred_21(A,B)
p367(A,B) :- redpred_30(A,B)
p369(A,B) :- p30(A,C),p369_1(C,B)
p369_1(A,B) :- redpred_24(A,B)
p372(A,B) :- skip1(A,C),p372_1(C,B)
p372_1(A,B) :- redpred_15(A,B)
p374(A,B) :- p30(A,C),p374_1(C,B)
p374_1(A,B) :- redpred_21(A,B)
p375(A,B) :- copy1(A,C),p375_1(C,B)
p375_1(A,B) :- redpred_31(A,B)
...
p186_1(A,B) :- redpred_38(A,B)
p189(A,B) :- p319(A,C),p189_1(C,B)
p189_1(A,B) :- redpred_37(A,B)
