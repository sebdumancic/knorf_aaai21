...
redpred_9(A,B) :- mk_lowercase(A,C),mk_uppercase(C,B)
...
redpred_16(A,B) :- p27(A,C),p210(C,B)
redpred_17(A,B) :- skip1(A,C),p27(C,B)
redpred_18(A,B) :- skip1(A,C),p430(C,B)
redpred_19(A,B) :- skip1(A,C),p84(C,B)
redpred_20(A,B) :- p84(A,C),p27(C,B)
redpred_21(A,B) :- p27(A,C),p274(C,B)
redpred_22(A,B) :- skip1(A,C),p210(C,B)
redpred_23(A,B) :- skip1(A,C),p45(C,B)
redpred_24(A,B) :- p27(A,C),p84(C,B)
redpred_25(A,B) :- p295(A,C),p84(C,B)
redpred_26(A,B) :- copy1(A,C),p210(C,B)
redpred_27(A,B) :- copy1(A,C),p27(C,B)
redpred_28(A,B) :- copy1(A,C),p84(C,B)
redpred_29(A,B) :- p210(A,C),p84(C,B)
redpred_30(A,B) :- p27(A,C),p506(C,B)
redpred_31(A,B) :- p506(A,C),p274(C,B)
redpred_32(A,B) :- p45(A,C),p264(C,B)
redpred_33(A,B) :- p27(A,C),p264(C,B)
redpred_34(A,B) :- p264(A,C),p430(C,B)
redpred_35(A,B) :- p27(A,C),p45(C,B)
redpred_36(A,B) :- p84(A,C),p506(C,B)
redpred_37(A,B) :- mk_uppercase(A,C),p264(C,B)
redpred_38(A,B) :- p45(A,C),p295(C,B)
redpred_39(A,B) :- skip1(A,C),p295(C,B)
redpred_40(A,B) :- p27(A,C),p27(C,B)
redpred_41(A,B) :- p243(A,C),p27(C,B)
redpred_42(A,B) :- p45(A,C),p27(C,B)
redpred_43(A,B) :- skip1(A,C),p264(C,B)
redpred_44(A,B) :- p45(A,C),p210(C,B)
redpred_45(A,B) :- p506(A,C),p84(C,B)
redpred_46(A,B) :- p84(A,C),p45(C,B)
redpred_47(A,B) :- p84(A,C),p295(C,B)
redpred_48(A,B) :- p27(A,C),p430(C,B)
redpred_49(A,B) :- copy1(A,C),p264(C,B)
redpred_50(A,B) :- p506(A,C),p45(C,B)
redpred_51(A,B) :- skip1(A,C),p506(C,B)
redpred_52(A,B) :- skip1(A,C),p536(C,B)
redpred_53(A,B) :- p264(A,C),p84(C,B)
redpred_54(A,B) :- p84(A,C),p264(C,B)
redpred_55(A,B) :- copy1(A,C),p506(C,B)
redpred_56(A,B) :- p210(A,C),p27(C,B)
redpred_57(A,B) :- mk_lowercase(A,C),p27(C,B)
redpred_58(A,B) :- p45(A,C),p84(C,B)
redpred_59(A,B) :- p84(A,C),p84(C,B)
redpred_60(A,B) :- p430(A,C),p84(C,B)
redpred_61(A,B) :- mk_uppercase(A,C),p506(C,B)
redpred_62(A,B) :- copy1(A,C),p243(C,B)
redpred_63(A,B) :- mk_lowercase(A,C),p84(C,B)
redpred_64(A,B) :- skip1(A,C),p243(C,B)
redpred_65(A,B) :- p84(A,C),p210(C,B)
redpred_66(A,B) :- p295(A,C),p295(C,B)
redpred_67(A,B) :- p264(A,C),p210(C,B)
redpred_68(A,B) :- mk_uppercase(A,C),p45(C,B)
redpred_69(A,B) :- p1895(A,C),p27(C,B)
redpred_70(A,B) :- p84(A,C),p274(C,B)
redpred_71(A,B) :- p264(A,C),p45(C,B)
redpred_72(A,B) :- p295(A,C),p210(C,B)
redpred_73(A,B) :- p295(A,C),p1895(C,B)
redpred_74(A,B) :- p430(A,C),p27(C,B)
redpred_75(A,B) :- p243(A,C),p84(C,B)
redpred_76(A,B) :- p295(A,C),p27(C,B)
redpred_77(A,B) :- mk_uppercase(A,C),p84(C,B)
redpred_78(A,B) :- mk_uppercase(A,C),p27(C,B)
redpred_79(A,B) :- copy1(A,C),p430(C,B)
redpred_80(A,B) :- p45(A,C),p506(C,B)
redpred_81(A,B) :- p264(A,C),p27(C,B)
redpred_82(A,B) :- p274(A,C),p45(C,B)
redpred_83(A,B) :- p27(A,C),p295(C,B)
redpred_84(A,B) :- p274(A,C),p506(C,B)
redpred_85(A,B) :- mk_lowercase(A,C),p264(C,B)
redpred_86(A,B) :- copy1(A,C),p536(C,B)
redpred_87(A,B) :- p84(A,C),p430(C,B)
redpred_88(A,B) :- copy1(A,C),p295(C,B)
redpred_89(A,B) :- p430(A,C),p506(C,B)
redpred_90(A,B) :- p295(A,C),p45(C,B)
redpred_91(A,B) :- p506(A,C),p27(C,B)
redpred_92(A,B) :- p506(A,C),p506(C,B)
redpred_93(A,B) :- p210(A,C),p264(C,B)
redpred_94(A,B) :- skip1(A,C),p1895(C,B)
redpred_95(A,B) :- p210(A,C),p430(C,B)
redpred_96(A,B) :- p274(A,C),p27(C,B)
redpred_97(A,B) :- p45(A,C),p45(C,B)
redpred_98(A,B) :- p536(A,C),p27(C,B)
redpred_99(A,B) :- p274(A,C),p84(C,B)
redpred_100(A,B) :- copy1(A,C),p45(C,B)
redpred_101(A,B) :- p84(A,C),p536(C,B)
redpred_102(A,B) :- skip1(A,C),p274(C,B)
redpred_103(A,B) :- p536(A,C),p84(C,B)
redpred_104(A,B) :- p430(A,C),p210(C,B)
redpred_105(A,B) :- p243(A,C),p430(C,B)
redpred_106(A,B) :- p210(A,C),p45(C,B)
redpred_107(A,B) :- p295(A,C),p430(C,B)
redpred_108(A,B) :- p17(A,C),p704(C,B)
redpred_109(A,B) :- copy1(A,C),p509(C,B)
redpred_110(A,B) :- p84(A,C),p2079(C,B)
redpred_111(A,B) :- copy1(A,C),p595(C,B)
redpred_112(A,B) :- p67(A,C),p47(C,B)
redpred_113(A,B) :- p124_1(A,C),p1899(C,B)
redpred_114(A,B) :- p17(A,C),p555(C,B)
redpred_115(A,B) :- copy1(A,C),p333(C,B)
redpred_116(A,B) :- copy1(A,C),p58(C,B)
redpred_117(A,B) :- skip1(A,C),p67(C,B)
redpred_118(A,B) :- skip1(A,C),p21(C,B)
redpred_119(A,B) :- p1362(A,C),p17(C,B)
redpred_120(A,B) :- p67(A,C),p161(C,B)
redpred_121(A,B) :- p575(A,C),mk_lowercase(C,B)
redpred_122(A,B) :- p172(A,C),p2297(C,B)
redpred_123(A,B) :- copy1(A,C),p67(C,B)
redpred_124(A,B) :- p107(A,C),p155(C,B)
redpred_125(A,B) :- p295(A,C),p582(C,B)
redpred_126(A,B) :- p56(A,C),p97_1(C,B)
redpred_127(A,B) :- skip1(A,C),p1631(C,B)
redpred_128(A,B) :- copy1(A,C),p364(C,B)
redpred_129(A,B) :- copy1(A,C),p172(C,B)
redpred_130(A,B) :- copy1(A,C),p489(C,B)
redpred_131(A,B) :- p21_1(A,C),p317(C,B)
redpred_132(A,B) :- skip1(A,C),p58(C,B)
redpred_133(A,B) :- copy1(A,C),p566(C,B)
redpred_134(A,B) :- p106(A,C),p58(C,B)
redpred_135(A,B) :- skip1(A,C),p582(C,B)
redpred_136(A,B) :- skip1(A,C),p106(C,B)
redpred_137(A,B) :- copy1(A,C),p1899(C,B)
redpred_138(A,B) :- mk_uppercase(A,C),p172(C,B)
redpred_139(A,B) :- skip1(A,C),p613(C,B)
redpred_140(A,B) :- copy1(A,C),p582(C,B)
redpred_141(A,B) :- copy1(A,C),p581(C,B)
redpred_142(A,B) :- skip1(A,C),p1216(C,B)
redpred_143(A,B) :- p67(A,C),p19(C,B)
redpred_144(A,B) :- skip1(A,C),p509(C,B)
redpred_145(A,B) :- skip1(A,C),p1323(C,B)
redpred_146(A,B) :- p56(A,C),p317(C,B)
redpred_147(A,B) :- skip1(A,C),p2388(C,B)
redpred_148(A,B) :- p47(A,C),p67(C,B)
redpred_149(A,B) :- p17(A,C),p428(C,B)
redpred_150(A,B) :- p56(A,C),p58(C,B)
redpred_151(A,B) :- copy1(A,C),p89(C,B)
redpred_152(A,B) :- copy1(A,C),p471(C,B)
redpred_153(A,B) :- p27(A,C),p113(C,B)
redpred_154(A,B) :- skip1(A,C),p317(C,B)
redpred_155(A,B) :- p84(A,C),p1360(C,B)
redpred_156(A,B) :- p58(A,C),p1395(C,B)
redpred_157(A,B) :- p67(A,C),p119(C,B)
redpred_158(A,B) :- p84(A,C),p333(C,B)
redpred_159(A,B) :- p67(A,C),p56(C,B)
redpred_160(A,B) :- skip1(A,C),p1257(C,B)
redpred_161(A,B) :- p67(A,C),p17(C,B)
redpred_162(A,B) :- skip1(A,C),p581(C,B)
redpred_163(A,B) :- skip1(A,C),p957(C,B)
redpred_164(A,B) :- skip1(A,C),p89(C,B)
redpred_165(A,B) :- p23(A,C),p555(C,B)
redpred_166(A,B) :- p210(A,C),p1360(C,B)
redpred_167(A,B) :- skip1(A,C),p1362(C,B)
redpred_168(A,B) :- p430(A,C),p58(C,B)
redpred_169(A,B) :- copy1(A,C),p1362(C,B)
redpred_170(A,B) :- copy1(A,C),p97(C,B)
redpred_171(A,B) :- copy1(A,C),p792(C,B)
redpred_172(A,B) :- p27(A,C),p1631(C,B)
redpred_173(A,B) :- p27(A,C),p67(C,B)
redpred_174(A,B) :- p67(A,C),p106_1(C,B)
redpred_175(A,B) :- p84(A,C),p582(C,B)
redpred_176(A,B) :- p181(A,C),p31_1(C,B)
redpred_177(A,B) :- skip1(A,C),p1395(C,B)
redpred_178(A,B) :- p17(A,C),p67(C,B)
redpred_179(A,B) :- skip1(A,C),p154(C,B)
redpred_180(A,B) :- p673(A,C),mk_uppercase(C,B)
...
p103_1(A,B) :- redpred_39(A,B)
p106(A,B) :- skip1(A,C),p106_1(C,B)
p106_1(A,B) :- redpred_40(A,B)
...
p137(A,B) :- redpred_20(A,B)
p138(A,B) :- skip1(A,C),p138_1(C,B)
p138_1(A,B) :- redpred_19(A,B)
...
p171_1(A,B) :- redpred_17(A,B)
p172(A,B) :- p27(A,C),p172_1(C,B)
p172_1(A,B) :- redpred_17(A,B)
p179(A,B) :- mk_uppercase(A,C),p179_1(C,B)
p179_1(A,B) :- redpred_40(A,B)
p180(A,B) :- copy1(A,C),p180_1(C,B)
p180_1(A,B) :- redpred_24(A,B)
p181(A,B) :- copy1(A,C),p181_1(C,B)
p181_1(A,B) :- redpred_18(A,B)
p182(A,B) :- copy1(A,C),p182_1(C,B)
p182_1(A,B) :- redpred_51(A,B)
p184(A,B) :- redpred_52(A,B)
p186(A,B) :- p430(A,C),p186_1(C,B)
p186_1(A,B) :- redpred_20(A,B)
...
p680_1(A,B) :- redpred_47(A,B)
p681(A,B) :- p84(A,C),p681_1(C,B)
p681_1(A,B) :- redpred_87(A,B)
...
p704(A,B) :- redpred_88(A,B)
p706(A,B) :- p210(A,C),p706_1(C,B)
p706_1(A,B) :- p1895(A,C),p210(C,B)
p707(A,B) :- redpred_62(A,B)
p709(A,B) :- redpred_17(A,B)
p716(A,B) :- redpred_28(A,B)
...
p1639_1(A,B) :- redpred_54(A,B)
p1641(A,B) :- redpred_17(A,B)
p1642(A,B) :- redpred_40(A,B)
p1643(A,B) :- p264(A,C),p1643_1(C,B)
p1643_1(A,B) :- p264(A,C),p506(C,B)
p1645(A,B) :- redpred_47(A,B)
p1647(A,B) :- copy1(A,C),p1647_1(C,B)
p1647_1(A,B) :- redpred_20(A,B)
p1648(A,B) :- redpred_39(A,B)
...
p2143_1(A,B) :- redpred_58(A,B)
p2144(A,B) :- p84(A,C),p2144_1(C,B)
p2144_1(A,B) :- redpred_97(A,B)
p2145(A,B) :- redpred_27(A,B)
p2146(A,B) :- redpred_74(A,B)
p2151(A,B) :- copy1(A,C),p2151_1(C,B)
p2151_1(A,B) :- redpred_20(A,B)
p2152(A,B) :- p295(A,C),p2152_1(C,B)
p2152_1(A,B) :- redpred_36(A,B)
p2155(A,B) :- copy1(A,C),p2155_1(C,B)
p2155_1(A,B) :- redpred_19(A,B)
p2156(A,B) :- redpred_91(A,B)
p2161(A,B) :- redpred_105(A,B)
p2162(A,B) :- copy1(A,C),p2162_1(C,B)
p2162_1(A,B) :- redpred_84(A,B)
p2163(A,B) :- redpred_78(A,B)
p2168(A,B) :- mk_uppercase(A,C),p1895(C,B)
p2171(A,B) :- skip1(A,C),p2171_1(C,B)
p2171_1(A,B) :- redpred_60(A,B)
p2173(A,B) :- mk_lowercase(A,C),p2173_1(C,B)
p2173_1(A,B) :- redpred_22(A,B)
p2176(A,B) :- p506(A,C),p2176_1(C,B)
p2176_1(A,B) :- redpred_69(A,B)
p2177(A,B) :- redpred_23(A,B)
p2180(A,B) :- p27(A,C),p2180_1(C,B)
p2180_1(A,B) :- redpred_19(A,B)
p2189(A,B) :- redpred_19(A,B)
p2194(A,B) :- skip1(A,C),p2194_1(C,B)
p2194_1(A,B) :- redpred_20(A,B)
p2204(A,B) :- redpred_19(A,B)
p2205(A,B) :- redpred_77(A,B)
p2206(A,B) :- copy1(A,C),p2206_1(C,B)
p2206_1(A,B) :- redpred_30(A,B)
p2210(A,B) :- mk_uppercase(A,C),p2210_1(C,B)
p2210_1(A,B) :- redpred_17(A,B)
...
p197(A,B) :- redpred_110(A,B)
p201(A,B) :- mk_uppercase(A,C),p201_1(C,B)
p201_1(A,B) :- redpred_121(A,B)
...
p281(A,B) :- redpred_126(A,B)
p288(A,B) :- p21_1(A,C),p956(C,B)
p289(A,B) :- redpred_125(A,B)
...
p619_1(A,B) :- redpred_132(A,B)
p626(A,B) :- p27(A,C),p2273(C,B)
p631(A,B) :- p31_1(A,C),p1843(C,B)
p634(A,B) :- redpred_145(A,B)
p636(A,B) :- redpred_127(A,B)
...
p911_1(A,B) :- redpred_156(A,B)
p912(A,B) :- redpred_141(A,B)
...
p969(A,B) :- redpred_157(A,B)
p972(A,B) :- redpred_158(A,B)
p974(A,B) :- p566(A,C),p21_1(C,B)
p975(A,B) :- redpred_115(A,B)
...
p1121(A,B) :- redpred_149(A,B)
p1122(A,B) :- mk_uppercase(A,C),p58(C,B)
p1124(A,B) :- redpred_150(A,B)
...
p1316(A,B) :- redpred_168(A,B)
p1318(A,B) :- skip1(A,C),p1318_1(C,B)
p1318_1(A,B) :- p190(A,C),p274(C,B)
p1320(A,B) :- redpred_137(A,B)
p1322(A,B) :- redpred_139(A,B)
...
p1469(A,B) :- redpred_146(A,B)
p1471(A,B) :- redpred_168(A,B)
p1472(A,B) :- redpred_170(A,B)
p1480(A,B) :- redpred_132(A,B)
...
p1861_1(A,B) :- redpred_163(A,B)
p1862(A,B) :- redpred_173(A,B)
...
p1934(A,B) :- redpred_165(A,B)
p1939(A,B) :- p27(A,C),p1939_1(C,B)
p1939_1(A,B) :- redpred_162(A,B)
...
p2342(A,B) :- redpred_175(A,B)
p2344(A,B) :- redpred_173(A,B)
