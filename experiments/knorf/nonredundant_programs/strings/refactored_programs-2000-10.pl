...
redpred_15(A,B) :- skip1(A,C),p3(C,B)
redpred_16(A,B) :- p1634(A,C),p67(C,B)
redpred_17(A,B) :- p3(A,C),p6(C,B)
redpred_18(A,B) :- p6(A,C),p31(C,B)
redpred_19(A,B) :- mk_uppercase(A,C),p31(C,B)
redpred_20(A,B) :- skip1(A,C),p334(C,B)
redpred_21(A,B) :- copy1(A,C),p67(C,B)
redpred_22(A,B) :- p45(A,C),p82(C,B)
redpred_23(A,B) :- copy1(A,C),p3(C,B)
redpred_24(A,B) :- skip1(A,C),p6(C,B)
redpred_25(A,B) :- p31(A,C),p82(C,B)
redpred_26(A,B) :- p67(A,C),p313(C,B)
redpred_27(A,B) :- skip1(A,C),p372(C,B)
redpred_28(A,B) :- p67(A,C),p31(C,B)
redpred_29(A,B) :- p45(A,C),p313(C,B)
redpred_30(A,B) :- skip1(A,C),p67(C,B)
redpred_31(A,B) :- p82(A,C),p67(C,B)
redpred_32(A,B) :- mk_lowercase(A,C),p67(C,B)
redpred_33(A,B) :- p313(A,C),p3(C,B)
redpred_34(A,B) :- skip1(A,C),p82(C,B)
redpred_35(A,B) :- p31(A,C),mk_lowercase(C,B)
redpred_36(A,B) :- p313(A,C),p82(C,B)
redpred_37(A,B) :- p3(A,C),p3(C,B)
redpred_38(A,B) :- p6(A,C),p6(C,B)
redpred_39(A,B) :- p3(A,C),p67(C,B)
redpred_40(A,B) :- p67(A,C),p3(C,B)
redpred_41(A,B) :- skip1(A,C),p1634(C,B)
redpred_42(A,B) :- copy1(A,C),p82(C,B)
redpred_43(A,B) :- copy1(A,C),p6(C,B)
redpred_44(A,B) :- p3(A,C),p372(C,B)
redpred_45(A,B) :- p67(A,C),p6(C,B)
redpred_46(A,B) :- p6(A,C),p3(C,B)
redpred_47(A,B) :- p3(A,C),p31(C,B)
redpred_48(A,B) :- p313(A,C),mk_lowercase(C,B)
redpred_49(A,B) :- mk_lowercase(A,C),p372(C,B)
redpred_50(A,B) :- skip1(A,C),p313(C,B)
redpred_51(A,B) :- p372(A,C),p31(C,B)
redpred_52(A,B) :- p372(A,C),p67(C,B)
redpred_53(A,B) :- mk_lowercase(A,C),p3(C,B)
redpred_54(A,B) :- p313(A,C),p67(C,B)
redpred_55(A,B) :- p45(A,C),p3(C,B)
redpred_56(A,B) :- p67(A,C),p67(C,B)
redpred_57(A,B) :- skip1(A,C),p45(C,B)
redpred_58(A,B) :- mk_uppercase(A,C),p45(C,B)
redpred_59(A,B) :- p6(A,C),p372(C,B)
redpred_60(A,B) :- skip1(A,C),p524(C,B)
redpred_61(A,B) :- copy1(A,C),p372(C,B)
redpred_62(A,B) :- p67(A,C),p82(C,B)
redpred_63(A,B) :- copy1(A,C),p45(C,B)
redpred_64(A,B) :- skip1(A,C),p31(C,B)
redpred_65(A,B) :- p313(A,C),p6(C,B)
redpred_66(A,B) :- p67(A,C),p45(C,B)
redpred_67(A,B) :- copy1(A,C),p334(C,B)
redpred_68(A,B) :- p31(A,C),p6(C,B)
redpred_69(A,B) :- p6(A,C),p67(C,B)
redpred_70(A,B) :- p6(A,C),p313(C,B)
redpred_71(A,B) :- p45(A,C),p67(C,B)
redpred_72(A,B) :- p313(A,C),p313(C,B)
redpred_73(A,B) :- p82(A,C),p3(C,B)
redpred_74(A,B) :- mk_uppercase(A,C),p313(C,B)
redpred_75(A,B) :- copy1(A,C),p31(C,B)
redpred_76(A,B) :- p67(A,C),p372(C,B)
redpred_77(A,B) :- p45(A,C),p45(C,B)
redpred_78(A,B) :- p372(A,C),p3(C,B)
redpred_79(A,B) :- p524(A,C),p67(C,B)
redpred_80(A,B) :- p334(A,C),p3(C,B)
redpred_81(A,B) :- p3(A,C),p82(C,B)
redpred_82(A,B) :- p31(A,C),p3(C,B)
redpred_83(A,B) :- p524(A,C),p3(C,B)
redpred_84(A,B) :- p31(A,C),p67(C,B)
redpred_85(A,B) :- mk_uppercase(A,C),p67(C,B)
redpred_86(A,B) :- copy1(A,C),p313(C,B)
redpred_87(A,B) :- p31(A,C),p372(C,B)
redpred_88(A,B) :- p6(A,C),p45(C,B)
redpred_89(A,B) :- p82(A,C),p372(C,B)
redpred_90(A,B) :- mk_lowercase(A,C),p6(C,B)
redpred_91(A,B) :- p334(A,C),p67(C,B)
redpred_92(A,B) :- p313(A,C),p31(C,B)
redpred_93(A,B) :- mk_uppercase(A,C),p372(C,B)
redpred_94(A,B) :- p31(A,C),p313(C,B)
redpred_95(A,B) :- mk_uppercase(A,C),p6(C,B)
redpred_96(A,B) :- p3(A,C),p313(C,B)
redpred_97(A,B) :- p3(A,C),p1961(C,B)
redpred_98(A,B) :- p338_1(A,C),p53_1(C,B)
redpred_99(A,B) :- p82(A,C),p81(C,B)
redpred_100(A,B) :- p3(A,C),p1592(C,B)
redpred_101(A,B) :- p11(A,C),p15(C,B)
redpred_102(A,B) :- p291(A,C),p313(C,B)
redpred_103(A,B) :- p887(A,C),p67(C,B)
redpred_104(A,B) :- skip1(A,C),p11(C,B)
redpred_105(A,B) :- p45(A,C),p204(C,B)
redpred_106(A,B) :- p424(A,C),p6(C,B)
redpred_107(A,B) :- skip1(A,C),p809(C,B)
redpred_108(A,B) :- skip1(A,C),p1328(C,B)
redpred_109(A,B) :- copy1(A,C),p352(C,B)
redpred_110(A,B) :- p11(A,C),p99(C,B)
redpred_111(A,B) :- skip1(A,C),p863(C,B)
redpred_112(A,B) :- p126(A,C),p53(C,B)
redpred_113(A,B) :- skip1(A,C),p1609(C,B)
redpred_114(A,B) :- copy1(A,C),p566(C,B)
redpred_115(A,B) :- p907(A,C),p53(C,B)
redpred_116(A,B) :- copy1(A,C),p833(C,B)
redpred_117(A,B) :- copy1(A,C),p203(C,B)
redpred_118(A,B) :- copy1(A,C),p532(C,B)
redpred_119(A,B) :- skip1(A,C),p413(C,B)
redpred_120(A,B) :- copy1(A,C),p1944(C,B)
redpred_121(A,B) :- skip1(A,C),p532(C,B)
redpred_122(A,B) :- p67(A,C),p532(C,B)
redpred_123(A,B) :- skip1(A,C),p204(C,B)
redpred_124(A,B) :- skip1(A,C),p53(C,B)
redpred_125(A,B) :- p67(A,C),p787(C,B)
redpred_126(A,B) :- p809(A,C),p69_1(C,B)
redpred_127(A,B) :- copy1(A,C),p907(C,B)
redpred_128(A,B) :- p809(A,C),p24(C,B)
redpred_129(A,B) :- skip1(A,C),p225(C,B)
redpred_130(A,B) :- copy1(A,C),p333(C,B)
redpred_131(A,B) :- skip1(A,C),p29(C,B)
redpred_132(A,B) :- skip1(A,C),p1631(C,B)
redpred_133(A,B) :- skip1(A,C),p950(C,B)
redpred_134(A,B) :- skip1(A,C),p361(C,B)
redpred_135(A,B) :- p887(A,C),p15(C,B)
redpred_136(A,B) :- mk_lowercase(A,C),p53(C,B)
redpred_137(A,B) :- p6(A,C),p53(C,B)
redpred_138(A,B) :- p67(A,C),p809(C,B)
redpred_139(A,B) :- p53(A,C),p98(C,B)
redpred_140(A,B) :- p67(A,C),p94(C,B)
redpred_141(A,B) :- p809(A,C),p53_1(C,B)
redpred_142(A,B) :- p3(A,C),p225(C,B)
redpred_143(A,B) :- copy1(A,C),p501(C,B)
redpred_144(A,B) :- p40(A,C),p67(C,B)
redpred_145(A,B) :- copy1(A,C),p53(C,B)
redpred_146(A,B) :- copy1(A,C),p321(C,B)
redpred_147(A,B) :- p24(A,C),p809(C,B)
redpred_148(A,B) :- copy1(A,C),p1328(C,B)
redpred_149(A,B) :- skip1(A,C),p1961(C,B)
redpred_150(A,B) :- p4(A,C),p532(C,B)
redpred_151(A,B) :- p42(A,C),p45(C,B)
redpred_152(A,B) :- p11(A,C),p53_1(C,B)
redpred_153(A,B) :- skip1(A,C),p566(C,B)
redpred_154(A,B) :- copy1(A,C),p887(C,B)
redpred_155(A,B) :- copy1(A,C),p29(C,B)
redpred_156(A,B) :- p115(A,C),p15(C,B)
redpred_157(A,B) :- p11(A,C),p329(C,B)
redpred_158(A,B) :- p809(A,C),p15(C,B)
redpred_159(A,B) :- skip1(A,C),p301(C,B)
...
p559(A,B) :- redpred_10(A,B)
p560(A,B) :- redpred_11(A,B)
...
p1253(A,B) :- redpred_9(A,B)
p1256(A,B) :- redpred_1(A,B)
p1259(A,B) :- redpred_1(A,B)
p1260(A,B) :- redpred_9(A,B)
...
p1313(A,B) :- redpred_10(A,B)
p1316(A,B) :- redpred_8(A,B)
...
p1801(A,B) :- redpred_13(A,B)
p1806(A,B) :- redpred_6(A,B)
p1809(A,B) :- redpred_9(A,B)
...
p33_1(A,B) :- redpred_25(A,B)
p35(A,B) :- copy1(A,C),p35_1(C,B)
p35_1(A,B) :- redpred_15(A,B)
...
p450_1(A,B) :- redpred_62(A,B)
p452(A,B) :- p524(A,C),p6(C,B)
p454(A,B) :- p3(A,C),p454_1(C,B)
p454_1(A,B) :- redpred_37(A,B)
p455(A,B) :- redpred_32(A,B)
...
p468(A,B) :- redpred_30(A,B)
p469(A,B) :- redpred_23(A,B)
p471(A,B) :- redpred_42(A,B)
p472(A,B) :- redpred_25(A,B)
p474(A,B) :- mk_lowercase(A,C),p474_1(C,B)
p474_1(A,B) :- redpred_54(A,B)
p476(A,B) :- mk_uppercase(A,C),p476_1(C,B)
p476_1(A,B) :- redpred_38(A,B)
p482(A,B) :- redpred_57(A,B)
...
p1323(A,B) :- redpred_30(A,B)
p1327(A,B) :- redpred_95(A,B)
p1328(A,B) :- p67(A,C),p1328_1(C,B)
p1328_1(A,B) :- redpred_57(A,B)
p1331(A,B) :- redpred_31(A,B)
p1332(A,B) :- redpred_84(A,B)
p1335(A,B) :- skip1(A,C),p1335_1(C,B)
p1335_1(A,B) :- redpred_15(A,B)
p1336(A,B) :- redpred_17(A,B)
p1342(A,B) :- skip1(A,C),p1342_1(C,B)
p1342_1(A,B) :- redpred_15(A,B)
p1345(A,B) :- redpred_56(A,B)
p1349(A,B) :- redpred_28(A,B)
p1350(A,B) :- skip1(A,C),p1350_1(C,B)
p1350_1(A,B) :- redpred_34(A,B)
p1352(A,B) :- redpred_64(A,B)
...
p25(A,B) :- redpred_97(A,B)
p26(A,B) :- redpred_98(A,B)
p27(A,B) :- redpred_99(A,B)
...
p76_1(A,B) :- redpred_101(A,B)
p78(A,B) :- redpred_102(A,B)
p83(A,B) :- skip1(A,C),p83_1(C,B)
p83_1(A,B) :- redpred_103(A,B)
...
p106(A,B) :- redpred_104(A,B)
p107(A,B) :- redpred_105(A,B)
p111(A,B) :- redpred_106(A,B)
...
p132_1(A,B) :- redpred_107(A,B)
p133(A,B) :- redpred_108(A,B)
...
p288(A,B) :- redpred_116(A,B)
p292(A,B) :- p212_1(A,C),p1748(C,B)
p294(A,B) :- redpred_118(A,B)
...
p440_1(A,B) :- redpred_123(A,B)
p442(A,B) :- redpred_118(A,B)
p447(A,B) :- p1191(A,C),p168_1(C,B)
p451(A,B) :- redpred_125(A,B)
p453(A,B) :- p1719(A,C),p173_1(C,B)
p457(A,B) :- p809(A,C),p1910(C,B)
p467(A,B) :- redpred_126(A,B)
...
p533_1(A,B) :- redpred_128(A,B)
p537(A,B) :- redpred_122(A,B)
p538(A,B) :- redpred_129(A,B)
...
p593(A,B) :- redpred_132(A,B)
p594(A,B) :- redpred_123(A,B)
...
p627_1(A,B) :- redpred_124(A,B)
p628(A,B) :- p81_1(A,C),p361(C,B)
p634(A,B) :- p1191_1(A,C),p193(C,B)
p638(A,B) :- redpred_125(A,B)
p640(A,B) :- redpred_116(A,B)
p642(A,B) :- p67(A,C),p1857(C,B)
p649(A,B) :- redpred_124(A,B)
...
p773_1(A,B) :- redpred_106(A,B)
p774(A,B) :- p15(A,C),p1681(C,B)
p779(A,B) :- redpred_141(A,B)
p783(A,B) :- p809(A,C),p514(C,B)
p784(A,B) :- redpred_114(A,B)
...
p877_1(A,B) :- redpred_111(A,B)
p878(A,B) :- redpred_143(A,B)
...
p918(A,B) :- redpred_145(A,B)
p921(A,B) :- redpred_146(A,B)
...
p1137(A,B) :- redpred_120(A,B)
p1139(A,B) :- p338_1(A,C),p188(C,B)
p1146(A,B) :- redpred_150(A,B)
p1148(A,B) :- redpred_143(A,B)
...
p1250(A,B) :- redpred_126(A,B)
p1251(A,B) :- p219_1(A,C),p458(C,B)
p1252(A,B) :- redpred_153(A,B)
...
p1374(A,B) :- redpred_140(A,B)
p1376(A,B) :- p139(A,C),p775(C,B)
p1378(A,B) :- redpred_108(A,B)
...
p1492_1(A,B) :- redpred_141(A,B)
p1493(A,B) :- p81_1(A,C),p340_1(C,B)
p1494(A,B) :- redpred_98(A,B)
p1496(A,B) :- redpred_139(A,B)
...
p1555_1(A,B) :- redpred_131(A,B)
p1558(A,B) :- redpred_148(A,B)
...
p1601_1(A,B) :- redpred_124(A,B)
p1602(A,B) :- p99(A,C),p809(C,B)
p1604(A,B) :- redpred_147(A,B)
p1605(A,B) :- redpred_153(A,B)
...
p1735(A,B) :- redpred_149(A,B)
p1736(A,B) :- copy1(A,C),p507(C,B)
p1738(A,B) :- redpred_124(A,B)
p1739(A,B) :- redpred_123(A,B)
p1744(A,B) :- p3(A,C),p1744_1(C,B)
p1744_1(A,B) :- p809(A,C),p659_1(C,B)
p1746(A,B) :- redpred_104(A,B)
...
p1909_1(A,B) :- redpred_132(A,B)
p1914(A,B) :- p67(A,C),p1914_1(C,B)
p1914_1(A,B) :- redpred_101(A,B)
p1919(A,B) :- p67(A,C),p1919_1(C,B)
p1919_1(A,B) :- redpred_107(A,B)
p1920(A,B) :- redpred_155(A,B)
p1927(A,B) :- redpred_158(A,B)
p1928(A,B) :- skip1(A,C),p1431(C,B)
p1932(A,B) :- redpred_158(A,B)
p1936(A,B) :- redpred_101(A,B)
p1941(A,B) :- redpred_157(A,B)
...
p1973(A,B) :- redpred_99(A,B)
p1976(A,B) :- copy1(A,C),p1976_1(C,B)
p1976_1(A,B) :- redpred_152(A,B)
p1980(A,B) :- p67(A,C),p1980_1(C,B)
p1980_1(A,B) :- redpred_141(A,B)
