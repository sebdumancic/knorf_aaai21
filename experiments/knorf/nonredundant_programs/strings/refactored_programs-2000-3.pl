...
redpred_16(A,B) :- p65(A,C),p298(C,B)
redpred_17(A,B) :- p65(A,C),p63(C,B)
redpred_18(A,B) :- skip1(A,C),p65(C,B)
redpred_19(A,B) :- skip1(A,C),p17(C,B)
redpred_20(A,B) :- p17(A,C),p17(C,B)
redpred_21(A,B) :- p17(A,C),p268(C,B)
redpred_22(A,B) :- p298(A,C),p63(C,B)
redpred_23(A,B) :- p43(A,C),p65(C,B)
redpred_24(A,B) :- p33(A,C),p43(C,B)
redpred_25(A,B) :- p65(A,C),p29(C,B)
redpred_26(A,B) :- skip1(A,C),p43(C,B)
redpred_27(A,B) :- skip1(A,C),p63(C,B)
redpred_28(A,B) :- p268(A,C),p17(C,B)
redpred_29(A,B) :- p771(A,C),p65(C,B)
redpred_30(A,B) :- p17(A,C),p65(C,B)
redpred_31(A,B) :- p33(A,C),p65(C,B)
redpred_32(A,B) :- skip1(A,C),p29(C,B)
redpred_33(A,B) :- p65(A,C),p1733(C,B)
redpred_34(A,B) :- mk_lowercase(A,C),p43(C,B)
redpred_35(A,B) :- p17(A,C),p43(C,B)
redpred_36(A,B) :- p29(A,C),p65(C,B)
redpred_37(A,B) :- copy1(A,C),p298(C,B)
redpred_38(A,B) :- p268(A,C),p298(C,B)
redpred_39(A,B) :- skip1(A,C),p458(C,B)
redpred_40(A,B) :- skip1(A,C),p1733(C,B)
redpred_41(A,B) :- p17(A,C),p63(C,B)
redpred_42(A,B) :- p43(A,C),p268(C,B)
redpred_43(A,B) :- p17(A,C),p29(C,B)
redpred_44(A,B) :- p268(A,C),p65(C,B)
redpred_45(A,B) :- p65(A,C),p43(C,B)
redpred_46(A,B) :- copy1(A,C),p29(C,B)
redpred_47(A,B) :- p458(A,C),p63(C,B)
redpred_48(A,B) :- p1733(A,C),p65(C,B)
redpred_49(A,B) :- copy1(A,C),p17(C,B)
redpred_50(A,B) :- p268(A,C),p268(C,B)
redpred_51(A,B) :- p33(A,C),p17(C,B)
redpred_52(A,B) :- p29(A,C),p17(C,B)
redpred_53(A,B) :- p65(A,C),p826(C,B)
redpred_54(A,B) :- skip1(A,C),p771(C,B)
redpred_55(A,B) :- mk_uppercase(A,C),p65(C,B)
redpred_56(A,B) :- p65(A,C),p65(C,B)
redpred_57(A,B) :- p65(A,C),p17(C,B)
redpred_58(A,B) :- skip1(A,C),p268(C,B)
redpred_59(A,B) :- p298(A,C),p298(C,B)
redpred_60(A,B) :- p43(A,C),p1733(C,B)
redpred_61(A,B) :- p65(A,C),p268(C,B)
redpred_62(A,B) :- p17(A,C),p33(C,B)
redpred_63(A,B) :- copy1(A,C),p458(C,B)
redpred_64(A,B) :- mk_lowercase(A,C),p65(C,B)
redpred_65(A,B) :- mk_lowercase(A,C),p17(C,B)
redpred_66(A,B) :- p63(A,C),p268(C,B)
redpred_67(A,B) :- copy1(A,C),p65(C,B)
redpred_68(A,B) :- p65(A,C),p33(C,B)
redpred_69(A,B) :- mk_lowercase(A,C),p268(C,B)
redpred_70(A,B) :- skip1(A,C),p298(C,B)
redpred_71(A,B) :- copy1(A,C),p826(C,B)
redpred_72(A,B) :- p63(A,C),p65(C,B)
redpred_73(A,B) :- p43(A,C),p33(C,B)
redpred_74(A,B) :- mk_uppercase(A,C),p17(C,B)
redpred_75(A,B) :- skip1(A,C),p826(C,B)
redpred_76(A,B) :- p298(A,C),p65(C,B)
redpred_77(A,B) :- p29(A,C),p29(C,B)
redpred_78(A,B) :- p298(A,C),p33(C,B)
redpred_79(A,B) :- p458(A,C),p65(C,B)
redpred_80(A,B) :- p298(A,C),p29(C,B)
redpred_81(A,B) :- copy1(A,C),p43(C,B)
redpred_82(A,B) :- copy1(A,C),p63(C,B)
redpred_83(A,B) :- mk_lowercase(A,C),p33(C,B)
redpred_84(A,B) :- p43(A,C),p17(C,B)
redpred_85(A,B) :- p268(A,C),p63(C,B)
redpred_86(A,B) :- copy1(A,C),p33(C,B)
redpred_87(A,B) :- p33(A,C),p268(C,B)
redpred_88(A,B) :- mk_uppercase(A,C),p268(C,B)
redpred_89(A,B) :- p43(A,C),p298(C,B)
redpred_90(A,B) :- p268(A,C),p29(C,B)
redpred_91(A,B) :- mk_lowercase(A,C),p29(C,B)
redpred_92(A,B) :- skip1(A,C),p33(C,B)
redpred_93(A,B) :- p63(A,C),p33(C,B)
redpred_94(A,B) :- p43(A,C),p29(C,B)
redpred_95(A,B) :- p17(A,C),p298(C,B)
redpred_96(A,B) :- p65(A,C),p458(C,B)
redpred_97(A,B) :- p298(A,C),p17(C,B)
redpred_98(A,B) :- p65(A,C),p771(C,B)
redpred_99(A,B) :- p29(A,C),p33(C,B)
redpred_100(A,B) :- copy1(A,C),p1733(C,B)
redpred_101(A,B) :- p33(A,C),p33(C,B)
redpred_102(A,B) :- p826(A,C),p1733(C,B)
redpred_103(A,B) :- p65(A,C),p152(C,B)
redpred_104(A,B) :- p7_1(A,C),p486(C,B)
redpred_105(A,B) :- skip1(A,C),p297(C,B)
redpred_106(A,B) :- p521(A,C),p634(C,B)
redpred_107(A,B) :- copy1(A,C),p965(C,B)
redpred_108(A,B) :- p65(A,C),p1767(C,B)
redpred_109(A,B) :- skip1(A,C),p486(C,B)
redpred_110(A,B) :- p135(A,C),p918_1(C,B)
redpred_111(A,B) :- p1478(A,C),p305(C,B)
redpred_112(A,B) :- skip1(A,C),p843(C,B)
redpred_113(A,B) :- p63(A,C),p152(C,B)
redpred_114(A,B) :- p65(A,C),p297(C,B)
redpred_115(A,B) :- p232(A,C),p210_1(C,B)
redpred_116(A,B) :- copy1(A,C),p486(C,B)
redpred_117(A,B) :- skip1(A,C),p16(C,B)
redpred_118(A,B) :- skip1(A,C),p965(C,B)
redpred_119(A,B) :- p31(A,C),p7_1(C,B)
redpred_120(A,B) :- skip1(A,C),p135(C,B)
redpred_121(A,B) :- copy1(A,C),p297(C,B)
redpred_122(A,B) :- skip1(A,C),p971(C,B)
redpred_123(A,B) :- p7_1(A,C),p889(C,B)
redpred_124(A,B) :- p65(A,C),p972(C,B)
redpred_125(A,B) :- mk_lowercase(A,C),p152(C,B)
redpred_126(A,B) :- p297(A,C),p7_1(C,B)
redpred_127(A,B) :- p135(A,C),p129(C,B)
redpred_128(A,B) :- skip1(A,C),p668(C,B)
redpred_129(A,B) :- p7_1(A,C),p657(C,B)
redpred_130(A,B) :- copy1(A,C),p1535(C,B)
redpred_131(A,B) :- p6(A,C),p9(C,B)
redpred_132(A,B) :- copy1(A,C),p972(C,B)
redpred_133(A,B) :- p54(A,C),p521(C,B)
redpred_134(A,B) :- p63(A,C),p232(C,B)
redpred_135(A,B) :- copy1(A,C),p359(C,B)
redpred_136(A,B) :- p971(A,C),p7_1(C,B)
redpred_137(A,B) :- p398(A,C),p337(C,B)
redpred_138(A,B) :- copy1(A,C),p485(C,B)
redpred_139(A,B) :- p297(A,C),p129(C,B)
redpred_140(A,B) :- p129(A,C),p965(C,B)
redpred_141(A,B) :- p1756(A,C),p55_1(C,B)
redpred_142(A,B) :- skip1(A,C),p370(C,B)
redpred_143(A,B) :- p33(A,C),p725(C,B)
redpred_144(A,B) :- p65(A,C),p486(C,B)
redpred_145(A,B) :- skip1(A,C),p455(C,B)
redpred_146(A,B) :- skip1(A,C),p23(C,B)
redpred_147(A,B) :- skip1(A,C),p77(C,B)
...
p475(A,B) :- redpred_8(A,B)
p476(A,B) :- redpred_1(A,B)
p477(A,B) :- redpred_9(A,B)
...
p833(A,B) :- redpred_12(A,B)
p835(A,B) :- redpred_2(A,B)
p840(A,B) :- redpred_2(A,B)
p842(A,B) :- redpred_10(A,B)
...
p1779(A,B) :- redpred_9(A,B)
p1782(A,B) :- redpred_15(A,B)
p1800(A,B) :- redpred_9(A,B)
p1803(A,B) :- redpred_12(A,B)
p1814(A,B) :- redpred_12(A,B)
...
p521(A,B) :- redpred_82(A,B)
p525(A,B) :- redpred_44(A,B)
p526(A,B) :- mk_lowercase(A,C),p526_1(C,B)
p526_1(A,B) :- redpred_59(A,B)
p528(A,B) :- redpred_30(A,B)
p536(A,B) :- redpred_83(A,B)
p538(A,B) :- redpred_84(A,B)
...
p1382_1(A,B) :- redpred_99(A,B)
p1384(A,B) :- skip1(A,C),p1384_1(C,B)
p1384_1(A,B) :- redpred_20(A,B)
...
p1422_1(A,B) :- redpred_58(A,B)
p1426(A,B) :- redpred_100(A,B)
p1427(A,B) :- p268(A,C),p1427_1(C,B)
p1427_1(A,B) :- redpred_25(A,B)
p1429(A,B) :- skip1(A,C),p1429_1(C,B)
p1429_1(A,B) :- redpred_56(A,B)
...
p1437_1(A,B) :- redpred_85(A,B)
p1444(A,B) :- redpred_58(A,B)
...
p422_1(A,B) :- redpred_126(A,B)
p424(A,B) :- copy1(A,C),p618(C,B)
p425(A,B) :- redpred_127(A,B)
...
p487(A,B) :- redpred_105(A,B)
p490(A,B) :- redpred_130(A,B)
p491(A,B) :- redpred_131(A,B)
...
p620(A,B) :- redpred_119(A,B)
p621(A,B) :- redpred_116(A,B)
...
p913(A,B) :- redpred_121(A,B)
p915(A,B) :- skip1(A,C),p915_1(C,B)
p915_1(A,B) :- redpred_122(A,B)
p917(A,B) :- redpred_123(A,B)
...
p991(A,B) :- redpred_128(A,B)
p994(A,B) :- redpred_137(A,B)
p998(A,B) :- redpred_134(A,B)
...
p1383_1(A,B) :- redpred_109(A,B)
p1385(A,B) :- p17(A,C),p1385_1(C,B)
p1385_1(A,B) :- redpred_122(A,B)
...
p1675_1(A,B) :- redpred_145(A,B)
p1676(A,B) :- redpred_145(A,B)
...
p1933(A,B) :- redpred_142(A,B)
p1936(A,B) :- p54(A,C),p359(C,B)
p1937(A,B) :- redpred_117(A,B)
