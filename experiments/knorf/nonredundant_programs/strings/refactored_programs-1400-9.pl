...
redpred_15(A,B) :- skip1(A,C),p18(C,B)
redpred_16(A,B) :- copy1(A,C),p82(C,B)
redpred_17(A,B) :- p166(A,C),p82(C,B)
redpred_18(A,B) :- p18(A,C),p18(C,B)
redpred_19(A,B) :- mk_uppercase(A,C),p12(C,B)
redpred_20(A,B) :- skip1(A,C),p60(C,B)
redpred_21(A,B) :- p82(A,C),p51(C,B)
redpred_22(A,B) :- p12(A,C),p12(C,B)
redpred_23(A,B) :- copy1(A,C),p18(C,B)
redpred_24(A,B) :- skip1(A,C),p104(C,B)
redpred_25(A,B) :- p82(A,C),p60(C,B)
redpred_26(A,B) :- skip1(A,C),p51(C,B)
redpred_27(A,B) :- p82(A,C),p12(C,B)
redpred_28(A,B) :- p166(A,C),p12(C,B)
redpred_29(A,B) :- p166(A,C),mk_uppercase(C,B)
redpred_30(A,B) :- skip1(A,C),p12(C,B)
redpred_31(A,B) :- copy1(A,C),p166(C,B)
redpred_32(A,B) :- p82(A,C),p166(C,B)
redpred_33(A,B) :- p18(A,C),p12(C,B)
redpred_34(A,B) :- mk_lowercase(A,C),p12(C,B)
redpred_35(A,B) :- skip1(A,C),p82(C,B)
redpred_36(A,B) :- p12(A,C),p330(C,B)
redpred_37(A,B) :- copy1(A,C),p330(C,B)
redpred_38(A,B) :- p104(A,C),p12(C,B)
redpred_39(A,B) :- mk_uppercase(A,C),p82(C,B)
redpred_40(A,B) :- skip1(A,C),p303(C,B)
redpred_41(A,B) :- mk_lowercase(A,C),p82(C,B)
redpred_42(A,B) :- p51(A,C),p12(C,B)
redpred_43(A,B) :- p12(A,C),p51(C,B)
redpred_44(A,B) :- p82(A,C),p82(C,B)
redpred_45(A,B) :- p104(A,C),p82(C,B)
redpred_46(A,B) :- copy1(A,C),p12(C,B)
redpred_47(A,B) :- skip1(A,C),p166(C,B)
redpred_48(A,B) :- p12(A,C),p82(C,B)
redpred_49(A,B) :- p82(A,C),p330(C,B)
redpred_50(A,B) :- skip1(A,C),p330(C,B)
redpred_51(A,B) :- mk_uppercase(A,C),p60(C,B)
redpred_52(A,B) :- p303(A,C),p82(C,B)
redpred_53(A,B) :- p330(A,C),p166(C,B)
redpred_54(A,B) :- p60(A,C),p82(C,B)
redpred_55(A,B) :- mk_uppercase(A,C),p18(C,B)
redpred_56(A,B) :- mk_lowercase(A,C),mk_lowercase(C,B)
redpred_57(A,B) :- p60(A,C),p18(C,B)
redpred_58(A,B) :- p12(A,C),p60(C,B)
redpred_59(A,B) :- copy1(A,C),p104(C,B)
redpred_60(A,B) :- p51(A,C),p82(C,B)
redpred_61(A,B) :- p18(A,C),mk_lowercase(C,B)
redpred_62(A,B) :- p51(A,C),mk_lowercase(C,B)
redpred_63(A,B) :- mk_lowercase(A,C),p51(C,B)
redpred_64(A,B) :- p82(A,C),p104(C,B)
redpred_65(A,B) :- p12(A,C),p18(C,B)
redpred_66(A,B) :- skip1(A,C),p106(C,B)
redpred_67(A,B) :- p60(A,C),p330(C,B)
redpred_68(A,B) :- p330(A,C),p12(C,B)
redpred_69(A,B) :- mk_lowercase(A,C),p60(C,B)
redpred_70(A,B) :- p106(A,C),p104(C,B)
redpred_71(A,B) :- p60(A,C),p12(C,B)
redpred_72(A,B) :- p51(A,C),p166(C,B)
redpred_73(A,B) :- p18(A,C),p166(C,B)
redpred_74(A,B) :- copy1(A,C),p51(C,B)
redpred_75(A,B) :- p330(A,C),p82(C,B)
redpred_76(A,B) :- p330(A,C),p330(C,B)
redpred_77(A,B) :- p12(A,C),p166(C,B)
redpred_78(A,B) :- p330(A,C),mk_uppercase(C,B)
redpred_79(A,B) :- p166(A,C),p51(C,B)
redpred_80(A,B) :- mk_lowercase(A,C),p104(C,B)
redpred_81(A,B) :- p330(A,C),p60(C,B)
redpred_82(A,B) :- p272(A,C),p332(C,B)
redpred_83(A,B) :- p57_1(A,C),p14(C,B)
redpred_84(A,B) :- p32_1(A,C),p695(C,B)
redpred_85(A,B) :- copy1(A,C),p327(C,B)
redpred_86(A,B) :- skip1(A,C),p2(C,B)
redpred_87(A,B) :- skip1(A,C),p14(C,B)
redpred_88(A,B) :- skip1(A,C),p366(C,B)
redpred_89(A,B) :- copy1(A,C),p819(C,B)
redpred_90(A,B) :- copy1(A,C),p492(C,B)
redpred_91(A,B) :- p82(A,C),p695(C,B)
redpred_92(A,B) :- p110_1(A,C),p1024(C,B)
redpred_93(A,B) :- p6_1(A,C),p14(C,B)
redpred_94(A,B) :- p275(A,C),p45(C,B)
redpred_95(A,B) :- p82(A,C),p176(C,B)
redpred_96(A,B) :- p82(A,C),p219(C,B)
redpred_97(A,B) :- p238(A,C),copy1(C,B)
redpred_98(A,B) :- p44(A,C),p46(C,B)
redpred_99(A,B) :- p338(A,C),p144(C,B)
redpred_100(A,B) :- p34_1(A,C),p1073(C,B)
redpred_101(A,B) :- skip1(A,C),p1071(C,B)
redpred_102(A,B) :- copy1(A,C),p219(C,B)
redpred_103(A,B) :- skip1(A,C),p44(C,B)
redpred_104(A,B) :- skip1(A,C),p6(C,B)
redpred_105(A,B) :- skip1(A,C),p174(C,B)
redpred_106(A,B) :- skip1(A,C),p338(C,B)
redpred_107(A,B) :- copy1(A,C),p789(C,B)
redpred_108(A,B) :- p695(A,C),p1167(C,B)
redpred_109(A,B) :- skip1(A,C),p129(C,B)
redpred_110(A,B) :- copy1(A,C),p565(C,B)
redpred_111(A,B) :- p12(A,C),p131(C,B)
redpred_112(A,B) :- p43_1(A,C),p57_1(C,B)
redpred_113(A,B) :- p2(A,C),p1071(C,B)
redpred_114(A,B) :- skip1(A,C),p724_1(C,B)
redpred_115(A,B) :- p724(A,C),copy1(C,B)
redpred_116(A,B) :- copy1(A,C),p703(C,B)
...
p586(A,B) :- redpred_10(A,B)
p587(A,B) :- redpred_9(A,B)
p589(A,B) :- redpred_12(A,B)
...
p1395(A,B) :- redpred_13(A,B)
p1397(A,B) :- redpred_11(A,B)
p1398(A,B) :- redpred_12(A,B)
p2(A,B) :- skip1(A,C),p2_1(C,B)
p2_1(A,B) :- redpred_15(A,B)
...
p222_1(A,B) :- redpred_42(A,B)
p223(A,B) :- redpred_20(A,B)
p224(A,B) :- redpred_16(A,B)
p233(A,B) :- redpred_51(A,B)
p238(A,B) :- p82(A,C),p238_1(C,B)
p238_1(A,B) :- redpred_47(A,B)
...
p262_1(A,B) :- redpred_53(A,B)
p263(A,B) :- mk_uppercase(A,C),p263_1(C,B)
p263_1(A,B) :- redpred_36(A,B)
...
p274_1(A,B) :- redpred_17(A,B)
p275(A,B) :- copy1(A,C),p275_1(C,B)
p275_1(A,B) :- redpred_35(A,B)
p281(A,B) :- p82(A,C),p281_1(C,B)
p281_1(A,B) :- redpred_54(A,B)
...
p643_1(A,B) :- redpred_27(A,B)
p644(A,B) :- redpred_74(A,B)
p645(A,B) :- copy1(A,C),p645_1(C,B)
p645_1(A,B) :- redpred_48(A,B)
p653(A,B) :- redpred_55(A,B)
...
p1076_1(A,B) :- redpred_27(A,B)
p1077(A,B) :- p104(A,C),p1077_1(C,B)
p1077_1(A,B) :- redpred_81(A,B)
p1078(A,B) :- redpred_64(A,B)
p1079(A,B) :- redpred_31(A,B)
p1080(A,B) :- redpred_33(A,B)
...
p1396_1(A,B) :- redpred_51(A,B)
p1399(A,B) :- p166(A,C),p1399_1(C,B)
p1399_1(A,B) :- redpred_35(A,B)
...
p36_1(A,B) :- redpred_83(A,B)
p37(A,B) :- redpred_84(A,B)
...
p703_1(A,B) :- redpred_105(A,B)
p704(A,B) :- p82(A,C),p704_1(C,B)
p704_1(A,B) :- redpred_88(A,B)
...
p724_1(A,B) :- redpred_106(A,B)
p729(A,B) :- redpred_107(A,B)
...
p1230(A,B) :- redpred_111(A,B)
p1232(A,B) :- p51(A,C),p1232_1(C,B)
p1232_1(A,B) :- redpred_112(A,B)
...
p1369(A,B) :- redpred_113(A,B)
p1370(A,B) :- copy1(A,C),p1370_1(C,B)
p1370_1(A,B) :- redpred_106(A,B)
...
p298_1(A,B) :- redpred_114(A,B)
p360(A,B) :- p330(A,C),p360_1(C,B)
p360_1(A,B) :- p329(A,C),p60(C,B)
p386(A,B) :- redpred_115(A,B)
p403(A,B) :- redpred_116(A,B)
p433(A,B) :- redpred_116(A,B)
