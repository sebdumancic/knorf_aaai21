...
redpred_12(A,B) :- copy1(A,C),p5(C,B)
redpred_13(A,B) :- skip1(A,C),p40(C,B)
redpred_14(A,B) :- skip1(A,C),p25(C,B)
redpred_15(A,B) :- p33(A,C),p5(C,B)
redpred_16(A,B) :- skip1(A,C),p5(C,B)
redpred_17(A,B) :- skip1(A,C),p33(C,B)
redpred_18(A,B) :- p168(A,C),p5(C,B)
redpred_19(A,B) :- skip1(A,C),p4(C,B)
redpred_20(A,B) :- skip1(A,C),p189(C,B)
redpred_21(A,B) :- p168(A,C),p33(C,B)
redpred_22(A,B) :- p33(A,C),mk_uppercase(C,B)
redpred_23(A,B) :- p33(A,C),p57(C,B)
redpred_24(A,B) :- p5(A,C),p5(C,B)
redpred_25(A,B) :- p5(A,C),mk_uppercase(C,B)
redpred_26(A,B) :- skip1(A,C),p57(C,B)
redpred_27(A,B) :- copy1(A,C),p33(C,B)
redpred_28(A,B) :- copy1(A,C),p57(C,B)
redpred_29(A,B) :- p33(A,C),p33(C,B)
redpred_30(A,B) :- p5(A,C),p40(C,B)
redpred_31(A,B) :- p5(A,C),p33(C,B)
redpred_32(A,B) :- p5(A,C),p189(C,B)
redpred_33(A,B) :- p5(A,C),p168(C,B)
redpred_34(A,B) :- p25(A,C),p33(C,B)
redpred_35(A,B) :- copy1(A,C),p189(C,B)
redpred_36(A,B) :- p40(A,C),p5(C,B)
redpred_37(A,B) :- mk_uppercase(A,C),p33(C,B)
redpred_38(A,B) :- p33(A,C),p274(C,B)
redpred_39(A,B) :- p40(A,C),p1(C,B)
redpred_40(A,B) :- p47(A,C),p110(C,B)
redpred_41(A,B) :- p176(A,C),p300(C,B)
redpred_42(A,B) :- p154(A,C),p31_1(C,B)
redpred_43(A,B) :- p31_1(A,C),p176(C,B)
...
p83_1(A,B) :- redpred_23(A,B)
p90(A,B) :- redpred_16(A,B)
p93(A,B) :- p5(A,C),p93_1(C,B)
p93_1(A,B) :- redpred_20(A,B)
