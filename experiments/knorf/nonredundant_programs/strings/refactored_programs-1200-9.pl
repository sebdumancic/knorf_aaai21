redpred_1(A,B) :- mk_lowercase(A,C),mk_uppercase(C,B)
...
redpred_16(A,B) :- skip1(A,C),p224(C,B)
redpred_17(A,B) :- p32(A,C),p82(C,B)
redpred_18(A,B) :- copy1(A,C),p21(C,B)
redpred_19(A,B) :- copy1(A,C),p9(C,B)
redpred_20(A,B) :- p9(A,C),p242(C,B)
redpred_21(A,B) :- copy1(A,C),p20(C,B)
redpred_22(A,B) :- copy1(A,C),p131(C,B)
redpred_23(A,B) :- p21(A,C),p9(C,B)
redpred_24(A,B) :- p9(A,C),p21(C,B)
redpred_25(A,B) :- p20(A,C),p224(C,B)
redpred_26(A,B) :- mk_lowercase(A,C),p20(C,B)
redpred_27(A,B) :- skip1(A,C),p9(C,B)
redpred_28(A,B) :- p21(A,C),p204(C,B)
redpred_29(A,B) :- skip1(A,C),p336(C,B)
redpred_30(A,B) :- skip1(A,C),p32(C,B)
redpred_31(A,B) :- mk_lowercase(A,C),p21(C,B)
redpred_32(A,B) :- p9(A,C),p336(C,B)
redpred_33(A,B) :- p224(A,C),p21(C,B)
redpred_34(A,B) :- p21(A,C),p82(C,B)
redpred_35(A,B) :- p9(A,C),p20(C,B)
redpred_36(A,B) :- p9(A,C),p9(C,B)
redpred_37(A,B) :- p336(A,C),p21(C,B)
redpred_38(A,B) :- p204(A,C),p20(C,B)
redpred_39(A,B) :- p21(A,C),p32(C,B)
redpred_40(A,B) :- p21(A,C),p21(C,B)
redpred_41(A,B) :- mk_lowercase(A,C),p9(C,B)
redpred_42(A,B) :- p21(A,C),p20(C,B)
redpred_43(A,B) :- p9(A,C),p224(C,B)
redpred_44(A,B) :- skip1(A,C),p21(C,B)
redpred_45(A,B) :- p82(A,C),p9(C,B)
redpred_46(A,B) :- p242(A,C),p9(C,B)
redpred_47(A,B) :- p21(A,C),p336(C,B)
redpred_48(A,B) :- mk_uppercase(A,C),p20(C,B)
redpred_49(A,B) :- skip1(A,C),p204(C,B)
redpred_50(A,B) :- p9(A,C),p32(C,B)
redpred_51(A,B) :- skip1(A,C),p131(C,B)
redpred_52(A,B) :- copy1(A,C),p224(C,B)
redpred_53(A,B) :- p131(A,C),p21(C,B)
redpred_54(A,B) :- p224(A,C),p9(C,B)
redpred_55(A,B) :- p336(A,C),p32(C,B)
redpred_56(A,B) :- skip1(A,C),p51(C,B)
redpred_57(A,B) :- p131(A,C),p9(C,B)
redpred_58(A,B) :- skip1(A,C),p20(C,B)
redpred_59(A,B) :- p204(A,C),p21(C,B)
redpred_60(A,B) :- mk_uppercase(A,C),p9(C,B)
redpred_61(A,B) :- p21(A,C),p224(C,B)
redpred_62(A,B) :- p9(A,C),p131(C,B)
redpred_63(A,B) :- copy1(A,C),p82(C,B)
redpred_64(A,B) :- mk_uppercase(A,C),p21(C,B)
redpred_65(A,B) :- p9(A,C),p204(C,B)
redpred_66(A,B) :- p32(A,C),p20(C,B)
redpred_67(A,B) :- p20(A,C),p21(C,B)
redpred_68(A,B) :- p336(A,C),p131(C,B)
redpred_69(A,B) :- copy1(A,C),p336(C,B)
redpred_70(A,B) :- copy1(A,C),p32(C,B)
redpred_71(A,B) :- skip1(A,C),p242(C,B)
redpred_72(A,B) :- copy1(A,C),p204(C,B)
redpred_73(A,B) :- p204(A,C),p9(C,B)
redpred_74(A,B) :- p1(A,C),p21(C,B)
redpred_75(A,B) :- p21(A,C),p131(C,B)
redpred_76(A,B) :- skip1(A,C),p1(C,B)
redpred_77(A,B) :- mk_uppercase(A,C),p204(C,B)
redpred_78(A,B) :- mk_lowercase(A,C),p131(C,B)
redpred_79(A,B) :- p224(A,C),p20(C,B)
redpred_80(A,B) :- p32(A,C),p9(C,B)
redpred_81(A,B) :- mk_lowercase(A,C),p178(C,B)
redpred_82(A,B) :- p460(A,C),mk_lowercase(C,B)
redpred_83(A,B) :- p287(A,C),p242(C,B)
redpred_84(A,B) :- skip1(A,C),p178(C,B)
redpred_85(A,B) :- skip1(A,C),p724(C,B)
redpred_86(A,B) :- skip1(A,C),p637(C,B)
redpred_87(A,B) :- p9(A,C),p870(C,B)
redpred_88(A,B) :- skip1(A,C),p13(C,B)
redpred_89(A,B) :- copy1(A,C),p584(C,B)
redpred_90(A,B) :- p9(A,C),p724(C,B)
redpred_91(A,B) :- p9(A,C),p637(C,B)
redpred_92(A,B) :- p60(A,C),p120_1(C,B)
redpred_93(A,B) :- skip1(A,C),p835(C,B)
redpred_94(A,B) :- p13(A,C),p120_1(C,B)
redpred_95(A,B) :- skip1(A,C),p49(C,B)
redpred_96(A,B) :- skip1(A,C),p57(C,B)
redpred_97(A,B) :- mk_lowercase(A,C),p460(C,B)
redpred_98(A,B) :- p120_1(A,C),p17(C,B)
redpred_99(A,B) :- p16_1(A,C),p637(C,B)
redpred_100(A,B) :- skip1(A,C),p464(C,B)
redpred_101(A,B) :- p449_1(A,C),p30_1(C,B)
redpred_102(A,B) :- skip1(A,C),p161(C,B)
redpred_103(A,B) :- mk_uppercase(A,C),p533(C,B)
redpred_104(A,B) :- skip1(A,C),p75_1(C,B)
redpred_105(A,B) :- p911(A,C),p273_1(C,B)
redpred_106(A,B) :- p120_1(A,C),p508(C,B)
redpred_107(A,B) :- p911(A,C),p21(C,B)
redpred_108(A,B) :- copy1(A,C),p178(C,B)
redpred_109(A,B) :- p32(A,C),p120(C,B)
redpred_110(A,B) :- p637(A,C),p336(C,B)
redpred_111(A,B) :- skip1(A,C),p93_1(C,B)
redpred_112(A,B) :- skip1(A,C),p53_1(C,B)
redpred_113(A,B) :- p93(A,C),copy1(C,B)
...
p79_1(A,B) :- redpred_38(A,B)
p87(A,B) :- redpred_39(A,B)
...
p94_1(A,B) :- redpred_27(A,B)
p101(A,B) :- p21(A,C),p101_1(C,B)
p101_1(A,B) :- redpred_27(A,B)
...
p52_1(A,B) :- redpred_83(A,B)
p53(A,B) :- p21(A,C),p53_1(C,B)
p53_1(A,B) :- redpred_84(A,B)
...
p284(A,B) :- redpred_86(A,B)
p288(A,B) :- p287(A,C),p288_1(C,B)
p288_1(A,B) :- redpred_91(A,B)
p292(A,B) :- redpred_92(A,B)
p294(A,B) :- skip1(A,C),p355(C,B)
p295(A,B) :- p20(A,C),p295_1(C,B)
p295_1(A,B) :- redpred_93(A,B)
...
p470_1(A,B) :- redpred_88(A,B)
p476(A,B) :- redpred_97(A,B)
...
p622(A,B) :- redpred_101(A,B)
p626(A,B) :- p120_1(A,C),p626_1(C,B)
p626_1(A,B) :- redpred_86(A,B)
...
p790_1(A,B) :- redpred_83(A,B)
p792(A,B) :- p21(A,C),p724(C,B)
p795(A,B) :- redpred_108(A,B)
p800(A,B) :- redpred_99(A,B)
...
p1165_1(A,B) :- redpred_84(A,B)
p1166(A,B) :- redpred_98(A,B)
...
p1188_1(A,B) :- redpred_102(A,B)
p1189(A,B) :- p120_1(A,C),p993(C,B)
p1190(A,B) :- redpred_81(A,B)
