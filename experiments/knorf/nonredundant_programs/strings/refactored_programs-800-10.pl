...
redpred_13(A,B) :- copy1(A,C),p60(C,B)
redpred_14(A,B) :- skip1(A,C),p2(C,B)
redpred_15(A,B) :- skip1(A,C),p78(C,B)
redpred_16(A,B) :- p39(A,C),p78(C,B)
redpred_17(A,B) :- mk_lowercase(A,C),p23(C,B)
redpred_18(A,B) :- p60(A,C),p39(C,B)
redpred_19(A,B) :- skip1(A,C),p60(C,B)
redpred_20(A,B) :- p15(A,C),p78(C,B)
redpred_21(A,B) :- copy1(A,C),p78(C,B)
redpred_22(A,B) :- mk_lowercase(A,C),p78(C,B)
redpred_23(A,B) :- p60(A,C),p60(C,B)
redpred_24(A,B) :- p78(A,C),p2(C,B)
redpred_25(A,B) :- p285(A,C),p60(C,B)
redpred_26(A,B) :- p194(A,C),p60(C,B)
redpred_27(A,B) :- p78(A,C),p78(C,B)
redpred_28(A,B) :- p78(A,C),p60(C,B)
redpred_29(A,B) :- copy1(A,C),p15(C,B)
redpred_30(A,B) :- p101(A,C),p60(C,B)
redpred_31(A,B) :- p60(A,C),p101(C,B)
redpred_32(A,B) :- skip1(A,C),p23(C,B)
redpred_33(A,B) :- p101(A,C),mk_lowercase(C,B)
redpred_34(A,B) :- p60(A,C),p2(C,B)
redpred_35(A,B) :- p2(A,C),p60(C,B)
redpred_36(A,B) :- p2(A,C),p2(C,B)
redpred_37(A,B) :- copy1(A,C),p101(C,B)
redpred_38(A,B) :- skip1(A,C),p39(C,B)
redpred_39(A,B) :- mk_uppercase(A,C),p23(C,B)
redpred_40(A,B) :- skip1(A,C),p194(C,B)
redpred_41(A,B) :- skip1(A,C),p15(C,B)
redpred_42(A,B) :- p194(A,C),mk_lowercase(C,B)
redpred_43(A,B) :- p39(A,C),p101(C,B)
redpred_44(A,B) :- mk_lowercase(A,C),p2(C,B)
redpred_45(A,B) :- skip1(A,C),p101(C,B)
redpred_46(A,B) :- p60(A,C),p78(C,B)
redpred_47(A,B) :- copy1(A,C),p194(C,B)
redpred_48(A,B) :- p78(A,C),p23(C,B)
redpred_49(A,B) :- skip1(A,C),p600(C,B)
redpred_50(A,B) :- mk_uppercase(A,C),p78(C,B)
redpred_51(A,B) :- p15(A,C),p194(C,B)
redpred_52(A,B) :- p78(A,C),p194(C,B)
redpred_53(A,B) :- mk_uppercase(A,C),p60(C,B)
redpred_54(A,B) :- mk_uppercase(A,C),p101(C,B)
redpred_55(A,B) :- mk_lowercase(A,C),p60(C,B)
redpred_56(A,B) :- p60(A,C),p23(C,B)
redpred_57(A,B) :- copy1(A,C),p23(C,B)
redpred_58(A,B) :- p194(A,C),mk_uppercase(C,B)
redpred_59(A,B) :- skip1(A,C),p285(C,B)
redpred_60(A,B) :- p78(A,C),p101(C,B)
redpred_61(A,B) :- p194(A,C),p15(C,B)
redpred_62(A,B) :- p39(A,C),p60(C,B)
redpred_63(A,B) :- p23(A,C),p39(C,B)
redpred_64(A,B) :- p201(A,C),p78(C,B)
redpred_65(A,B) :- skip1(A,C),p318(C,B)
redpred_66(A,B) :- skip1(A,C),p200(C,B)
redpred_67(A,B) :- skip1(A,C),p8(C,B)
redpred_68(A,B) :- skip1(A,C),p18(C,B)
redpred_69(A,B) :- skip1(A,C),p96(C,B)
redpred_70(A,B) :- p318(A,C),mk_lowercase(C,B)
redpred_71(A,B) :- skip1(A,C),p341(C,B)
redpred_72(A,B) :- p78(A,C),p342(C,B)
redpred_73(A,B) :- skip1(A,C),p162_1(C,B)
redpred_74(A,B) :- copy1(A,C),p175(C,B)
redpred_75(A,B) :- skip1(A,C),p105(C,B)
redpred_76(A,B) :- p60(A,C),p18(C,B)
redpred_77(A,B) :- skip1(A,C),p108_1(C,B)
redpred_78(A,B) :- skip1(A,C),p276_1(C,B)
...
p301(A,B) :- redpred_12(A,B)
p303(A,B) :- redpred_5(A,B)
p304(A,B) :- redpred_5(A,B)
p309(A,B) :- redpred_8(A,B)
...
p571_1(A,B) :- redpred_61(A,B)
p573(A,B) :- copy1(A,C),p573_1(C,B)
p573_1(A,B) :- redpred_15(A,B)
p583(A,B) :- redpred_23(A,B)
p590(A,B) :- redpred_18(A,B)
p594(A,B) :- copy1(A,C),p594_1(C,B)
p594_1(A,B) :- redpred_62(A,B)
p595(A,B) :- p60(A,C),p595_1(C,B)
p595_1(A,B) :- redpred_20(A,B)
...
p108_1(A,B) :- redpred_67(A,B)
p112(A,B) :- p23(A,C),p253(C,B)
p118(A,B) :- redpred_68(A,B)
