...
redpred_15(A,B) :- skip1(A,C),p138(C,B)
redpred_16(A,B) :- copy1(A,C),p144(C,B)
redpred_17(A,B) :- skip1(A,C),p5(C,B)
redpred_18(A,B) :- p242(A,C),p144(C,B)
redpred_19(A,B) :- p4(A,C),p5(C,B)
redpred_20(A,B) :- skip1(A,C),p121(C,B)
redpred_21(A,B) :- p138(A,C),p242(C,B)
redpred_22(A,B) :- skip1(A,C),p242(C,B)
redpred_23(A,B) :- p5(A,C),p233(C,B)
redpred_24(A,B) :- p5(A,C),p5(C,B)
redpred_25(A,B) :- copy1(A,C),p207(C,B)
redpred_26(A,B) :- skip1(A,C),p4(C,B)
redpred_27(A,B) :- copy1(A,C),p4(C,B)
redpred_28(A,B) :- skip1(A,C),p207(C,B)
redpred_29(A,B) :- p5(A,C),p4(C,B)
redpred_30(A,B) :- p5(A,C),p144(C,B)
redpred_31(A,B) :- copy1(A,C),p5(C,B)
redpred_32(A,B) :- p707(A,C),p4(C,B)
redpred_33(A,B) :- p4(A,C),p138(C,B)
redpred_34(A,B) :- p4(A,C),p4(C,B)
redpred_35(A,B) :- p4(A,C),p635(C,B)
redpred_36(A,B) :- mk_uppercase(A,C),p144(C,B)
redpred_37(A,B) :- p29(A,C),p121(C,B)
redpred_38(A,B) :- p221(A,C),p5(C,B)
redpred_39(A,B) :- p138(A,C),p4(C,B)
redpred_40(A,B) :- mk_uppercase(A,C),p5(C,B)
redpred_41(A,B) :- skip1(A,C),p221(C,B)
redpred_42(A,B) :- p5(A,C),p207(C,B)
redpred_43(A,B) :- p5(A,C),p707(C,B)
redpred_44(A,B) :- p144(A,C),p121(C,B)
redpred_45(A,B) :- copy1(A,C),p221(C,B)
redpred_46(A,B) :- p29(A,C),p5(C,B)
redpred_47(A,B) :- p121(A,C),p4(C,B)
redpred_48(A,B) :- p4(A,C),p221(C,B)
redpred_49(A,B) :- p5(A,C),p221(C,B)
redpred_50(A,B) :- p221(A,C),p138(C,B)
redpred_51(A,B) :- p4(A,C),p121(C,B)
redpred_52(A,B) :- p242(A,C),p5(C,B)
redpred_53(A,B) :- copy1(A,C),p138(C,B)
redpred_54(A,B) :- skip1(A,C),p29(C,B)
redpred_55(A,B) :- p4(A,C),p233(C,B)
redpred_56(A,B) :- p233(A,C),p4(C,B)
redpred_57(A,B) :- p4(A,C),p242(C,B)
redpred_58(A,B) :- p242(A,C),p4(C,B)
redpred_59(A,B) :- mk_uppercase(A,C),p4(C,B)
redpred_60(A,B) :- copy1(A,C),p121(C,B)
redpred_61(A,B) :- p207(A,C),p138(C,B)
redpred_62(A,B) :- p144(A,C),p5(C,B)
redpred_63(A,B) :- p207(A,C),p5(C,B)
redpred_64(A,B) :- p207(A,C),p144(C,B)
redpred_65(A,B) :- p207(A,C),p207(C,B)
redpred_66(A,B) :- copy1(A,C),p242(C,B)
redpred_67(A,B) :- p5(A,C),p121(C,B)
redpred_68(A,B) :- p4(A,C),p144(C,B)
redpred_69(A,B) :- p5(A,C),p242(C,B)
redpred_70(A,B) :- p121(A,C),p5(C,B)
redpred_71(A,B) :- p144(A,C),p4(C,B)
redpred_72(A,B) :- p221(A,C),p144(C,B)
redpred_73(A,B) :- mk_lowercase(A,C),p5(C,B)
redpred_74(A,B) :- p4(A,C),p207(C,B)
redpred_75(A,B) :- p138(A,C),p5(C,B)
redpred_76(A,B) :- copy1(A,C),p635(C,B)
redpred_77(A,B) :- skip1(A,C),p635(C,B)
redpred_78(A,B) :- mk_lowercase(A,C),p121(C,B)
redpred_79(A,B) :- skip1(A,C),p144(C,B)
redpred_80(A,B) :- p207(A,C),p121(C,B)
redpred_81(A,B) :- p207(A,C),p4(C,B)
redpred_82(A,B) :- p242(A,C),p16(C,B)
redpred_83(A,B) :- skip1(A,C),p286(C,B)
redpred_84(A,B) :- p4(A,C),p116(C,B)
redpred_85(A,B) :- copy1(A,C),p286(C,B)
redpred_86(A,B) :- copy1(A,C),p58(C,B)
redpred_87(A,B) :- copy1(A,C),p32(C,B)
redpred_88(A,B) :- p5(A,C),p674(C,B)
redpred_89(A,B) :- p116(A,C),p286(C,B)
redpred_90(A,B) :- p58(A,C),p60(C,B)
redpred_91(A,B) :- p172(A,C),mk_uppercase(C,B)
redpred_92(A,B) :- p207(A,C),p286(C,B)
redpred_93(A,B) :- p5(A,C),p511(C,B)
redpred_94(A,B) :- skip1(A,C),p510(C,B)
redpred_95(A,B) :- skip1(A,C),p469(C,B)
redpred_96(A,B) :- p4(A,C),p651(C,B)
redpred_97(A,B) :- p552_1(A,C),p9_1(C,B)
redpred_98(A,B) :- p116(A,C),p60(C,B)
redpred_99(A,B) :- copy1(A,C),p510(C,B)
redpred_100(A,B) :- copy1(A,C),p790(C,B)
redpred_101(A,B) :- p60(A,C),p95(C,B)
redpred_102(A,B) :- skip1(A,C),p88(C,B)
redpred_103(A,B) :- skip1(A,C),p928(C,B)
redpred_104(A,B) :- p4(A,C),p286(C,B)
redpred_105(A,B) :- skip1(A,C),p58(C,B)
redpred_106(A,B) :- p68_1(A,C),p52_1(C,B)
redpred_107(A,B) :- p644_1(A,C),p16(C,B)
redpred_108(A,B) :- p116(A,C),p874(C,B)
redpred_109(A,B) :- p9_1(A,C),p876(C,B)
...
p73_1(A,B) :- redpred_17(A,B)
p76(A,B) :- skip1(A,C),p76_1(C,B)
p76_1(A,B) :- redpred_32(A,B)
...
p91_1(A,B) :- redpred_29(A,B)
p95(A,B) :- p4(A,C),p95_1(C,B)
p95_1(A,B) :- redpred_19(A,B)
...
p116_1(A,B) :- redpred_26(A,B)
p122(A,B) :- mk_uppercase(A,C),p122_1(C,B)
p122_1(A,B) :- redpred_26(A,B)
...
p229(A,B) :- redpred_26(A,B)
p230(A,B) :- redpred_40(A,B)
p235(A,B) :- skip1(A,C),p235_1(C,B)
p235_1(A,B) :- redpred_49(A,B)
p237(A,B) :- copy1(A,C),p237_1(C,B)
p237_1(A,B) :- redpred_22(A,B)
...
p256_1(A,B) :- redpred_51(A,B)
p257(A,B) :- copy1(A,C),p257_1(C,B)
p257_1(A,B) :- redpred_29(A,B)
p260(A,B) :- copy1(A,C),p260_1(C,B)
p260_1(A,B) :- redpred_52(A,B)
p266(A,B) :- redpred_31(A,B)
p267(A,B) :- mk_lowercase(A,C),p138(C,B)
p268(A,B) :- copy1(A,C),p268_1(C,B)
p268_1(A,B) :- redpred_33(A,B)
...
p364_1(A,B) :- redpred_52(A,B)
p366(A,B) :- copy1(A,C),p366_1(C,B)
p366_1(A,B) :- redpred_61(A,B)
p367(A,B) :- redpred_24(A,B)
...
p385_1(A,B) :- redpred_35(A,B)
p388(A,B) :- copy1(A,C),p388_1(C,B)
p388_1(A,B) :- redpred_34(A,B)
...
p413_1(A,B) :- redpred_62(A,B)
p419(A,B) :- redpred_29(A,B)
p422(A,B) :- copy1(A,C),p422_1(C,B)
p422_1(A,B) :- redpred_63(A,B)
p424(A,B) :- redpred_27(A,B)
p425(A,B) :- redpred_17(A,B)
p428(A,B) :- copy1(A,C),p428_1(C,B)
p428_1(A,B) :- redpred_41(A,B)
p429(A,B) :- redpred_50(A,B)
p437(A,B) :- copy1(A,C),p437_1(C,B)
p437_1(A,B) :- redpred_62(A,B)
p443(A,B) :- redpred_43(A,B)
p444(A,B) :- redpred_36(A,B)
p451(A,B) :- redpred_16(A,B)
p456(A,B) :- redpred_27(A,B)
p457(A,B) :- skip1(A,C),p457_1(C,B)
p457_1(A,B) :- redpred_30(A,B)
p458(A,B) :- redpred_59(A,B)
...
p1046_1(A,B) :- redpred_28(A,B)
p1052(A,B) :- p121(A,C),p1052_1(C,B)
p1052_1(A,B) :- redpred_21(A,B)
p1053(A,B) :- redpred_25(A,B)
p1057(A,B) :- p5(A,C),p1057_1(C,B)
p1057_1(A,B) :- redpred_38(A,B)
p1058(A,B) :- skip1(A,C),p1058_1(C,B)
p1058_1(A,B) :- redpred_63(A,B)
p1059(A,B) :- redpred_79(A,B)
p1063(A,B) :- skip1(A,C),p1063_1(C,B)
p1063_1(A,B) :- redpred_24(A,B)
p1064(A,B) :- p5(A,C),p1064_1(C,B)
p1064_1(A,B) :- redpred_70(A,B)
p1065(A,B) :- redpred_27(A,B)
p1066(A,B) :- redpred_80(A,B)
p1067(A,B) :- redpred_31(A,B)
p1068(A,B) :- redpred_31(A,B)
...
p38_1(A,B) :- redpred_83(A,B)
p39(A,B) :- p271(A,C),p201_1(C,B)
p40(A,B) :- redpred_84(A,B)
...
p298_1(A,B) :- redpred_91(A,B)
p299(A,B) :- redpred_92(A,B)
p303(A,B) :- redpred_93(A,B)
...
p621(A,B) :- redpred_101(A,B)
p625(A,B) :- redpred_102(A,B)
...
p798(A,B) :- redpred_104(A,B)
p800(A,B) :- redpred_104(A,B)
