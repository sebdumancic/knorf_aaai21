...
redpred_17(A,B) :- p39(A,C),p39(C,B)
redpred_18(A,B) :- copy1(A,C),p39(C,B)
redpred_19(A,B) :- skip1(A,C),p39(C,B)
redpred_20(A,B) :- p22(A,C),p31(C,B)
redpred_21(A,B) :- p19(A,C),p133(C,B)
redpred_22(A,B) :- p31(A,C),p5(C,B)
redpred_23(A,B) :- p19(A,C),p22(C,B)
redpred_24(A,B) :- skip1(A,C),p38(C,B)
redpred_25(A,B) :- p39(A,C),p19(C,B)
redpred_26(A,B) :- p158(A,C),p39(C,B)
redpred_27(A,B) :- p39(A,C),p31(C,B)
redpred_28(A,B) :- p489(A,C),p19(C,B)
redpred_29(A,B) :- p38(A,C),p489(C,B)
redpred_30(A,B) :- skip1(A,C),p489(C,B)
redpred_31(A,B) :- p39(A,C),p22(C,B)
redpred_32(A,B) :- p39(A,C),p196(C,B)
redpred_33(A,B) :- skip1(A,C),p19(C,B)
redpred_34(A,B) :- p38(A,C),p39(C,B)
redpred_35(A,B) :- mk_lowercase(A,C),p158(C,B)
redpred_36(A,B) :- p196(A,C),p22(C,B)
redpred_37(A,B) :- p489(A,C),p39(C,B)
redpred_38(A,B) :- p22(A,C),p19(C,B)
redpred_39(A,B) :- p39(A,C),p158(C,B)
redpred_40(A,B) :- p19(A,C),p39(C,B)
redpred_41(A,B) :- p31(A,C),p39(C,B)
redpred_42(A,B) :- p31(A,C),p19(C,B)
redpred_43(A,B) :- p31(A,C),p196(C,B)
redpred_44(A,B) :- copy1(A,C),p19(C,B)
redpred_45(A,B) :- skip1(A,C),p22(C,B)
redpred_46(A,B) :- p19(A,C),p158(C,B)
redpred_47(A,B) :- p19(A,C),p19(C,B)
redpred_48(A,B) :- p19(A,C),p196(C,B)
redpred_49(A,B) :- skip1(A,C),p31(C,B)
redpred_50(A,B) :- skip1(A,C),p196(C,B)
redpred_51(A,B) :- p19(A,C),p121(C,B)
redpred_52(A,B) :- p196(A,C),p39(C,B)
redpred_53(A,B) :- p39(A,C),p489(C,B)
redpred_54(A,B) :- skip1(A,C),p158(C,B)
redpred_55(A,B) :- p19(A,C),p489(C,B)
redpred_56(A,B) :- p196(A,C),p88(C,B)
redpred_57(A,B) :- p39(A,C),p38(C,B)
redpred_58(A,B) :- p22(A,C),p39(C,B)
redpred_59(A,B) :- mk_lowercase(A,C),p38(C,B)
redpred_60(A,B) :- p22(A,C),p22(C,B)
redpred_61(A,B) :- copy1(A,C),p489(C,B)
redpred_62(A,B) :- mk_uppercase(A,C),p39(C,B)
redpred_63(A,B) :- p158(A,C),p19(C,B)
redpred_64(A,B) :- p22(A,C),p38(C,B)
redpred_65(A,B) :- p19(A,C),p31(C,B)
redpred_66(A,B) :- skip1(A,C),p5(C,B)
redpred_67(A,B) :- mk_uppercase(A,C),p22(C,B)
redpred_68(A,B) :- p158(A,C),p31(C,B)
redpred_69(A,B) :- p489(A,C),p196(C,B)
redpred_70(A,B) :- p489(A,C),p31(C,B)
redpred_71(A,B) :- mk_lowercase(A,C),p39(C,B)
redpred_72(A,B) :- p196(A,C),p196(C,B)
redpred_73(A,B) :- p196(A,C),p121(C,B)
redpred_74(A,B) :- skip1(A,C),p133(C,B)
redpred_75(A,B) :- skip1(A,C),p88(C,B)
redpred_76(A,B) :- p39(A,C),p88(C,B)
redpred_77(A,B) :- p38(A,C),p196(C,B)
redpred_78(A,B) :- p31(A,C),p489(C,B)
redpred_79(A,B) :- mk_lowercase(A,C),p19(C,B)
redpred_80(A,B) :- p38(A,C),p19(C,B)
redpred_81(A,B) :- p31(A,C),p31(C,B)
redpred_82(A,B) :- p196(A,C),p19(C,B)
redpred_83(A,B) :- copy1(A,C),p196(C,B)
redpred_84(A,B) :- copy1(A,C),p158(C,B)
redpred_85(A,B) :- mk_uppercase(A,C),p158(C,B)
redpred_86(A,B) :- mk_uppercase(A,C),p19(C,B)
redpred_87(A,B) :- p158(A,C),p158(C,B)
redpred_88(A,B) :- p38(A,C),p158(C,B)
redpred_89(A,B) :- copy1(A,C),p31(C,B)
redpred_90(A,B) :- p38(A,C),p31(C,B)
redpred_91(A,B) :- p489(A,C),p22(C,B)
redpred_92(A,B) :- p19(A,C),p38(C,B)
redpred_93(A,B) :- p88(A,C),p19(C,B)
redpred_94(A,B) :- copy1(A,C),p38(C,B)
redpred_95(A,B) :- p489(A,C),p5(C,B)
redpred_96(A,B) :- p133(A,C),p39(C,B)
redpred_97(A,B) :- p489(A,C),p489(C,B)
redpred_98(A,B) :- copy1(A,C),p133(C,B)
redpred_99(A,B) :- p39(A,C),p133(C,B)
redpred_100(A,B) :- p489(A,C),p38(C,B)
redpred_101(A,B) :- p39(A,C),p5(C,B)
redpred_102(A,B) :- p5(A,C),p19(C,B)
redpred_103(A,B) :- p5(A,C),p489(C,B)
redpred_104(A,B) :- p196(A,C),p31(C,B)
redpred_105(A,B) :- p5(A,C),p39(C,B)
redpred_106(A,B) :- skip1(A,C),p121(C,B)
redpred_107(A,B) :- copy1(A,C),p22(C,B)
redpred_108(A,B) :- p22(A,C),p88(C,B)
redpred_109(A,B) :- mk_uppercase(A,C),p133(C,B)
redpred_110(A,B) :- skip1(A,C),p611(C,B)
redpred_111(A,B) :- p17(A,C),p196(C,B)
redpred_112(A,B) :- p721(A,C),p841(C,B)
redpred_113(A,B) :- skip1(A,C),p159(C,B)
redpred_114(A,B) :- skip1(A,C),p369(C,B)
redpred_115(A,B) :- p17(A,C),p126(C,B)
redpred_116(A,B) :- p126(A,C),p194(C,B)
redpred_117(A,B) :- p19(A,C),p1438(C,B)
redpred_118(A,B) :- skip1(A,C),p17(C,B)
redpred_119(A,B) :- p100(A,C),p418(C,B)
redpred_120(A,B) :- p216(A,C),p770(C,B)
redpred_121(A,B) :- p29(A,C),p26_1(C,B)
redpred_122(A,B) :- p5(A,C),p1564(C,B)
redpred_123(A,B) :- p39(A,C),p17(C,B)
redpred_124(A,B) :- skip1(A,C),p1086(C,B)
redpred_125(A,B) :- p11_1(A,C),p130(C,B)
redpred_126(A,B) :- p219(A,C),p889(C,B)
redpred_127(A,B) :- copy1(A,C),p194(C,B)
redpred_128(A,B) :- mk_uppercase(A,C),p17(C,B)
redpred_129(A,B) :- p29(A,C),p219(C,B)
redpred_130(A,B) :- p205(A,C),p94(C,B)
redpred_131(A,B) :- p39(A,C),p129(C,B)
redpred_132(A,B) :- p19(A,C),p17(C,B)
redpred_133(A,B) :- p126(A,C),p125_1(C,B)
redpred_134(A,B) :- p94(A,C),p841(C,B)
redpred_135(A,B) :- skip1(A,C),p127(C,B)
redpred_136(A,B) :- p17(A,C),p216(C,B)
redpred_137(A,B) :- copy1(A,C),p1101(C,B)
redpred_138(A,B) :- copy1(A,C),p17(C,B)
redpred_139(A,B) :- p17(A,C),p7(C,B)
redpred_140(A,B) :- p37_1(A,C),p94(C,B)
redpred_141(A,B) :- copy1(A,C),p205(C,B)
redpred_142(A,B) :- p94(A,C),p44_1(C,B)
redpred_143(A,B) :- p17(A,C),p32(C,B)
redpred_144(A,B) :- p233(A,C),p17(C,B)
redpred_145(A,B) :- skip1(A,C),p233(C,B)
redpred_146(A,B) :- p39(A,C),p141(C,B)
redpred_147(A,B) :- copy1(A,C),p369(C,B)
redpred_148(A,B) :- p141_1(A,C),p94(C,B)
redpred_149(A,B) :- p19(A,C),p1564(C,B)
redpred_150(A,B) :- skip1(A,C),p205(C,B)
redpred_151(A,B) :- skip1(A,C),p359(C,B)
redpred_152(A,B) :- p158(A,C),p889(C,B)
redpred_153(A,B) :- copy1(A,C),p141(C,B)
redpred_154(A,B) :- p19(A,C),p11(C,B)
redpred_155(A,B) :- p17(A,C),p22(C,B)
redpred_156(A,B) :- p17(A,C),p11_1(C,B)
redpred_157(A,B) :- p39(A,C),p359(C,B)
redpred_158(A,B) :- p7(A,C),p259(C,B)
redpred_159(A,B) :- copy1(A,C),p244(C,B)
redpred_160(A,B) :- skip1(A,C),p382(C,B)
redpred_161(A,B) :- p6_1(A,C),p66_1(C,B)
redpred_162(A,B) :- skip1(A,C),p2411(C,B)
redpred_163(A,B) :- p17(A,C),p61(C,B)
redpred_164(A,B) :- skip1(A,C),p194(C,B)
redpred_165(A,B) :- p39(A,C),p889(C,B)
redpred_166(A,B) :- p341(A,C),mk_lowercase(C,B)
redpred_167(A,B) :- copy1(A,C),p359(C,B)
redpred_168(A,B) :- skip1(A,C),p2786(C,B)
redpred_169(A,B) :- p11_1(A,C),p259(C,B)
redpred_170(A,B) :- copy1(A,C),p94(C,B)
redpred_171(A,B) :- p11_1(A,C),p284(C,B)
redpred_172(A,B) :- copy1(A,C),p523(C,B)
redpred_173(A,B) :- p39(A,C),p233(C,B)
redpred_174(A,B) :- p126(A,C),p205(C,B)
redpred_175(A,B) :- p17(A,C),p44_1(C,B)
redpred_176(A,B) :- p39(A,C),p1267(C,B)
redpred_177(A,B) :- copy1(A,C),p282(C,B)
redpred_178(A,B) :- skip1(A,C),p1564(C,B)
redpred_179(A,B) :- p1782(A,C),p718_1(C,B)
redpred_180(A,B) :- copy1(A,C),p466(C,B)
redpred_181(A,B) :- p39(A,C),p800(C,B)
redpred_182(A,B) :- mk_uppercase(A,C),p94(C,B)
redpred_183(A,B) :- mk_lowercase(A,C),p205(C,B)
redpred_184(A,B) :- p22(A,C),p731(C,B)
redpred_185(A,B) :- p94(A,C),p86_1(C,B)
redpred_186(A,B) :- p118(A,C),p149(C,B)
redpred_187(A,B) :- p190_1(A,C),p211_1(C,B)
redpred_188(A,B) :- p382(A,C),p7(C,B)
redpred_189(A,B) :- p7(A,C),p646(C,B)
redpred_190(A,B) :- copy1(A,C),p127(C,B)
redpred_191(A,B) :- copy1(A,C),p2786(C,B)
redpred_192(A,B) :- copy1(A,C),p1415(C,B)
redpred_193(A,B) :- p382(A,C),mk_lowercase(C,B)
redpred_194(A,B) :- p77(A,C),p28(C,B)
redpred_195(A,B) :- copy1(A,C),p1438(C,B)
redpred_196(A,B) :- p29(A,C),p292(C,B)
redpred_197(A,B) :- p359(A,C),p284(C,B)
redpred_198(A,B) :- p17(A,C),p149(C,B)
redpred_199(A,B) :- p39(A,C),p159(C,B)
redpred_200(A,B) :- skip1(A,C),p685(C,B)
redpred_201(A,B) :- skip1(A,C),p150_1(C,B)
redpred_202(A,B) :- p19(A,C),p150(C,B)
redpred_203(A,B) :- skip1(A,C),p2380(C,B)
redpred_204(A,B) :- copy1(A,C),p2380(C,B)
...
p88(A,B) :- redpred_11(A,B)
p89(A,B) :- redpred_10(A,B)
...
p591(A,B) :- redpred_15(A,B)
p593(A,B) :- redpred_3(A,B)
p594(A,B) :- redpred_10(A,B)
...
p832(A,B) :- redpred_9(A,B)
p834(A,B) :- redpred_15(A,B)
...
p1182(A,B) :- redpred_10(A,B)
p1186(A,B) :- redpred_14(A,B)
p1189(A,B) :- redpred_1(A,B)
p1190(A,B) :- redpred_13(A,B)
...
p1808(A,B) :- redpred_14(A,B)
p1811(A,B) :- redpred_16(A,B)
p1812(A,B) :- redpred_3(A,B)
p1813(A,B) :- redpred_3(A,B)
p1818(A,B) :- redpred_4(A,B)
p1821(A,B) :- redpred_8(A,B)
...
p2099(A,B) :- redpred_13(A,B)
p2100(A,B) :- redpred_10(A,B)
p2101(A,B) :- redpred_9(A,B)
p2105(A,B) :- redpred_3(A,B)
p2109(A,B) :- redpred_4(A,B)
p2111(A,B) :- redpred_15(A,B)
...
p2488(A,B) :- redpred_15(A,B)
p2489(A,B) :- redpred_3(A,B)
p2490(A,B) :- redpred_15(A,B)
p2497(A,B) :- redpred_10(A,B)
...
p2581(A,B) :- redpred_10(A,B)
p2583(A,B) :- redpred_3(A,B)
p2586(A,B) :- redpred_10(A,B)
...
p66_1(A,B) :- redpred_34(A,B)
p77(A,B) :- redpred_35(A,B)
p78(A,B) :- skip1(A,C),p78_1(C,B)
p78_1(A,B) :- redpred_36(A,B)
p80(A,B) :- redpred_37(A,B)
p86(A,B) :- p39(A,C),p86_1(C,B)
p86_1(A,B) :- redpred_38(A,B)
p92(A,B) :- redpred_39(A,B)
p94(A,B) :- skip1(A,C),p94_1(C,B)
p94_1(A,B) :- redpred_25(A,B)
...
p141_1(A,B) :- redpred_47(A,B)
p148(A,B) :- p39(A,C),p148_1(C,B)
p148_1(A,B) :- redpred_48(A,B)
p149(A,B) :- redpred_49(A,B)
p153(A,B) :- redpred_40(A,B)
p159(A,B) :- skip1(A,C),p159_1(C,B)
p159_1(A,B) :- redpred_24(A,B)
p162(A,B) :- redpred_19(A,B)
p164(A,B) :- skip1(A,C),p164_1(C,B)
p164_1(A,B) :- redpred_38(A,B)
...
p502_1(A,B) :- redpred_63(A,B)
p510(A,B) :- redpred_71(A,B)
p516(A,B) :- redpred_45(A,B)
p519(A,B) :- p38(A,C),p519_1(C,B)
p519_1(A,B) :- redpred_28(A,B)
p520(A,B) :- redpred_45(A,B)
p523(A,B) :- p19(A,C),p523_1(C,B)
p523_1(A,B) :- redpred_25(A,B)
p528(A,B) :- p39(A,C),p528_1(C,B)
p528_1(A,B) :- redpred_75(A,B)
p530(A,B) :- mk_lowercase(A,C),p530_1(C,B)
p530_1(A,B) :- redpred_33(A,B)
p536(A,B) :- copy1(A,C),p536_1(C,B)
p536_1(A,B) :- redpred_58(A,B)
...
p653_1(A,B) :- redpred_63(A,B)
p662(A,B) :- redpred_54(A,B)
p667(A,B) :- mk_uppercase(A,C),p667_1(C,B)
p667_1(A,B) :- redpred_33(A,B)
p668(A,B) :- redpred_33(A,B)
p669(A,B) :- copy1(A,C),p669_1(C,B)
p669_1(A,B) :- redpred_32(A,B)
p672(A,B) :- redpred_49(A,B)
p674(A,B) :- mk_lowercase(A,C),p674_1(C,B)
p674_1(A,B) :- redpred_25(A,B)
p678(A,B) :- redpred_80(A,B)
p680(A,B) :- redpred_17(A,B)
p684(A,B) :- redpred_66(A,B)
p686(A,B) :- redpred_44(A,B)
p691(A,B) :- p39(A,C),p691_1(C,B)
p691_1(A,B) :- redpred_43(A,B)
p695(A,B) :- redpred_75(A,B)
p697(A,B) :- copy1(A,C),p697_1(C,B)
p697_1(A,B) :- redpred_45(A,B)
p699(A,B) :- p158(A,C),p699_1(C,B)
p699_1(A,B) :- redpred_19(A,B)
p703(A,B) :- skip1(A,C),p703_1(C,B)
p703_1(A,B) :- redpred_50(A,B)
p704(A,B) :- redpred_45(A,B)
p708(A,B) :- redpred_81(A,B)
p716(A,B) :- skip1(A,C),p716_1(C,B)
p716_1(A,B) :- redpred_55(A,B)
p717(A,B) :- redpred_47(A,B)
p718(A,B) :- p39(A,C),p718_1(C,B)
p718_1(A,B) :- redpred_82(A,B)
p719(A,B) :- redpred_83(A,B)
p721(A,B) :- redpred_84(A,B)
p723(A,B) :- copy1(A,C),p723_1(C,B)
p723_1(A,B) :- redpred_80(A,B)
p725(A,B) :- redpred_34(A,B)
p729(A,B) :- redpred_40(A,B)
p731(A,B) :- copy1(A,C),p731_1(C,B)
p731_1(A,B) :- redpred_30(A,B)
p736(A,B) :- redpred_44(A,B)
p746(A,B) :- redpred_42(A,B)
p756(A,B) :- redpred_85(A,B)
p767(A,B) :- copy1(A,C),p767_1(C,B)
p767_1(A,B) :- p121(A,C),p38(C,B)
p770(A,B) :- redpred_86(A,B)
p781(A,B) :- redpred_40(A,B)
p782(A,B) :- redpred_84(A,B)
p783(A,B) :- redpred_86(A,B)
p784(A,B) :- redpred_32(A,B)
p788(A,B) :- redpred_87(A,B)
p790(A,B) :- skip1(A,C),p790_1(C,B)
p790_1(A,B) :- redpred_40(A,B)
p792(A,B) :- redpred_61(A,B)
...
p323(A,B) :- redpred_127(A,B)
p327(A,B) :- p19(A,C),p1258(C,B)
p333(A,B) :- redpred_128(A,B)
...
p397(A,B) :- redpred_130(A,B)
p400(A,B) :- p26(A,C),p1193(C,B)
p401(A,B) :- redpred_131(A,B)
p405(A,B) :- redpred_132(A,B)
p406(A,B) :- mk_uppercase(A,C),p159(C,B)
p408(A,B) :- p461_1(A,C),p2663(C,B)
p413(A,B) :- redpred_133(A,B)
...
p546_1(A,B) :- redpred_120(A,B)
p547(A,B) :- redpred_141(A,B)
p551(A,B) :- p102_1(A,C),p2302(C,B)
p553(A,B) :- redpred_137(A,B)
p558(A,B) :- p19(A,C),p558_1(C,B)
p558_1(A,B) :- redpred_142(A,B)
...
p590(A,B) :- redpred_144(A,B)
p601(A,B) :- redpred_129(A,B)
p605(A,B) :- p489(A,C),p580_1(C,B)
p613(A,B) :- redpred_126(A,B)
p614(A,B) :- p1438(A,C),p259(C,B)
p617(A,B) :- skip1(A,C),p617_1(C,B)
p617_1(A,B) :- redpred_145(A,B)
...
p838(A,B) :- redpred_132(A,B)
p843(A,B) :- redpred_160(A,B)
p845(A,B) :- skip1(A,C),p845_1(C,B)
p845_1(A,B) :- p545(A,C),p247_1(C,B)
p848(A,B) :- redpred_161(A,B)
...
p897_1(A,B) :- redpred_111(A,B)
p900(A,B) :- redpred_131(A,B)
...
p1039(A,B) :- redpred_171(A,B)
p1044(A,B) :- redpred_172(A,B)
...
p1278_1(A,B) :- redpred_118(A,B)
p1279(A,B) :- redpred_176(A,B)
p1281(A,B) :- redpred_177(A,B)
...
p1303(A,B) :- redpred_117(A,B)
p1305(A,B) :- redpred_178(A,B)
...
p1383(A,B) :- redpred_114(A,B)
p1388(A,B) :- p247_1(A,C),p1641_1(C,B)
p1390(A,B) :- redpred_157(A,B)
...
p1514(A,B) :- redpred_112(A,B)
p1517(A,B) :- copy1(A,C),p869(C,B)
p1518(A,B) :- redpred_159(A,B)
...
p1568(A,B) :- redpred_181(A,B)
p1569(A,B) :- redpred_182(A,B)
p1571(A,B) :- redpred_183(A,B)
p1572(A,B) :- redpred_171(A,B)
p1575(A,B) :- p796(A,C),p58_1(C,B)
p1576(A,B) :- mk_lowercase(A,C),p1576_1(C,B)
p1576_1(A,B) :- p159(A,C),p126(C,B)
p1579(A,B) :- redpred_184(A,B)
...
p1692(A,B) :- redpred_186(A,B)
p1693(A,B) :- redpred_167(A,B)
p1697(A,B) :- p196(A,C),p1697_1(C,B)
p1697_1(A,B) :- p159(A,C),p2292(C,B)
p1704(A,B) :- redpred_181(A,B)
p1707(A,B) :- redpred_123(A,B)
...
p1855(A,B) :- redpred_161(A,B)
p1856(A,B) :- redpred_152(A,B)
...
p2055(A,B) :- redpred_158(A,B)
p2058(A,B) :- redpred_186(A,B)
...
p2234_1(A,B) :- redpred_175(A,B)
p2237(A,B) :- p19(A,C),p2175(C,B)
p2238(A,B) :- redpred_147(A,B)
...
p2266(A,B) :- redpred_195(A,B)
p2270(A,B) :- redpred_184(A,B)
...
p2456(A,B) :- redpred_199(A,B)
p2457(A,B) :- p328_1(A,C),p141(C,B)
p2458(A,B) :- redpred_198(A,B)
...
p2751(A,B) :- redpred_132(A,B)
p2754(A,B) :- redpred_165(A,B)
p2755(A,B) :- p61(A,C),p923(C,B)
p2756(A,B) :- redpred_187(A,B)
p2758(A,B) :- copy1(A,C),p2758_1(C,B)
p2758_1(A,B) :- p1438(A,C),p141_1(C,B)
p2760(A,B) :- p1703(A,C),p841(C,B)
p2763(A,B) :- p937(A,C),p205(C,B)
p2764(A,B) :- redpred_131(A,B)
p2766(A,B) :- redpred_135(A,B)
p2767(A,B) :- redpred_154(A,B)
...
p2539(A,B) :- redpred_202(A,B)
p2554(A,B) :- redpred_200(A,B)
p2598(A,B) :- skip1(A,C),p2598_1(C,B)
p2598_1(A,B) :- redpred_201(A,B)
