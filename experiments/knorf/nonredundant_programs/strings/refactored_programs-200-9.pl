...
redpred_10(A,B) :- copy1(A,C),p59(C,B)
redpred_11(A,B) :- p4(A,C),p11(C,B)
redpred_12(A,B) :- p59(A,C),mk_uppercase(C,B)
redpred_13(A,B) :- skip1(A,C),p59(C,B)
redpred_14(A,B) :- copy1(A,C),p4(C,B)
redpred_15(A,B) :- skip1(A,C),p4(C,B)
redpred_16(A,B) :- p59(A,C),p4(C,B)
redpred_17(A,B) :- p4(A,C),p59(C,B)
redpred_18(A,B) :- p59(A,C),p95(C,B)
redpred_19(A,B) :- p59(A,C),p59(C,B)
redpred_20(A,B) :- skip1(A,C),p34(C,B)
redpred_21(A,B) :- mk_uppercase(A,C),mk_lowercase(C,B)
redpred_22(A,B) :- skip1(A,C),p74(C,B)
