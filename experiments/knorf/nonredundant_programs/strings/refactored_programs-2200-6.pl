...
redpred_16(A,B) :- p5(A,C),p55(C,B)
redpred_17(A,B) :- mk_lowercase(A,C),p157(C,B)
redpred_18(A,B) :- p5(A,C),p134(C,B)
redpred_19(A,B) :- skip1(A,C),p134(C,B)
redpred_20(A,B) :- skip1(A,C),p66(C,B)
redpred_21(A,B) :- copy1(A,C),p134(C,B)
redpred_22(A,B) :- p31(A,C),p66(C,B)
redpred_23(A,B) :- p31(A,C),p31(C,B)
redpred_24(A,B) :- p134(A,C),p157(C,B)
redpred_25(A,B) :- p157(A,C),p134(C,B)
redpred_26(A,B) :- p134(A,C),p31(C,B)
redpred_27(A,B) :- skip1(A,C),p46(C,B)
redpred_28(A,B) :- p5(A,C),p401(C,B)
redpred_29(A,B) :- skip1(A,C),p401(C,B)
redpred_30(A,B) :- p55(A,C),p157(C,B)
redpred_31(A,B) :- skip1(A,C),p31(C,B)
redpred_32(A,B) :- p134(A,C),p134(C,B)
redpred_33(A,B) :- p401(A,C),p401(C,B)
redpred_34(A,B) :- mk_uppercase(A,C),p31(C,B)
redpred_35(A,B) :- copy1(A,C),p31(C,B)
redpred_36(A,B) :- p55(A,C),p55(C,B)
redpred_37(A,B) :- copy1(A,C),p55(C,B)
redpred_38(A,B) :- skip1(A,C),p5(C,B)
redpred_39(A,B) :- copy1(A,C),p409(C,B)
redpred_40(A,B) :- p134(A,C),p5(C,B)
redpred_41(A,B) :- mk_uppercase(A,C),p134(C,B)
redpred_42(A,B) :- p31(A,C),p46(C,B)
redpred_43(A,B) :- mk_lowercase(A,C),p401(C,B)
redpred_44(A,B) :- p157(A,C),p31(C,B)
redpred_45(A,B) :- skip1(A,C),p157(C,B)
redpred_46(A,B) :- p401(A,C),p55(C,B)
redpred_47(A,B) :- copy1(A,C),p66(C,B)
redpred_48(A,B) :- p66(A,C),p134(C,B)
redpred_49(A,B) :- p80(A,C),p134(C,B)
redpred_50(A,B) :- p31(A,C),p5(C,B)
redpred_51(A,B) :- p401(A,C),p31(C,B)
redpred_52(A,B) :- p157(A,C),p66(C,B)
redpred_53(A,B) :- p401(A,C),p5(C,B)
redpred_54(A,B) :- p31(A,C),p55(C,B)
redpred_55(A,B) :- mk_lowercase(A,C),p55(C,B)
redpred_56(A,B) :- p134(A,C),p401(C,B)
redpred_57(A,B) :- mk_lowercase(A,C),p31(C,B)
redpred_58(A,B) :- skip1(A,C),p55(C,B)
redpred_59(A,B) :- p5(A,C),p66(C,B)
redpred_60(A,B) :- copy1(A,C),p5(C,B)
redpred_61(A,B) :- copy1(A,C),p46(C,B)
redpred_62(A,B) :- p46(A,C),mk_uppercase(C,B)
redpred_63(A,B) :- p66(A,C),p401(C,B)
redpred_64(A,B) :- p134(A,C),p55(C,B)
redpred_65(A,B) :- copy1(A,C),p157(C,B)
redpred_66(A,B) :- p31(A,C),p80(C,B)
redpred_67(A,B) :- mk_lowercase(A,C),p134(C,B)
redpred_68(A,B) :- p134(A,C),p66(C,B)
redpred_69(A,B) :- p66(A,C),p31(C,B)
redpred_70(A,B) :- copy1(A,C),p401(C,B)
redpred_71(A,B) :- p31(A,C),p134(C,B)
redpred_72(A,B) :- p66(A,C),p55(C,B)
redpred_73(A,B) :- mk_uppercase(A,C),p46(C,B)
redpred_74(A,B) :- p31(A,C),p401(C,B)
redpred_75(A,B) :- mk_lowercase(A,C),p5(C,B)
redpred_76(A,B) :- p5(A,C),p31(C,B)
redpred_77(A,B) :- p1032(A,C),p31(C,B)
redpred_78(A,B) :- mk_lowercase(A,C),p66(C,B)
redpred_79(A,B) :- p55(A,C),p31(C,B)
redpred_80(A,B) :- p134(A,C),p46(C,B)
redpred_81(A,B) :- p31(A,C),p157(C,B)
redpred_82(A,B) :- p46(A,C),p31(C,B)
redpred_83(A,B) :- p80(A,C),p401(C,B)
redpred_84(A,B) :- skip1(A,C),p409(C,B)
redpred_85(A,B) :- p66(A,C),p66(C,B)
redpred_86(A,B) :- p46(A,C),p401(C,B)
redpred_87(A,B) :- p46(A,C),p134(C,B)
redpred_88(A,B) :- mk_uppercase(A,C),p157(C,B)
redpred_89(A,B) :- p157(A,C),p5(C,B)
redpred_90(A,B) :- skip1(A,C),p80(C,B)
redpred_91(A,B) :- p401(A,C),p134(C,B)
redpred_92(A,B) :- p46(A,C),p66(C,B)
redpred_93(A,B) :- p5(A,C),p80(C,B)
redpred_94(A,B) :- p409(A,C),p31(C,B)
redpred_95(A,B) :- p157(A,C),p46(C,B)
redpred_96(A,B) :- p401(A,C),p66(C,B)
redpred_97(A,B) :- p66(A,C),p157(C,B)
redpred_98(A,B) :- skip1(A,C),p1032(C,B)
redpred_99(A,B) :- p116(A,C),p1139(C,B)
redpred_100(A,B) :- skip1(A,C),p530(C,B)
redpred_101(A,B) :- mk_uppercase(A,C),p530(C,B)
redpred_102(A,B) :- p31(A,C),p530(C,B)
redpred_103(A,B) :- skip1(A,C),p948(C,B)
redpred_104(A,B) :- skip1(A,C),p1441(C,B)
redpred_105(A,B) :- skip1(A,C),p374(C,B)
redpred_106(A,B) :- p401(A,C),p328(C,B)
redpred_107(A,B) :- skip1(A,C),p340(C,B)
redpred_108(A,B) :- p16(A,C),p71(C,B)
redpred_109(A,B) :- skip1(A,C),p400(C,B)
redpred_110(A,B) :- skip1(A,C),p54(C,B)
redpred_111(A,B) :- skip1(A,C),p120(C,B)
redpred_112(A,B) :- p29(A,C),p1269(C,B)
redpred_113(A,B) :- p31(A,C),p120(C,B)
redpred_114(A,B) :- p120(A,C),p530(C,B)
redpred_115(A,B) :- skip1(A,C),p544(C,B)
redpred_116(A,B) :- p46(A,C),p645(C,B)
redpred_117(A,B) :- p134(A,C),p1423(C,B)
redpred_118(A,B) :- p134(A,C),p148(C,B)
redpred_119(A,B) :- copy1(A,C),p1423(C,B)
redpred_120(A,B) :- p31(A,C),p340(C,B)
redpred_121(A,B) :- p340(A,C),p71(C,B)
redpred_122(A,B) :- skip1(A,C),p813(C,B)
redpred_123(A,B) :- p340(A,C),p256(C,B)
redpred_124(A,B) :- skip1(A,C),p44(C,B)
redpred_125(A,B) :- copy1(A,C),p572(C,B)
redpred_126(A,B) :- p1423(A,C),copy1(C,B)
redpred_127(A,B) :- skip1(A,C),p95(C,B)
redpred_128(A,B) :- mk_uppercase(A,C),p572(C,B)
redpred_129(A,B) :- copy1(A,C),p374(C,B)
redpred_130(A,B) :- copy1(A,C),p120(C,B)
redpred_131(A,B) :- skip1(A,C),p645(C,B)
redpred_132(A,B) :- p16_1(A,C),p16(C,B)
redpred_133(A,B) :- copy1(A,C),p1268(C,B)
redpred_134(A,B) :- skip1(A,C),p1268(C,B)
redpred_135(A,B) :- p340(A,C),p46(C,B)
redpred_136(A,B) :- skip1(A,C),p1423(C,B)
redpred_137(A,B) :- p340(A,C),p246(C,B)
redpred_138(A,B) :- copy1(A,C),p58(C,B)
redpred_139(A,B) :- p134(A,C),p530(C,B)
redpred_140(A,B) :- copy1(A,C),p340(C,B)
redpred_141(A,B) :- p71(A,C),p44(C,B)
redpred_142(A,B) :- p914(A,C),p58_1(C,B)
redpred_143(A,B) :- p36_1(A,C),p147_1(C,B)
redpred_144(A,B) :- p5(A,C),p340(C,B)
redpred_145(A,B) :- copy1(A,C),p530(C,B)
redpred_146(A,B) :- p31(A,C),p572(C,B)
redpred_147(A,B) :- copy1(A,C),p1881(C,B)
redpred_148(A,B) :- p62_1(A,C),p400(C,B)
redpred_149(A,B) :- skip1(A,C),p145(C,B)
redpred_150(A,B) :- p530(A,C),p1268(C,B)
redpred_151(A,B) :- p134(A,C),p1113(C,B)
redpred_152(A,B) :- copy1(A,C),p2034(C,B)
redpred_153(A,B) :- p340(A,C),p404(C,B)
redpred_154(A,B) :- p418(A,C),p813(C,B)
redpred_155(A,B) :- p64(A,C),p1061(C,B)
redpred_156(A,B) :- p120(A,C),p205(C,B)
redpred_157(A,B) :- p1269(A,C),p71(C,B)
...
p401(A,B) :- redpred_13(A,B)
p403(A,B) :- redpred_11(A,B)
p405(A,B) :- redpred_10(A,B)
p409(A,B) :- redpred_14(A,B)
...
p518(A,B) :- redpred_10(A,B)
p521(A,B) :- redpred_11(A,B)
...
p1773(A,B) :- redpred_15(A,B)
p1777(A,B) :- redpred_11(A,B)
p1778(A,B) :- redpred_10(A,B)
...
p145_1(A,B) :- redpred_19(A,B)
p146(A,B) :- copy1(A,C),p146_1(C,B)
p146_1(A,B) :- redpred_19(A,B)
...
p1187_1(A,B) :- redpred_62(A,B)
p1190(A,B) :- skip1(A,C),p1190_1(C,B)
p1190_1(A,B) :- redpred_79(A,B)
...
p1379(A,B) :- redpred_54(A,B)
p1380(A,B) :- mk_lowercase(A,C),p1380_1(C,B)
p1380_1(A,B) :- redpred_27(A,B)
p1381(A,B) :- redpred_94(A,B)
p1382(A,B) :- copy1(A,C),p1382_1(C,B)
p1382_1(A,B) :- redpred_18(A,B)
p1386(A,B) :- redpred_46(A,B)
p1392(A,B) :- skip1(A,C),p1392_1(C,B)
p1392_1(A,B) :- redpred_19(A,B)
p1393(A,B) :- redpred_65(A,B)
...
p2064_1(A,B) :- redpred_20(A,B)
p2067(A,B) :- redpred_91(A,B)
p2068(A,B) :- redpred_19(A,B)
p2072(A,B) :- redpred_35(A,B)
p2079(A,B) :- skip1(A,C),p2079_1(C,B)
p2079_1(A,B) :- redpred_31(A,B)
p2082(A,B) :- copy1(A,C),p2082_1(C,B)
p2082_1(A,B) :- redpred_38(A,B)
p2086(A,B) :- redpred_70(A,B)
p2092(A,B) :- redpred_50(A,B)
p2093(A,B) :- redpred_32(A,B)
p2094(A,B) :- p5(A,C),p2094_1(C,B)
p2094_1(A,B) :- redpred_31(A,B)
p2097(A,B) :- redpred_19(A,B)
p2100(A,B) :- skip1(A,C),p2100_1(C,B)
p2100_1(A,B) :- redpred_19(A,B)
p2101(A,B) :- redpred_71(A,B)
p2105(A,B) :- redpred_96(A,B)
p2106(A,B) :- redpred_87(A,B)
...
p48(A,B) :- redpred_101(A,B)
p49(A,B) :- redpred_102(A,B)
p50(A,B) :- p256(A,C),p544(C,B)
p60(A,B) :- p36_1(A,C),p1381(C,B)
p61(A,B) :- redpred_103(A,B)
...
p171(A,B) :- redpred_107(A,B)
p172(A,B) :- mk_uppercase(A,C),p172_1(C,B)
p172_1(A,B) :- redpred_108(A,B)
...
p191_1(A,B) :- redpred_105(A,B)
p192(A,B) :- mk_lowercase(A,C),p203(C,B)
p193(A,B) :- redpred_109(A,B)
p195(A,B) :- redpred_110(A,B)
p196(A,B) :- redpred_111(A,B)
p201(A,B) :- redpred_112(A,B)
...
p268_1(A,B) :- redpred_100(A,B)
p272(A,B) :- redpred_117(A,B)
...
p317(A,B) :- redpred_120(A,B)
p319(A,B) :- redpred_121(A,B)
...
p361(A,B) :- redpred_116(A,B)
p368(A,B) :- redpred_123(A,B)
p370(A,B) :- redpred_124(A,B)
...
p596(A,B) :- redpred_132(A,B)
p597(A,B) :- p1529(A,C),p270(C,B)
p598(A,B) :- redpred_131(A,B)
p599(A,B) :- redpred_133(A,B)
...
p908(A,B) :- redpred_142(A,B)
p909(A,B) :- redpred_144(A,B)
p910(A,B) :- redpred_145(A,B)
p912(A,B) :- skip1(A,C),p219(C,B)
p913(A,B) :- redpred_107(A,B)
...
p1050_1(A,B) :- redpred_106(A,B)
p1056(A,B) :- p29(A,C),p16(C,B)
p1058(A,B) :- redpred_100(A,B)
...
p1202(A,B) :- redpred_147(A,B)
p1203(A,B) :- redpred_133(A,B)
...
p1240_1(A,B) :- redpred_153(A,B)
p1241(A,B) :- p16_1(A,C),p120(C,B)
p1243(A,B) :- redpred_130(A,B)
...
p1593(A,B) :- redpred_109(A,B)
p1596(A,B) :- redpred_144(A,B)
p1599(A,B) :- redpred_134(A,B)
...
p1795(A,B) :- redpred_101(A,B)
p1797(A,B) :- redpred_120(A,B)
...
p1814(A,B) :- redpred_121(A,B)
p1817(A,B) :- p36_1(A,C),p530(C,B)
p1818(A,B) :- redpred_154(A,B)
...
p1841(A,B) :- redpred_100(A,B)
p1844(A,B) :- p78(A,C),p16(C,B)
p1851(A,B) :- p75(A,C),p5(C,B)
p1853(A,B) :- redpred_148(A,B)
p1855(A,B) :- redpred_125(A,B)
...
p1896_1(A,B) :- redpred_156(A,B)
p1897(A,B) :- redpred_156(A,B)
...
p1963_1(A,B) :- redpred_124(A,B)
p1967(A,B) :- redpred_102(A,B)
...
p2144(A,B) :- redpred_155(A,B)
p2145(A,B) :- copy1(A,C),p2145_1(C,B)
p2145_1(A,B) :- redpred_121(A,B)
p2148(A,B) :- redpred_154(A,B)
p2149(A,B) :- skip1(A,C),p2149_1(C,B)
p2149_1(A,B) :- redpred_115(A,B)
