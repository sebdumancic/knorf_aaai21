...
redpred_15(A,B) :- p29(A,C),p97(C,B)
redpred_16(A,B) :- skip1(A,C),p97(C,B)
redpred_17(A,B) :- copy1(A,C),p418(C,B)
redpred_18(A,B) :- p97(A,C),p238(C,B)
redpred_19(A,B) :- p4(A,C),p97(C,B)
redpred_20(A,B) :- p97(A,C),p29(C,B)
redpred_21(A,B) :- copy1(A,C),p4(C,B)
redpred_22(A,B) :- skip1(A,C),p423(C,B)
redpred_23(A,B) :- p29(A,C),p423(C,B)
redpred_24(A,B) :- skip1(A,C),p551(C,B)
redpred_25(A,B) :- p4(A,C),p418(C,B)
redpred_26(A,B) :- skip1(A,C),p89(C,B)
redpred_27(A,B) :- skip1(A,C),p40(C,B)
redpred_28(A,B) :- p97(A,C),p97(C,B)
redpred_29(A,B) :- p97(A,C),p4(C,B)
redpred_30(A,B) :- skip1(A,C),p238(C,B)
redpred_31(A,B) :- mk_lowercase(A,C),p423(C,B)
redpred_32(A,B) :- p423(A,C),p418(C,B)
redpred_33(A,B) :- p89(A,C),p97(C,B)
redpred_34(A,B) :- skip1(A,C),p418(C,B)
redpred_35(A,B) :- p423(A,C),p4(C,B)
redpred_36(A,B) :- p89(A,C),p4(C,B)
redpred_37(A,B) :- p423(A,C),p238(C,B)
redpred_38(A,B) :- p29(A,C),p4(C,B)
redpred_39(A,B) :- skip1(A,C),p28(C,B)
redpred_40(A,B) :- skip1(A,C),p4(C,B)
redpred_41(A,B) :- copy1(A,C),p97(C,B)
redpred_42(A,B) :- copy1(A,C),p423(C,B)
redpred_43(A,B) :- p4(A,C),p29(C,B)
redpred_44(A,B) :- copy1(A,C),p238(C,B)
redpred_45(A,B) :- p418(A,C),p418(C,B)
redpred_46(A,B) :- p423(A,C),p29(C,B)
redpred_47(A,B) :- p40(A,C),p238(C,B)
redpred_48(A,B) :- p4(A,C),p4(C,B)
redpred_49(A,B) :- p238(A,C),p97(C,B)
redpred_50(A,B) :- skip1(A,C),p94(C,B)
redpred_51(A,B) :- mk_uppercase(A,C),p4(C,B)
redpred_52(A,B) :- p40(A,C),p4(C,B)
redpred_53(A,B) :- skip1(A,C),p29(C,B)
redpred_54(A,B) :- skip1(A,C),p265(C,B)
redpred_55(A,B) :- p265(A,C),p97(C,B)
redpred_56(A,B) :- copy1(A,C),p89(C,B)
redpred_57(A,B) :- p238(A,C),p4(C,B)
redpred_58(A,B) :- p97(A,C),p423(C,B)
redpred_59(A,B) :- copy1(A,C),p29(C,B)
redpred_60(A,B) :- p40(A,C),p423(C,B)
redpred_61(A,B) :- mk_uppercase(A,C),p97(C,B)
redpred_62(A,B) :- skip1(A,C),p254(C,B)
redpred_63(A,B) :- p29(A,C),p719(C,B)
redpred_64(A,B) :- p546(A,C),p40(C,B)
redpred_65(A,B) :- skip1(A,C),p546(C,B)
redpred_66(A,B) :- p620(A,C),p34(C,B)
redpred_67(A,B) :- skip1(A,C),p479(C,B)
redpred_68(A,B) :- skip1(A,C),p536(C,B)
redpred_69(A,B) :- p211(A,C),p5_1(C,B)
redpred_70(A,B) :- skip1(A,C),p69_1(C,B)
redpred_71(A,B) :- p97(A,C),p719(C,B)
redpred_72(A,B) :- copy1(A,C),p182(C,B)
redpred_73(A,B) :- p69(A,C),p97(C,B)
redpred_74(A,B) :- p546(A,C),p34(C,B)
redpred_75(A,B) :- copy1(A,C),p376(C,B)
redpred_76(A,B) :- skip1(A,C),p182(C,B)
redpred_77(A,B) :- p14(A,C),p5_1(C,B)
redpred_78(A,B) :- skip1(A,C),p132(C,B)
redpred_79(A,B) :- p546(A,C),p423(C,B)
redpred_80(A,B) :- p5_1(A,C),p479(C,B)
redpred_81(A,B) :- skip1(A,C),p397_1(C,B)
redpred_82(A,B) :- p897(A,C),copy1(C,B)
redpred_83(A,B) :- p97(A,C),p5(C,B)
redpred_84(A,B) :- p254(A,C),p148(C,B)
redpred_85(A,B) :- copy1(A,C),p211(C,B)
redpred_86(A,B) :- p97(A,C),p254(C,B)
redpred_87(A,B) :- p746(A,C),p97(C,B)
redpred_88(A,B) :- skip1(A,C),p39_1(C,B)
...
p361(A,B) :- redpred_9(A,B)
p364(A,B) :- redpred_1(A,B)
p366(A,B) :- redpred_10(A,B)
...
p14_1(A,B) :- redpred_16(A,B)
p16(A,B) :- mk_lowercase(A,C),p16_1(C,B)
p16_1(A,B) :- redpred_16(A,B)
...
p85_1(A,B) :- redpred_16(A,B)
p86(A,B) :- redpred_19(A,B)
p90(A,B) :- redpred_21(A,B)
...
p108_1(A,B) :- redpred_32(A,B)
p111(A,B) :- copy1(A,C),p111_1(C,B)
p111_1(A,B) :- redpred_30(A,B)
...
p163(A,B) :- redpred_21(A,B)
p164(A,B) :- redpred_34(A,B)
...
p198_1(A,B) :- redpred_38(A,B)
p201(A,B) :- p97(A,C),p201_1(C,B)
p201_1(A,B) :- redpred_23(A,B)
p202(A,B) :- redpred_21(A,B)
p203(A,B) :- p4(A,C),p203_1(C,B)
p203_1(A,B) :- redpred_36(A,B)
p204(A,B) :- redpred_39(A,B)
p209(A,B) :- redpred_40(A,B)
p211(A,B) :- p97(A,C),p211_1(C,B)
p211_1(A,B) :- redpred_40(A,B)
p216(A,B) :- redpred_16(A,B)
...
p481_1(A,B) :- redpred_48(A,B)
p491(A,B) :- p418(A,C),p491_1(C,B)
p491_1(A,B) :- redpred_54(A,B)
p493(A,B) :- skip1(A,C),p493_1(C,B)
p493_1(A,B) :- redpred_15(A,B)
...
p669(A,B) :- redpred_21(A,B)
p670(A,B) :- p4(A,C),p670_1(C,B)
p670_1(A,B) :- redpred_16(A,B)
p671(A,B) :- redpred_41(A,B)
...
p710(A,B) :- redpred_19(A,B)
p712(A,B) :- p97(A,C),p712_1(C,B)
p712_1(A,B) :- redpred_28(A,B)
...
p124_1(A,B) :- redpred_62(A,B)
p125(A,B) :- p14(A,C),p125_1(C,B)
p125_1(A,B) :- redpred_65(A,B)
...
p326_1(A,B) :- redpred_70(A,B)
p329(A,B) :- p37(A,C),p78_1(C,B)
p331(A,B) :- redpred_71(A,B)
...
p447(A,B) :- redpred_72(A,B)
p449(A,B) :- p34(A,C),p449_1(C,B)
p449_1(A,B) :- redpred_78(A,B)
p450(A,B) :- p219(A,C),p466_1(C,B)
p451(A,B) :- redpred_79(A,B)
...
p504_1(A,B) :- redpred_67(A,B)
p506(A,B) :- p1(A,C),p506_1(C,B)
p506_1(A,B) :- redpred_81(A,B)
...
p736(A,B) :- redpred_76(A,B)
p744(A,B) :- redpred_85(A,B)
p746(A,B) :- copy1(A,C),p746_1(C,B)
p746_1(A,B) :- redpred_70(A,B)
...
p295_1(A,B) :- redpred_88(A,B)
p313(A,B) :- p37(A,C),p313_1(C,B)
p313_1(A,B) :- redpred_87(A,B)
