...
redpred_16(A,B) :- skip1(A,C),p559(C,B)
redpred_17(A,B) :- p8(A,C),p343(C,B)
redpred_18(A,B) :- p8(A,C),p30(C,B)
redpred_19(A,B) :- copy1(A,C),p5(C,B)
redpred_20(A,B) :- p418(A,C),p3(C,B)
redpred_21(A,B) :- skip1(A,C),p176(C,B)
redpred_22(A,B) :- skip1(A,C),p418(C,B)
redpred_23(A,B) :- skip1(A,C),p343(C,B)
redpred_24(A,B) :- p30(A,C),p5(C,B)
redpred_25(A,B) :- p30(A,C),p30(C,B)
redpred_26(A,B) :- copy1(A,C),p8(C,B)
redpred_27(A,B) :- skip1(A,C),p75(C,B)
redpred_28(A,B) :- skip1(A,C),p5(C,B)
redpred_29(A,B) :- copy1(A,C),p176(C,B)
redpred_30(A,B) :- copy1(A,C),p36(C,B)
redpred_31(A,B) :- p5(A,C),p36(C,B)
redpred_32(A,B) :- copy1(A,C),p418(C,B)
redpred_33(A,B) :- mk_lowercase(A,C),p8(C,B)
redpred_34(A,B) :- mk_uppercase(A,C),p30(C,B)
redpred_35(A,B) :- p3(A,C),p5(C,B)
redpred_36(A,B) :- mk_uppercase(A,C),p5(C,B)
redpred_37(A,B) :- p343(A,C),p176(C,B)
redpred_38(A,B) :- skip1(A,C),p30(C,B)
redpred_39(A,B) :- p5(A,C),p176(C,B)
redpred_40(A,B) :- mk_lowercase(A,C),p5(C,B)
redpred_41(A,B) :- p176(A,C),p5(C,B)
redpred_42(A,B) :- skip1(A,C),p59(C,B)
redpred_43(A,B) :- p343(A,C),p5(C,B)
redpred_44(A,B) :- mk_uppercase(A,C),p3(C,B)
redpred_45(A,B) :- copy1(A,C),p75(C,B)
redpred_46(A,B) :- p30(A,C),p343(C,B)
redpred_47(A,B) :- skip1(A,C),p36(C,B)
redpred_48(A,B) :- p5(A,C),p30(C,B)
redpred_49(A,B) :- p36(A,C),p5(C,B)
redpred_50(A,B) :- p5(A,C),p5(C,B)
redpred_51(A,B) :- copy1(A,C),p30(C,B)
redpred_52(A,B) :- p3(A,C),p30(C,B)
redpred_53(A,B) :- p176(A,B),is_number(B)
redpred_54(A,B) :- skip1(A,C),p3(C,B)
redpred_55(A,B) :- p30(A,C),p3(C,B)
redpred_56(A,B) :- mk_lowercase(A,C),p36(C,B)
redpred_57(A,B) :- skip1(A,C),p8(C,B)
redpred_58(A,B) :- skip1(A,C),p168(C,B)
redpred_59(A,B) :- p343(A,C),p30(C,B)
redpred_60(A,B) :- p30(A,C),p75(C,B)
redpred_61(A,B) :- p5(A,C),p75(C,B)
redpred_62(A,B) :- p343(A,C),p168(C,B)
redpred_63(A,B) :- p30(A,C),p176(C,B)
redpred_64(A,B) :- p30(A,C),p418(C,B)
redpred_65(A,B) :- p30(A,C),p168(C,B)
redpred_66(A,B) :- mk_uppercase(A,C),p176(C,B)
redpred_67(A,B) :- p418(A,C),p30(C,B)
redpred_68(A,B) :- mk_uppercase(A,C),p75(C,B)
redpred_69(A,B) :- p75(A,C),p3(C,B)
redpred_70(A,B) :- mk_lowercase(A,C),p168(C,B)
redpred_71(A,B) :- p418(A,C),p36(C,B)
redpred_72(A,B) :- copy1(A,C),p343(C,B)
redpred_73(A,B) :- p3(A,C),p176(C,B)
redpred_74(A,B) :- p418(A,C),p5(C,B)
redpred_75(A,B) :- p176(A,C),p30(C,B)
redpred_76(A,B) :- p5(A,C),p418(C,B)
redpred_77(A,B) :- p30(A,C),p8(C,B)
redpred_78(A,B) :- p5(A,C),p343(C,B)
redpred_79(A,B) :- p3(A,C),p343(C,B)
redpred_80(A,B) :- p8(A,C),p176(C,B)
redpred_81(A,B) :- mk_lowercase(A,C),p343(C,B)
redpred_82(A,B) :- p75(A,C),p30(C,B)
redpred_83(A,B) :- mk_lowercase(A,C),p418(C,B)
redpred_84(A,B) :- p3(A,C),p418(C,B)
redpred_85(A,B) :- copy1(A,C),p3(C,B)
redpred_86(A,B) :- p33(A,C),copy1(C,B)
redpred_87(A,B) :- skip1(A,C),p121(C,B)
redpred_88(A,B) :- skip1(A,C),p174(C,B)
redpred_89(A,B) :- p114(A,C),p200(C,B)
redpred_90(A,B) :- skip1(A,C),p61(C,B)
redpred_91(A,B) :- p5(A,C),p205(C,B)
redpred_92(A,B) :- copy1(A,C),p127(C,B)
redpred_93(A,B) :- skip1(A,C),p800(C,B)
redpred_94(A,B) :- skip1(A,C),p127(C,B)
redpred_95(A,B) :- p30(A,C),p641(C,B)
redpred_96(A,B) :- p607(A,C),p467(C,B)
redpred_97(A,B) :- p34(A,C),p191(C,B)
redpred_98(A,B) :- p136(A,C),mk_uppercase(C,B)
redpred_99(A,B) :- skip1(A,C),p439(C,B)
...
p950(A,B) :- redpred_11(A,B)
p959(A,B) :- redpred_9(A,B)
p961(A,B) :- redpred_5(A,B)
p974(A,B) :- redpred_11(A,B)
...
p262_1(A,B) :- redpred_38(A,B)
p266(A,B) :- skip1(A,C),p266_1(C,B)
p266_1(A,B) :- redpred_25(A,B)
p267(A,B) :- copy1(A,C),p267_1(C,B)
p267_1(A,B) :- redpred_18(A,B)
...
p276_1(A,B) :- redpred_25(A,B)
p278(A,B) :- skip1(A,C),p278_1(C,B)
p278_1(A,B) :- redpred_60(A,B)
p287(A,B) :- redpred_61(A,B)
p288(A,B) :- redpred_52(A,B)
p289(A,B) :- redpred_51(A,B)
...
p376_1(A,B) :- redpred_27(A,B)
p377(A,B) :- copy1(A,C),p377_1(C,B)
p377_1(A,B) :- redpred_28(A,B)
...
p667(A,B) :- redpred_76(A,B)
p668(A,B) :- mk_lowercase(A,C),p668_1(C,B)
p668_1(A,B) :- redpred_24(A,B)
...
p813_1(A,B) :- redpred_63(A,B)
p814(A,B) :- redpred_45(A,B)
p815(A,B) :- redpred_85(A,B)
p817(A,B) :- copy1(A,C),p817_1(C,B)
p817_1(A,B) :- redpred_25(A,B)
p821(A,B) :- p75(A,C),p821_1(C,B)
p821_1(A,B) :- redpred_48(A,B)
p823(A,B) :- skip1(A,C),p823_1(C,B)
p823_1(A,B) :- redpred_39(A,B)
p826(A,B) :- p559(A,C),p826_1(C,B)
p826_1(A,B) :- redpred_52(A,B)
...
p73_1(A,B) :- redpred_87(A,B)
p78(A,B) :- redpred_88(A,B)
p80(A,B) :- p868(A,C),p80_1(C,B)
p80_1(A,B) :- p16(A,C),p153_1(C,B)
p81(A,B) :- redpred_89(A,B)
...
p126(A,B) :- redpred_91(A,B)
p140(A,B) :- redpred_87(A,B)
