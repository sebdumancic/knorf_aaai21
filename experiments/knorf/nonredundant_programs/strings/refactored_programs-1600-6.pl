...
redpred_16(A,B) :- p131(A,C),p55(C,B)
redpred_17(A,B) :- skip1(A,C),p19(C,B)
redpred_18(A,B) :- skip1(A,C),p55(C,B)
redpred_19(A,B) :- skip1(A,C),p165(C,B)
redpred_20(A,B) :- copy1(A,C),p19(C,B)
redpred_21(A,B) :- p131(A,C),p112(C,B)
redpred_22(A,B) :- p204(A,C),p19(C,B)
redpred_23(A,B) :- p212(A,C),p131(C,B)
redpred_24(A,B) :- p212(A,C),p55(C,B)
redpred_25(A,B) :- p131(A,C),p19(C,B)
redpred_26(A,B) :- skip1(A,C),p131(C,B)
redpred_27(A,B) :- skip1(A,C),p144(C,B)
redpred_28(A,B) :- mk_uppercase(A,C),p19(C,B)
redpred_29(A,B) :- p15(A,C),p19(C,B)
redpred_30(A,B) :- skip1(A,C),p212(C,B)
redpred_31(A,B) :- p144(A,C),p131(C,B)
redpred_32(A,B) :- copy1(A,C),p131(C,B)
redpred_33(A,B) :- p131(A,C),p212(C,B)
redpred_34(A,B) :- p112(A,C),mk_uppercase(C,B)
redpred_35(A,B) :- p212(A,C),p19(C,B)
redpred_36(A,B) :- copy1(A,C),p204(C,B)
redpred_37(A,B) :- p144(A,C),p19(C,B)
redpred_38(A,B) :- p112(A,C),p131(C,B)
redpred_39(A,B) :- p204(A,C),p131(C,B)
redpred_40(A,B) :- p19(A,C),p19(C,B)
redpred_41(A,B) :- p55(A,C),p144(C,B)
redpred_42(A,B) :- p19(A,C),p131(C,B)
redpred_43(A,B) :- skip1(A,C),p15(C,B)
redpred_44(A,B) :- copy1(A,C),p144(C,B)
redpred_45(A,B) :- p165(A,C),p19(C,B)
redpred_46(A,B) :- p131(A,C),p131(C,B)
redpred_47(A,B) :- p55(A,C),p131(C,B)
redpred_48(A,B) :- p55(A,C),p19(C,B)
redpred_49(A,B) :- skip1(A,C),p204(C,B)
redpred_50(A,B) :- p131(A,C),p204(C,B)
redpred_51(A,B) :- p19(A,C),p55(C,B)
redpred_52(A,B) :- p131(A,C),p165(C,B)
redpred_53(A,B) :- p131(A,C),p144(C,B)
redpred_54(A,B) :- mk_lowercase(A,C),p212(C,B)
redpred_55(A,B) :- copy1(A,C),p55(C,B)
redpred_56(A,B) :- skip1(A,C),p112(C,B)
redpred_57(A,B) :- p112(A,C),p19(C,B)
redpred_58(A,B) :- p19(A,C),p204(C,B)
redpred_59(A,B) :- p165(A,C),p212(C,B)
redpred_60(A,B) :- copy1(A,C),p165(C,B)
redpred_61(A,B) :- p165(A,C),p131(C,B)
redpred_62(A,B) :- p19(A,C),p165(C,B)
redpred_63(A,B) :- skip1(A,C),p975(C,B)
redpred_64(A,B) :- mk_uppercase(A,C),p131(C,B)
redpred_65(A,B) :- p55(A,C),p55(C,B)
redpred_66(A,B) :- p204(A,C),p212(C,B)
redpred_67(A,B) :- p131(A,C),p975(C,B)
redpred_68(A,B) :- copy1(A,C),p975(C,B)
redpred_69(A,B) :- p542(A,C),mk_uppercase(C,B)
redpred_70(A,B) :- p19(A,C),p212(C,B)
redpred_71(A,B) :- copy1(A,C),p542(C,B)
redpred_72(A,B) :- p19(A,C),p144(C,B)
redpred_73(A,B) :- p112(A,C),p165(C,B)
redpred_74(A,B) :- p55(A,C),p204(C,B)
redpred_75(A,B) :- mk_lowercase(A,C),p131(C,B)
redpred_76(A,B) :- copy1(A,C),p112(C,B)
redpred_77(A,B) :- p204(A,C),p112(C,B)
redpred_78(A,B) :- copy1(A,C),p15(C,B)
redpred_79(A,B) :- p212(A,C),p204(C,B)
redpred_80(A,B) :- copy1(A,C),p870(C,B)
redpred_81(A,B) :- p90_1(A,C),p579(C,B)
redpred_82(A,B) :- skip1(A,C),p842(C,B)
redpred_83(A,B) :- p16(A,C),p43(C,B)
redpred_84(A,B) :- copy1(A,C),p430(C,B)
redpred_85(A,B) :- skip1(A,C),p991(C,B)
redpred_86(A,B) :- p19(A,C),p422(C,B)
redpred_87(A,B) :- p19(A,C),p90(C,B)
redpred_88(A,B) :- skip1(A,C),p149(C,B)
redpred_89(A,B) :- skip1(A,C),p374(C,B)
redpred_90(A,B) :- p131(A,C),p147(C,B)
redpred_91(A,B) :- p131(A,C),p509(C,B)
redpred_92(A,B) :- p515(A,C),p3(C,B)
redpred_93(A,B) :- skip1(A,C),p9(C,B)
redpred_94(A,B) :- copy1(A,C),p1070(C,B)
redpred_95(A,B) :- p16(A,C),p930(C,B)
redpred_96(A,B) :- p131(A,C),p842(C,B)
redpred_97(A,B) :- skip1(A,C),p1422(C,B)
redpred_98(A,B) :- p699_1(A,C),p9(C,B)
redpred_99(A,B) :- copy1(A,C),p842(C,B)
redpred_100(A,B) :- skip1(A,C),p147(C,B)
redpred_101(A,B) :- skip1(A,C),p252(C,B)
redpred_102(A,B) :- copy1(A,C),p900(C,B)
redpred_103(A,B) :- skip1(A,C),p1070(C,B)
redpred_104(A,B) :- p43(A,C),p147(C,B)
redpred_105(A,B) :- copy1(A,C),p149(C,B)
redpred_106(A,B) :- p12(A,C),p112(C,B)
redpred_107(A,B) :- copy1(A,C),p147(C,B)
redpred_108(A,B) :- copy1(A,C),p241(C,B)
redpred_109(A,B) :- copy1(A,C),p41(C,B)
redpred_110(A,B) :- p401_1(A,C),p116_1(C,B)
redpred_111(A,B) :- p16(A,C),p12_1(C,B)
redpred_112(A,B) :- p116_1(A,C),p842(C,B)
redpred_113(A,B) :- p342(A,C),p43(C,B)
redpred_114(A,B) :- p55(A,C),p71(C,B)
redpred_115(A,B) :- p19(A,C),p147(C,B)
redpred_116(A,B) :- p16(A,C),p3(C,B)
redpred_117(A,B) :- p19(A,C),p531(C,B)
redpred_118(A,B) :- copy1(A,C),p310(C,B)
redpred_119(A,B) :- skip1(A,C),p414(C,B)
redpred_120(A,B) :- p147(A,C),p3(C,B)
redpred_121(A,B) :- p252_1(A,C),p171(C,B)
redpred_122(A,B) :- copy1(A,C),p563(C,B)
redpred_123(A,B) :- p68(A,C),p579(C,B)
redpred_124(A,B) :- mk_uppercase(A,C),p430(C,B)
...
p926(A,B) :- redpred_9(A,B)
p931(A,B) :- redpred_3(A,B)
p945(A,B) :- redpred_9(A,B)
...
p531_1(A,B) :- redpred_61(A,B)
p532(A,B) :- redpred_27(A,B)
p533(A,B) :- redpred_63(A,B)
...
p760(A,B) :- redpred_40(A,B)
p762(A,B) :- p19(A,C),p762_1(C,B)
p762_1(A,B) :- redpred_58(A,B)
p763(A,B) :- p19(A,C),p763_1(C,B)
p763_1(A,B) :- redpred_25(A,B)
p765(A,B) :- skip1(A,C),p765_1(C,B)
p765_1(A,B) :- redpred_42(A,B)
p766(A,B) :- skip1(A,C),p766_1(C,B)
p766_1(A,B) :- redpred_17(A,B)
p785(A,B) :- skip1(A,C),p785_1(C,B)
p785_1(A,B) :- redpred_50(A,B)
p790(A,B) :- p212(A,C),p790_1(C,B)
p790_1(A,B) :- redpred_72(A,B)
...
p1569_1(A,B) :- redpred_25(A,B)
p1573(A,B) :- redpred_17(A,B)
p1574(A,B) :- p19(A,C),p1574_1(C,B)
p1574_1(A,B) :- redpred_79(A,B)
p1576(A,B) :- redpred_60(A,B)
p1577(A,B) :- redpred_26(A,B)
p1580(A,B) :- copy1(A,C),p1580_1(C,B)
p1580_1(A,B) :- redpred_48(A,B)
p1583(A,B) :- redpred_68(A,B)
p1584(A,B) :- redpred_46(A,B)
p1585(A,B) :- redpred_26(A,B)
p1592(A,B) :- mk_lowercase(A,C),p1592_1(C,B)
p1592_1(A,B) :- redpred_17(A,B)
...
p25(A,B) :- redpred_80(A,B)
p31(A,B) :- redpred_81(A,B)
...
p73(A,B) :- redpred_83(A,B)
p75(A,B) :- redpred_84(A,B)
...
p198(A,B) :- redpred_91(A,B)
p207(A,B) :- mk_uppercase(A,C),p207_1(C,B)
p207_1(A,B) :- redpred_92(A,B)
...
p254(A,B) :- redpred_94(A,B)
p255(A,B) :- redpred_95(A,B)
...
p298_1(A,B) :- redpred_98(A,B)
p302(A,B) :- p16(A,C),p178(C,B)
p304(A,B) :- redpred_99(A,B)
...
p591(A,B) :- redpred_101(A,B)
p592(A,B) :- p3(A,C),p64_1(C,B)
p597(A,B) :- redpred_96(A,B)
...
p605_1(A,B) :- redpred_106(A,B)
p607(A,B) :- redpred_107(A,B)
...
p721(A,B) :- redpred_111(A,B)
p724(A,B) :- redpred_112(A,B)
p725(A,B) :- redpred_113(A,B)
...
p803(A,B) :- redpred_113(A,B)
p804(A,B) :- redpred_115(A,B)
...
p901_1(A,B) :- redpred_93(A,B)
p902(A,B) :- redpred_105(A,B)
p907(A,B) :- p131(A,C),p907_1(C,B)
p907_1(A,B) :- redpred_100(A,B)
p908(A,B) :- redpred_84(A,B)
p909(A,B) :- redpred_117(A,B)
...
p1107(A,B) :- redpred_111(A,B)
p1109(A,B) :- skip1(A,C),p1109_1(C,B)
p1109_1(A,B) :- redpred_106(A,B)
...
p1149(A,B) :- redpred_102(A,B)
p1150(A,B) :- p165(A,C),p1150_1(C,B)
p1150_1(A,B) :- redpred_89(A,B)
...
p1244(A,B) :- redpred_98(A,B)
p1245(A,B) :- p44_1(A,C),p870(C,B)
p1246(A,B) :- redpred_123(A,B)
p1247(A,B) :- redpred_88(A,B)
...
p1268(A,B) :- redpred_119(A,B)
p1269(A,B) :- redpred_124(A,B)
p1273(A,B) :- p131(A,C),p430(C,B)
p1274(A,B) :- p147(A,C),p16(C,B)
p1279(A,B) :- redpred_86(A,B)
...
p1397(A,B) :- redpred_115(A,B)
p1404(A,B) :- redpred_90(A,B)
...
p1555(A,B) :- redpred_84(A,B)
p1562(A,B) :- copy1(A,C),p1562_1(C,B)
p1562_1(A,B) :- redpred_93(A,B)
