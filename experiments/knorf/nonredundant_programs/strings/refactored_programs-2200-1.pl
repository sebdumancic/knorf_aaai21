...
redpred_2(A,B) :- mk_lowercase(A,C),mk_lowercase(C,B)
...
redpred_17(A,B) :- p29(A,C),p80(C,B)
redpred_18(A,B) :- p80(A,C),p10(C,B)
redpred_19(A,B) :- skip1(A,C),p105(C,B)
redpred_20(A,B) :- copy1(A,C),p10(C,B)
redpred_21(A,B) :- skip1(A,C),p10(C,B)
redpred_22(A,B) :- copy1(A,C),p225(C,B)
redpred_23(A,B) :- skip1(A,C),p279(C,B)
redpred_24(A,B) :- p105(A,C),p80(C,B)
redpred_25(A,B) :- mk_uppercase(A,C),p10(C,B)
redpred_26(A,B) :- copy1(A,C),p176(C,B)
redpred_27(A,B) :- mk_lowercase(A,C),p246(C,B)
redpred_28(A,B) :- mk_lowercase(A,C),p80(C,B)
redpred_29(A,B) :- skip1(A,C),p29(C,B)
redpred_30(A,B) :- mk_lowercase(A,C),p10(C,B)
redpred_31(A,B) :- p10(A,C),p279(C,B)
redpred_32(A,B) :- p225(A,C),p10(C,B)
redpred_33(A,B) :- p30(A,C),p279(C,B)
redpred_34(A,B) :- copy1(A,C),p246(C,B)
redpred_35(A,B) :- copy1(A,C),p305(C,B)
redpred_36(A,B) :- p80(A,C),p30(C,B)
redpred_37(A,B) :- p246(A,C),p225(C,B)
redpred_38(A,B) :- p29(A,C),p29(C,B)
redpred_39(A,B) :- skip1(A,C),p30(C,B)
redpred_40(A,B) :- copy1(A,C),p105(C,B)
redpred_41(A,B) :- p105(A,C),p10(C,B)
redpred_42(A,B) :- copy1(A,C),p29(C,B)
redpred_43(A,B) :- skip1(A,C),p176(C,B)
redpred_44(A,B) :- p279(A,C),p279(C,B)
redpred_45(A,B) :- p10(A,C),p246(C,B)
redpred_46(A,B) :- p176(A,C),p30(C,B)
redpred_47(A,B) :- p10(A,C),p10(C,B)
redpred_48(A,B) :- skip1(A,C),p246(C,B)
redpred_49(A,B) :- skip1(A,C),p305(C,B)
redpred_50(A,B) :- p10(A,C),p29(C,B)
redpred_51(A,B) :- p246(A,C),p29(C,B)
redpred_52(A,B) :- p29(A,C),p225(C,B)
redpred_53(A,B) :- mk_lowercase(A,C),p30(C,B)
redpred_54(A,B) :- p29(A,C),p105(C,B)
redpred_55(A,B) :- p29(A,C),p279(C,B)
redpred_56(A,B) :- mk_uppercase(A,C),p105(C,B)
redpred_57(A,B) :- p10(A,C),p30(C,B)
redpred_58(A,B) :- skip1(A,C),p80(C,B)
redpred_59(A,B) :- p105(A,C),p279(C,B)
redpred_60(A,B) :- skip1(A,C),p225(C,B)
redpred_61(A,B) :- p29(A,C),p30(C,B)
redpred_62(A,B) :- p30(A,C),p10(C,B)
redpred_63(A,B) :- p10(A,C),p754(C,B)
redpred_64(A,B) :- p29(A,C),p10(C,B)
redpred_65(A,B) :- p105(A,C),p225(C,B)
redpred_66(A,B) :- p279(A,C),p10(C,B)
redpred_67(A,B) :- p30(A,C),p30(C,B)
redpred_68(A,B) :- skip1(A,C),p12(C,B)
redpred_69(A,B) :- p225(A,C),p105(C,B)
redpred_70(A,B) :- copy1(A,C),p12(C,B)
redpred_71(A,B) :- p279(A,C),p105(C,B)
redpred_72(A,B) :- p30(A,C),p29(C,B)
redpred_73(A,B) :- mk_uppercase(A,C),p29(C,B)
redpred_74(A,B) :- copy1(A,C),p279(C,B)
redpred_75(A,B) :- p279(A,C),p29(C,B)
redpred_76(A,B) :- skip1(A,C),p754(C,B)
redpred_77(A,B) :- copy1(A,C),p30(C,B)
redpred_78(A,B) :- p30(A,C),p80(C,B)
redpred_79(A,B) :- p12(A,C),p29(C,B)
redpred_80(A,B) :- mk_uppercase(A,C),p30(C,B)
redpred_81(A,B) :- p105(A,C),p29(C,B)
redpred_82(A,B) :- copy1(A,C),p80(C,B)
redpred_83(A,B) :- p10(A,C),p80(C,B)
redpred_84(A,B) :- p225(A,C),p29(C,B)
redpred_85(A,B) :- p225(A,C),p30(C,B)
redpred_86(A,B) :- mk_lowercase(A,C),p279(C,B)
redpred_87(A,B) :- p30(A,C),p105(C,B)
redpred_88(A,B) :- p29(A,C),p305(C,B)
redpred_89(A,B) :- p29(A,C),p246(C,B)
redpred_90(A,B) :- p10(A,C),p176(C,B)
redpred_91(A,B) :- p225(A,C),p225(C,B)
redpred_92(A,B) :- p29(A,C),p176(C,B)
redpred_93(A,B) :- copy1(A,C),p754(C,B)
redpred_94(A,B) :- mk_lowercase(A,C),p225(C,B)
redpred_95(A,B) :- p29(A,C),p754(C,B)
redpred_96(A,B) :- p754(A,C),p29(C,B)
redpred_97(A,B) :- p10(A,C),p12(C,B)
redpred_98(A,B) :- p176(A,C),p10(C,B)
redpred_99(A,B) :- mk_uppercase(A,C),p305(C,B)
redpred_100(A,B) :- p10(A,C),p105(C,B)
redpred_101(A,B) :- p80(A,C),p29(C,B)
redpred_102(A,B) :- mk_lowercase(A,C),p29(C,B)
redpred_103(A,B) :- p279(A,C),p80(C,B)
redpred_104(A,B) :- p10(A,C),p225(C,B)
redpred_105(A,B) :- p246(A,C),p279(C,B)
redpred_106(A,B) :- p80(A,C),p225(C,B)
redpred_107(A,B) :- p754(A,C),p30(C,B)
redpred_108(A,B) :- skip1(A,C),p662(C,B)
redpred_109(A,B) :- p10(A,C),p64(C,B)
redpred_110(A,B) :- p177(A,C),p133(C,B)
redpred_111(A,B) :- p471(A,C),copy1(C,B)
redpred_112(A,B) :- copy1(A,C),p1564(C,B)
redpred_113(A,B) :- p114(A,C),p312(C,B)
redpred_114(A,B) :- copy1(A,C),p177(C,B)
redpred_115(A,B) :- p10(A,C),p148(C,B)
redpred_116(A,B) :- copy1(A,C),p1103(C,B)
redpred_117(A,B) :- p471(A,C),p498(C,B)
redpred_118(A,B) :- skip1(A,C),p75(C,B)
redpred_119(A,B) :- mk_uppercase(A,C),p662(C,B)
redpred_120(A,B) :- p7(A,C),p1199(C,B)
redpred_121(A,B) :- p137_1(A,C),p9(C,B)
redpred_122(A,B) :- copy1(A,C),p109(C,B)
redpred_123(A,B) :- p64(A,C),p7(C,B)
redpred_124(A,B) :- p2184(A,C),p145_1(C,B)
redpred_125(A,B) :- p29(A,C),p75(C,B)
redpred_126(A,B) :- skip1(A,C),p365(C,B)
redpred_127(A,B) :- skip1(A,C),p46(C,B)
redpred_128(A,B) :- p87(A,C),p7(C,B)
redpred_129(A,B) :- skip1(A,C),p177(C,B)
redpred_130(A,B) :- copy1(A,C),p75(C,B)
redpred_131(A,B) :- p283(A,C),p7(C,B)
redpred_132(A,B) :- p7(A,C),p75(C,B)
redpred_133(A,B) :- p46(A,C),p46_1(C,B)
redpred_134(A,B) :- skip1(A,C),p1318(C,B)
redpred_135(A,B) :- p7(A,C),p843(C,B)
redpred_136(A,B) :- p46_1(A,C),p100_1(C,B)
redpred_137(A,B) :- p29(A,C),p759(C,B)
redpred_138(A,B) :- p9(A,C),p64(C,B)
redpred_139(A,B) :- p10(A,C),p1199(C,B)
redpred_140(A,B) :- copy1(A,C),p46(C,B)
redpred_141(A,B) :- copy1(A,C),p920(C,B)
redpred_142(A,B) :- copy1(A,C),p86(C,B)
redpred_143(A,B) :- p46_1(A,C),p312(C,B)
redpred_144(A,B) :- skip1(A,C),p315(C,B)
redpred_145(A,B) :- p471(A,C),p225(C,B)
redpred_146(A,B) :- p46(A,C),p283(C,B)
redpred_147(A,B) :- p87(A,C),p428(C,B)
redpred_148(A,B) :- p283(A,C),p91(C,B)
redpred_149(A,B) :- skip1(A,C),p1034(C,B)
redpred_150(A,B) :- copy1(A,C),p311(C,B)
redpred_151(A,B) :- copy1(A,C),p283(C,B)
redpred_152(A,B) :- skip1(A,C),p1103(C,B)
redpred_153(A,B) :- p21(A,C),p528_1(C,B)
redpred_154(A,B) :- p10(A,C),p283(C,B)
redpred_155(A,B) :- copy1(A,C),p1406(C,B)
redpred_156(A,B) :- p471(A,C),p10(C,B)
redpred_157(A,B) :- skip1(A,C),p1793(C,B)
redpred_158(A,B) :- p9(A,C),p177(C,B)
redpred_159(A,B) :- copy1(A,C),p145(C,B)
redpred_160(A,B) :- p145_1(A,C),p177(C,B)
redpred_161(A,B) :- p29(A,C),p177(C,B)
redpred_162(A,B) :- skip1(A,C),p64(C,B)
redpred_163(A,B) :- p114(A,C),p311(C,B)
redpred_164(A,B) :- p383_1(A,C),p91(C,B)
redpred_165(A,B) :- skip1(A,C),p111(C,B)
...
p241(A,B) :- redpred_21(A,B)
p245(A,B) :- mk_lowercase(A,C),p245_1(C,B)
p245_1(A,B) :- redpred_38(A,B)
p250(A,B) :- skip1(A,C),p250_1(C,B)
p250_1(A,B) :- redpred_60(A,B)
p252(A,B) :- p10(A,C),p252_1(C,B)
p252_1(A,B) :- redpred_45(A,B)
p256(A,B) :- redpred_61(A,B)
p257(A,B) :- copy1(A,C),p257_1(C,B)
p257_1(A,B) :- redpred_62(A,B)
p260(A,B) :- skip1(A,C),p260_1(C,B)
p260_1(A,B) :- redpred_21(A,B)
p264(A,B) :- redpred_63(A,B)
p270(A,B) :- redpred_42(A,B)
p276(A,B) :- mk_uppercase(A,C),p276_1(C,B)
p276_1(A,B) :- redpred_64(A,B)
p283(A,B) :- p29(A,C),p283_1(C,B)
p283_1(A,B) :- redpred_29(A,B)
p285(A,B) :- skip1(A,C),p285_1(C,B)
p285_1(A,B) :- redpred_21(A,B)
...
p384_1(A,B) :- redpred_21(A,B)
p391(A,B) :- redpred_70(A,B)
p400(A,B) :- p12(A,C),p400_1(C,B)
p400_1(A,B) :- redpred_50(A,B)
...
p410_1(A,B) :- redpred_71(A,B)
p415(A,B) :- copy1(A,C),p415_1(C,B)
p415_1(A,B) :- redpred_64(A,B)
p416(A,B) :- copy1(A,C),p416_1(C,B)
p416_1(A,B) :- redpred_72(A,B)
p420(A,B) :- p225(A,C),p420_1(C,B)
p420_1(A,B) :- redpred_38(A,B)
...
p274(A,B) :- redpred_122(A,B)
p281(A,B) :- mk_uppercase(A,C),p281_1(C,B)
p281_1(A,B) :- redpred_123(A,B)
p284(A,B) :- redpred_124(A,B)
...
p354(A,B) :- redpred_109(A,B)
p356(A,B) :- p225(A,C),p75(C,B)
p360(A,B) :- redpred_126(A,B)
...
p580(A,B) :- redpred_134(A,B)
p581(A,B) :- p112(A,C),p712(C,B)
p588(A,B) :- redpred_136(A,B)
...
p637(A,B) :- redpred_131(A,B)
p639(A,B) :- redpred_137(A,B)
...
p747(A,B) :- redpred_119(A,B)
p748(A,B) :- p137_1(A,C),p245(C,B)
p751(A,B) :- redpred_136(A,B)
p755(A,B) :- redpred_114(A,B)
p757(A,B) :- redpred_113(A,B)
p764(A,B) :- redpred_141(A,B)
p765(A,B) :- p10(A,C),p185(C,B)
p767(A,B) :- redpred_129(A,B)
...
p858(A,B) :- redpred_145(A,B)
p860(A,B) :- redpred_146(A,B)
...
p1085(A,B) :- redpred_152(A,B)
p1088(A,B) :- p66_1(A,C),p148(C,B)
p1090(A,B) :- redpred_143(A,B)
p1093(A,B) :- redpred_127(A,B)
p1097(A,B) :- redpred_144(A,B)
...
p1296_1(A,B) :- redpred_156(A,B)
p1300(A,B) :- redpred_141(A,B)
...
p1308(A,B) :- redpred_157(A,B)
p1310(A,B) :- redpred_130(A,B)
...
p1428(A,B) :- redpred_125(A,B)
p1429(A,B) :- redpred_125(A,B)
...
p1544(A,B) :- redpred_152(A,B)
p1548(A,B) :- p46(A,C),p1576(C,B)
p1549(A,B) :- redpred_122(A,B)
...
p1570(A,B) :- redpred_125(A,B)
p1579(A,B) :- p10(A,C),p177(C,B)
p1584(A,B) :- redpred_162(A,B)
p1587(A,B) :- redpred_130(A,B)
p1588(A,B) :- p454(A,C),p357(C,B)
p1591(A,B) :- skip1(A,C),p1062(C,B)
p1593(A,B) :- redpred_154(A,B)
...
p2038(A,B) :- redpred_115(A,B)
p2039(A,B) :- p225(A,C),p2039_1(C,B)
p2039_1(A,B) :- redpred_128(A,B)
...
p2085(A,B) :- redpred_160(A,B)
p2086(A,B) :- redpred_162(A,B)
...
p2163_1(A,B) :- redpred_149(A,B)
p2164(A,B) :- p283(A,C),p36(C,B)
p2168(A,B) :- redpred_163(A,B)
...
p1205_1(A,B) :- redpred_165(A,B)
p1210(A,B) :- skip1(A,C),p1210_1(C,B)
p1210_1(A,B) :- redpred_164(A,B)
