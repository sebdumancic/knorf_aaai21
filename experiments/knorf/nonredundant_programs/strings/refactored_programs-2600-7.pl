...
redpred_17(A,B) :- skip1(A,C),p1286(C,B)
redpred_18(A,B) :- skip1(A,C),p15(C,B)
redpred_19(A,B) :- skip1(A,C),p21(C,B)
redpred_20(A,B) :- p28(A,C),p28(C,B)
redpred_21(A,B) :- p83(A,C),p22(C,B)
redpred_22(A,B) :- p83(A,C),p235(C,B)
redpred_23(A,B) :- p28(A,C),p235(C,B)
redpred_24(A,B) :- skip1(A,C),p28(C,B)
redpred_25(A,B) :- skip1(A,C),p83(C,B)
redpred_26(A,B) :- p83(A,C),p62(C,B)
redpred_27(A,B) :- copy1(A,C),p21(C,B)
redpred_28(A,B) :- p15(A,C),p28(C,B)
redpred_29(A,B) :- p28(A,C),p83(C,B)
redpred_30(A,B) :- p83(A,C),p83(C,B)
redpred_31(A,B) :- p28(A,C),p15(C,B)
redpred_32(A,B) :- p15(A,C),p83(C,B)
redpred_33(A,B) :- p83(A,C),p21(C,B)
redpred_34(A,B) :- copy1(A,C),p77(C,B)
redpred_35(A,B) :- skip1(A,C),p62(C,B)
redpred_36(A,B) :- p83(A,C),p28(C,B)
redpred_37(A,B) :- skip1(A,C),p235(C,B)
redpred_38(A,B) :- p21(A,C),p83(C,B)
redpred_39(A,B) :- p83(A,C),p1286(C,B)
redpred_40(A,B) :- p235(A,C),p15(C,B)
redpred_41(A,B) :- skip1(A,C),p38(C,B)
redpred_42(A,B) :- p234(A,C),p83(C,B)
redpred_43(A,B) :- p28(A,C),p21(C,B)
redpred_44(A,B) :- copy1(A,C),p28(C,B)
redpred_45(A,B) :- copy1(A,C),p83(C,B)
redpred_46(A,B) :- p21(A,C),p15(C,B)
redpred_47(A,B) :- p15(A,C),p21(C,B)
redpred_48(A,B) :- copy1(A,C),p62(C,B)
redpred_49(A,B) :- p77(A,C),p235(C,B)
redpred_50(A,B) :- skip1(A,C),p77(C,B)
redpred_51(A,B) :- copy1(A,C),p235(C,B)
redpred_52(A,B) :- p83(A,C),p77(C,B)
redpred_53(A,B) :- mk_lowercase(A,C),p28(C,B)
redpred_54(A,B) :- p62(A,C),p22(C,B)
redpred_55(A,B) :- p83(A,C),p15(C,B)
redpred_56(A,B) :- p22(A,C),p235(C,B)
redpred_57(A,B) :- p62(A,C),p83(C,B)
redpred_58(A,B) :- skip1(A,C),p1388(C,B)
redpred_59(A,B) :- p1286(A,C),p83(C,B)
redpred_60(A,B) :- p22(A,C),p83(C,B)
redpred_61(A,B) :- p21(A,C),p28(C,B)
redpred_62(A,B) :- p62(A,C),p28(C,B)
redpred_63(A,B) :- copy1(A,C),p38(C,B)
redpred_64(A,B) :- p234(A,C),p28(C,B)
redpred_65(A,B) :- mk_uppercase(A,C),p22(C,B)
redpred_66(A,B) :- mk_lowercase(A,C),p83(C,B)
redpred_67(A,B) :- p83(A,C),p1388(C,B)
redpred_68(A,B) :- p28(A,C),p22(C,B)
redpred_69(A,B) :- p28(A,C),p62(C,B)
redpred_70(A,B) :- p77(A,C),p28(C,B)
redpred_71(A,B) :- skip1(A,C),p22(C,B)
redpred_72(A,B) :- p21(A,C),p62(C,B)
redpred_73(A,B) :- p21(A,C),p235(C,B)
redpred_74(A,B) :- copy1(A,C),p22(C,B)
redpred_75(A,B) :- copy1(A,C),p234(C,B)
redpred_76(A,B) :- copy1(A,C),p15(C,B)
redpred_77(A,B) :- p15(A,C),p234(C,B)
redpred_78(A,B) :- p77(A,C),p83(C,B)
redpred_79(A,B) :- p234(A,C),p15(C,B)
redpred_80(A,B) :- mk_uppercase(A,C),p21(C,B)
redpred_81(A,B) :- p77(A,C),p77(C,B)
redpred_82(A,B) :- mk_uppercase(A,C),p77(C,B)
redpred_83(A,B) :- p1388(A,C),p28(C,B)
redpred_84(A,B) :- p15(A,C),p15(C,B)
redpred_85(A,B) :- p38(A,C),p83(C,B)
redpred_86(A,B) :- p235(A,C),p21(C,B)
redpred_87(A,B) :- p235(A,C),p77(C,B)
redpred_88(A,B) :- p28(A,C),p77(C,B)
redpred_89(A,B) :- mk_lowercase(A,C),p15(C,B)
redpred_90(A,B) :- p235(A,C),p83(C,B)
redpred_91(A,B) :- p15(A,C),p38(C,B)
redpred_92(A,B) :- p235(A,C),p28(C,B)
redpred_93(A,B) :- p62(A,C),p62(C,B)
redpred_94(A,B) :- mk_uppercase(A,C),p28(C,B)
redpred_95(A,B) :- p22(A,C),p62(C,B)
redpred_96(A,B) :- p38(A,C),p21(C,B)
redpred_97(A,B) :- p83(A,C),p234(C,B)
redpred_98(A,B) :- mk_uppercase(A,C),p235(C,B)
redpred_99(A,B) :- p77(A,C),p15(C,B)
redpred_100(A,B) :- p77(A,C),p38(C,B)
redpred_101(A,B) :- mk_uppercase(A,C),p83(C,B)
redpred_102(A,B) :- p21(A,C),p22(C,B)
redpred_103(A,B) :- skip1(A,C),p234(C,B)
redpred_104(A,B) :- p77(A,C),p22(C,B)
redpred_105(A,B) :- p22(A,C),p28(C,B)
redpred_106(A,B) :- p28(A,C),p38(C,B)
redpred_107(A,B) :- p15(A,C),p62(C,B)
redpred_108(A,B) :- p235(A,C),p62(C,B)
redpred_109(A,B) :- p235(A,C),p235(C,B)
redpred_110(A,B) :- p15(A,C),p22(C,B)
redpred_111(A,B) :- mk_lowercase(A,C),p21(C,B)
redpred_112(A,B) :- p28(A,C),p1286(C,B)
redpred_113(A,B) :- p70(A,C),p444_1(C,B)
redpred_114(A,B) :- p77(A,C),p70(C,B)
redpred_115(A,B) :- skip1(A,C),p70(C,B)
redpred_116(A,B) :- skip1(A,C),p39(C,B)
redpred_117(A,B) :- p891(A,C),p271(C,B)
redpred_118(A,B) :- p1441(A,C),p435(C,B)
redpred_119(A,B) :- p408(A,C),p83(C,B)
redpred_120(A,B) :- p70(A,C),p108(C,B)
redpred_121(A,B) :- skip1(A,C),p2129(C,B)
redpred_122(A,B) :- skip1(A,C),p526(C,B)
redpred_123(A,B) :- copy1(A,C),p39(C,B)
redpred_124(A,B) :- p27(A,C),p1348(C,B)
redpred_125(A,B) :- p435(A,C),p7(C,B)
redpred_126(A,B) :- p22(A,C),p6(C,B)
redpred_127(A,B) :- skip1(A,C),p55(C,B)
redpred_128(A,B) :- p19(A,C),p404(C,B)
redpred_129(A,B) :- mk_lowercase(A,C),p1081(C,B)
redpred_130(A,B) :- copy1(A,C),p817(C,B)
redpred_131(A,B) :- p1081(A,C),p28(C,B)
redpred_132(A,B) :- p192(A,C),p108(C,B)
redpred_133(A,B) :- p829(A,C),p28(C,B)
redpred_134(A,B) :- copy1(A,C),p487(C,B)
redpred_135(A,B) :- skip1(A,C),p81(C,B)
redpred_136(A,B) :- p235(A,C),p1804(C,B)
redpred_137(A,B) :- p1503(A,C),p1927(C,B)
redpred_138(A,B) :- p108(A,C),p30(C,B)
redpred_139(A,B) :- p1348(A,C),p465_1(C,B)
redpred_140(A,B) :- skip1(A,C),p6(C,B)
redpred_141(A,B) :- p775(A,C),p28(C,B)
redpred_142(A,B) :- copy1(A,C),p7(C,B)
redpred_143(A,B) :- copy1(A,C),p1410(C,B)
redpred_144(A,B) :- p28(A,C),p817(C,B)
redpred_145(A,B) :- p30(A,C),p171_1(C,B)
redpred_146(A,B) :- skip1(A,C),p1927(C,B)
redpred_147(A,B) :- mk_uppercase(A,C),p526(C,B)
redpred_148(A,B) :- mk_uppercase(A,C),p39(C,B)
redpred_149(A,B) :- p28(A,C),p2238(C,B)
redpred_150(A,B) :- p1081(A,C),p1093(C,B)
redpred_151(A,B) :- skip1(A,C),p1084(C,B)
redpred_152(A,B) :- p18(A,C),p39(C,B)
redpred_153(A,B) :- copy1(A,C),p271(C,B)
redpred_154(A,B) :- skip1(A,C),p676(C,B)
redpred_155(A,B) :- copy1(A,C),p30(C,B)
redpred_156(A,B) :- mk_lowercase(A,C),p70(C,B)
redpred_157(A,B) :- p28(A,C),p1927(C,B)
redpred_158(A,B) :- p70(A,C),p891(C,B)
redpred_159(A,B) :- p83(A,C),p1927(C,B)
redpred_160(A,B) :- p192(A,C),p51_1(C,B)
redpred_161(A,B) :- p28(A,C),p81(C,B)
redpred_162(A,B) :- copy1(A,C),p70(C,B)
redpred_163(A,B) :- skip1(A,C),p7(C,B)
redpred_164(A,B) :- p192(A,C),p62(C,B)
redpred_165(A,B) :- p235(A,C),p367(C,B)
redpred_166(A,B) :- p83(A,C),p676(C,B)
redpred_167(A,B) :- skip1(A,C),p1850(C,B)
redpred_168(A,B) :- p332(A,C),p62(C,B)
redpred_169(A,B) :- p28(A,C),p159(C,B)
redpred_170(A,B) :- p28(A,C),p941(C,B)
redpred_171(A,B) :- copy1(A,C),p276(C,B)
redpred_172(A,B) :- p526(A,C),mk_lowercase(C,B)
redpred_173(A,B) :- copy1(A,C),p1484(C,B)
redpred_174(A,B) :- skip1(A,C),p271(C,B)
redpred_175(A,B) :- p70(A,C),p21(C,B)
redpred_176(A,B) :- copy1(A,C),p159(C,B)
redpred_177(A,B) :- p171_1(A,C),p6_1(C,B)
redpred_178(A,B) :- skip1(A,C),p332(C,B)
redpred_179(A,B) :- skip1(A,C),p1416(C,B)
redpred_180(A,B) :- p39(A,C),p1084(C,B)
redpred_181(A,B) :- copy1(A,C),p81(C,B)
redpred_182(A,B) :- mk_uppercase(A,C),p1927(C,B)
redpred_183(A,B) :- p1289(A,C),p292(C,B)
redpred_184(A,B) :- p28(A,C),p1348(C,B)
redpred_185(A,B) :- skip1(A,C),p1914_1(C,B)
redpred_186(A,B) :- p1981(A,C),p28(C,B)
redpred_187(A,B) :- skip1(A,C),p1265(C,B)
...
p804(A,B) :- redpred_12(A,B)
p805(A,B) :- redpred_5(A,B)
p808(A,B) :- redpred_10(A,B)
p810(A,B) :- redpred_11(A,B)
...
p909(A,B) :- redpred_10(A,B)
p910(A,B) :- redpred_12(A,B)
p911(A,B) :- redpred_1(A,B)
p913(A,B) :- redpred_6(A,B)
p917(A,B) :- redpred_14(A,B)
...
p1444(A,B) :- redpred_10(A,B)
p1445(A,B) :- redpred_5(A,B)
p1446(A,B) :- redpred_1(A,B)
p1447(A,B) :- redpred_10(A,B)
...
p1472(A,B) :- redpred_10(A,B)
p1474(A,B) :- redpred_12(A,B)
p1479(A,B) :- redpred_11(A,B)
...
p1568(A,B) :- redpred_10(A,B)
p1575(A,B) :- redpred_5(A,B)
p1582(A,B) :- redpred_3(A,B)
p1583(A,B) :- redpred_14(A,B)
...
p1675(A,B) :- redpred_9(A,B)
p1676(A,B) :- redpred_11(A,B)
p1678(A,B) :- redpred_10(A,B)
...
p1767(A,B) :- redpred_11(A,B)
p1782(A,B) :- redpred_10(A,B)
...
p2219(A,B) :- redpred_12(A,B)
p2235(A,B) :- redpred_11(A,B)
p2237(A,B) :- redpred_10(A,B)
...
p2369(A,B) :- redpred_10(A,B)
p2370(A,B) :- redpred_3(A,B)
p2372(A,B) :- redpred_10(A,B)
...
p2441(A,B) :- redpred_16(A,B)
p2449(A,B) :- redpred_11(A,B)
p2451(A,B) :- redpred_12(A,B)
...
p10_1(A,B) :- redpred_22(A,B)
p12(A,B) :- redpred_23(A,B)
p18(A,B) :- redpred_24(A,B)
p19(A,B) :- redpred_25(A,B)
...
p65(A,B) :- redpred_36(A,B)
p69(A,B) :- p83(A,C),p69_1(C,B)
p69_1(A,B) :- redpred_30(A,B)
p70(A,B) :- skip1(A,C),p70_1(C,B)
p70_1(A,B) :- redpred_25(A,B)
p71(A,B) :- redpred_37(A,B)
...
p81_1(A,B) :- redpred_25(A,B)
p84(A,B) :- p83(A,C),p84_1(C,B)
p84_1(A,B) :- redpred_39(A,B)
p86(A,B) :- copy1(A,C),p86_1(C,B)
p86_1(A,B) :- redpred_40(A,B)
...
p209_1(A,B) :- redpred_20(A,B)
p214(A,B) :- redpred_29(A,B)
p219(A,B) :- redpred_31(A,B)
...
p510_1(A,B) :- redpred_73(A,B)
p513(A,B) :- redpred_74(A,B)
p515(A,B) :- redpred_75(A,B)
...
p966_1(A,B) :- redpred_35(A,B)
p968(A,B) :- mk_uppercase(A,C),p968_1(C,B)
p968_1(A,B) :- redpred_87(A,B)
...
p998_1(A,B) :- redpred_39(A,B)
p999(A,B) :- redpred_93(A,B)
p1008(A,B) :- redpred_29(A,B)
p1009(A,B) :- redpred_45(A,B)
p1013(A,B) :- redpred_74(A,B)
p1016(A,B) :- redpred_98(A,B)
p1017(A,B) :- redpred_52(A,B)
p1020(A,B) :- redpred_44(A,B)
p1021(A,B) :- mk_lowercase(A,C),p1021_1(C,B)
p1021_1(A,B) :- redpred_99(A,B)
p1025(A,B) :- redpred_29(A,B)
p1028(A,B) :- redpred_28(A,B)
p1030(A,B) :- p62(A,C),p1030_1(C,B)
p1030_1(A,B) :- redpred_43(A,B)
p1041(A,B) :- redpred_31(A,B)
p1042(A,B) :- skip1(A,C),p1042_1(C,B)
p1042_1(A,B) :- redpred_20(A,B)
p1045(A,B) :- redpred_79(A,B)
p1046(A,B) :- mk_uppercase(A,C),p1046_1(C,B)
p1046_1(A,B) :- redpred_21(A,B)
...
p1370_1(A,B) :- redpred_20(A,B)
p1372(A,B) :- redpred_29(A,B)
p1374(A,B) :- p28(A,C),p1374_1(C,B)
p1374_1(A,B) :- redpred_96(A,B)
p1376(A,B) :- p22(A,C),p1376_1(C,B)
p1376_1(A,B) :- redpred_99(A,B)
p1377(A,B) :- redpred_101(A,B)
p1379(A,B) :- copy1(A,C),p1379_1(C,B)
p1379_1(A,B) :- redpred_35(A,B)
p1380(A,B) :- copy1(A,C),p1380_1(C,B)
p1380_1(A,B) :- redpred_85(A,B)
p1381(A,B) :- skip1(A,C),p1381_1(C,B)
p1381_1(A,B) :- redpred_50(A,B)
p1383(A,B) :- mk_lowercase(A,C),p1383_1(C,B)
p1383_1(A,B) :- redpred_36(A,B)
p1386(A,B) :- redpred_101(A,B)
p1390(A,B) :- p28(A,C),p1390_1(C,B)
p1390_1(A,B) :- redpred_97(A,B)
p1391(A,B) :- p22(A,C),p1391_1(C,B)
p1391_1(A,B) :- p38(A,C),p22(C,B)
p1392(A,B) :- redpred_41(A,B)
p1395(A,B) :- skip1(A,C),p1395_1(C,B)
p1395_1(A,B) :- redpred_104(A,B)
p1399(A,B) :- redpred_52(A,B)
...
p1889_1(A,B) :- redpred_107(A,B)
p1894(A,B) :- redpred_29(A,B)
p1896(A,B) :- redpred_49(A,B)
p1900(A,B) :- redpred_24(A,B)
p1901(A,B) :- p77(A,C),p1901_1(C,B)
p1901_1(A,B) :- redpred_61(A,B)
p1903(A,B) :- redpred_44(A,B)
p1906(A,B) :- copy1(A,C),p1906_1(C,B)
p1906_1(A,B) :- redpred_58(A,B)
p1907(A,B) :- copy1(A,C),p1907_1(C,B)
p1907_1(A,B) :- redpred_108(A,B)
p1911(A,B) :- redpred_94(A,B)
...
p188(A,B) :- redpred_124(A,B)
p191(A,B) :- redpred_121(A,B)
p193(A,B) :- redpred_125(A,B)
...
p291(A,B) :- redpred_129(A,B)
p295(A,B) :- redpred_130(A,B)
...
p484_1(A,B) :- redpred_139(A,B)
p488(A,B) :- redpred_140(A,B)
p494(A,B) :- redpred_127(A,B)
p496(A,B) :- p48_1(A,C),p174(C,B)
p497(A,B) :- redpred_141(A,B)
p498(A,B) :- p7_1(A,C),p510(C,B)
p499(A,B) :- redpred_142(A,B)
...
p532(A,B) :- redpred_145(A,B)
p533(A,B) :- skip1(A,C),p440(C,B)
p539(A,B) :- redpred_146(A,B)
...
p627(A,B) :- redpred_150(A,B)
p631(A,B) :- redpred_151(A,B)
...
p762_1(A,B) :- redpred_160(A,B)
p770(A,B) :- p12(A,C),p1431(C,B)
p773(A,B) :- redpred_161(A,B)
...
p821_1(A,B) :- redpred_140(A,B)
p822(A,B) :- redpred_148(A,B)
p825(A,B) :- redpred_163(A,B)
...
p1014(A,B) :- redpred_131(A,B)
p1019(A,B) :- redpred_165(A,B)
...
p1116(A,B) :- redpred_149(A,B)
p1117(A,B) :- redpred_115(A,B)
p1118(A,B) :- skip1(A,C),p1118_1(C,B)
p1118_1(A,B) :- redpred_122(A,B)
p1119(A,B) :- p906(A,C),p83(C,B)
p1120(A,B) :- p30_1(A,C),p1296(C,B)
p1122(A,B) :- redpred_167(A,B)
p1123(A,B) :- copy1(A,C),p6(C,B)
p1124(A,B) :- redpred_168(A,B)
p1128(A,B) :- redpred_169(A,B)
...
p1260(A,B) :- redpred_168(A,B)
p1265(A,B) :- skip1(A,C),p1265_1(C,B)
p1265_1(A,B) :- redpred_116(A,B)
p1268(A,B) :- p444_1(A,C),p951(C,B)
p1270(A,B) :- redpred_132(A,B)
...
p1580(A,B) :- redpred_162(A,B)
p1581(A,B) :- redpred_147(A,B)
...
p1773(A,B) :- redpred_170(A,B)
p1774(A,B) :- p19(A,C),p834(C,B)
p1775(A,B) :- redpred_116(A,B)
...
p1808_1(A,B) :- redpred_175(A,B)
p1810(A,B) :- p28(A,C),p367(C,B)
p1819(A,B) :- redpred_155(A,B)
...
p1831_1(A,B) :- redpred_137(A,B)
p1832(A,B) :- p605(A,C),p1825(C,B)
p1833(A,B) :- redpred_129(A,B)
...
p1862(A,B) :- redpred_181(A,B)
p1863(A,B) :- redpred_182(A,B)
...
p1966(A,B) :- redpred_132(A,B)
p1967(A,B) :- skip1(A,C),p1967_1(C,B)
p1967_1(A,B) :- redpred_180(A,B)
...
p2067(A,B) :- redpred_156(A,B)
p2069(A,B) :- redpred_182(A,B)
...
p2190_1(A,B) :- redpred_174(A,B)
p2192(A,B) :- skip1(A,C),p2192_1(C,B)
p2192_1(A,B) :- redpred_172(A,B)
...
p2334_1(A,B) :- redpred_154(A,B)
p2342(A,B) :- p83(A,C),p817(C,B)
p2343(A,B) :- redpred_162(A,B)
...
p1125_1(A,B) :- redpred_187(A,B)
p1126(A,B) :- mk_lowercase(A,C),p1126_1(C,B)
p1126_1(A,B) :- redpred_187(A,B)
