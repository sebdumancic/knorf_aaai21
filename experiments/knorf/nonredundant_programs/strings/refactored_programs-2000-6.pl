...
redpred_17(A,B) :- skip1(A,C),p11(C,B)
redpred_18(A,B) :- p16(A,C),p154(C,B)
redpred_19(A,B) :- skip1(A,C),p44(C,B)
redpred_20(A,B) :- p44(A,C),p44(C,B)
redpred_21(A,B) :- skip1(A,C),p16(C,B)
redpred_22(A,B) :- copy1(A,C),p58(C,B)
redpred_23(A,B) :- p16(A,C),p124(C,B)
redpred_24(A,B) :- copy1(A,C),p44(C,B)
redpred_25(A,B) :- mk_lowercase(A,C),p16(C,B)
redpred_26(A,B) :- p16(A,C),p295(C,B)
redpred_27(A,B) :- skip1(A,C),p190(C,B)
redpred_28(A,B) :- p190(A,C),p16(C,B)
redpred_29(A,B) :- mk_lowercase(A,C),p44(C,B)
redpred_30(A,B) :- p11(A,C),p16(C,B)
redpred_31(A,B) :- p58(A,C),p44(C,B)
redpred_32(A,B) :- skip1(A,C),p58(C,B)
redpred_33(A,B) :- skip1(A,C),p295(C,B)
redpred_34(A,B) :- p44(A,C),p124(C,B)
redpred_35(A,B) :- skip1(A,C),p124(C,B)
redpred_36(A,B) :- p44(A,C),p534(C,B)
redpred_37(A,B) :- p295(A,C),p44(C,B)
redpred_38(A,B) :- p44(A,C),p154(C,B)
redpred_39(A,B) :- p154(A,C),p11(C,B)
redpred_40(A,B) :- p190(A,C),p44(C,B)
redpred_41(A,B) :- p16(A,C),p16(C,B)
redpred_42(A,B) :- p124(A,C),p295(C,B)
redpred_43(A,B) :- copy1(A,C),p16(C,B)
redpred_44(A,B) :- p58(A,C),p190(C,B)
redpred_45(A,B) :- p44(A,C),p16(C,B)
redpred_46(A,B) :- p124(A,C),p16(C,B)
redpred_47(A,B) :- p44(A,C),p295(C,B)
redpred_48(A,B) :- skip1(A,C),p29(C,B)
redpred_49(A,B) :- p124(A,C),p44(C,B)
redpred_50(A,B) :- copy1(A,C),p124(C,B)
redpred_51(A,B) :- p295(A,C),p16(C,B)
redpred_52(A,B) :- p29(A,C),p44(C,B)
redpred_53(A,B) :- p16(A,C),p44(C,B)
redpred_54(A,B) :- p44(A,C),p753(C,B)
redpred_55(A,B) :- skip1(A,C),p277(C,B)
redpred_56(A,B) :- mk_uppercase(A,C),p16(C,B)
redpred_57(A,B) :- p44(A,C),p11(C,B)
redpred_58(A,B) :- p11(A,C),p44(C,B)
redpred_59(A,B) :- p154(A,C),p44(C,B)
redpred_60(A,B) :- p154(A,C),p16(C,B)
redpred_61(A,B) :- p295(A,C),p190(C,B)
redpred_62(A,B) :- copy1(A,C),p753(C,B)
redpred_63(A,B) :- p295(A,C),p58(C,B)
redpred_64(A,B) :- copy1(A,C),p295(C,B)
redpred_65(A,B) :- p16(A,C),p11(C,B)
redpred_66(A,B) :- mk_uppercase(A,C),p44(C,B)
redpred_67(A,B) :- p44(A,C),p190(C,B)
redpred_68(A,B) :- p16(A,C),p58(C,B)
redpred_69(A,B) :- skip1(A,C),p154(C,B)
redpred_70(A,B) :- copy1(A,C),p190(C,B)
redpred_71(A,B) :- mk_uppercase(A,C),p190(C,B)
redpred_72(A,B) :- p58(A,C),p16(C,B)
redpred_73(A,B) :- p11(A,C),p58(C,B)
redpred_74(A,B) :- mk_uppercase(A,C),p124(C,B)
redpred_75(A,B) :- copy1(A,C),p154(C,B)
redpred_76(A,B) :- p44(A,C),p58(C,B)
redpred_77(A,B) :- p753(A,C),p16(C,B)
redpred_78(A,B) :- copy1(A,C),p11(C,B)
redpred_79(A,B) :- p16(A,C),p190(C,B)
redpred_80(A,B) :- p295(A,C),p295(C,B)
redpred_81(A,B) :- p154(A,C),p190(C,B)
redpred_82(A,B) :- p295(A,C),p29(C,B)
redpred_83(A,B) :- p44(A,C),p277(C,B)
redpred_84(A,B) :- mk_lowercase(A,C),p295(C,B)
redpred_85(A,B) :- p753(A,C),p58(C,B)
redpred_86(A,B) :- p753(A,C),p154(C,B)
redpred_87(A,B) :- p295(A,C),p154(C,B)
redpred_88(A,B) :- p11(A,C),p11(C,B)
redpred_89(A,B) :- mk_uppercase(A,C),p11(C,B)
redpred_90(A,B) :- p154(A,C),p154(C,B)
redpred_91(A,B) :- p29(A,C),p16(C,B)
redpred_92(A,B) :- p190(A,C),p190(C,B)
redpred_93(A,B) :- p277(A,C),p16(C,B)
redpred_94(A,B) :- skip1(A,C),p753(C,B)
redpred_95(A,B) :- p16(A,C),p29(C,B)
redpred_96(A,B) :- p534(A,C),p16(C,B)
redpred_97(A,B) :- skip1(A,C),p752(C,B)
redpred_98(A,B) :- p22_1(A,C),p89_1(C,B)
redpred_99(A,B) :- p143(A,C),p200(C,B)
redpred_100(A,B) :- p44(A,C),p22(C,B)
redpred_101(A,B) :- copy1(A,C),p147(C,B)
redpred_102(A,B) :- p16(A,C),p887(C,B)
redpred_103(A,B) :- p59(A,C),p995(C,B)
redpred_104(A,B) :- skip1(A,C),p134(C,B)
redpred_105(A,B) :- skip1(A,C),p113(C,B)
redpred_106(A,B) :- p356_1(A,C),p1869(C,B)
redpred_107(A,B) :- p22_1(A,C),p24(C,B)
redpred_108(A,B) :- skip1(A,C),p22(C,B)
redpred_109(A,B) :- p40(A,C),p503(C,B)
redpred_110(A,B) :- p16(A,C),p254(C,B)
redpred_111(A,B) :- skip1(A,C),p200(C,B)
redpred_112(A,B) :- p1162(A,C),p200(C,B)
redpred_113(A,B) :- p46(A,C),p1869(C,B)
redpred_114(A,B) :- p30(A,C),p308(C,B)
redpred_115(A,B) :- skip1(A,C),p1869(C,B)
redpred_116(A,B) :- p83_1(A,C),p40(C,B)
redpred_117(A,B) :- p16(A,C),p970(C,B)
redpred_118(A,B) :- p1162(A,C),p570(C,B)
redpred_119(A,B) :- copy1(A,C),p22(C,B)
redpred_120(A,B) :- p22_1(A,C),p613(C,B)
redpred_121(A,B) :- p106(A,C),p24(C,B)
redpred_122(A,B) :- p148(A,C),p350(C,B)
redpred_123(A,B) :- p22(A,C),p154(C,B)
redpred_124(A,B) :- skip1(A,C),p1162(C,B)
redpred_125(A,B) :- p40(A,C),p24(C,B)
redpred_126(A,B) :- skip1(A,C),p254(C,B)
redpred_127(A,B) :- skip1(A,C),p1309(C,B)
redpred_128(A,B) :- skip1(A,C),p168(C,B)
redpred_129(A,B) :- skip1(A,C),p1066(C,B)
redpred_130(A,B) :- copy1(A,C),p613(C,B)
redpred_131(A,B) :- p16(A,C),p1409(C,B)
redpred_132(A,B) :- skip1(A,C),p848(C,B)
redpred_133(A,B) :- copy1(A,C),p1067(C,B)
redpred_134(A,B) :- p44(A,C),p200(C,B)
redpred_135(A,B) :- p1205(A,C),p143(C,B)
redpred_136(A,B) :- copy1(A,C),p970(C,B)
redpred_137(A,B) :- copy1(A,C),p345(C,B)
redpred_138(A,B) :- p83_1(A,C),p660(C,B)
redpred_139(A,B) :- p40(A,C),p1048(C,B)
redpred_140(A,B) :- p1205(A,C),p40(C,B)
redpred_141(A,B) :- skip1(A,C),p1048(C,B)
redpred_142(A,B) :- copy1(A,C),p168(C,B)
redpred_143(A,B) :- p22_1(A,C),p254(C,B)
redpred_144(A,B) :- p83(A,C),p16(C,B)
redpred_145(A,B) :- copy1(A,C),p752(C,B)
redpred_146(A,B) :- p152(A,C),p211(C,B)
redpred_147(A,B) :- skip1(A,C),p60(C,B)
redpred_148(A,B) :- p22(A,C),p24(C,B)
redpred_149(A,B) :- p295(A,C),p611(C,B)
redpred_150(A,B) :- copy1(A,C),p200(C,B)
redpred_151(A,B) :- p16(A,C),p1490(C,B)
redpred_152(A,B) :- p152(A,C),p137_1(C,B)
redpred_153(A,B) :- skip1(A,C),p1067(C,B)
redpred_154(A,B) :- skip1(A,C),p970(C,B)
redpred_155(A,B) :- skip1(A,C),p447(C,B)
redpred_156(A,B) :- skip1(A,C),p247(C,B)
redpred_157(A,B) :- p44(A,C),p1048(C,B)
redpred_158(A,B) :- p40(A,C),p83_1(C,B)
...
p1564(A,B) :- redpred_11(A,B)
p1566(A,B) :- redpred_14(A,B)
...
p75_1(A,B) :- redpred_32(A,B)
p78(A,B) :- mk_uppercase(A,C),p78_1(C,B)
p78_1(A,B) :- redpred_21(A,B)
...
p1108_1(A,B) :- redpred_91(A,B)
p1113(A,B) :- redpred_19(A,B)
p1116(A,B) :- redpred_19(A,B)
p1118(A,B) :- redpred_41(A,B)
p1120(A,B) :- redpred_59(A,B)
p1122(A,B) :- p44(A,C),p1122_1(C,B)
p1122_1(A,B) :- redpred_42(A,B)
...
p1181(A,B) :- redpred_69(A,B)
p1182(A,B) :- skip1(A,C),p1182_1(C,B)
p1182_1(A,B) :- p154(A,C),p124(C,B)
p1189(A,B) :- p58(A,C),p1189_1(C,B)
p1189_1(A,B) :- redpred_45(A,B)
p1190(A,B) :- mk_uppercase(A,C),p1190_1(C,B)
p1190_1(A,B) :- redpred_18(A,B)
p1194(A,B) :- redpred_41(A,B)
p1199(A,B) :- redpred_35(A,B)
p1200(A,B) :- mk_uppercase(A,C),p1200_1(C,B)
p1200_1(A,B) :- redpred_20(A,B)
p1201(A,B) :- redpred_72(A,B)
p1204(A,B) :- redpred_19(A,B)
...
p1209_1(A,B) :- redpred_92(A,B)
p1210(A,B) :- redpred_27(A,B)
p1212(A,B) :- redpred_21(A,B)
p1220(A,B) :- skip1(A,C),p1220_1(C,B)
p1220_1(A,B) :- redpred_67(A,B)
p1226(A,B) :- p44(A,C),p1226_1(C,B)
p1226_1(A,B) :- redpred_21(A,B)
p1227(A,B) :- p44(A,C),p1227_1(C,B)
p1227_1(A,B) :- redpred_79(A,B)
p1231(A,B) :- redpred_21(A,B)
...
p1764_1(A,B) :- redpred_41(A,B)
p1766(A,B) :- redpred_24(A,B)
p1767(A,B) :- redpred_50(A,B)
p1774(A,B) :- copy1(A,C),p1774_1(C,B)
p1774_1(A,B) :- redpred_32(A,B)
p1775(A,B) :- skip1(A,C),p1775_1(C,B)
p1775_1(A,B) :- redpred_46(A,B)
p1777(A,B) :- redpred_64(A,B)
...
p17(A,B) :- redpred_98(A,B)
p18(A,B) :- p143(A,C),p1800(C,B)
p20(A,B) :- redpred_99(A,B)
...
p138(A,B) :- redpred_106(A,B)
p139(A,B) :- p134(A,C),p60(C,B)
p141(A,B) :- redpred_107(A,B)
p146(A,B) :- p241(A,C),p144(C,B)
p155(A,B) :- redpred_108(A,B)
...
p180(A,B) :- redpred_108(A,B)
p185(A,B) :- p1381(A,C),p35(C,B)
p188(A,B) :- redpred_109(A,B)
...
p504(A,B) :- redpred_129(A,B)
p505(A,B) :- p1416(A,C),p1205(C,B)
p509(A,B) :- redpred_103(A,B)
...
p578(A,B) :- redpred_133(A,B)
p579(A,B) :- p30(A,C),p752(C,B)
p582(A,B) :- redpred_113(A,B)
...
p733(A,B) :- redpred_136(A,B)
p735(A,B) :- p40(A,C),p1063(C,B)
p736(A,B) :- redpred_101(A,B)
p737(A,B) :- redpred_137(A,B)
...
p747_1(A,B) :- redpred_127(A,B)
p749(A,B) :- p152(A,C),p365(C,B)
p750(A,B) :- redpred_126(A,B)
...
p879_1(A,B) :- redpred_111(A,B)
p880(A,B) :- redpred_137(A,B)
p882(A,B) :- p124(A,C),p60(C,B)
p884(A,B) :- mk_uppercase(A,C),p884_1(C,B)
p884_1(A,B) :- p1513(A,C),p502(C,B)
p885(A,B) :- redpred_130(A,B)
p889(A,B) :- redpred_124(A,B)
...
p1052(A,B) :- redpred_143(A,B)
p1053(A,B) :- copy1(A,C),p1053_1(C,B)
p1053_1(A,B) :- redpred_135(A,B)
p1056(A,B) :- copy1(A,C),p1056_1(C,B)
p1056_1(A,B) :- redpred_123(A,B)
...
p1157(A,B) :- redpred_149(A,B)
p1158(A,B) :- redpred_150(A,B)
...
p1224(A,B) :- redpred_152(A,B)
p1225(A,B) :- redpred_153(A,B)
...
p1344(A,B) :- redpred_150(A,B)
p1345(A,B) :- redpred_150(A,B)
p1348(A,B) :- mk_lowercase(A,C),p1348_1(C,B)
p1348_1(A,B) :- p826(A,C),p365(C,B)
p1351(A,B) :- redpred_107(A,B)
p1352(A,B) :- redpred_154(A,B)
p1353(A,B) :- p89_1(A,C),p1205(C,B)
p1360(A,B) :- redpred_100(A,B)
p1362(A,B) :- p44(A,C),p1362_1(C,B)
p1362_1(A,B) :- redpred_111(A,B)
...
p1479(A,B) :- redpred_120(A,B)
p1480(A,B) :- p229(A,C),p44(C,B)
p1481(A,B) :- p40(A,C),p1347(C,B)
p1483(A,B) :- redpred_97(A,B)
p1486(A,B) :- redpred_155(A,B)
p1487(A,B) :- redpred_106(A,B)
...
p1628_1(A,B) :- redpred_144(A,B)
p1631(A,B) :- redpred_137(A,B)
...
p1728(A,B) :- redpred_145(A,B)
p1730(A,B) :- redpred_151(A,B)
p1736(A,B) :- redpred_116(A,B)
p1738(A,B) :- redpred_157(A,B)
p1744(A,B) :- p222_1(A,C),p86_1(C,B)
p1746(A,B) :- p148_1(A,C),p810_1(C,B)
p1754(A,B) :- p60(A,C),p44(C,B)
p1759(A,B) :- p40(A,C),p60(C,B)
p1761(A,B) :- redpred_157(A,B)
p1763(A,B) :- redpred_149(A,B)
p1765(A,B) :- copy1(A,C),p1765_1(C,B)
p1765_1(A,B) :- p970(A,C),p58(C,B)
p1771(A,B) :- redpred_147(A,B)
p1780(A,B) :- p832(A,C),p86_1(C,B)
p1781(A,B) :- redpred_158(A,B)
...
p1794_1(A,B) :- redpred_127(A,B)
p1797(A,B) :- p1205(A,C),p39(C,B)
p1799(A,B) :- p148(A,C),p1205(C,B)
p1802(A,B) :- redpred_158(A,B)
p1804(A,B) :- redpred_108(A,B)
p1805(A,B) :- redpred_131(A,B)
p1806(A,B) :- redpred_111(A,B)
p1807(A,B) :- p16(A,C),p1807_1(C,B)
p1807_1(A,B) :- p887(A,C),p1070(C,B)
p1812(A,B) :- redpred_132(A,B)
p1813(A,B) :- redpred_154(A,B)
...
p1870_1(A,B) :- redpred_156(A,B)
p1871(A,B) :- redpred_150(A,B)
p1875(A,B) :- p1869(A,C),p887(C,B)
p1877(A,B) :- mk_uppercase(A,C),p1877_1(C,B)
p1877_1(A,B) :- redpred_108(A,B)
