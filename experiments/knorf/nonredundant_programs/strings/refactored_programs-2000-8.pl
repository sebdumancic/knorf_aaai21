...
redpred_12(A,B) :- copy1(A,C),copy1(C,B)
...
redpred_16(A,B) :- p5(A,C),p20(C,B)
redpred_17(A,B) :- copy1(A,C),p229(C,B)
redpred_18(A,B) :- copy1(A,C),p61(C,B)
redpred_19(A,B) :- p27(A,C),p5(C,B)
redpred_20(A,B) :- copy1(A,C),p134(C,B)
redpred_21(A,B) :- p20(A,C),p20(C,B)
redpred_22(A,B) :- skip1(A,C),p134(C,B)
redpred_23(A,B) :- p5(A,C),p134(C,B)
redpred_24(A,B) :- skip1(A,C),p32(C,B)
redpred_25(A,B) :- p20(A,C),p104(C,B)
redpred_26(A,B) :- p20(A,C),p5(C,B)
redpred_27(A,B) :- copy1(A,C),p20(C,B)
redpred_28(A,B) :- p134(A,C),p134(C,B)
redpred_29(A,B) :- skip1(A,C),p104(C,B)
redpred_30(A,B) :- p20(A,C),p101(C,B)
redpred_31(A,B) :- p5(A,C),p229(C,B)
redpred_32(A,B) :- mk_uppercase(A,C),p27(C,B)
redpred_33(A,B) :- skip1(A,C),p20(C,B)
redpred_34(A,B) :- skip1(A,C),p27(C,B)
redpred_35(A,B) :- p20(A,C),p27(C,B)
redpred_36(A,B) :- p20(A,C),p319(C,B)
redpred_37(A,B) :- p20(A,C),p134(C,B)
redpred_38(A,B) :- p20(A,C),p700(C,B)
redpred_39(A,B) :- p61(A,C),p134(C,B)
redpred_40(A,B) :- copy1(A,C),p104(C,B)
redpred_41(A,B) :- mk_lowercase(A,C),p104(C,B)
redpred_42(A,B) :- mk_uppercase(A,C),p134(C,B)
redpred_43(A,B) :- skip1(A,C),p5(C,B)
redpred_44(A,B) :- p134(A,C),p104(C,B)
redpred_45(A,B) :- mk_lowercase(A,C),p5(C,B)
redpred_46(A,B) :- p134(A,C),p32(C,B)
redpred_47(A,B) :- copy1(A,C),p5(C,B)
redpred_48(A,B) :- p20(A,C),p61(C,B)
redpred_49(A,B) :- p101(A,C),p134(C,B)
redpred_50(A,B) :- p229(A,C),p104(C,B)
redpred_51(A,B) :- p61(A,C),p101(C,B)
redpred_52(A,B) :- mk_uppercase(A,C),p61(C,B)
redpred_53(A,B) :- p134(A,C),p20(C,B)
redpred_54(A,B) :- p134(A,C),p5(C,B)
redpred_55(A,B) :- p61(A,C),p104(C,B)
redpred_56(A,B) :- mk_lowercase(A,C),p134(C,B)
redpred_57(A,B) :- skip1(A,C),p229(C,B)
redpred_58(A,B) :- skip1(A,C),p101(C,B)
redpred_59(A,B) :- p20(A,C),p972(C,B)
redpred_60(A,B) :- skip1(A,C),p972(C,B)
redpred_61(A,B) :- copy1(A,C),p101(C,B)
redpred_62(A,B) :- p27(A,C),p134(C,B)
redpred_63(A,B) :- p5(A,C),p61(C,B)
redpred_64(A,B) :- p27(A,C),p61(C,B)
redpred_65(A,B) :- p20(A,C),p229(C,B)
redpred_66(A,B) :- copy1(A,C),p319(C,B)
redpred_67(A,B) :- skip1(A,C),p61(C,B)
redpred_68(A,B) :- p229(A,C),p5(C,B)
redpred_69(A,B) :- p61(A,C),p20(C,B)
redpred_70(A,B) :- p61(A,C),p319(C,B)
redpred_71(A,B) :- skip1(A,C),p700(C,B)
redpred_72(A,B) :- p134(A,C),p61(C,B)
redpred_73(A,B) :- p101(A,C),p229(C,B)
redpred_74(A,B) :- p134(A,C),p101(C,B)
redpred_75(A,B) :- skip1(A,C),p319(C,B)
redpred_76(A,B) :- p101(A,C),p27(C,B)
redpred_77(A,B) :- p101(A,C),p20(C,B)
redpred_78(A,B) :- p20(A,C),p32(C,B)
redpred_79(A,B) :- p27(A,C),p101(C,B)
redpred_80(A,B) :- p229(A,C),p61(C,B)
redpred_81(A,B) :- p134(A,C),p27(C,B)
redpred_82(A,B) :- copy1(A,C),p27(C,B)
redpred_83(A,B) :- p229(A,C),p20(C,B)
redpred_84(A,B) :- p27(A,C),p20(C,B)
redpred_85(A,B) :- p101(A,C),p101(C,B)
redpred_86(A,B) :- p134(A,C),p700(C,B)
redpred_87(A,B) :- p134(A,C),p229(C,B)
redpred_88(A,B) :- p27(A,C),p229(C,B)
redpred_89(A,B) :- p104(A,C),p134(C,B)
redpred_90(A,B) :- mk_lowercase(A,C),p20(C,B)
redpred_91(A,B) :- p104(A,C),p20(C,B)
redpred_92(A,B) :- mk_lowercase(A,C),p700(C,B)
redpred_93(A,B) :- p229(A,C),p27(C,B)
redpred_94(A,B) :- p700(A,C),p134(C,B)
redpred_95(A,B) :- mk_lowercase(A,C),p61(C,B)
redpred_96(A,B) :- p700(A,C),p20(C,B)
redpred_97(A,B) :- p104(A,C),p101(C,B)
redpred_98(A,B) :- p5(A,C),p5(C,B)
redpred_99(A,B) :- p319(A,C),p20(C,B)
redpred_100(A,B) :- p27(A,C),p700(C,B)
redpred_101(A,B) :- p61(A,C),p229(C,B)
redpred_102(A,B) :- copy1(A,C),p415(C,B)
redpred_103(A,B) :- p664(A,C),p356(C,B)
redpred_104(A,B) :- copy1(A,C),p802(C,B)
redpred_105(A,B) :- skip1(A,C),p187(C,B)
redpred_106(A,B) :- p185(A,C),p41_1(C,B)
redpred_107(A,B) :- p20(A,C),p664(C,B)
redpred_108(A,B) :- skip1(A,C),p208(C,B)
redpred_109(A,B) :- p66(A,C),p22(C,B)
redpred_110(A,B) :- p275(A,C),p627_1(C,B)
redpred_111(A,B) :- p66(A,C),p5(C,B)
redpred_112(A,B) :- p22(A,C),p538(C,B)
redpred_113(A,B) :- p134(A,C),p193(C,B)
redpred_114(A,B) :- p86(A,C),p61(C,B)
redpred_115(A,B) :- skip1(A,C),p564(C,B)
redpred_116(A,B) :- skip1(A,C),p344(C,B)
redpred_117(A,B) :- p134(A,C),p791(C,B)
redpred_118(A,B) :- skip1(A,C),p185(C,B)
redpred_119(A,B) :- p104(A,C),p272(C,B)
redpred_120(A,B) :- copy1(A,C),p860(C,B)
redpred_121(A,B) :- p187(A,C),p152_1(C,B)
redpred_122(A,B) :- p95_1(A,C),p193(C,B)
redpred_123(A,B) :- p51(A,C),p174_1(C,B)
redpred_124(A,B) :- p185(A,C),p265(C,B)
redpred_125(A,B) :- p149_1(A,C),p66(C,B)
redpred_126(A,B) :- skip1(A,C),p1416(C,B)
redpred_127(A,B) :- p95_1(A,C),p187(C,B)
redpred_128(A,B) :- p134(A,C),p86(C,B)
redpred_129(A,B) :- copy1(A,C),p970(C,B)
redpred_130(A,B) :- skip1(A,C),p1632(C,B)
redpred_131(A,B) :- p134(A,C),p970(C,B)
redpred_132(A,B) :- copy1(A,C),p120(C,B)
redpred_133(A,B) :- skip1(A,C),p860(C,B)
redpred_134(A,B) :- p307_1(A,C),p29_1(C,B)
redpred_135(A,B) :- p20(A,C),p185(C,B)
redpred_136(A,B) :- skip1(A,C),p1097(C,B)
redpred_137(A,B) :- skip1(A,C),p970(C,B)
redpred_138(A,B) :- skip1(A,C),p1236(C,B)
redpred_139(A,B) :- p22(A,C),p731(C,B)
redpred_140(A,B) :- p134(A,C),p67(C,B)
redpred_141(A,B) :- p66(A,C),p113(C,B)
redpred_142(A,B) :- copy1(A,C),p10(C,B)
redpred_143(A,B) :- p20(A,C),p564(C,B)
redpred_144(A,B) :- p66_1(A,C),p174_1(C,B)
redpred_145(A,B) :- copy1(A,C),p1107(C,B)
redpred_146(A,B) :- p55_1(A,C),p22(C,B)
redpred_147(A,B) :- p29_1(A,C),p415(C,B)
redpred_148(A,B) :- p66_1(A,C),p185(C,B)
redpred_149(A,B) :- p27(A,C),p185(C,B)
redpred_150(A,B) :- p165(A,C),p174(C,B)
redpred_151(A,B) :- p187(A,C),p307_1(C,B)
redpred_152(A,B) :- p134(A,C),p89(C,B)
redpred_153(A,B) :- p104(A,C),p66(C,B)
redpred_154(A,B) :- p185(A,C),p174_1(C,B)
redpred_155(A,B) :- copy1(A,C),p86(C,B)
redpred_156(A,B) :- copy1(A,C),p698(C,B)
redpred_157(A,B) :- p20(A,C),p187(C,B)
redpred_158(A,B) :- p229(A,C),p174(C,B)
redpred_159(A,B) :- copy1(A,C),p1501(C,B)
redpred_160(A,B) :- copy1(A,C),p1097(C,B)
redpred_161(A,B) :- copy1(A,C),p187(C,B)
redpred_162(A,B) :- p752(A,C),mk_lowercase(C,B)
redpred_163(A,B) :- copy1(A,C),p664(C,B)
redpred_164(A,B) :- skip1(A,C),p1650(C,B)
redpred_165(A,B) :- p1663(A,C),p27(C,B)
...
p1502(A,B) :- redpred_12(A,B)
p1506(A,B) :- redpred_2(A,B)
p1509(A,B) :- redpred_6(A,B)
p1511(A,B) :- redpred_12(A,B)
...
p1914(A,B) :- redpred_14(A,B)
p1919(A,B) :- redpred_8(A,B)
p1922(A,B) :- redpred_8(A,B)
...
p287_1(A,B) :- redpred_65(A,B)
p294(A,B) :- copy1(A,C),p294_1(C,B)
p294_1(A,B) :- redpred_28(A,B)
p295(A,B) :- redpred_20(A,B)
p300(A,B) :- redpred_27(A,B)
p305(A,B) :- redpred_57(A,B)
p306(A,B) :- redpred_66(A,B)
p307(A,B) :- p134(A,C),p307_1(C,B)
p307_1(A,B) :- redpred_67(A,B)
p310(A,B) :- redpred_21(A,B)
p311(A,B) :- skip1(A,C),p311_1(C,B)
p311_1(A,B) :- redpred_34(A,B)
p317(A,B) :- redpred_33(A,B)
...
p689_1(A,B) :- redpred_74(A,B)
p698(A,B) :- p20(A,C),p698_1(C,B)
p698_1(A,B) :- redpred_43(A,B)
...
p1120_1(A,B) :- redpred_62(A,B)
p1125(A,B) :- skip1(A,C),p1125_1(C,B)
p1125_1(A,B) :- redpred_53(A,B)
...
p1507_1(A,B) :- redpred_33(A,B)
p1510(A,B) :- skip1(A,C),p1510_1(C,B)
p1510_1(A,B) :- redpred_33(A,B)
p1512(A,B) :- copy1(A,C),p1512_1(C,B)
p1512_1(A,B) :- redpred_24(A,B)
p1513(A,B) :- p61(A,C),p1513_1(C,B)
p1513_1(A,B) :- redpred_65(A,B)
...
p64(A,B) :- redpred_104(A,B)
p68(A,B) :- p134(A,C),p68_1(C,B)
p68_1(A,B) :- redpred_105(A,B)
...
p85(A,B) :- redpred_106(A,B)
p87(A,B) :- p66_1(A,C),p456_1(C,B)
p90(A,B) :- redpred_107(A,B)
...
p157(A,B) :- redpred_112(A,B)
p161(A,B) :- p20(A,C),p125(C,B)
p167(A,B) :- redpred_113(A,B)
...
p332(A,B) :- redpred_122(A,B)
p333(A,B) :- p20(A,C),p624(C,B)
p336(A,B) :- redpred_111(A,B)
...
p388(A,B) :- redpred_127(A,B)
p389(A,B) :- mk_uppercase(A,C),p29(C,B)
p390(A,B) :- redpred_128(A,B)
...
p596(A,B) :- redpred_137(A,B)
p598(A,B) :- redpred_138(A,B)
p601(A,B) :- redpred_139(A,B)
p605(A,B) :- p31(A,C),p66_1(C,B)
p609(A,B) :- redpred_140(A,B)
...
p741(A,B) :- redpred_146(A,B)
p742(A,B) :- p629(A,C),p24(C,B)
p746(A,B) :- redpred_147(A,B)
...
p805_1(A,B) :- redpred_106(A,B)
p807(A,B) :- redpred_103(A,B)
...
p1105(A,B) :- redpred_132(A,B)
p1106(A,B) :- redpred_153(A,B)
p1110(A,B) :- redpred_140(A,B)
...
p1124_1(A,B) :- redpred_121(A,B)
p1126(A,B) :- redpred_150(A,B)
...
p1155_1(A,B) :- redpred_149(A,B)
p1156(A,B) :- p29_1(A,C),p1476(C,B)
p1157(A,B) :- redpred_123(A,B)
...
p1439(A,B) :- redpred_157(A,B)
p1440(A,B) :- p144(A,C),p187(C,B)
p1442(A,B) :- redpred_107(A,B)
...
p1656(A,B) :- redpred_122(A,B)
p1660(A,B) :- redpred_129(A,B)
p1661(A,B) :- redpred_143(A,B)
p1662(A,B) :- p20(A,C),p75(C,B)
p1663(A,B) :- skip1(A,C),p1663_1(C,B)
p1663_1(A,B) :- redpred_118(A,B)
...
p1812(A,B) :- redpred_162(A,B)
p1814(A,B) :- redpred_141(A,B)
p1815(A,B) :- redpred_163(A,B)
p1818(A,B) :- redpred_147(A,B)
...
p1909_1(A,B) :- redpred_105(A,B)
p1911(A,B) :- copy1(A,C),p1911_1(C,B)
p1911_1(A,B) :- redpred_162(A,B)
...
p1936(A,B) :- redpred_134(A,B)
p1945(A,B) :- redpred_163(A,B)
