...
redpred_17(A,B) :- skip1(A,C),p309(C,B)
redpred_18(A,B) :- p209(A,C),p216(C,B)
redpred_19(A,B) :- skip1(A,C),p209(C,B)
redpred_20(A,B) :- skip1(A,C),p325(C,B)
redpred_21(A,B) :- skip1(A,C),p99(C,B)
redpred_22(A,B) :- p99(A,C),p99(C,B)
redpred_23(A,B) :- skip1(A,C),p22(C,B)
redpred_24(A,B) :- skip1(A,C),p88(C,B)
redpred_25(A,B) :- copy1(A,C),p99(C,B)
redpred_26(A,B) :- p64(A,C),p275(C,B)
redpred_27(A,B) :- copy1(A,C),p22(C,B)
redpred_28(A,B) :- skip1(A,C),p64(C,B)
redpred_29(A,B) :- p386(A,C),p22(C,B)
redpred_30(A,B) :- p99(A,C),p22(C,B)
redpred_31(A,B) :- copy1(A,C),p216(C,B)
redpred_32(A,B) :- p99(A,C),p309(C,B)
redpred_33(A,B) :- p22(A,C),p22(C,B)
redpred_34(A,B) :- copy1(A,C),p88(C,B)
redpred_35(A,B) :- p64(A,C),p22(C,B)
redpred_36(A,B) :- p216(A,C),p209(C,B)
redpred_37(A,B) :- p99(A,C),p325(C,B)
redpred_38(A,B) :- p64(A,C),p216(C,B)
redpred_39(A,B) :- p22(A,C),p209(C,B)
redpred_40(A,B) :- copy1(A,C),p275(C,B)
redpred_41(A,B) :- p22(A,C),p325(C,B)
redpred_42(A,B) :- p309(A,C),p22(C,B)
redpred_43(A,B) :- p216(A,C),p99(C,B)
redpred_44(A,B) :- p22(A,C),p216(C,B)
redpred_45(A,B) :- skip1(A,C),p216(C,B)
redpred_46(A,B) :- p275(A,C),p99(C,B)
redpred_47(A,B) :- skip1(A,C),p175(C,B)
redpred_48(A,B) :- p22(A,C),p88(C,B)
redpred_49(A,B) :- p22(A,C),p99(C,B)
redpred_50(A,B) :- p309(A,C),p99(C,B)
redpred_51(A,B) :- p64(A,C),p209(C,B)
redpred_52(A,B) :- p99(A,C),p209(C,B)
redpred_53(A,B) :- mk_uppercase(A,C),p209(C,B)
redpred_54(A,B) :- p22(A,C),p275(C,B)
redpred_55(A,B) :- p88(A,C),p99(C,B)
redpred_56(A,B) :- p64(A,C),p99(C,B)
redpred_57(A,B) :- mk_uppercase(A,C),p99(C,B)
redpred_58(A,B) :- p209(A,C),p88(C,B)
redpred_59(A,B) :- p325(A,C),p22(C,B)
redpred_60(A,B) :- p209(A,C),p99(C,B)
redpred_61(A,B) :- p209(A,C),p22(C,B)
redpred_62(A,B) :- p216(A,C),p22(C,B)
redpred_63(A,B) :- copy1(A,C),p325(C,B)
redpred_64(A,B) :- p22(A,C),p64(C,B)
redpred_65(A,B) :- mk_uppercase(A,C),p22(C,B)
redpred_66(A,B) :- mk_lowercase(A,C),p22(C,B)
redpred_67(A,B) :- p99(A,C),p275(C,B)
redpred_68(A,B) :- p275(A,C),p22(C,B)
redpred_69(A,B) :- copy1(A,C),p209(C,B)
redpred_70(A,B) :- p99(A,C),p175(C,B)
redpred_71(A,B) :- p275(A,C),p216(C,B)
redpred_72(A,B) :- copy1(A,C),p309(C,B)
redpred_73(A,B) :- p22(A,C),p386(C,B)
redpred_74(A,B) :- p216(A,C),p325(C,B)
redpred_75(A,B) :- skip1(A,C),p275(C,B)
redpred_76(A,B) :- p275(A,C),p309(C,B)
redpred_77(A,B) :- mk_lowercase(A,C),p99(C,B)
redpred_78(A,B) :- p325(A,C),p309(C,B)
redpred_79(A,B) :- p99(A,C),p216(C,B)
redpred_80(A,B) :- p209(A,C),p64(C,B)
redpred_81(A,B) :- mk_lowercase(A,C),p275(C,B)
redpred_82(A,B) :- p64(A,C),p325(C,B)
redpred_83(A,B) :- p42(A,C),p275(C,B)
redpred_84(A,B) :- p99(A,C),p64(C,B)
redpred_85(A,B) :- copy1(A,C),p42(C,B)
redpred_86(A,B) :- p88(A,C),p325(C,B)
redpred_87(A,B) :- skip1(A,C),p42(C,B)
redpred_88(A,B) :- p22(A,C),p309(C,B)
redpred_89(A,B) :- p325(A,C),p325(C,B)
redpred_90(A,B) :- p64(A,C),p64(C,B)
redpred_91(A,B) :- p386(A,C),p325(C,B)
redpred_92(A,B) :- skip1(A,C),p386(C,B)
redpred_93(A,B) :- p325(A,C),p99(C,B)
redpred_94(A,B) :- p64(A,C),p309(C,B)
redpred_95(A,B) :- p209(A,C),p209(C,B)
redpred_96(A,B) :- mk_lowercase(A,C),p216(C,B)
redpred_97(A,B) :- p309(A,C),p216(C,B)
redpred_98(A,B) :- p275(A,C),p209(C,B)
redpred_99(A,B) :- p209(A,C),p275(C,B)
redpred_100(A,B) :- copy1(A,C),p41(C,B)
redpred_101(A,B) :- skip1(A,C),p1535(C,B)
redpred_102(A,B) :- copy1(A,C),p61(C,B)
redpred_103(A,B) :- skip1(A,C),p779(C,B)
redpred_104(A,B) :- p134_1(A,C),p26(C,B)
redpred_105(A,B) :- copy1(A,C),p13(C,B)
redpred_106(A,B) :- skip1(A,C),p26(C,B)
redpred_107(A,B) :- skip1(A,C),p679(C,B)
redpred_108(A,B) :- p64(A,C),p100(C,B)
redpred_109(A,B) :- p275(A,C),p742(C,B)
redpred_110(A,B) :- p26_1(A,C),p281_1(C,B)
redpred_111(A,B) :- skip1(A,C),p59(C,B)
redpred_112(A,B) :- skip1(A,C),p1196(C,B)
redpred_113(A,B) :- p45_1(A,C),p47(C,B)
redpred_114(A,B) :- p79(A,C),p100(C,B)
redpred_115(A,B) :- p26(A,C),p15(C,B)
redpred_116(A,B) :- skip1(A,C),p1323(C,B)
redpred_117(A,B) :- p215(A,C),p163(C,B)
redpred_118(A,B) :- copy1(A,C),p111(C,B)
redpred_119(A,B) :- skip1(A,C),p134(C,B)
redpred_120(A,B) :- copy1(A,C),p1257(C,B)
redpred_121(A,B) :- skip1(A,C),p146(C,B)
redpred_122(A,B) :- p45_1(A,C),p408(C,B)
redpred_123(A,B) :- p99(A,C),p150(C,B)
redpred_124(A,B) :- p475(A,C),p26(C,B)
redpred_125(A,B) :- skip1(A,C),p13(C,B)
redpred_126(A,B) :- p100(A,C),p45_1(C,B)
redpred_127(A,B) :- copy1(A,C),p550(C,B)
redpred_128(A,B) :- copy1(A,C),p26(C,B)
redpred_129(A,B) :- copy1(A,C),p779(C,B)
redpred_130(A,B) :- p22(A,C),p13(C,B)
redpred_131(A,B) :- skip1(A,C),p36(C,B)
redpred_132(A,B) :- p15(A,C),p779(C,B)
redpred_133(A,B) :- copy1(A,C),p1619(C,B)
redpred_134(A,B) :- p22(A,C),p742(C,B)
redpred_135(A,B) :- p26(A,C),p475(C,B)
redpred_136(A,B) :- copy1(A,C),p287(C,B)
redpred_137(A,B) :- skip1(A,C),p475(C,B)
redpred_138(A,B) :- skip1(A,C),p189(C,B)
redpred_139(A,B) :- p122(A,C),p309(C,B)
redpred_140(A,B) :- p742(A,C),p26(C,B)
redpred_141(A,B) :- p100(A,C),p29(C,B)
redpred_142(A,B) :- p99(A,C),p273(C,B)
redpred_143(A,B) :- copy1(A,C),p475(C,B)
redpred_144(A,B) :- p742(A,C),p34(C,B)
redpred_145(A,B) :- p209(A,C),p287(C,B)
redpred_146(A,B) :- mk_lowercase(A,C),p1060(C,B)
redpred_147(A,B) :- skip1(A,C),p742(C,B)
redpred_148(A,B) :- p34(A,C),p1158_1(C,B)
redpred_149(A,B) :- skip1(A,C),p720(C,B)
redpred_150(A,B) :- p22(A,C),p26(C,B)
redpred_151(A,B) :- skip1(A,C),p151(C,B)
redpred_152(A,B) :- copy1(A,C),p1323(C,B)
redpred_153(A,B) :- p475(A,C),p176_1(C,B)
redpred_154(A,B) :- p100(A,C),p309(C,B)
redpred_155(A,B) :- p275(A,C),p26(C,B)
redpred_156(A,B) :- p23(A,C),p1065(C,B)
redpred_157(A,B) :- skip1(A,C),p936(C,B)
redpred_158(A,B) :- p26(A,C),p36_1(C,B)
redpred_159(A,B) :- p23(A,C),p268_1(C,B)
redpred_160(A,B) :- mk_lowercase(A,C),p26(C,B)
redpred_161(A,B) :- copy1(A,C),p1102(C,B)
redpred_162(A,B) :- p1196(A,C),p34(C,B)
redpred_163(A,B) :- p220(A,C),p26(C,B)
redpred_164(A,B) :- skip1(A,C),p561(C,B)
redpred_165(A,B) :- p561(A,C),copy1(C,B)
redpred_166(A,B) :- p55_1(A,C),p88(C,B)
redpred_167(A,B) :- skip1(A,C),p141(C,B)
...
p610(A,B) :- redpred_15(A,B)
p618(A,B) :- redpred_2(A,B)
p619(A,B) :- redpred_9(A,B)
...
p1228(A,B) :- redpred_13(A,B)
p1229(A,B) :- redpred_5(A,B)
p1232(A,B) :- redpred_11(A,B)
...
p1639(A,B) :- redpred_15(A,B)
p1640(A,B) :- redpred_4(A,B)
p1642(A,B) :- redpred_6(A,B)
...
p1933(A,B) :- redpred_10(A,B)
p1938(A,B) :- redpred_2(A,B)
p1947(A,B) :- redpred_9(A,B)
p1948(A,B) :- redpred_1(A,B)
p1950(A,B) :- redpred_9(A,B)
p1954(A,B) :- redpred_4(A,B)
p1955(A,B) :- redpred_1(A,B)
p1958(A,B) :- redpred_9(A,B)
...
p2038(A,B) :- redpred_9(A,B)
p2045(A,B) :- redpred_6(A,B)
...
p769(A,B) :- redpred_69(A,B)
p772(A,B) :- p22(A,C),p772_1(C,B)
p772_1(A,B) :- redpred_80(A,B)
p773(A,B) :- redpred_68(A,B)
p777(A,B) :- copy1(A,C),p777_1(C,B)
p777_1(A,B) :- redpred_23(A,B)
p779(A,B) :- skip1(A,C),p779_1(C,B)
p779_1(A,B) :- redpred_22(A,B)
...
p1745_1(A,B) :- redpred_45(A,B)
p1747(A,B) :- skip1(A,C),p1747_1(C,B)
p1747_1(A,B) :- redpred_21(A,B)
p1748(A,B) :- redpred_44(A,B)
...
p366(A,B) :- redpred_118(A,B)
p367(A,B) :- p7_1(A,C),p180_1(C,B)
p369(A,B) :- redpred_119(A,B)
...
p442(A,B) :- redpred_123(A,B)
p444(A,B) :- redpred_109(A,B)
...
p561_1(A,B) :- redpred_106(A,B)
p562(A,B) :- p29(A,C),p888(C,B)
p566(A,B) :- redpred_127(A,B)
...
p604(A,B) :- redpred_128(A,B)
p605(A,B) :- p49_1(A,C),p166(C,B)
p606(A,B) :- redpred_104(A,B)
p607(A,B) :- redpred_129(A,B)
...
p652(A,B) :- redpred_111(A,B)
p653(A,B) :- redpred_130(A,B)
...
p819(A,B) :- redpred_139(A,B)
p821(A,B) :- redpred_128(A,B)
...
p889_1(A,B) :- redpred_125(A,B)
p890(A,B) :- p553_1(A,C),p36(C,B)
p894(A,B) :- redpred_143(A,B)
...
p1037_1(A,B) :- redpred_135(A,B)
p1038(A,B) :- p287(A,C),p153(C,B)
p1039(A,B) :- redpred_143(A,B)
p1043(A,B) :- redpred_145(A,B)
...
p1112(A,B) :- redpred_147(A,B)
p1113(A,B) :- redpred_148(A,B)
...
p1215_1(A,B) :- redpred_112(A,B)
p1217(A,B) :- p99(A,C),p1217_1(C,B)
p1217_1(A,B) :- redpred_151(A,B)
p1219(A,B) :- copy1(A,C),p1219_1(C,B)
p1219_1(A,B) :- redpred_144(A,B)
p1220(A,B) :- redpred_145(A,B)
p1221(A,B) :- p1087(A,C),p467_1(C,B)
p1223(A,B) :- redpred_130(A,B)
...
p1291(A,B) :- redpred_100(A,B)
p1292(A,B) :- redpred_152(A,B)
...
p1336(A,B) :- redpred_154(A,B)
p1337(A,B) :- p216(A,C),p13(C,B)
p1340(A,B) :- redpred_155(A,B)
...
p1364(A,B) :- redpred_148(A,B)
p1375(A,B) :- p1065(A,C),p467_1(C,B)
p1382(A,B) :- redpred_156(A,B)
...
p1409(A,B) :- redpred_102(A,B)
p1410(A,B) :- p209(A,C),p742(C,B)
p1412(A,B) :- redpred_140(A,B)
...
p1428(A,B) :- redpred_139(A,B)
p1436(A,B) :- redpred_157(A,B)
...
p1452(A,B) :- redpred_118(A,B)
p1453(A,B) :- mk_lowercase(A,C),p1453_1(C,B)
p1453_1(A,B) :- redpred_135(A,B)
...
p1793_1(A,B) :- redpred_149(A,B)
p1800(A,B) :- redpred_146(A,B)
...
p2105_1(A,B) :- redpred_117(A,B)
p2107(A,B) :- redpred_142(A,B)
...
p2016_1(A,B) :- redpred_166(A,B)
p2028(A,B) :- copy1(A,C),p2028_1(C,B)
p2028_1(A,B) :- redpred_167(A,B)
