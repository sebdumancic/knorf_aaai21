...
redpred_16(A,B) :- skip1(A,C),p300(C,B)
redpred_17(A,B) :- skip1(A,C),p77(C,B)
redpred_18(A,B) :- p36(A,C),p300(C,B)
redpred_19(A,B) :- mk_uppercase(A,C),p36(C,B)
redpred_20(A,B) :- skip1(A,C),p106(C,B)
redpred_21(A,B) :- skip1(A,C),p15(C,B)
redpred_22(A,B) :- p18(A,C),p77(C,B)
redpred_23(A,B) :- p77(A,C),p18(C,B)
redpred_24(A,B) :- p40(A,C),p300(C,B)
redpred_25(A,B) :- skip1(A,C),p40(C,B)
redpred_26(A,B) :- p150(A,C),p15(C,B)
redpred_27(A,B) :- p80(A,C),p15(C,B)
redpred_28(A,B) :- mk_lowercase(A,C),p150(C,B)
redpred_29(A,B) :- p77(A,C),p77(C,B)
redpred_30(A,B) :- p80(A,C),p77(C,B)
redpred_31(A,B) :- skip1(A,C),p150(C,B)
redpred_32(A,B) :- p18(A,C),p15(C,B)
redpred_33(A,B) :- skip1(A,C),p36(C,B)
redpred_34(A,B) :- p15(A,C),p106(C,B)
redpred_35(A,B) :- p15(A,C),p77(C,B)
redpred_36(A,B) :- p15(A,C),p36(C,B)
redpred_37(A,B) :- p36(A,C),p15(C,B)
redpred_38(A,B) :- p77(A,C),p300(C,B)
redpred_39(A,B) :- p150(A,C),p77(C,B)
redpred_40(A,B) :- skip1(A,C),p242(C,B)
redpred_41(A,B) :- p15(A,C),p15(C,B)
redpred_42(A,B) :- p15(A,C),p18(C,B)
redpred_43(A,B) :- p15(A,C),p150(C,B)
redpred_44(A,B) :- p36(A,C),p77(C,B)
redpred_45(A,B) :- copy1(A,C),p15(C,B)
redpred_46(A,B) :- p77(A,C),p15(C,B)
redpred_47(A,B) :- p36(A,C),p278(C,B)
redpred_48(A,B) :- copy1(A,C),p40(C,B)
redpred_49(A,B) :- p300(A,C),p80(C,B)
redpred_50(A,B) :- p15(A,C),p40(C,B)
redpred_51(A,B) :- skip1(A,C),p232(C,B)
redpred_52(A,B) :- copy1(A,C),p80(C,B)
redpred_53(A,B) :- copy1(A,C),p150(C,B)
redpred_54(A,B) :- p40(A,C),p77(C,B)
redpred_55(A,B) :- skip1(A,C),p80(C,B)
redpred_56(A,B) :- copy1(A,C),p77(C,B)
redpred_57(A,B) :- p40(A,C),p40(C,B)
redpred_58(A,B) :- mk_uppercase(A,C),p77(C,B)
redpred_59(A,B) :- mk_lowercase(A,C),p77(C,B)
redpred_60(A,B) :- skip1(A,C),p18(C,B)
redpred_61(A,B) :- mk_lowercase(A,C),p15(C,B)
redpred_62(A,B) :- mk_uppercase(A,C),p15(C,B)
redpred_63(A,B) :- p15(A,C),p80(C,B)
redpred_64(A,B) :- p40(A,C),p36(C,B)
redpred_65(A,B) :- p242(A,C),p15(C,B)
redpred_66(A,B) :- p77(A,C),p40(C,B)
redpred_67(A,B) :- p150(A,C),p36(C,B)
redpred_68(A,B) :- p77(A,C),p80(C,B)
redpred_69(A,B) :- p15(A,C),p300(C,B)
redpred_70(A,B) :- p36(A,C),p36(C,B)
redpred_71(A,B) :- copy1(A,C),p300(C,B)
redpred_72(A,B) :- mk_uppercase(A,C),p300(C,B)
redpred_73(A,B) :- p278(A,C),p77(C,B)
redpred_74(A,B) :- copy1(A,C),p36(C,B)
redpred_75(A,B) :- p80(A,C),p278(C,B)
redpred_76(A,B) :- copy1(A,C),p18(C,B)
redpred_77(A,B) :- p300(A,C),p77(C,B)
redpred_78(A,B) :- p18(A,C),p80(C,B)
redpred_79(A,B) :- p80(A,C),p18(C,B)
redpred_80(A,B) :- p150(A,C),p18(C,B)
redpred_81(A,B) :- p300(A,C),p15(C,B)
redpred_82(A,B) :- p40(A,C),p15(C,B)
redpred_83(A,B) :- p18(A,C),p278(C,B)
redpred_84(A,B) :- p80(A,C),p150(C,B)
redpred_85(A,B) :- mk_lowercase(A,C),p40(C,B)
redpred_86(A,B) :- p106(A,C),p77(C,B)
redpred_87(A,B) :- p18(A,C),p40(C,B)
redpred_88(A,B) :- mk_uppercase(A,C),p80(C,B)
redpred_89(A,B) :- skip1(A,C),p942(C,B)
redpred_90(A,B) :- p203(A,C),p285_1(C,B)
redpred_91(A,B) :- copy1(A,C),p215(C,B)
redpred_92(A,B) :- skip1(A,C),p177(C,B)
redpred_93(A,B) :- p463(A,C),p5_1(C,B)
redpred_94(A,B) :- p211_1(A,C),p342(C,B)
redpred_95(A,B) :- skip1(A,C),p3(C,B)
redpred_96(A,B) :- p14(A,C),p600(C,B)
redpred_97(A,B) :- skip1(A,C),p211(C,B)
redpred_98(A,B) :- skip1(A,C),p223(C,B)
redpred_99(A,B) :- p77(A,C),p23(C,B)
redpred_100(A,B) :- skip1(A,C),p23(C,B)
redpred_101(A,B) :- skip1(A,C),p600(C,B)
redpred_102(A,B) :- p105(A,C),p150(C,B)
redpred_103(A,B) :- not_empty(A),p1341(A,B)
redpred_104(A,B) :- skip1(A,C),p5(C,B)
redpred_105(A,B) :- p283(A,C),p285_1(C,B)
redpred_106(A,B) :- p23(A,C),p288(C,B)
redpred_107(A,B) :- p15(A,C),p600(C,B)
redpred_108(A,B) :- copy1(A,C),p284(C,B)
redpred_109(A,B) :- copy1(A,C),p954(C,B)
redpred_110(A,B) :- p565_1(A,C),p600(C,B)
redpred_111(A,B) :- mk_uppercase(A,C),p194(C,B)
redpred_112(A,B) :- p77(A,C),p3(C,B)
redpred_113(A,B) :- p23(A,C),p281(C,B)
redpred_114(A,B) :- skip1(A,C),p284(C,B)
redpred_115(A,B) :- copy1(A,C),p23(C,B)
redpred_116(A,B) :- p792(A,C),p203(C,B)
redpred_117(A,B) :- skip1(A,C),p304(C,B)
redpred_118(A,B) :- p1464(A,C),p5_1(C,B)
redpred_119(A,B) :- p957(A,C),mk_lowercase(C,B)
...
p1420(A,B) :- redpred_12(A,B)
p1423(A,B) :- redpred_1(A,B)
p1428(A,B) :- redpred_7(A,B)
...
p149(A,B) :- redpred_16(A,B)
p151(A,B) :- p40(A,C),p151_1(C,B)
p151_1(A,B) :- redpred_17(A,B)
p153(A,B) :- mk_uppercase(A,C),p153_1(C,B)
p153_1(A,B) :- redpred_26(A,B)
...
p177_1(A,B) :- redpred_43(A,B)
p183(A,B) :- copy1(A,C),p183_1(C,B)
p183_1(A,B) :- redpred_17(A,B)
...
p218_1(A,B) :- redpred_40(A,B)
p223(A,B) :- skip1(A,C),p223_1(C,B)
p223_1(A,B) :- redpred_31(A,B)
...
p634_1(A,B) :- redpred_39(A,B)
p635(A,B) :- redpred_20(A,B)
p644(A,B) :- mk_lowercase(A,C),p644_1(C,B)
p644_1(A,B) :- redpred_41(A,B)
p647(A,B) :- redpred_56(A,B)
p654(A,B) :- copy1(A,C),p106(C,B)
p664(A,B) :- redpred_41(A,B)
p665(A,B) :- redpred_72(A,B)
p668(A,B) :- redpred_17(A,B)
p673(A,B) :- redpred_73(A,B)
p677(A,B) :- redpred_31(A,B)
p683(A,B) :- redpred_48(A,B)
p688(A,B) :- redpred_35(A,B)
p692(A,B) :- skip1(A,C),p692_1(C,B)
p692_1(A,B) :- redpred_55(A,B)
p693(A,B) :- redpred_36(A,B)
p695(A,B) :- redpred_52(A,B)
p701(A,B) :- redpred_56(A,B)
p704(A,B) :- redpred_74(A,B)
p705(A,B) :- skip1(A,C),p705_1(C,B)
p705_1(A,B) :- redpred_17(A,B)
p711(A,B) :- redpred_72(A,B)
p715(A,B) :- copy1(A,C),p715_1(C,B)
p715_1(A,B) :- redpred_75(A,B)
p718(A,B) :- p80(A,C),p718_1(C,B)
p718_1(A,B) :- redpred_21(A,B)
p724(A,B) :- p15(A,C),p724_1(C,B)
p724_1(A,B) :- redpred_29(A,B)
...
p817(A,B) :- redpred_66(A,B)
p819(A,B) :- redpred_38(A,B)
p820(A,B) :- mk_lowercase(A,C),p300(C,B)
p828(A,B) :- p80(A,C),p300(C,B)
p833(A,B) :- copy1(A,C),p833_1(C,B)
p833_1(A,B) :- redpred_26(A,B)
p836(A,B) :- p77(A,C),p836_1(C,B)
p836_1(A,B) :- redpred_43(A,B)
p842(A,B) :- redpred_19(A,B)
p848(A,B) :- redpred_48(A,B)
p860(A,B) :- redpred_45(A,B)
p863(A,B) :- redpred_70(A,B)
p869(A,B) :- redpred_45(A,B)
p878(A,B) :- redpred_21(A,B)
p879(A,B) :- p36(A,C),p879_1(C,B)
p879_1(A,B) :- p40(A,C),p80(C,B)
p881(A,B) :- copy1(A,C),p881_1(C,B)
p881_1(A,B) :- redpred_17(A,B)
...
p237(A,B) :- redpred_91(A,B)
p238(A,B) :- p106(A,C),p177(C,B)
p240(A,B) :- p792(A,C),p982(C,B)
p241(A,B) :- redpred_96(A,B)
p243(A,B) :- redpred_97(A,B)
...
p494(A,B) :- redpred_104(A,B)
p495(A,B) :- copy1(A,C),p495_1(C,B)
p495_1(A,B) :- redpred_105(A,B)
p497(A,B) :- redpred_95(A,B)
...
p646_1(A,B) :- redpred_105(A,B)
p649(A,B) :- p92_1(A,C),p792(C,B)
p650(A,B) :- redpred_107(A,B)
...
p780(A,B) :- redpred_109(A,B)
p781(A,B) :- p15(A,C),p781_1(C,B)
p781_1(A,B) :- redpred_110(A,B)
...
p825_1(A,B) :- redpred_98(A,B)
p826(A,B) :- copy1(A,C),p724(C,B)
p827(A,B) :- redpred_104(A,B)
...
p904(A,B) :- redpred_112(A,B)
p916(A,B) :- redpred_109(A,B)
p928(A,B) :- p161(A,C),p37(C,B)
p930(A,B) :- p15(A,C),p930_1(C,B)
p930_1(A,B) :- redpred_113(A,B)
p931(A,B) :- redpred_96(A,B)
...
p1594(A,B) :- redpred_111(A,B)
p1598(A,B) :- p389_1(A,C),p1598_1(C,B)
p1598_1(A,B) :- redpred_113(A,B)
...
p512_1(A,B) :- redpred_117(A,B)
p521(A,B) :- redpred_119(A,B)
...
p865_1(A,B) :- redpred_117(A,B)
p902(A,B) :- p77(A,C),p902_1(C,B)
p902_1(A,B) :- redpred_119(A,B)
