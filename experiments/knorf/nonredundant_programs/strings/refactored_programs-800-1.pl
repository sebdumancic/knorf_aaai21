...
redpred_15(A,B) :- p29(A,C),p29(C,B)
redpred_16(A,B) :- p80(A,C),p29(C,B)
redpred_17(A,B) :- skip1(A,C),p19(C,B)
redpred_18(A,B) :- p80(A,C),p19(C,B)
redpred_19(A,B) :- skip1(A,C),p114(C,B)
redpred_20(A,B) :- p80(A,C),p80(C,B)
redpred_21(A,B) :- skip1(A,C),p35(C,B)
redpred_22(A,B) :- p114(A,C),p29(C,B)
redpred_23(A,B) :- copy1(A,C),p80(C,B)
redpred_24(A,B) :- p45(A,C),p80(C,B)
redpred_25(A,B) :- p29(A,C),p80(C,B)
redpred_26(A,B) :- p80(A,C),p465(C,B)
redpred_27(A,B) :- skip1(A,C),p29(C,B)
redpred_28(A,B) :- mk_lowercase(A,C),p80(C,B)
redpred_29(A,B) :- copy1(A,C),p248(C,B)
redpred_30(A,B) :- p22(A,C),p29(C,B)
redpred_31(A,B) :- skip1(A,C),p106(C,B)
redpred_32(A,B) :- p465(A,C),p35(C,B)
redpred_33(A,B) :- skip1(A,C),p22(C,B)
redpred_34(A,B) :- copy1(A,C),p29(C,B)
redpred_35(A,B) :- skip1(A,C),p534(C,B)
redpred_36(A,B) :- p465(A,C),p80(C,B)
redpred_37(A,B) :- p114(A,C),p80(C,B)
redpred_38(A,B) :- skip1(A,C),p80(C,B)
redpred_39(A,B) :- skip1(A,C),p248(C,B)
redpred_40(A,B) :- p248(A,C),p22(C,B)
redpred_41(A,B) :- p35(A,C),p19(C,B)
redpred_42(A,B) :- p22(A,C),mk_lowercase(C,B)
redpred_43(A,B) :- copy1(A,C),p19(C,B)
redpred_44(A,B) :- p29(A,C),p22(C,B)
redpred_45(A,B) :- p80(A,C),p248(C,B)
redpred_46(A,B) :- copy1(A,C),p114(C,B)
redpred_47(A,B) :- p29(A,C),p106(C,B)
redpred_48(A,B) :- p248(A,C),p80(C,B)
redpred_49(A,B) :- mk_lowercase(A,C),p465(C,B)
redpred_50(A,B) :- p248(A,C),p29(C,B)
redpred_51(A,B) :- mk_lowercase(A,C),p114(C,B)
redpred_52(A,B) :- p35(A,C),p29(C,B)
redpred_53(A,B) :- mk_lowercase(A,C),p29(C,B)
redpred_54(A,B) :- mk_uppercase(A,C),p29(C,B)
redpred_55(A,B) :- skip1(A,C),p465(C,B)
redpred_56(A,B) :- p19(A,C),p29(C,B)
redpred_57(A,B) :- p465(A,C),p465(C,B)
redpred_58(A,B) :- p45(A,C),p29(C,B)
redpred_59(A,B) :- p29(A,C),p114(C,B)
redpred_60(A,B) :- p465(A,C),p19(C,B)
redpred_61(A,B) :- p80(A,C),p22(C,B)
redpred_62(A,B) :- mk_uppercase(A,C),p80(C,B)
redpred_63(A,B) :- p29(A,C),p465(C,B)
redpred_64(A,B) :- p44(A,C),p194(C,B)
redpred_65(A,B) :- skip1(A,C),p116_1(C,B)
redpred_66(A,B) :- p3_1(A,C),p24_1(C,B)
redpred_67(A,B) :- p79(A,C),copy1(C,B)
redpred_68(A,B) :- skip1(A,C),p345(C,B)
redpred_69(A,B) :- p121(A,C),p467(C,B)
redpred_70(A,B) :- p44(A,C),mk_uppercase(C,B)
redpred_71(A,B) :- copy1(A,C),p27(C,B)
redpred_72(A,B) :- p1_1(A,C),p184(C,B)
redpred_73(A,B) :- skip1(A,C),p44(C,B)
redpred_74(A,B) :- skip1(A,C),p187(C,B)
redpred_75(A,B) :- p410(A,C),p116_1(C,B)
redpred_76(A,B) :- skip1(A,C),p141(C,B)
redpred_77(A,B) :- p44(A,C),mk_lowercase(C,B)
redpred_78(A,B) :- copy1(A,C),p44(C,B)
redpred_79(A,B) :- p105(A,C),copy1(C,B)
redpred_80(A,B) :- p44_1(A,C),p74(C,B)
redpred_81(A,B) :- p44(A,C),p248(C,B)
redpred_82(A,B) :- p318(A,C),p33(C,B)
redpred_83(A,B) :- p2_1(A,C),p184(C,B)
redpred_84(A,B) :- p116_1(A,C),p510(C,B)
redpred_85(A,B) :- p85(A,C),p132_1(C,B)
redpred_86(A,B) :- p44(A,C),p22(C,B)
redpred_87(A,B) :- p248(A,C),p323(C,B)
redpred_88(A,B) :- skip1(A,C),p191_1(C,B)
...
p390(A,B) :- redpred_11(A,B)
p395(A,B) :- redpred_10(A,B)
p396(A,B) :- redpred_6(A,B)
p398(A,B) :- redpred_10(A,B)
...
p465(A,B) :- redpred_14(A,B)
p469(A,B) :- redpred_14(A,B)
p470(A,B) :- redpred_6(A,B)
p474(A,B) :- redpred_14(A,B)
...
p578(A,B) :- redpred_9(A,B)
p580(A,B) :- redpred_10(A,B)
p581(A,B) :- redpred_14(A,B)
...
p24_1(A,B) :- redpred_20(A,B)
p26(A,B) :- copy1(A,C),p26_1(C,B)
p26_1(A,B) :- redpred_16(A,B)
...
p551(A,B) :- redpred_25(A,B)
p555(A,B) :- redpred_62(A,B)
p557(A,B) :- p557_1(A,C),p557_1(C,B)
p557_1(A,B) :- redpred_34(A,B)
p560(A,B) :- redpred_62(A,B)
p561(A,B) :- p35(A,C),p561_1(C,B)
p561_1(A,B) :- redpred_61(A,B)
p569(A,B) :- redpred_55(A,B)
p571(A,B) :- p29(A,C),p571_1(C,B)
p571_1(A,B) :- redpred_38(A,B)
p577(A,B) :- copy1(A,C),p577_1(C,B)
p577_1(A,B) :- redpred_63(A,B)
...
p674_1(A,B) :- redpred_15(A,B)
p675(A,B) :- redpred_60(A,B)
...
p108(A,B) :- redpred_72(A,B)
p110(A,B) :- p234(A,C),p110_1(C,B)
p110_1(A,B) :- redpred_73(A,B)
...
p322_1(A,B) :- redpred_76(A,B)
p324(A,B) :- p19(A,C),p324_1(C,B)
p324_1(A,B) :- redpred_77(A,B)
p325(A,B) :- redpred_75(A,B)
...
p468_1(A,B) :- redpred_68(A,B)
p471(A,B) :- skip1(A,C),p471_1(C,B)
p471_1(A,B) :- redpred_81(A,B)
...
p662_1(A,B) :- redpred_83(A,B)
p664(A,B) :- redpred_73(A,B)
