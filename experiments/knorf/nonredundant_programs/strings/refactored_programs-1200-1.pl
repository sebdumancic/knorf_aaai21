...
redpred_17(A,B) :- skip1(A,C),p370(C,B)
redpred_18(A,B) :- skip1(A,C),p37(C,B)
redpred_19(A,B) :- p4(A,C),p129(C,B)
redpred_20(A,B) :- p256(A,C),p256(C,B)
redpred_21(A,B) :- p189(A,C),p129(C,B)
redpred_22(A,B) :- p129(A,C),p37(C,B)
redpred_23(A,B) :- p417(A,C),p370(C,B)
redpred_24(A,B) :- p4(A,C),p370(C,B)
redpred_25(A,B) :- skip1(A,C),p106(C,B)
redpred_26(A,B) :- p37(A,C),p37(C,B)
redpred_27(A,B) :- p106(A,C),p37(C,B)
redpred_28(A,B) :- p37(A,C),p256(C,B)
redpred_29(A,B) :- p4(A,C),p37(C,B)
redpred_30(A,B) :- p213(A,C),p106(C,B)
redpred_31(A,B) :- skip1(A,C),p189(C,B)
redpred_32(A,B) :- copy1(A,C),p4(C,B)
redpred_33(A,B) :- copy1(A,C),p37(C,B)
redpred_34(A,B) :- p256(A,C),p129(C,B)
redpred_35(A,B) :- p4(A,C),p106(C,B)
redpred_36(A,B) :- p129(A,C),p417(C,B)
redpred_37(A,B) :- skip1(A,C),p4(C,B)
redpred_38(A,B) :- skip1(A,C),p417(C,B)
redpred_39(A,B) :- p37(A,C),p106(C,B)
redpred_40(A,B) :- p4(A,C),p4(C,B)
redpred_41(A,B) :- p37(A,C),p4(C,B)
redpred_42(A,B) :- p537(A,C),p4(C,B)
redpred_43(A,B) :- p129(A,C),p189(C,B)
redpred_44(A,B) :- p213(A,C),p37(C,B)
redpred_45(A,B) :- p37(A,C),p417(C,B)
redpred_46(A,B) :- p37(A,C),p189(C,B)
redpred_47(A,B) :- p189(A,C),p4(C,B)
redpred_48(A,B) :- p189(A,C),p37(C,B)
redpred_49(A,B) :- copy1(A,C),p370(C,B)
redpred_50(A,B) :- p4(A,C),p189(C,B)
redpred_51(A,B) :- p256(A,C),p213(C,B)
redpred_52(A,B) :- copy1(A,C),p213(C,B)
redpred_53(A,B) :- p537(A,C),p37(C,B)
redpred_54(A,B) :- p4(A,C),p213(C,B)
redpred_55(A,B) :- p4(A,C),p537(C,B)
redpred_56(A,B) :- copy1(A,C),p129(C,B)
redpred_57(A,B) :- copy1(A,C),p106(C,B)
redpred_58(A,B) :- p37(A,C),p213(C,B)
redpred_59(A,B) :- p213(A,C),p4(C,B)
redpred_60(A,B) :- p93(A,C),p4(C,B)
redpred_61(A,B) :- mk_uppercase(A,C),p37(C,B)
redpred_62(A,B) :- skip1(A,C),p129(C,B)
redpred_63(A,B) :- copy1(A,C),p256(C,B)
redpred_64(A,B) :- p417(A,C),p417(C,B)
redpred_65(A,B) :- p417(A,C),p4(C,B)
redpred_66(A,B) :- skip1(A,C),p256(C,B)
redpred_67(A,B) :- skip1(A,C),p213(C,B)
redpred_68(A,B) :- p256(A,C),p37(C,B)
redpred_69(A,B) :- p129(A,C),p4(C,B)
redpred_70(A,B) :- p189(A,C),p189(C,B)
redpred_71(A,B) :- p189(A,C),p417(C,B)
redpred_72(A,B) :- p4(A,C),p256(C,B)
redpred_73(A,B) :- p4(A,C),p375(C,B)
redpred_74(A,B) :- mk_uppercase(A,C),p189(C,B)
redpred_75(A,B) :- p106(A,C),p4(C,B)
redpred_76(A,B) :- skip1(A,C),p375(C,B)
redpred_77(A,B) :- copy1(A,C),p189(C,B)
redpred_78(A,B) :- p370(A,C),p4(C,B)
redpred_79(A,B) :- p37(A,C),p129(C,B)
redpred_80(A,B) :- mk_lowercase(A,C),p4(C,B)
redpred_81(A,B) :- p213(A,C),p537(C,B)
redpred_82(A,B) :- copy1(A,C),p417(C,B)
redpred_83(A,B) :- mk_lowercase(A,C),p213(C,B)
redpred_84(A,B) :- skip1(A,C),p537(C,B)
redpred_85(A,B) :- skip1(A,C),p977(C,B)
redpred_86(A,B) :- copy1(A,C),p978(C,B)
redpred_87(A,B) :- copy1(A,C),p413(C,B)
redpred_88(A,B) :- p1054(A,C),copy1(C,B)
redpred_89(A,B) :- p312(A,C),p89_1(C,B)
redpred_90(A,B) :- p312(A,C),p80(C,B)
redpred_91(A,B) :- p106(A,C),p111(C,B)
redpred_92(A,B) :- skip1(A,C),p123(C,B)
redpred_93(A,B) :- skip1(A,C),p978(C,B)
redpred_94(A,B) :- p413(A,C),p80(C,B)
redpred_95(A,B) :- p977(A,C),copy1(C,B)
redpred_96(A,B) :- mk_lowercase(A,C),p476(C,B)
redpred_97(A,B) :- p118(A,C),p111_1(C,B)
redpred_98(A,B) :- skip1(A,C),p27(C,B)
redpred_99(A,B) :- p54_1(A,C),p346(C,B)
redpred_100(A,B) :- p54_1(A,C),p150(C,B)
redpred_101(A,B) :- p71(A,C),mk_lowercase(C,B)
redpred_102(A,B) :- skip1(A,C),p413(C,B)
redpred_103(A,B) :- p1071(A,C),p112(C,B)
redpred_104(A,B) :- copy1(A,C),p65(C,B)
redpred_105(A,B) :- mk_uppercase(A,C),p151(C,B)
redpred_106(A,B) :- p537(A,C),p349_1(C,B)
redpred_107(A,B) :- p1098(A,C),p80(C,B)
redpred_108(A,B) :- p150(A,C),p200_1(C,B)
redpred_109(A,B) :- p6_1(A,C),p332(C,B)
redpred_110(A,B) :- p89_1(A,C),p111(C,B)
redpred_111(A,B) :- p529(A,C),copy1(C,B)
redpred_112(A,B) :- p71(A,C),p150(C,B)
...
p449_1(A,B) :- redpred_68(A,B)
p454(A,B) :- redpred_32(A,B)
p465(A,B) :- redpred_26(A,B)
p466(A,B) :- copy1(A,C),p466_1(C,B)
p466_1(A,B) :- redpred_38(A,B)
p469(A,B) :- p129(A,C),p469_1(C,B)
p469_1(A,B) :- redpred_66(A,B)
p470(A,B) :- redpred_19(A,B)
p471(A,B) :- redpred_66(A,B)
...
p476_1(A,B) :- redpred_37(A,B)
p478(A,B) :- skip1(A,C),p478_1(C,B)
p478_1(A,B) :- redpred_70(A,B)
...
p487_1(A,B) :- redpred_65(A,B)
p489(A,B) :- copy1(A,C),p489_1(C,B)
p489_1(A,B) :- redpred_31(A,B)
...
p683_1(A,B) :- redpred_29(A,B)
p687(A,B) :- copy1(A,C),p687_1(C,B)
p687_1(A,B) :- redpred_31(A,B)
p691(A,B) :- p106(A,C),p691_1(C,B)
p691_1(A,B) :- redpred_66(A,B)
...
p756(A,B) :- redpred_29(A,B)
p757(A,B) :- redpred_33(A,B)
p763(A,B) :- redpred_23(A,B)
p770(A,B) :- redpred_82(A,B)
...
p1095(A,B) :- redpred_67(A,B)
p1096(A,B) :- p375(A,C),p37(C,B)
p1098(A,B) :- mk_lowercase(A,C),p256(C,B)
p1099(A,B) :- skip1(A,C),p1099_1(C,B)
p1099_1(A,B) :- redpred_54(A,B)
p1102(A,B) :- copy1(A,C),p1102_1(C,B)
p1102_1(A,B) :- redpred_79(A,B)
p1103(A,B) :- redpred_33(A,B)
p1104(A,B) :- redpred_19(A,B)
p1105(A,B) :- redpred_56(A,B)
p1110(A,B) :- redpred_50(A,B)
...
p729_1(A,B) :- redpred_108(A,B)
p730(A,B) :- p489(A,C),p628(C,B)
p732(A,B) :- redpred_90(A,B)
...
p739_1(A,B) :- redpred_98(A,B)
p742(A,B) :- copy1(A,C),p742_1(C,B)
p742_1(A,B) :- redpred_102(A,B)
...
p858_1(A,B) :- redpred_106(A,B)
p859(A,B) :- p37(A,C),p1102(C,B)
p862(A,B) :- redpred_110(A,B)
p864(A,B) :- p369(A,C),p29(C,B)
p866(A,B) :- p369_1(A,C),p978(C,B)
p869(A,B) :- redpred_105(A,B)
p870(A,B) :- redpred_111(A,B)
...
p955(A,B) :- redpred_99(A,B)
p958(A,B) :- p89_1(A,C),p385(C,B)
p959(A,B) :- redpred_110(A,B)
