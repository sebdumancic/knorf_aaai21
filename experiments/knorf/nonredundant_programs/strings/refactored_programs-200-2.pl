...
redpred_7(A,B) :- skip1(A,C),p81(C,B)
redpred_8(A,B) :- copy1(A,C),p62(C,B)
redpred_9(A,B) :- skip1(A,C),p7(C,B)
redpred_10(A,B) :- mk_uppercase(A,C),p81(C,B)
redpred_11(A,B) :- copy1(A,C),p57(C,B)
redpred_12(A,B) :- p81(A,C),p81(C,B)
redpred_13(A,B) :- skip1(A,C),p57(C,B)
redpred_14(A,B) :- copy1(A,C),p81(C,B)
redpred_15(A,B) :- p7(A,C),p81(C,B)
redpred_16(A,B) :- skip1(A,C),p135(C,B)
redpred_17(A,B) :- p62(A,C),p7(C,B)
redpred_18(A,B) :- p114(A,C),p7(C,B)
redpred_19(A,B) :- skip1(A,C),p27(C,B)
redpred_20(A,B) :- copy1(A,C),p7(C,B)
redpred_21(A,B) :- p135(A,C),copy1(C,B)
redpred_22(A,B) :- p27(A,C),mk_lowercase(C,B)
redpred_23(A,B) :- skip1(A,C),p114(C,B)
redpred_24(A,B) :- p81(A,C),p7(C,B)
redpred_25(A,B) :- p60(A,C),p60(C,B)
...
p2(A,B) :- redpred_7(A,B)
p5(A,B) :- mk_lowercase(A,C),p5_1(C,B)
p5_1(A,B) :- redpred_8(A,B)
p11(A,B) :- redpred_9(A,B)
p12(A,B) :- copy1(A,C),p27(C,B)
p13(A,B) :- skip1(A,C),p13_1(C,B)
p13_1(A,B) :- redpred_9(A,B)
...
p92(A,B) :- redpred_14(A,B)
p93(A,B) :- p114(A,C),p93_1(C,B)
p93_1(A,B) :- redpred_19(A,B)
...
p189_1(A,B) :- redpred_17(A,B)
p191(A,B) :- redpred_12(A,B)
p192(A,B) :- redpred_15(A,B)
