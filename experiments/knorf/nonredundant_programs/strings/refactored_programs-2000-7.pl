...
redpred_18(A,B) :- p184(A,C),p1(C,B)
redpred_19(A,B) :- mk_uppercase(A,C),p18(C,B)
redpred_20(A,B) :- p86(A,C),p1(C,B)
redpred_21(A,B) :- p1(A,C),p1(C,B)
redpred_22(A,B) :- skip1(A,C),p40(C,B)
redpred_23(A,B) :- p1(A,C),p53(C,B)
redpred_24(A,B) :- skip1(A,C),p86(C,B)
redpred_25(A,B) :- p53(A,C),p18(C,B)
redpred_26(A,B) :- copy1(A,C),p1(C,B)
redpred_27(A,B) :- skip1(A,C),p53(C,B)
redpred_28(A,B) :- p18(A,C),p1(C,B)
redpred_29(A,B) :- p18(A,C),p40(C,B)
redpred_30(A,B) :- copy1(A,C),p40(C,B)
redpred_31(A,B) :- p1(A,C),p18(C,B)
redpred_32(A,B) :- skip1(A,C),p208(C,B)
redpred_33(A,B) :- p208(A,C),p86(C,B)
redpred_34(A,B) :- p18(A,C),p184(C,B)
redpred_35(A,B) :- skip1(A,C),p184(C,B)
redpred_36(A,B) :- p184(A,C),p18(C,B)
redpred_37(A,B) :- skip1(A,C),p18(C,B)
redpred_38(A,B) :- p18(A,C),p208(C,B)
redpred_39(A,B) :- p1(A,C),p184(C,B)
redpred_40(A,B) :- p208(A,C),p1(C,B)
redpred_41(A,B) :- p18(A,C),p18(C,B)
redpred_42(A,B) :- mk_lowercase(A,C),p18(C,B)
redpred_43(A,B) :- p5(A,C),p86(C,B)
redpred_44(A,B) :- p5(A,C),p5(C,B)
redpred_45(A,B) :- p1(A,C),p5(C,B)
redpred_46(A,B) :- copy1(A,C),p53(C,B)
redpred_47(A,B) :- skip1(A,C),p5(C,B)
redpred_48(A,B) :- copy1(A,C),p184(C,B)
redpred_49(A,B) :- p18(A,C),p136(C,B)
redpred_50(A,B) :- p86(A,C),p208(C,B)
redpred_51(A,B) :- copy1(A,C),p5(C,B)
redpred_52(A,B) :- mk_uppercase(A,C),p86(C,B)
redpred_53(A,B) :- p1(A,C),p86(C,B)
redpred_54(A,B) :- p86(A,C),p184(C,B)
redpred_55(A,B) :- p1(A,C),p40(C,B)
redpred_56(A,B) :- p86(A,C),p18(C,B)
redpred_57(A,B) :- p184(A,C),p208(C,B)
redpred_58(A,B) :- p53(A,C),p5(C,B)
redpred_59(A,B) :- mk_lowercase(A,C),p1(C,B)
redpred_60(A,B) :- mk_lowercase(A,C),p5(C,B)
redpred_61(A,B) :- copy1(A,C),p18(C,B)
redpred_62(A,B) :- p40(A,C),p1(C,B)
redpred_63(A,B) :- p5(A,C),p18(C,B)
redpred_64(A,B) :- copy1(A,C),p86(C,B)
redpred_65(A,B) :- mk_uppercase(A,C),p1(C,B)
redpred_66(A,B) :- p18(A,C),p53(C,B)
redpred_67(A,B) :- p53(A,C),p1(C,B)
redpred_68(A,B) :- p208(A,C),p53(C,B)
redpred_69(A,B) :- copy1(A,C),p208(C,B)
redpred_70(A,B) :- skip1(A,C),p501(C,B)
redpred_71(A,B) :- p1(A,C),p339(C,B)
redpred_72(A,B) :- p18(A,C),p5(C,B)
redpred_73(A,B) :- p339(A,C),p18(C,B)
redpred_74(A,B) :- skip1(A,C),p136(C,B)
redpred_75(A,B) :- p208(A,C),p18(C,B)
redpred_76(A,B) :- skip1(A,C),p339(C,B)
redpred_77(A,B) :- mk_uppercase(A,C),p5(C,B)
redpred_78(A,B) :- p86(A,C),p501(C,B)
redpred_79(A,B) :- p18(A,C),p86(C,B)
redpred_80(A,B) :- p40(A,C),p5(C,B)
redpred_81(A,B) :- skip1(A,C),p56(C,B)
redpred_82(A,B) :- copy1(A,C),p339(C,B)
redpred_83(A,B) :- p18(A,C),p501(C,B)
redpred_84(A,B) :- p56(A,C),p18(C,B)
redpred_85(A,B) :- p40(A,C),p18(C,B)
redpred_86(A,B) :- p53(A,C),p86(C,B)
redpred_87(A,B) :- p5(A,C),p1(C,B)
redpred_88(A,B) :- p1(A,C),p208(C,B)
redpred_89(A,B) :- p53(A,C),p40(C,B)
redpred_90(A,B) :- p501(A,C),p5(C,B)
redpred_91(A,B) :- mk_lowercase(A,C),p86(C,B)
redpred_92(A,B) :- p53(A,C),p53(C,B)
redpred_93(A,B) :- mk_lowercase(A,C),p40(C,B)
redpred_94(A,B) :- mk_uppercase(A,C),p53(C,B)
redpred_95(A,B) :- skip1(A,C),p90(C,B)
redpred_96(A,B) :- skip1(A,C),p781(C,B)
redpred_97(A,B) :- skip1(A,C),p682(C,B)
redpred_98(A,B) :- p119_1(A,C),p154(C,B)
redpred_99(A,B) :- copy1(A,C),p68(C,B)
redpred_100(A,B) :- p59(A,C),p781(C,B)
redpred_101(A,B) :- skip1(A,C),p68(C,B)
redpred_102(A,B) :- copy1(A,C),p682(C,B)
redpred_103(A,B) :- p53(A,C),p781(C,B)
redpred_104(A,B) :- p362(A,C),p516(C,B)
redpred_105(A,B) :- p682(A,C),p122(C,B)
redpred_106(A,B) :- p63_1(A,C),p326(C,B)
redpred_107(A,B) :- p1(A,C),p241(C,B)
redpred_108(A,B) :- p149(A,C),p480(C,B)
redpred_109(A,B) :- p49(A,C),mk_uppercase(C,B)
redpred_110(A,B) :- p302(A,C),p1(C,B)
redpred_111(A,B) :- skip1(A,C),p81(C,B)
redpred_112(A,B) :- skip1(A,C),p390(C,B)
redpred_113(A,B) :- copy1(A,C),p390(C,B)
redpred_114(A,B) :- p119(A,C),p106(C,B)
redpred_115(A,B) :- p1(A,C),p59(C,B)
redpred_116(A,B) :- skip1(A,C),p1655(C,B)
redpred_117(A,B) :- p2_1(A,C),p1387(C,B)
redpred_118(A,B) :- mk_lowercase(A,C),p326(C,B)
redpred_119(A,B) :- p1(A,C),p1362(C,B)
redpred_120(A,B) :- skip1(A,C),p514(C,B)
redpred_121(A,B) :- p63_1(A,C),p21_1(C,B)
redpred_122(A,B) :- p50_1(A,C),p642(C,B)
redpred_123(A,B) :- skip1(A,C),p1978(C,B)
redpred_124(A,B) :- p59(A,C),p94(C,B)
redpred_125(A,B) :- copy1(A,C),p781(C,B)
redpred_126(A,B) :- copy1(A,C),p3(C,B)
redpred_127(A,B) :- p302(A,C),mk_uppercase(C,B)
redpred_128(A,B) :- p1(A,C),p781(C,B)
redpred_129(A,B) :- mk_uppercase(A,C),p1362(C,B)
redpred_130(A,B) :- skip1(A,C),p122(C,B)
redpred_131(A,B) :- p2_1(A,C),p50_1(C,B)
redpred_132(A,B) :- p682(A,C),p1314(C,B)
redpred_133(A,B) :- p208(A,C),p68(C,B)
redpred_134(A,B) :- copy1(A,C),p326(C,B)
redpred_135(A,B) :- p362(A,C),p153(C,B)
redpred_136(A,B) :- p1(A,C),p493(C,B)
redpred_137(A,B) :- skip1(A,C),p302(C,B)
redpred_138(A,B) :- p2_1(A,C),p326(C,B)
redpred_139(A,B) :- copy1(A,C),p99(C,B)
redpred_140(A,B) :- p8(A,C),p18(C,B)
redpred_141(A,B) :- p46(A,C),p1314(C,B)
redpred_142(A,B) :- p1772(A,C),p77_1(C,B)
redpred_143(A,B) :- skip1(A,C),p423_1(C,B)
redpred_144(A,B) :- skip1(A,C),p1239(C,B)
...
p1555(A,B) :- redpred_12(A,B)
p1556(A,B) :- redpred_4(A,B)
p1559(A,B) :- redpred_10(A,B)
...
p118_1(A,B) :- redpred_31(A,B)
p119(A,B) :- copy1(A,C),p119_1(C,B)
p119_1(A,B) :- redpred_41(A,B)
p122(A,B) :- skip1(A,C),p122_1(C,B)
p122_1(A,B) :- redpred_21(A,B)
...
p640_1(A,B) :- redpred_44(A,B)
p641(A,B) :- redpred_25(A,B)
p642(A,B) :- redpred_79(A,B)
p644(A,B) :- redpred_45(A,B)
p646(A,B) :- redpred_37(A,B)
p651(A,B) :- redpred_75(A,B)
p656(A,B) :- mk_uppercase(A,C),p656_1(C,B)
p656_1(A,B) :- redpred_70(A,B)
p658(A,B) :- redpred_42(A,B)
p659(A,B) :- redpred_17(A,B)
p661(A,B) :- skip1(A,C),p661_1(C,B)
p661_1(A,B) :- redpred_24(A,B)
p662(A,B) :- redpred_80(A,B)
p663(A,B) :- skip1(A,C),p663_1(C,B)
p663_1(A,B) :- redpred_32(A,B)
...
p691(A,B) :- redpred_63(A,B)
p694(A,B) :- p501(A,C),p694_1(C,B)
p694_1(A,B) :- redpred_81(A,B)
p696(A,B) :- mk_lowercase(A,C),p696_1(C,B)
p696_1(A,B) :- redpred_35(A,B)
p698(A,B) :- p501(A,C),p698_1(C,B)
p698_1(A,B) :- redpred_66(A,B)
...
p1105_1(A,B) :- redpred_66(A,B)
p1106(A,B) :- redpred_35(A,B)
p1108(A,B) :- redpred_63(A,B)
p1109(A,B) :- p18(A,C),p1109_1(C,B)
p1109_1(A,B) :- redpred_47(A,B)
p1114(A,B) :- redpred_37(A,B)
p1115(A,B) :- redpred_21(A,B)
p1116(A,B) :- skip1(A,C),p1116_1(C,B)
p1116_1(A,B) :- redpred_88(A,B)
p1118(A,B) :- p208(A,C),p1118_1(C,B)
p1118_1(A,B) :- redpred_34(A,B)
p1119(A,B) :- redpred_42(A,B)
p1119(A,B) :- skip1(A,C),p1119(C,B)
p1122(A,B) :- skip1(A,C),p1122_1(C,B)
p1122_1(A,B) :- redpred_56(A,B)
p1123(A,B) :- redpred_21(A,B)
p1125(A,B) :- p501(A,C),p1125_1(C,B)
p1125_1(A,B) :- redpred_56(A,B)
p1127(A,B) :- redpred_36(A,B)
...
p1426(A,B) :- redpred_21(A,B)
p1427(A,B) :- redpred_35(A,B)
p1434(A,B) :- p18(A,C),p1434_1(C,B)
p1434_1(A,B) :- redpred_34(A,B)
p1437(A,B) :- redpred_38(A,B)
p1441(A,B) :- p208(A,C),p40(C,B)
p1442(A,B) :- redpred_66(A,B)
p1445(A,B) :- skip1(A,C),p1445_1(C,B)
p1445_1(A,B) :- redpred_28(A,B)
p1447(A,B) :- redpred_61(A,B)
p1451(A,B) :- p1(A,C),p1451_1(C,B)
p1451_1(A,B) :- redpred_21(A,B)
p1453(A,B) :- redpred_61(A,B)
p1455(A,B) :- copy1(A,C),p1455_1(C,B)
p1455_1(A,B) :- redpred_21(A,B)
p1458(A,B) :- copy1(A,C),p1458_1(C,B)
p1458_1(A,B) :- redpred_84(A,B)
p1462(A,B) :- redpred_61(A,B)
p1463(A,B) :- redpred_58(A,B)
p1468(A,B) :- skip1(A,C),p1468_1(C,B)
p1468_1(A,B) :- redpred_45(A,B)
p1470(A,B) :- redpred_64(A,B)
p1471(A,B) :- redpred_32(A,B)
p1472(A,B) :- p40(A,C),p1472_1(C,B)
p1472_1(A,B) :- redpred_17(A,B)
p1473(A,B) :- copy1(A,C),p1473_1(C,B)
p1473_1(A,B) :- redpred_17(A,B)
p1478(A,B) :- p86(A,C),p1478_1(C,B)
p1478_1(A,B) :- redpred_40(A,B)
p1481(A,B) :- redpred_40(A,B)
p1486(A,B) :- redpred_45(A,B)
p1487(A,B) :- copy1(A,C),p1487_1(C,B)
p1487_1(A,B) :- redpred_37(A,B)
...
p1845(A,B) :- redpred_64(A,B)
p1849(A,B) :- copy1(A,C),p1849_1(C,B)
p1849_1(A,B) :- redpred_62(A,B)
p1852(A,B) :- redpred_19(A,B)
p1866(A,B) :- redpred_30(A,B)
p1867(A,B) :- skip1(A,C),p1867_1(C,B)
p1867_1(A,B) :- redpred_92(A,B)
...
p1988_1(A,B) :- redpred_40(A,B)
p1992(A,B) :- skip1(A,C),p1992_1(C,B)
p1992_1(A,B) :- redpred_39(A,B)
p1994(A,B) :- redpred_19(A,B)
p1998(A,B) :- p184(A,C),p1998_1(C,B)
p1998_1(A,B) :- redpred_28(A,B)
p1999(A,B) :- redpred_37(A,B)
...
p19(A,B) :- redpred_95(A,B)
p23(A,B) :- p1105(A,C),p269(C,B)
p26(A,B) :- redpred_96(A,B)
p29(A,B) :- mk_lowercase(A,C),p29_1(C,B)
p29_1(A,B) :- p302(A,C),p49_1(C,B)
p31(A,B) :- redpred_97(A,B)
p32(A,B) :- redpred_98(A,B)
...
p245(A,B) :- redpred_110(A,B)
p246(A,B) :- copy1(A,C),p246_1(C,B)
p246_1(A,B) :- redpred_111(A,B)
p250(A,B) :- p2_1(A,C),p816_1(C,B)
p261(A,B) :- redpred_112(A,B)
...
p763_1(A,B) :- redpred_101(A,B)
p765(A,B) :- redpred_113(A,B)
...
p774_1(A,B) :- redpred_132(A,B)
p775(A,B) :- redpred_123(A,B)
...
p880(A,B) :- redpred_129(A,B)
p881(A,B) :- redpred_130(A,B)
...
p959(A,B) :- redpred_132(A,B)
p962(A,B) :- copy1(A,C),p962_1(C,B)
p962_1(A,B) :- redpred_96(A,B)
...
p1374(A,B) :- redpred_138(A,B)
p1375(A,B) :- p254_1(A,C),p1988(C,B)
p1380(A,B) :- redpred_97(A,B)
p1382(A,B) :- redpred_139(A,B)
p1384(A,B) :- p106(A,C),p1758(C,B)
p1388(A,B) :- redpred_96(A,B)
...
p1645(A,B) :- redpred_97(A,B)
p1650(A,B) :- mk_lowercase(A,C),p1650_1(C,B)
p1650_1(A,B) :- redpred_97(A,B)
...
p1699(A,B) :- redpred_141(A,B)
p1700(A,B) :- p21_1(A,C),p302(C,B)
p1702(A,B) :- redpred_141(A,B)
...
p1745(A,B) :- redpred_142(A,B)
p1754(A,B) :- p59(A,C),p119_1(C,B)
p1755(A,B) :- redpred_120(A,B)
...
p814_1(A,B) :- redpred_145(A,B)
p907(A,B) :- skip1(A,C),p907_1(C,B)
p907_1(A,B) :- redpred_144(A,B)
