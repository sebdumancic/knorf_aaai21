...
redpred_15(A,B) :- skip1(A,C),p302(C,B)
redpred_16(A,B) :- skip1(A,C),p59(C,B)
redpred_17(A,B) :- p27(A,C),p188(C,B)
redpred_18(A,B) :- p39(A,C),p59(C,B)
redpred_19(A,B) :- skip1(A,C),p32(C,B)
redpred_20(A,B) :- p39(A,C),p39(C,B)
redpred_21(A,B) :- p39(A,C),p32(C,B)
redpred_22(A,B) :- p139(A,C),p59(C,B)
redpred_23(A,B) :- p59(A,C),p126(C,B)
redpred_24(A,B) :- skip1(A,C),p27(C,B)
redpred_25(A,B) :- p27(A,C),p27(C,B)
redpred_26(A,B) :- p27(A,C),p302(C,B)
redpred_27(A,B) :- p27(A,C),p32(C,B)
redpred_28(A,B) :- skip1(A,C),p39(C,B)
redpred_29(A,B) :- p27(A,C),p39(C,B)
redpred_30(A,B) :- p422(A,C),p27(C,B)
redpred_31(A,B) :- p126(A,C),p27(C,B)
redpred_32(A,B) :- p39(A,C),p27(C,B)
redpred_33(A,B) :- skip1(A,C),p139(C,B)
redpred_34(A,B) :- copy1(A,C),p27(C,B)
redpred_35(A,B) :- p302(A,C),p27(C,B)
redpred_36(A,B) :- copy1(A,C),p39(C,B)
redpred_37(A,B) :- copy1(A,C),p59(C,B)
redpred_38(A,B) :- p27(A,C),p59(C,B)
redpred_39(A,B) :- copy1(A,C),p126(C,B)
redpred_40(A,B) :- p39(A,C),p302(C,B)
redpred_41(A,B) :- p39(A,C),p139(C,B)
redpred_42(A,B) :- skip1(A,C),p422(C,B)
redpred_43(A,B) :- p32(A,C),p39(C,B)
redpred_44(A,B) :- skip1(A,C),p126(C,B)
redpred_45(A,B) :- p139(A,C),p27(C,B)
redpred_46(A,B) :- skip1(A,C),p188(C,B)
redpred_47(A,B) :- copy1(A,C),p302(C,B)
redpred_48(A,B) :- mk_lowercase(A,C),p39(C,B)
redpred_49(A,B) :- p139(A,C),p435(C,B)
redpred_50(A,B) :- p32(A,C),p27(C,B)
redpred_51(A,B) :- mk_uppercase(A,C),p39(C,B)
redpred_52(A,B) :- p39(A,C),p188(C,B)
redpred_53(A,B) :- p27(A,C),p139(C,B)
redpred_54(A,B) :- p126(A,C),p39(C,B)
redpred_55(A,B) :- skip1(A,C),p535(C,B)
redpred_56(A,B) :- p435(A,C),p27(C,B)
redpred_57(A,B) :- copy1(A,C),p32(C,B)
redpred_58(A,B) :- p139(A,C),p39(C,B)
redpred_59(A,B) :- p302(A,C),p188(C,B)
redpred_60(A,B) :- p126(A,C),p126(C,B)
redpred_61(A,B) :- p27(A,C),p535(C,B)
redpred_62(A,B) :- p59(A,C),p27(C,B)
redpred_63(A,B) :- p126(A,C),p32(C,B)
redpred_64(A,B) :- skip1(A,C),p435(C,B)
redpred_65(A,B) :- mk_lowercase(A,C),p27(C,B)
redpred_66(A,B) :- copy1(A,C),p275(C,B)
redpred_67(A,B) :- p86(A,C),p115(C,B)
redpred_68(A,B) :- mk_uppercase(A,C),p53(C,B)
redpred_69(A,B) :- p39(A,C),p484(C,B)
redpred_70(A,B) :- skip1(A,C),p807(C,B)
redpred_71(A,B) :- skip1(A,C),p581_1(C,B)
redpred_72(A,B) :- p86(A,C),p75_1(C,B)
redpred_73(A,B) :- p35_1(A,C),p152(C,B)
redpred_74(A,B) :- skip1(A,C),p35(C,B)
redpred_75(A,B) :- skip1(A,C),p283(C,B)
redpred_76(A,B) :- copy1(A,C),p35(C,B)
redpred_77(A,B) :- p329(A,C),p76(C,B)
redpred_78(A,B) :- mk_uppercase(A,C),p266(C,B)
redpred_79(A,B) :- skip1(A,C),p878(C,B)
redpred_80(A,B) :- p413(A,C),p239(C,B)
redpred_81(A,B) :- skip1(A,C),p239(C,B)
redpred_82(A,B) :- skip1(A,C),p934(C,B)
redpred_83(A,B) :- p35(A,C),p663_1(C,B)
redpred_84(A,B) :- p300(A,C),p139(C,B)
redpred_85(A,B) :- skip1(A,C),p372(C,B)
redpred_86(A,B) :- p239(A,C),p35_1(C,B)
redpred_87(A,B) :- skip1(A,C),p117(C,B)
redpred_88(A,B) :- skip1(A,C),p331(C,B)
...
p734(A,B) :- redpred_11(A,B)
p738(A,B) :- redpred_13(A,B)
p742(A,B) :- redpred_3(A,B)
p743(A,B) :- redpred_11(A,B)
...
p300_1(A,B) :- redpred_45(A,B)
p303(A,B) :- redpred_54(A,B)
p305(A,B) :- redpred_46(A,B)
...
p406(A,B) :- redpred_23(A,B)
p408(A,B) :- p27(A,C),p408_1(C,B)
p408_1(A,B) :- redpred_24(A,B)
p409(A,B) :- redpred_24(A,B)
...
p720_1(A,B) :- redpred_43(A,B)
p721(A,B) :- redpred_34(A,B)
p729(A,B) :- copy1(A,C),p729_1(C,B)
p729_1(A,B) :- redpred_45(A,B)
p736(A,B) :- redpred_63(A,B)
...
p756_1(A,B) :- redpred_25(A,B)
p759(A,B) :- redpred_25(A,B)
p760(A,B) :- p32(A,C),p435(C,B)
p761(A,B) :- redpred_61(A,B)
...
p996_1(A,B) :- redpred_24(A,B)
p1000(A,B) :- redpred_16(A,B)
...
p163(A,B) :- redpred_72(A,B)
p166(A,B) :- redpred_73(A,B)
...
p859_1(A,B) :- redpred_71(A,B)
p860(A,B) :- copy1(A,C),p860_1(C,B)
p860_1(A,B) :- redpred_86(A,B)
