...
redpred_15(A,B) :- copy1(A,C),p22(C,B)
redpred_16(A,B) :- p22(A,C),p241(C,B)
redpred_17(A,B) :- p11(A,C),p11(C,B)
redpred_18(A,B) :- p29(A,C),p165(C,B)
redpred_19(A,B) :- skip1(A,C),p22(C,B)
redpred_20(A,B) :- p22(A,C),p176(C,B)
redpred_21(A,B) :- mk_lowercase(A,C),p22(C,B)
redpred_22(A,B) :- p22(A,C),p22(C,B)
redpred_23(A,B) :- p11(A,C),p22(C,B)
redpred_24(A,B) :- skip1(A,C),p11(C,B)
redpred_25(A,B) :- mk_uppercase(A,C),p22(C,B)
redpred_26(A,B) :- copy1(A,C),p11(C,B)
redpred_27(A,B) :- p11(A,C),p165(C,B)
redpred_28(A,B) :- p176(A,C),mk_lowercase(C,B)
redpred_29(A,B) :- p165(A,C),p22(C,B)
redpred_30(A,B) :- skip1(A,C),p86(C,B)
redpred_31(A,B) :- copy1(A,C),p763(C,B)
redpred_32(A,B) :- copy1(A,C),p176(C,B)
redpred_33(A,B) :- skip1(A,C),p29(C,B)
redpred_34(A,B) :- p86(A,C),p11(C,B)
redpred_35(A,B) :- p29(A,C),p86(C,B)
redpred_36(A,B) :- p22(A,C),p165(C,B)
redpred_37(A,B) :- p42(A,C),p22(C,B)
redpred_38(A,B) :- p29(A,C),p11(C,B)
redpred_39(A,B) :- p22(A,C),p11(C,B)
redpred_40(A,B) :- p46(A,C),p22(C,B)
redpred_41(A,B) :- p176(A,C),p241(C,B)
redpred_42(A,B) :- copy1(A,C),p241(C,B)
redpred_43(A,B) :- p11(A,C),p29(C,B)
redpred_44(A,B) :- p165(A,C),p11(C,B)
redpred_45(A,B) :- skip1(A,C),p241(C,B)
redpred_46(A,B) :- copy1(A,C),p165(C,B)
redpred_47(A,B) :- skip1(A,C),p165(C,B)
redpred_48(A,B) :- skip1(A,C),p46(C,B)
redpred_49(A,B) :- p86(A,C),p29(C,B)
redpred_50(A,B) :- p165(A,C),p86(C,B)
redpred_51(A,B) :- p176(A,C),p86(C,B)
redpred_52(A,B) :- p86(A,C),mk_lowercase(C,B)
redpred_53(A,B) :- p11(A,C),p241(C,B)
redpred_54(A,B) :- p22(A,C),p86(C,B)
redpred_55(A,B) :- p86(A,C),p22(C,B)
redpred_56(A,B) :- copy1(A,C),p86(C,B)
redpred_57(A,B) :- p165(A,C),p241(C,B)
redpred_58(A,B) :- p46(A,C),p42(C,B)
redpred_59(A,B) :- mk_uppercase(A,C),p11(C,B)
redpred_60(A,B) :- p11(A,C),p46(C,B)
redpred_61(A,B) :- p46(A,C),p241(C,B)
redpred_62(A,B) :- p29(A,C),p22(C,B)
redpred_63(A,B) :- p46(A,C),p11(C,B)
redpred_64(A,B) :- p11(A,C),p176(C,B)
redpred_65(A,B) :- p176(A,C),p11(C,B)
redpred_66(A,B) :- skip1(A,C),p176(C,B)
redpred_67(A,B) :- skip1(A,C),p42(C,B)
redpred_68(A,B) :- copy1(A,C),p29(C,B)
redpred_69(A,B) :- copy1(A,C),p577(C,B)
redpred_70(A,B) :- skip1(A,C),p736(C,B)
redpred_71(A,B) :- copy1(A,C),p319(C,B)
redpred_72(A,B) :- skip1(A,C),p16(C,B)
redpred_73(A,B) :- skip1(A,C),p493(C,B)
redpred_74(A,B) :- p213(A,C),copy1(C,B)
redpred_75(A,B) :- skip1(A,C),p150(C,B)
redpred_76(A,B) :- copy1(A,C),p16(C,B)
redpred_77(A,B) :- skip1(A,C),p175_1(C,B)
redpred_78(A,B) :- skip1(A,C),p28(C,B)
redpred_79(A,B) :- p31_1(A,C),p302(C,B)
redpred_80(A,B) :- p493(A,C),p57(C,B)
redpred_81(A,B) :- p362(A,C),p175_1(C,B)
redpred_82(A,B) :- copy1(A,C),p370(C,B)
redpred_83(A,B) :- copy1(A,C),p33(C,B)
redpred_84(A,B) :- skip1(A,C),p565(C,B)
redpred_85(A,B) :- p71(A,C),p165(C,B)
redpred_86(A,B) :- p171(A,C),p12_1(C,B)
redpred_87(A,B) :- p11(A,C),p103(C,B)
...
p243_1(A,B) :- redpred_53(A,B)
p258(A,B) :- redpred_43(A,B)
p260(A,B) :- p29(A,C),p260_1(C,B)
p260_1(A,B) :- redpred_40(A,B)
p262(A,B) :- redpred_15(A,B)
...
p270_1(A,B) :- redpred_47(A,B)
p272(A,B) :- mk_lowercase(A,C),p272_1(C,B)
p272_1(A,B) :- redpred_47(A,B)
...
p577_1(A,B) :- redpred_24(A,B)
p588(A,B) :- redpred_28(A,B)
p591(A,B) :- redpred_26(A,B)
p592(A,B) :- p86(A,C),p86(C,B)
p595(A,B) :- redpred_33(A,B)
...
p654_1(A,B) :- redpred_78(A,B)
p656(A,B) :- redpred_87(A,B)
...
p730(A,B) :- redpred_80(A,B)
p732(A,B) :- redpred_83(A,B)
p735(A,B) :- mk_uppercase(A,C),p735_1(C,B)
p735_1(A,B) :- redpred_73(A,B)
p738(A,B) :- redpred_76(A,B)
