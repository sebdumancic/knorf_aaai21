...
redpred_17(A,B) :- copy1(A,C),p55(C,B)
redpred_18(A,B) :- p83(A,C),p568(C,B)
redpred_19(A,B) :- skip1(A,C),p568(C,B)
redpred_20(A,B) :- p187(A,C),p1(C,B)
redpred_21(A,B) :- skip1(A,C),p83(C,B)
redpred_22(A,B) :- p6(A,C),p1(C,B)
redpred_23(A,B) :- skip1(A,C),p1(C,B)
redpred_24(A,B) :- p6(A,C),p55(C,B)
redpred_25(A,B) :- mk_uppercase(A,C),p1(C,B)
redpred_26(A,B) :- p1(A,C),p187(C,B)
redpred_27(A,B) :- skip1(A,C),p55(C,B)
redpred_28(A,B) :- p83(A,C),p1(C,B)
redpred_29(A,B) :- skip1(A,C),p399(C,B)
redpred_30(A,B) :- p5(A,C),p83(C,B)
redpred_31(A,B) :- p83(A,C),p83(C,B)
redpred_32(A,B) :- p1(A,C),p83(C,B)
redpred_33(A,B) :- p83(A,C),p481(C,B)
redpred_34(A,B) :- copy1(A,C),p83(C,B)
redpred_35(A,B) :- p1(A,C),p568(C,B)
redpred_36(A,B) :- p83(A,C),p187(C,B)
redpred_37(A,B) :- p83(A,C),p55(C,B)
redpred_38(A,B) :- mk_lowercase(A,C),p83(C,B)
redpred_39(A,B) :- copy1(A,C),p568(C,B)
redpred_40(A,B) :- p187(A,C),p83(C,B)
redpred_41(A,B) :- copy1(A,C),p1(C,B)
redpred_42(A,B) :- p55(A,C),p1(C,B)
redpred_43(A,B) :- skip1(A,C),p36(C,B)
redpred_44(A,B) :- p83(A,C),p399(C,B)
redpred_45(A,B) :- skip1(A,C),p54(C,B)
redpred_46(A,B) :- skip1(A,C),p187(C,B)
redpred_47(A,B) :- p6(A,C),p187(C,B)
redpred_48(A,B) :- p399(A,C),p1(C,B)
redpred_49(A,B) :- p55(A,C),p83(C,B)
redpred_50(A,B) :- skip1(A,C),p144(C,B)
redpred_51(A,B) :- p1(A,C),p1(C,B)
redpred_52(A,B) :- skip1(A,C),p5(C,B)
redpred_53(A,B) :- p36(A,C),p6(C,B)
redpred_54(A,B) :- p36(A,C),p55(C,B)
redpred_55(A,B) :- copy1(A,C),p187(C,B)
redpred_56(A,B) :- mk_lowercase(A,C),p55(C,B)
redpred_57(A,B) :- skip1(A,C),p6(C,B)
redpred_58(A,B) :- p36(A,C),p1(C,B)
redpred_59(A,B) :- p399(A,C),p6(C,B)
redpred_60(A,B) :- p399(A,C),p83(C,B)
redpred_61(A,B) :- mk_uppercase(A,C),p399(C,B)
redpred_62(A,B) :- p1(A,C),p6(C,B)
redpred_63(A,B) :- p187(A,C),p6(C,B)
redpred_64(A,B) :- p1(A,C),p36(C,B)
redpred_65(A,B) :- skip1(A,C),p481(C,B)
redpred_66(A,B) :- p187(A,C),p481(C,B)
redpred_67(A,B) :- mk_lowercase(A,C),p1(C,B)
redpred_68(A,B) :- p83(A,C),p5(C,B)
redpred_69(A,B) :- p5(A,C),p6(C,B)
redpred_70(A,B) :- p5(A,C),p1(C,B)
redpred_71(A,B) :- p1(A,C),p55(C,B)
redpred_72(A,B) :- mk_uppercase(A,C),p83(C,B)
redpred_73(A,B) :- mk_lowercase(A,C),p399(C,B)
redpred_74(A,B) :- p6(A,C),p83(C,B)
redpred_75(A,B) :- p399(A,C),p399(C,B)
redpred_76(A,B) :- p5(A,C),p481(C,B)
redpred_77(A,B) :- p1(A,C),p399(C,B)
redpred_78(A,B) :- copy1(A,C),p399(C,B)
redpred_79(A,B) :- p187(A,C),p187(C,B)
redpred_80(A,B) :- p54(A,C),p1(C,B)
redpred_81(A,B) :- p83(A,C),p6(C,B)
redpred_82(A,B) :- p1(A,C),p481(C,B)
redpred_83(A,B) :- p187(A,C),p399(C,B)
redpred_84(A,B) :- mk_lowercase(A,C),p187(C,B)
redpred_85(A,B) :- copy1(A,C),p5(C,B)
redpred_86(A,B) :- p399(A,C),p187(C,B)
redpred_87(A,B) :- p1(A,C),p5(C,B)
redpred_88(A,B) :- p54(A,C),p36(C,B)
redpred_89(A,B) :- p144(A,C),p144(C,B)
redpred_90(A,B) :- p36(A,C),p83(C,B)
redpred_91(A,B) :- copy1(A,C),p36(C,B)
redpred_92(A,B) :- p173(A,C),p167(C,B)
redpred_93(A,B) :- p167(A,C),p875(C,B)
redpred_94(A,B) :- copy1(A,C),p552(C,B)
redpred_95(A,B) :- skip1(A,C),p135(C,B)
redpred_96(A,B) :- p135(A,C),p246_1(C,B)
redpred_97(A,B) :- p1(A,C),p89(C,B)
redpred_98(A,B) :- p147(A,C),p71(C,B)
redpred_99(A,B) :- p1187(A,C),mk_lowercase(C,B)
redpred_100(A,B) :- copy1(A,C),p42(C,B)
redpred_101(A,B) :- p442(A,C),p125(C,B)
redpred_102(A,B) :- p21(A,C),p35(C,B)
redpred_103(A,B) :- p442(A,C),mk_uppercase(C,B)
redpred_104(A,B) :- copy1(A,C),p1105(C,B)
redpred_105(A,B) :- p135(A,C),p5(C,B)
redpred_106(A,B) :- p552(A,C),p149(C,B)
redpred_107(A,B) :- copy1(A,C),p224(C,B)
redpred_108(A,B) :- p442(A,C),p23_1(C,B)
redpred_109(A,B) :- copy1(A,C),p190(C,B)
redpred_110(A,B) :- copy1(A,C),p611(C,B)
redpred_111(A,B) :- mk_lowercase(A,C),p893(C,B)
redpred_112(A,B) :- p337(A,C),p40(C,B)
redpred_113(A,B) :- skip1(A,C),p1085(C,B)
redpred_114(A,B) :- skip1(A,C),p442(C,B)
redpred_115(A,B) :- copy1(A,C),p771(C,B)
redpred_116(A,B) :- skip1(A,C),p21(C,B)
redpred_117(A,B) :- p1(A,C),p509(C,B)
redpred_118(A,B) :- copy1(A,C),p21(C,B)
redpred_119(A,B) :- skip1(A,C),p611(C,B)
redpred_120(A,B) :- copy1(A,C),p1776(C,B)
redpred_121(A,B) :- p167(A,C),p125(C,B)
redpred_122(A,B) :- skip1(A,C),p560(C,B)
redpred_123(A,B) :- copy1(A,C),p100(C,B)
redpred_124(A,B) :- p5(A,C),p147(C,B)
redpred_125(A,B) :- p125(A,C),p246_1(C,B)
redpred_126(A,B) :- skip1(A,C),p552(C,B)
redpred_127(A,B) :- p135(A,C),p92_1(C,B)
redpred_128(A,B) :- p125(A,C),p441(C,B)
redpred_129(A,B) :- skip1(A,C),p509(C,B)
redpred_130(A,B) :- p399(A,C),p509(C,B)
redpred_131(A,B) :- p83(A,C),p1646(C,B)
redpred_132(A,B) :- skip1(A,C),p190(C,B)
redpred_133(A,B) :- p125(A,C),p552(C,B)
redpred_134(A,B) :- p135(A,C),p36(C,B)
redpred_135(A,B) :- p83(A,C),p135(C,B)
redpred_136(A,B) :- p21_1(A,C),p237_1(C,B)
redpred_137(A,B) :- p21_1(A,C),p614(C,B)
redpred_138(A,B) :- skip1(A,C),p1280(C,B)
redpred_139(A,B) :- p135(A,C),p71(C,B)
redpred_140(A,B) :- mk_uppercase(A,C),p135(C,B)
redpred_141(A,B) :- p956(A,C),p161_1(C,B)
redpred_142(A,B) :- p125(A,C),p658_1(C,B)
...
p405(A,B) :- redpred_11(A,B)
p413(A,B) :- redpred_2(A,B)
p415(A,B) :- redpred_10(A,B)
...
p1075(A,B) :- redpred_10(A,B)
p1079(A,B) :- redpred_2(A,B)
p1083(A,B) :- redpred_5(A,B)
p1086(A,B) :- redpred_10(A,B)
...
p1489(A,B) :- redpred_12(A,B)
p1493(A,B) :- redpred_10(A,B)
...
p282(A,B) :- redpred_43(A,B)
p293(A,B) :- redpred_32(A,B)
p294(A,B) :- redpred_32(A,B)
p296(A,B) :- skip1(A,C),p296_1(C,B)
p296_1(A,B) :- redpred_58(A,B)
p302(A,B) :- redpred_17(A,B)
p304(A,B) :- redpred_17(A,B)
...
p628_1(A,B) :- redpred_74(A,B)
p630(A,B) :- redpred_72(A,B)
...
p918_1(A,B) :- redpred_63(A,B)
p924(A,B) :- redpred_31(A,B)
p926(A,B) :- redpred_86(A,B)
p930(A,B) :- p5(A,C),p930_1(C,B)
p930_1(A,B) :- redpred_23(A,B)
p932(A,B) :- redpred_43(A,B)
p935(A,B) :- copy1(A,C),p935_1(C,B)
p935_1(A,B) :- p568(A,C),p36(C,B)
p941(A,B) :- p1(A,C),p941_1(C,B)
p941_1(A,B) :- redpred_81(A,B)
p942(A,B) :- redpred_41(A,B)
...
p1297_1(A,B) :- redpred_47(A,B)
p1300(A,B) :- redpred_41(A,B)
p1303(A,B) :- redpred_43(A,B)
p1304(A,B) :- skip1(A,C),p1304_1(C,B)
p1304_1(A,B) :- redpred_32(A,B)
p1307(A,B) :- redpred_43(A,B)
p1311(A,B) :- redpred_67(A,B)
p1312(A,B) :- redpred_85(A,B)
...
p33(A,B) :- redpred_92(A,B)
p37(A,B) :- redpred_93(A,B)
p38(A,B) :- redpred_94(A,B)
...
p72_1(A,B) :- redpred_95(A,B)
p75(A,B) :- redpred_96(A,B)
...
p82(A,B) :- redpred_97(A,B)
p84(A,B) :- p36(A,C),p167(C,B)
p90(A,B) :- redpred_98(A,B)
...
p270(A,B) :- redpred_97(A,B)
p271(A,B) :- redpred_106(A,B)
p275(A,B) :- p71(A,C),p546(C,B)
p277(A,B) :- redpred_107(A,B)
p278(A,B) :- p1(A,C),p570(C,B)
p281(A,B) :- copy1(A,C),p281_1(C,B)
p281_1(A,B) :- redpred_108(A,B)
...
p594(A,B) :- redpred_116(A,B)
p598(A,B) :- p55(A,C),p598_1(C,B)
p598_1(A,B) :- redpred_114(A,B)
...
p732(A,B) :- redpred_104(A,B)
p733(A,B) :- mk_uppercase(A,C),p733_1(C,B)
p733_1(A,B) :- redpred_98(A,B)
...
p808_1(A,B) :- redpred_127(A,B)
p818(A,B) :- redpred_128(A,B)
...
p1391(A,B) :- redpred_128(A,B)
p1396(A,B) :- p5(A,C),p552(C,B)
p1398(A,B) :- p51(A,C),p21(C,B)
p1401(A,B) :- redpred_139(A,B)
...
p1411(A,B) :- redpred_121(A,B)
p1416(A,B) :- redpred_94(A,B)
...
p1547_1(A,B) :- redpred_122(A,B)
p1550(A,B) :- mk_uppercase(A,C),p17(C,B)
p1552(A,B) :- redpred_140(A,B)
...
p1645_1(A,B) :- redpred_141(A,B)
p1648(A,B) :- p187(A,C),p1529(C,B)
p1651(A,B) :- redpred_109(A,B)
...
p1764(A,B) :- redpred_139(A,B)
p1765(A,B) :- redpred_115(A,B)
