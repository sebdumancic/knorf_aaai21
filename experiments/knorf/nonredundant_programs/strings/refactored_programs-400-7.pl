...
redpred_13(A,B) :- skip1(A,C),p257(C,B)
redpred_14(A,B) :- p9(A,C),p25(C,B)
redpred_15(A,B) :- skip1(A,C),p9(C,B)
redpred_16(A,B) :- skip1(A,C),p25(C,B)
redpred_17(A,B) :- p25(A,C),p158(C,B)
redpred_18(A,B) :- skip1(A,C),p80(C,B)
redpred_19(A,B) :- p35(A,C),p9(C,B)
redpred_20(A,B) :- p25(A,C),p80(C,B)
redpred_21(A,B) :- skip1(A,C),p35(C,B)
redpred_22(A,B) :- p210(A,C),p80(C,B)
redpred_23(A,B) :- p158(A,C),p9(C,B)
redpred_24(A,B) :- p22(A,C),p9(C,B)
redpred_25(A,B) :- p25(A,C),p25(C,B)
redpred_26(A,B) :- copy1(A,C),p210(C,B)
redpred_27(A,B) :- skip1(A,C),p395(C,B)
redpred_28(A,B) :- skip1(A,C),p115(C,B)
redpred_29(A,B) :- copy1(A,C),p35(C,B)
redpred_30(A,B) :- p25(A,C),p35(C,B)
redpred_31(A,B) :- p9(A,C),p210(C,B)
redpred_32(A,B) :- p9(A,C),p9(C,B)
redpred_33(A,B) :- p25(A,C),p9(C,B)
redpred_34(A,B) :- copy1(A,C),p25(C,B)
redpred_35(A,B) :- skip1(A,C),p339(C,B)
redpred_36(A,B) :- copy1(A,C),p22(C,B)
redpred_37(A,B) :- skip1(A,C),p22(C,B)
redpred_38(A,B) :- p22(A,C),p210(C,B)
redpred_39(A,B) :- copy1(A,C),p9(C,B)
redpred_40(A,B) :- p257(A,C),p25(C,B)
redpred_41(A,B) :- copy1(A,C),p115(C,B)
redpred_42(A,B) :- p85(A,C),mk_uppercase(C,B)
redpred_43(A,B) :- skip1(A,C),p176(C,B)
redpred_44(A,B) :- p88(A,C),copy1(C,B)
redpred_45(A,B) :- p128(A,C),mk_lowercase(C,B)
