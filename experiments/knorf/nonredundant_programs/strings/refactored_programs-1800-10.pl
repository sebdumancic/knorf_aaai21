...
redpred_17(A,B) :- skip1(A,C),p152(C,B)
redpred_18(A,B) :- p23(A,C),p28(C,B)
redpred_19(A,B) :- skip1(A,C),p23(C,B)
redpred_20(A,B) :- skip1(A,C),p84(C,B)
redpred_21(A,B) :- p1(A,C),p178(C,B)
redpred_22(A,B) :- mk_uppercase(A,C),p23(C,B)
redpred_23(A,B) :- p23(A,C),p23(C,B)
redpred_24(A,B) :- copy1(A,C),p1(C,B)
redpred_25(A,B) :- p178(A,C),p23(C,B)
redpred_26(A,B) :- skip1(A,C),p28(C,B)
redpred_27(A,B) :- p23(A,C),p110(C,B)
redpred_28(A,B) :- p62(A,C),p23(C,B)
redpred_29(A,B) :- p178(A,C),p178(C,B)
redpred_30(A,B) :- p78(A,C),p23(C,B)
redpred_31(A,B) :- skip1(A,C),p1144(C,B)
redpred_32(A,B) :- skip1(A,C),p1(C,B)
redpred_33(A,B) :- p23(A,C),p78(C,B)
redpred_34(A,B) :- p23(A,C),p1(C,B)
redpred_35(A,B) :- skip1(A,C),p78(C,B)
redpred_36(A,B) :- copy1(A,C),p178(C,B)
redpred_37(A,B) :- p1(A,C),p1(C,B)
redpred_38(A,B) :- mk_lowercase(A,C),p1(C,B)
redpred_39(A,B) :- p1(A,C),p1144(C,B)
redpred_40(A,B) :- copy1(A,C),p23(C,B)
redpred_41(A,B) :- skip1(A,C),p339(C,B)
redpred_42(A,B) :- copy1(A,C),p62(C,B)
redpred_43(A,B) :- mk_uppercase(A,C),p78(C,B)
redpred_44(A,B) :- p1(A,C),p78(C,B)
redpred_45(A,B) :- p110(A,C),p178(C,B)
redpred_46(A,B) :- p28(A,C),p1(C,B)
redpred_47(A,B) :- p23(A,C),p62(C,B)
redpred_48(A,B) :- p62(A,C),p109(C,B)
redpred_49(A,B) :- p110(A,C),p23(C,B)
redpred_50(A,B) :- skip1(A,C),p178(C,B)
redpred_51(A,B) :- skip1(A,C),p110(C,B)
redpred_52(A,B) :- copy1(A,C),p110(C,B)
redpred_53(A,B) :- p1(A,C),p110(C,B)
redpred_54(A,B) :- skip1(A,C),p62(C,B)
redpred_55(A,B) :- mk_uppercase(A,C),p1(C,B)
redpred_56(A,B) :- p109(A,C),p23(C,B)
redpred_57(A,B) :- skip1(A,C),p109(C,B)
redpred_58(A,B) :- p1(A,C),p62(C,B)
redpred_59(A,B) :- p23(A,C),p109(C,B)
redpred_60(A,B) :- p1(A,C),p23(C,B)
redpred_61(A,B) :- mk_lowercase(A,C),p28(C,B)
redpred_62(A,B) :- mk_lowercase(A,C),p110(C,B)
redpred_63(A,B) :- p62(A,C),p62(C,B)
redpred_64(A,B) :- p23(A,C),p178(C,B)
redpred_65(A,B) :- p178(A,C),p1(C,B)
redpred_66(A,B) :- p1(A,C),p28(C,B)
redpred_67(A,B) :- copy1(A,C),p84(C,B)
redpred_68(A,B) :- mk_lowercase(A,C),p62(C,B)
redpred_69(A,B) :- p109(A,C),p178(C,B)
redpred_70(A,B) :- p1(A,C),p109(C,B)
redpred_71(A,B) :- mk_uppercase(A,C),p110(C,B)
redpred_72(A,B) :- p178(A,C),p110(C,B)
redpred_73(A,B) :- p110(A,C),p1(C,B)
redpred_74(A,B) :- p28(A,C),p23(C,B)
redpred_75(A,B) :- p23(A,C),p152(C,B)
redpred_76(A,B) :- copy1(A,C),p28(C,B)
redpred_77(A,B) :- p28(A,C),p178(C,B)
redpred_78(A,B) :- mk_uppercase(A,C),p62(C,B)
redpred_79(A,B) :- p339(A,C),p1(C,B)
redpred_80(A,B) :- p110(A,C),p110(C,B)
redpred_81(A,B) :- copy1(A,C),p109(C,B)
redpred_82(A,B) :- p1(A,C),p152(C,B)
redpred_83(A,B) :- p78(A,C),p109(C,B)
redpred_84(A,B) :- p109(A,C),p62(C,B)
redpred_85(A,B) :- mk_uppercase(A,C),p109(C,B)
redpred_86(A,B) :- copy1(A,C),p78(C,B)
redpred_87(A,B) :- mk_uppercase(A,C),p84(C,B)
redpred_88(A,B) :- p23(A,C),p84(C,B)
redpred_89(A,B) :- p78(A,C),p62(C,B)
redpred_90(A,B) :- p109(A,C),p1(C,B)
redpred_91(A,B) :- p178(A,C),p62(C,B)
redpred_92(A,B) :- p62(A,C),p84(C,B)
redpred_93(A,B) :- skip1(A,C),p443(C,B)
redpred_94(A,B) :- p23(A,C),p222(C,B)
redpred_95(A,B) :- p360(A,C),p215_1(C,B)
redpred_96(A,B) :- skip1(A,C),p385(C,B)
redpred_97(A,B) :- skip1(A,C),p40(C,B)
redpred_98(A,B) :- p4(A,C),p78(C,B)
redpred_99(A,B) :- copy1(A,C),p1255(C,B)
redpred_100(A,B) :- p86_1(A,C),p6(C,B)
redpred_101(A,B) :- copy1(A,C),p385(C,B)
redpred_102(A,B) :- skip1(A,C),p1255(C,B)
redpred_103(A,B) :- p40(A,C),p72_1(C,B)
redpred_104(A,B) :- copy1(A,C),p222(C,B)
redpred_105(A,B) :- p1(A,C),p222(C,B)
redpred_106(A,B) :- p1(A,C),p58(C,B)
redpred_107(A,B) :- skip1(A,C),p108(C,B)
redpred_108(A,B) :- copy1(A,C),p536(C,B)
redpred_109(A,B) :- copy1(A,C),p415(C,B)
redpred_110(A,B) :- copy1(A,C),p417(C,B)
redpred_111(A,B) :- skip1(A,C),p360(C,B)
redpred_112(A,B) :- p220(A,C),p222(C,B)
redpred_113(A,B) :- mk_uppercase(A,C),p222(C,B)
redpred_114(A,B) :- skip1(A,C),p415(C,B)
redpred_115(A,B) :- p1540(A,C),p385(C,B)
redpred_116(A,B) :- p1(A,C),p86(C,B)
redpred_117(A,B) :- skip1(A,C),p319(C,B)
redpred_118(A,B) :- copy1(A,C),p666(C,B)
redpred_119(A,B) :- skip1(A,C),p58(C,B)
redpred_120(A,B) :- skip1(A,C),p222(C,B)
redpred_121(A,B) :- skip1(A,C),p666(C,B)
redpred_122(A,B) :- p197(A,C),p86_1(C,B)
redpred_123(A,B) :- copy1(A,C),p482(C,B)
redpred_124(A,B) :- p37(A,C),p1264(C,B)
redpred_125(A,B) :- p197(A,C),p1144(C,B)
redpred_126(A,B) :- p385(A,C),p37(C,B)
redpred_127(A,B) :- p1(A,C),p666(C,B)
redpred_128(A,B) :- p197(A,C),p109(C,B)
redpred_129(A,B) :- p12(A,C),p246(C,B)
redpred_130(A,B) :- copy1(A,C),p86(C,B)
redpred_131(A,B) :- p1540(A,C),p344(C,B)
redpred_132(A,B) :- p37(A,C),p1540(C,B)
redpred_133(A,B) :- p385(A,C),p55_1(C,B)
redpred_134(A,B) :- copy1(A,C),p360(C,B)
redpred_135(A,B) :- p197(A,C),p31(C,B)
...
p1667(A,B) :- redpred_11(A,B)
p1668(A,B) :- redpred_3(A,B)
p1674(A,B) :- redpred_2(A,B)
p1682(A,B) :- redpred_14(A,B)
...
p108_1(A,B) :- redpred_35(A,B)
p117(A,B) :- copy1(A,C),p117_1(C,B)
p117_1(A,B) :- redpred_32(A,B)
...
p360_1(A,B) :- redpred_57(A,B)
p362(A,B) :- redpred_66(A,B)
p363(A,B) :- redpred_37(A,B)
...
p817_1(A,B) :- redpred_47(A,B)
p825(A,B) :- p23(A,C),p825_1(C,B)
p825_1(A,B) :- redpred_32(A,B)
p826(A,B) :- redpred_51(A,B)
p829(A,B) :- redpred_74(A,B)
p835(A,B) :- redpred_26(A,B)
p838(A,B) :- redpred_32(A,B)
p839(A,B) :- redpred_21(A,B)
p841(A,B) :- redpred_35(A,B)
...
p1079(A,B) :- redpred_81(A,B)
p1086(A,B) :- redpred_60(A,B)
p1087(A,B) :- redpred_60(A,B)
p1093(A,B) :- skip1(A,C),p1093_1(C,B)
p1093_1(A,B) :- redpred_28(A,B)
p1095(A,B) :- copy1(A,C),p1095_1(C,B)
p1095_1(A,B) :- redpred_32(A,B)
p1097(A,B) :- redpred_51(A,B)
...
p1141_1(A,B) :- redpred_50(A,B)
p1143(A,B) :- redpred_24(A,B)
...
p1155_1(A,B) :- redpred_21(A,B)
p1164(A,B) :- redpred_86(A,B)
p1165(A,B) :- redpred_24(A,B)
p1167(A,B) :- copy1(A,C),p1167_1(C,B)
p1167_1(A,B) :- redpred_79(A,B)
...
p1177_1(A,B) :- redpred_35(A,B)
p1182(A,B) :- p1(A,C),p1182_1(C,B)
p1182_1(A,B) :- redpred_60(A,B)
p1187(A,B) :- redpred_43(A,B)
p1189(A,B) :- skip1(A,C),p1189_1(C,B)
p1189_1(A,B) :- redpred_19(A,B)
p1190(A,B) :- redpred_38(A,B)
p1197(A,B) :- redpred_81(A,B)
p1207(A,B) :- redpred_27(A,B)
p1208(A,B) :- skip1(A,C),p1208_1(C,B)
p1208_1(A,B) :- redpred_57(A,B)
...
p171(A,B) :- redpred_101(A,B)
p173(A,B) :- redpred_102(A,B)
...
p639(A,B) :- redpred_102(A,B)
p642(A,B) :- redpred_118(A,B)
...
p674(A,B) :- redpred_104(A,B)
p688(A,B) :- p319(A,C),p72(C,B)
p689(A,B) :- redpred_119(A,B)
p690(A,B) :- redpred_107(A,B)
p694(A,B) :- p178(A,C),p222(C,B)
p695(A,B) :- skip1(A,C),p695_1(C,B)
p695_1(A,B) :- redpred_120(A,B)
...
p819(A,B) :- redpred_125(A,B)
p820(A,B) :- mk_uppercase(A,C),p820_1(C,B)
p820_1(A,B) :- redpred_126(A,B)
...
p977(A,B) :- redpred_130(A,B)
p978(A,B) :- p89(A,C),p1673(C,B)
p981(A,B) :- redpred_112(A,B)
...
p1331(A,B) :- redpred_96(A,B)
p1333(A,B) :- p34_1(A,C),p72(C,B)
p1334(A,B) :- redpred_94(A,B)
...
p1481_1(A,B) :- redpred_133(A,B)
p1482(A,B) :- redpred_96(A,B)
p1483(A,B) :- p294_1(A,C),p1231(C,B)
p1484(A,B) :- redpred_104(A,B)
p1485(A,B) :- copy1(A,C),p1485_1(C,B)
p1485_1(A,B) :- redpred_117(A,B)
...
p1605(A,B) :- redpred_120(A,B)
p1606(A,B) :- p23(A,C),p1606_1(C,B)
p1606_1(A,B) :- p385(A,C),p891(C,B)
p1607(A,B) :- redpred_110(A,B)
p1611(A,B) :- redpred_132(A,B)
p1612(A,B) :- redpred_130(A,B)
...
p1723_1(A,B) :- redpred_135(A,B)
p1725(A,B) :- redpred_109(A,B)
...
p1794(A,B) :- redpred_128(A,B)
p1795(A,B) :- redpred_109(A,B)
p1796(A,B) :- redpred_96(A,B)
p1798(A,B) :- copy1(A,C),p1798_1(C,B)
p1798_1(A,B) :- redpred_93(A,B)
