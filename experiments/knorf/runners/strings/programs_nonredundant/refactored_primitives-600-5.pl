...
redpred_14(A,B)  :-  skip1(A,C),p62(C,B).
redpred_15(A,B)  :-  skip1(A,C),p8(C,B).
redpred_16(A,B)  :-  p8(A,C),p8(C,B).
redpred_17(A,B)  :-  skip1(A,C),p7(C,B).
redpred_18(A,B)  :-  skip1(A,C),p377(C,B).
redpred_19(A,B)  :-  copy1(A,C),p120(C,B).
redpred_20(A,B)  :-  copy1(A,C),p8(C,B).
redpred_21(A,B)  :-  p8(A,C),p120(C,B).
redpred_22(A,B)  :-  skip1(A,C),p35(C,B).
redpred_23(A,B)  :-  copy1(A,C),p62(C,B).
redpred_24(A,B)  :-  skip1(A,C),p36(C,B).
redpred_25(A,B)  :-  p62(A,C),p8(C,B).
redpred_26(A,B)  :-  p7(A,C),p62(C,B).
redpred_27(A,B)  :-  skip1(A,C),p120(C,B).
redpred_28(A,B)  :-  mk_lowercase(A,C),p120(C,B).
redpred_29(A,B)  :-  p62(A,C),p35(C,B).
redpred_30(A,B)  :-  p8(A,C),p62(C,B).
redpred_31(A,B)  :-  copy1(A,C),p36(C,B).
redpred_32(A,B)  :-  skip1(A,C),p169(C,B).
redpred_33(A,B)  :-  p62(A,C),p107(C,B).
redpred_34(A,B)  :-  p35(A,C),p8(C,B).
redpred_35(A,B)  :-  p7(A,C),p120(C,B).
redpred_36(A,B)  :-  copy1(A,C),p7(C,B).
redpred_37(A,B)  :-  mk_uppercase(A,C),p8(C,B).
redpred_38(A,B)  :-  p7(A,C),p107(C,B).
redpred_39(A,B)  :-  p62(A,C),p62(C,B).
redpred_40(A,B)  :-  p107(A,C),p35(C,B).
redpred_41(A,B)  :-  p169(A,C),p62(C,B).
redpred_42(A,B)  :-  p62(A,C),p120(C,B).
redpred_43(A,B)  :-  skip1(A,C),p252(C,B).
redpred_44(A,B)  :-  p8(A,C),p169(C,B).
redpred_45(A,B)  :-  skip1(A,C),p460(C,B).
redpred_46(A,B)  :-  p62(A,C),p36(C,B).
redpred_47(A,B)  :-  mk_lowercase(A,C),p62(C,B).
redpred_48(A,B)  :-  p8(A,C),p35(C,B).
redpred_49(A,B)  :-  p62(A,C),p377(C,B).
redpred_50(A,B)  :-  p8(A,C),p111(C,B).
redpred_51(A,B)  :-  copy1(A,C),p35(C,B).
redpred_52(A,B)  :-  copy1(A,C),p169(C,B).
redpred_53(A,B)  :-  p49(A,C),p8(C,B).
redpred_54(A,B)  :-  skip1(A,C),p447(C,B).
redpred_55(A,B)  :-  p81(A,C),p60_1(C,B).
redpred_56(A,B)  :-  skip1(A,C),p25(C,B).
redpred_57(A,B)  :-  p25(A,C),p12(C,B).
redpred_58(A,B)  :-  p35(A,C),p297(C,B).
redpred_59(A,B)  :-  p25(A,C),p47_1(C,B).
redpred_60(A,B)  :-  p48(A,C),p25(C,B).
...
p163(A,B)  :-  redpred_35(A,B).
p164(A,B)  :-  copy1(A,C),p164_1(C,B).
p164_1(A,B)  :-  redpred_21(A,B).
...
p276(A,B)  :-  redpred_32(A,B).
p277(A,B)  :-  copy1(A,C),p277_1(C,B).
p277_1(A,B)  :-  redpred_14(A,B).
...
p487_1(A,B)  :-  redpred_61(A,B).
p488(A,B)  :-  copy1(A,C),p140(C,B).
p489(A,B)  :-  redpred_56(A,B).
