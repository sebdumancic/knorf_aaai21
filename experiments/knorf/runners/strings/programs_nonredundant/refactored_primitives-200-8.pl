...
redpred_9(A,B)  :-  copy1(A,C),p27(C,B).
redpred_10(A,B)  :-  p27(A,C),p186(C,B).
redpred_11(A,B)  :-  p7(A,C),p27(C,B).
redpred_12(A,B)  :-  skip1(A,C),p27(C,B).
redpred_13(A,B)  :-  p92(A,C),copy1(C,B).
redpred_14(A,B)  :-  skip1(A,C),p7(C,B).
redpred_15(A,B)  :-  p7(A,C),p7(C,B).
redpred_16(A,B)  :-  p27(A,C),p27(C,B).
redpred_17(A,B)  :-  mk_lowercase(A,C),p27(C,B).
redpred_18(A,B)  :-  p92(A,C),p7(C,B).
redpred_19(A,B)  :-  p186(A,C),copy1(C,B).
redpred_20(A,B)  :-  p27(A,C),p7(C,B).
redpred_21(A,B)  :-  mk_uppercase(A,C),p40(C,B).
...
p56_1(A,B)  :-  redpred_14(A,B).
p63(A,B)  :-  copy1(A,C),p63_1(C,B).
p63_1(A,B)  :-  redpred_15(A,B).
