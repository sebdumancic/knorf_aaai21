...
redpred_9(A,B)  :-  skip1(A,C),p49(C,B).
redpred_10(A,B)  :-  p49(A,C),p24(C,B).
redpred_11(A,B)  :-  p6(A,C),mk_lowercase(C,B).
redpred_12(A,B)  :-  skip1(A,C),p20(C,B).
redpred_13(A,B)  :-  p24(A,C),p20(C,B).
redpred_14(A,B)  :-  copy1(A,C),p24(C,B).
redpred_15(A,B)  :-  skip1(A,C),p24(C,B).
redpred_16(A,B)  :-  skip1(A,C),p169(C,B).
redpred_17(A,B)  :-  p20(A,C),p24(C,B).
redpred_18(A,B)  :-  p24(A,C),p24(C,B).
redpred_19(A,B)  :-  mk_uppercase(A,C),p6(C,B).
redpred_20(A,B)  :-  mk_lowercase(A,C),p24(C,B).
redpred_21(A,B)  :-  copy1(A,C),p49(C,B).
redpred_22(A,B)  :-  mk_uppercase(A,C),p24(C,B).
redpred_23(A,B)  :-  p169(A,C),p49(C,B).
redpred_24(A,B)  :-  p49(A,C),p49(C,B).
redpred_25(A,B)  :-  p24(A,C),p49(C,B).
redpred_26(A,B)  :-  p94(A,C),p49(C,B).
redpred_27(A,B)  :-  skip1(A,C),p27_1(C,B).
redpred_28(A,B)  :-  skip1(A,C),p26_1(C,B).
...
p8_1(A,B)  :-  redpred_9(A,B).
p9(A,B)  :-  p49(A,C),p9_1(C,B).
p9_1(A,B)  :-  redpred_10(A,B).
...
p171_1(A,B)  :-  redpred_15(A,B).
p174(A,B)  :-  skip1(A,C),p174_1(C,B).
p174_1(A,B)  :-  redpred_23(A,B).
p175(A,B)  :-  redpred_9(A,B).
p177(A,B)  :-  redpred_25(A,B).
