...
redpred_7(A,B)  :-  skip1(A,C),p152(C,B).
redpred_8(A,B)  :-  copy1(A,C),p2(C,B).
redpred_9(A,B)  :-  p106(A,C),p13(C,B).
redpred_10(A,B)  :-  copy1(A,C),p13(C,B).
redpred_11(A,B)  :-  p13(A,C),p66(C,B).
redpred_12(A,B)  :-  p2(A,C),p13(C,B).
redpred_13(A,B)  :-  skip1(A,C),p13(C,B).
redpred_14(A,B)  :-  mk_lowercase(A,C),p2(C,B).
redpred_15(A,B)  :-  skip1(A,C),p2(C,B).
redpred_16(A,B)  :-  skip1(A,C),p115(C,B).
redpred_17(A,B)  :-  p152(A,C),mk_uppercase(C,B).
redpred_18(A,B)  :-  p115(A,C),p13(C,B).
redpred_19(A,B)  :-  p2(A,C),p2(C,B).
redpred_20(A,B)  :-  skip1(A,C),p81(C,B).
redpred_21(A,B)  :-  p152(A,C),p81(C,B).
...
p1_1(A,B)  :-  redpred_7(A,B).
p3(A,B)  :-  p13(A,C),p41(C,B).
p9(A,B)  :-  redpred_8(A,B).
