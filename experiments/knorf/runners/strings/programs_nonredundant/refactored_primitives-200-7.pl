...
redpred_2(A,B)  :-  mk_uppercase(A,C),mk_uppercase(C,B).
redpred_3(A,B)  :-  not_empty(A),mk_uppercase(A,B).
redpred_4(A,B)  :-  not_empty(A),skip1(A,B).
redpred_5(A,B)  :-  mk_lowercase(A,C),mk_uppercase(C,B).
...
redpred_10(A,B)  :-  skip1(A,C),p65(C,B).
redpred_11(A,B)  :-  copy1(A,C),p65(C,B).
redpred_12(A,B)  :-  skip1(A,C),p70(C,B).
redpred_13(A,B)  :-  skip1(A,C),p59(C,B).
redpred_14(A,B)  :-  p59(A,C),p65(C,B).
redpred_15(A,B)  :-  copy1(A,C),p70(C,B).
redpred_16(A,B)  :-  copy1(A,C),p44(C,B).
redpred_17(A,B)  :-  p59(A,C),copy1(C,B).
redpred_18(A,B)  :-  p49_1(A,C),p5_1(C,B).
redpred_19(A,B)  :-  p53(A,C),copy1(C,B).
redpred_20(A,B)  :-  p101(A,C),copy1(C,B).
redpred_21(A,B)  :-  skip1(A,C),p49_1(C,B).
