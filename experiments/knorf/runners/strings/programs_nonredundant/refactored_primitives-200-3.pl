...
redpred_9(A,B)  :-  p27(A,C),mk_lowercase(C,B).
redpred_10(A,B)  :-  skip1(A,C),p27(C,B).
redpred_11(A,B)  :-  mk_lowercase(A,C),p26(C,B).
redpred_12(A,B)  :-  p6(A,C),p27(C,B).
redpred_13(A,B)  :-  mk_lowercase(A,C),p51(C,B).
redpred_14(A,B)  :-  copy1(A,C),p46(C,B).
redpred_15(A,B)  :-  copy1(A,C),p27(C,B).
redpred_16(A,B)  :-  copy1(A,C),p26(C,B).
redpred_17(A,B)  :-  skip1(A,C),p51(C,B).
redpred_18(A,B)  :-  skip1(A,C),p26(C,B).
redpred_19(A,B)  :-  p26(A,C),mk_lowercase(C,B).
redpred_20(A,B)  :-  copy1(A,C),p16(C,B).
redpred_21(A,B)  :-  skip1(A,C),p16(C,B).
redpred_22(A,B)  :-  p26(A,C),p26(C,B).
redpred_23(A,B)  :-  skip1(A,C),p68(C,B).
redpred_24(A,B)  :-  skip1(A,C),p6(C,B).
redpred_25(A,B)  :-  p68(A,C),p61_1(C,B).
redpred_26(A,B)  :-  p51(A,C),p61_1(C,B).
redpred_27(A,B)  :-  p86(A,C),p27(C,B).
...
p176(A,B)  :-  redpred_16(A,B).
p184(A,B)  :-  redpred_16(A,B).
p186(A,B)  :-  p26(A,C),p186_1(C,B).
p186_1(A,B)  :-  redpred_22(A,B).
