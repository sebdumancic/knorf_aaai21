...
redpred_9(A,B)  :-  p43(A,C),p34(C,B).
redpred_10(A,B)  :-  copy1(A,C),p34(C,B).
redpred_11(A,B)  :-  p133(A,C),copy1(C,B).
redpred_12(A,B)  :-  p34(A,C),copy1(C,B).
redpred_13(A,B)  :-  mk_uppercase(A,C),p40(C,B).
redpred_14(A,B)  :-  copy1(A,C),p43(C,B).
redpred_15(A,B)  :-  copy1(A,C),copy1(C,B).
redpred_16(A,B)  :-  p133(A,C),p30(C,B).
redpred_17(A,B)  :-  skip1(A,C),p34(C,B).
redpred_18(A,B)  :-  mk_lowercase(A,C),mk_uppercase(C,B).
redpred_19(A,B)  :-  p78_1(A,C),p3(C,B).
redpred_20(A,B)  :-  skip1(A,C),p133(C,B).
redpred_21(A,B)  :-  p89_1(A,C),mk_uppercase(C,B).
...
p81_1(A,B)  :-  redpred_15(A,B).
p84(A,B)  :-  copy1(A,C),p84_1(C,B).
p84_1(A,B)  :-  redpred_15(A,B).
...
p153_1(A,B)  :-  redpred_12(A,B).
p155(A,B)  :-  copy1(A,C),p155_1(C,B).
p155_1(A,B)  :-  redpred_10(A,B).
...
p179_1(A,B)  :-  redpred_16(A,B).
p182(A,B)  :-  p34(A,C),p182_1(C,B).
p182_1(A,B)  :-  redpred_15(A,B).
