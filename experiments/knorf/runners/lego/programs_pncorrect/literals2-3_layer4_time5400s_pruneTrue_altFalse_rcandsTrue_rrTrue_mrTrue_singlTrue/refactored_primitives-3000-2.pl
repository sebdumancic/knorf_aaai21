latent51_3(A,B)  :-  latent2_2(A,C),latent5_3(C,C3_0),latent1_2(C3_0,B).
latent12_2(A,B)  :-  latent3_2(A,C1_0),latent2_2(C1_0,B).
latent72_3(A,B)  :-  latent3_2(A,C1_0_1),latent4_3(C1_0_1,C2_0),latent1_2(C2_0,B).
...
latent237_2(A,B)  :-  latent65_2(A,C1_0),latent14_2(C1_0,B).
...
latent228_2(A,B)  :-  latent24_2(A,C),latent65_2(C,B).
latent63_3(A,B)  :-  latent7_3(A,C1_0),latent2_2(C1_0,C2_0),latent1_2(C2_0,B).
latent3_2(A,C1_0)  :-  place1(A,C),right(C,C1_0).
latent65_2(C,B)  :-  latent3_2(C,C3_0_1),latent8_3(C3_0_1,B).
latent55_3(A,B)  :-  latent8_3(A,C),latent6_2(C,C3_0),latent2_2(C3_0,B).
latent59_2(C1_0_1,B)  :-  latent2_2(C1_0_1,C3_0),latent4_3(C3_0,B).
latent102_3(A,B)  :-  latent7_3(A,C1_0_1),latent1_2(C1_0_1,C),latent8_3(C,B).
latent69_3(A,B)  :-  latent1_2(A,C),latent4_3(C,C3_0),latent2_2(C3_0,B).
...
p30(A,B)  :-  latent55_3(A,B).
p104(A,B)  :-  latent63_3(A,B).
p256(A,B)  :-  latent69_3(A,B).
p1503(A,B)  :-  latent72_3(A,B).
