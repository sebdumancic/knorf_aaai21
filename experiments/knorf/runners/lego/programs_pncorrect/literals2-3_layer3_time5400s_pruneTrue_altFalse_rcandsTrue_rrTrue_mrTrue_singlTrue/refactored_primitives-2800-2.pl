latent145_2(A,C2_0)  :-  latent8_3(A,C1_0_1),latent3_2(C1_0_1,C2_0).
...
latent101_2(A,C1_0)  :-  latent2_2(A,C1_0_1),latent3_2(C1_0_1,C1_0).
...
latent55_3(A,B)  :-  latent10_3(A,C1_0),latent2_2(C1_0,C2_0),latent1_2(C2_0,B).
latent1_2(A,B)  :-  right(A,C),place1(C,B).
latent274_2(A,B)  :-  latent50_3(A,C1_0),latent13_2(C1_0,B).
latent78_3(C0_0,B)  :-  latent1_2(C0_0,C),latent3_2(C,C3_0),latent2_2(C3_0,B).
latent51_2(A,C3_0)  :-  latent3_2(A,C1_0_1),latent2_2(C1_0_1,C3_0).
latent63_3(A,B)  :-  latent7_3(A,C1_0),latent1_2(C1_0,C3_0),latent2_2(C3_0,B).
...
latent59_3(A,B)  :-  latent3_2(A,C1_0_1),latent7_3(C1_0_1,C1_0),latent1_2(C1_0,B).
...
p59(A,B)  :-  latent59_3(A,B).
p106(A,B)  :-  latent63_3(A,B).
p1347(A,B)  :-  latent69_3(A,B).
p8(A,B)  :-  latent13_2(A,C),latent51_2(C,B).
p95(A,B)  :-  latent15_2(A,C1_0),latent15_2(C1_0,B).
p127(A,B)  :-  latent16_2(A,C1_0),latent13_2(C1_0,B).
p157(A,B)  :-  latent101_2(A,C1_0),latent15_2(C1_0,B).
p25(A,B)  :-  latent13_2(A,C),latent19_2(C,B).
p173(A,B)  :-  latent101_2(A,C2_0),latent31_2(C2_0,B).
p332(A,B)  :-  latent27_2(A,C),latent51_2(C,B).
p455(A,B)  :-  latent25_2(A,C),latent16_2(C,B).
p48(A,B)  :-  latent145_2(A,C2_0),latent19_2(C2_0,B).
p85(A,B)  :-  latent78_3(A,C2_0),latent51_2(C2_0,B).
p224(A,B)  :-  latent19_2(A,C),latent24_2(C,B).
p345(A,B)  :-  latent24_2(A,C),latent25_2(C,B).
p383(A,B)  :-  latent274_2(A,B).
p540(A,B)  :-  latent34_3(A,C),latent19_2(C,B).
p409(A,B)  :-  latent145_2(A,C3_0_1),latent50_3(C3_0_1,B).
