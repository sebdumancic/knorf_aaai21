...
latent60_3(A,B)  :-  latent2_2(A,C1_0_1),latent4_3(C1_0_1,C2_0),latent1_2(C2_0,B).
...
latent150_2(C1_0_1,B)  :-  latent9_3(C1_0_1,C1_0),latent5_3(C1_0,B).
...
p318(A,B)  :-  latent34_2(A,C),latent24_2(C,B).
...
p44(A,B)  :-  latent150_2(A,C1_0),latent16_2(C1_0,B).
p169(A,B)  :-  latent24_2(A,C2_0),latent59_2(C2_0,B).
p297(A,B)  :-  latent27_2(A,C),latent30_2(C,B).
p431(A,B)  :-  latent150_2(A,C2_0),latent59_2(C2_0,B).
p483(A,B)  :-  latent60_3(A,C1_0),latent16_2(C1_0,B).
