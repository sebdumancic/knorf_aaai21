...
latent57_2(C,B)  :-  latent5_2(C,C3_0_1),latent4_3(C3_0_1,B).
...
latent36_2(C1_0_1,B)  :-  latent5_2(C1_0_1,C1_0),latent1_2(C1_0,B).
...
latent22_2(A,B)  :-  latent5_2(A,C1_0_1),latent7_3(C1_0_1,B).
