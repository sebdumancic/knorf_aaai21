latent99_2(A,C3_0)  :-  latent2_2(A,C1_0_1),latent10_3(C1_0_1,C3_0).
...
latent150_2(C4_0,B)  :-  latent8_3(C4_0,C3_0),latent5_3(C3_0,B).
latent27_2(A,C3_0)  :-  latent2_2(A,C),latent3_2(C,C3_0).
latent20_2(A,C1_0)  :-  latent2_2(A,C),latent1_2(C,C1_0).
latent66_2(C1_0_1,B)  :-  latent7_3(C1_0_1,C2_0),latent2_2(C2_0,B).
latent67_3(A,B)  :-  latent1_2(A,C1_0_1),latent7_3(C1_0_1,C2_0),latent2_2(C2_0,B).
...
p111(A,B)  :-  latent27_2(A,C3_0_1),latent21_2(C3_0_1,B).
p1(A,B)  :-  latent10_3(A,C2_0_1),latent1_2(C2_0_1,C1_0),latent2_2(C1_0,B).
p6(A,B)  :-  latent67_3(A,B).
...
p194(A,B)  :-  latent15_2(A,C),latent21_2(C,B).
p17(A,B)  :-  latent69_2(A,C2_0),latent124_3(C2_0,B).
p51(A,B)  :-  latent99_2(A,C4_0),latent150_2(C4_0,B).
p127(A,B)  :-  latent21_2(A,C2_0),latent124_3(C2_0,B).
p23(A,B)  :-  latent13_2(A,C),latent72_3(C,B).
p142(A,B)  :-  latent67_3(A,C2_0),latent66_2(C2_0,B).
p43(A,B)  :-  latent21_2(A,C),latent26_2(C,B).
p53(A,B)  :-  latent13_2(A,C3_0_1),latent66_2(C3_0_1,B).
p104(A,B)  :-  latent27_2(A,C3_0_1),latent150_2(C3_0_1,B).
p55(A,B)  :-  latent21_2(A,C2_0),latent21_2(C2_0,C4_0),latent66_2(C4_0,B).
p62(A,B)  :-  latent13_2(A,C),latent20_2(C,C1_0),latent20_2(C1_0,B).
p97(A,B)  :-  latent150_2(A,C3_0_1),latent66_2(C3_0_1,C2_0),latent21_2(C2_0,B).
