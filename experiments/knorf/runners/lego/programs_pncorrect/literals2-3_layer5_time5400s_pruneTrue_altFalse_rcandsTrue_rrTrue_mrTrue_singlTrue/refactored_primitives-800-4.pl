...
latent12_2(A,B)  :-  latent1_2(A,C1_0_1),latent6_3(C1_0_1,B).
...
latent46_2(C1_0_1,B)  :-  latent2_2(C1_0_1,C2_0),latent6_3(C2_0,B).
latent26_2(A,B)  :-  latent8_2(A,C1_0),latent2_2(C1_0,B).
latent118_3(A,B)  :-  latent1_2(A,C1_0_1),latent3_2(C1_0_1,C3_0),latent7_3(C3_0,B).
...
latent64_2(C1_0_1,B)  :-  latent7_3(C1_0_1,C1_0),latent4_3(C1_0,B).
latent124_3(A,B)  :-  latent1_2(A,C1_0_1),latent3_2(C1_0_1,C1_0),latent4_3(C1_0,B).
latent51_2(C0_0,B)  :-  latent4_3(C0_0,C2_0),latent6_3(C2_0,B).
latent2_2(A,B)  :-  place1(A,C),place1(C,B).
latent33_3(A,B)  :-  latent1_2(A,C),latent1_2(C,C1_0),latent2_2(C1_0,B).
latent19_2(A,B)  :-  latent8_2(A,C1_0_1),latent7_3(C1_0_1,B).
...
latent89_3(A,C2_0)  :-  latent2_2(A,C1_0_2),latent3_2(C1_0_2,C2_0_1),latent7_3(C2_0_1,C2_0).
...
p342(A,B)  :-  latent29_2(A,C),latent29_2(C,B).
p73(A,B)  :-  latent26_2(A,C1_0),latent29_2(C1_0,B).
p112(A,B)  :-  latent25_2(A,C2_0),latent24_2(C2_0,B).
p251(A,B)  :-  latent27_2(A,C),latent29_2(C,B).
p0(A,B)  :-  latent15_2(A,C),latent26_2(C,B).
p6(A,B)  :-  latent46_2(A,C1_0),latent29_2(C1_0,B).
p240(A,B)  :-  latent12_2(A,C),latent24_2(C,B).
p690(A,B)  :-  latent19_2(A,C),latent24_2(C,B).
p17(A,B)  :-  latent118_3(A,B).
p28(A,B)  :-  latent89_3(A,B).
p55(A,B)  :-  latent120_3(A,B).
p167(A,B)  :-  latent124_3(A,B).
p20(A,B)  :-  latent46_2(A,C),latent51_2(C,B).
p236(A,B)  :-  latent120_3(A,C1_0),latent25_2(C1_0,B).
p252(A,B)  :-  latent33_3(A,C),latent15_2(C,B).
p21(A,B)  :-  latent33_3(A,C1_0),latent25_2(C1_0,B).
p35(A,B)  :-  latent64_2(A,C2_0),latent24_2(C2_0,B).
p379(A,B)  :-  latent46_2(A,C),latent19_2(C,B).
p22(A,B)  :-  latent29_2(A,C),latent29_2(C,C1_0),latent29_2(C1_0,B).
p523(A,B)  :-  latent25_2(A,C1_0_1),latent25_2(C1_0_1,C1_0),latent25_2(C1_0,B).
p434(A,B)  :-  latent29_2(A,C0_0),latent29_2(C0_0,C),latent46_2(C,B).
