...
latent153_3(C1_0_2,B)  :-  latent1_2(C1_0_2,C2_0),latent4_2(C2_0,C1_0),latent3_3(C1_0,B).
...
latent185_3(A,B)  :-  latent3_3(A,C),latent3_3(C,C3_0),latent2_2(C3_0,B).
latent169_3(A,B)  :-  latent7_2(A,C1_0_1),latent3_3(C1_0_1,C1_0),latent1_2(C1_0,B).
latent64_2(C,B)  :-  latent5_3(C,C3_0),latent1_2(C3_0,B).
latent8_3(A,B)  :-  right(A,C),right(C,C1_0),place1(C1_0,B).
latent161_3(A,B)  :-  latent2_2(A,C),latent1_2(C,C1_0),latent3_3(C1_0,B).
latent44_3(A,B)  :-  latent7_2(A,C1_0),latent1_2(C1_0,C2_0),latent1_2(C2_0,B).
latent1_2(A,B)  :-  place1(A,C),place1(C,B).
latent291_2(A,B)  :-  latent189_3(A,C2_0),latent55_2(C2_0,B).
...
latent159_3(A,B)  :-  latent1_2(A,C),latent2_2(C,C1_0),latent3_3(C1_0,B).
...
latent189_3(A,C1_0)  :-  latent1_2(A,C0_0),latent3_3(C0_0,C3_0_1),latent4_2(C3_0_1,C1_0).
latent274_2(A,B)  :-  latent18_2(A,C1_0_1),latent161_3(C1_0_1,B).
...
p120(A,B)  :-  latent185_3(A,B).
p42(A,B)  :-  latent189_3(A,C1_0),latent13_2(C1_0,B).
p147(A,B)  :-  latent274_2(A,B).
p390(A,B)  :-  latent291_2(A,B).
