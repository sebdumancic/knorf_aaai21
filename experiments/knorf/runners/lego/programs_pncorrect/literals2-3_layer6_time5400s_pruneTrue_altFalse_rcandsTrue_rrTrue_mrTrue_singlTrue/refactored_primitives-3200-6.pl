latent88_3(A,B)  :-  latent3_3(A,C2_0),latent4_2(C2_0,C3_0),latent2_2(C3_0,B).
...
latent84_3(A,B)  :-  latent1_2(A,C1_0_1),latent4_2(C1_0_1,C1_0),latent3_3(C1_0,B).
...
latent92_3(A,B)  :-  latent2_2(A,C1_0_1),latent4_2(C1_0_1,C3_0),latent6_3(C3_0,B).
...
p30(A,B)  :-  latent84_3(A,B).
p44(A,B)  :-  latent86_3(A,B).
p82(A,B)  :-  latent88_3(A,B).
...
p41(A,B)  :-  latent34_2(A,C2_0),latent33_3(C2_0,B).
p53(A,B)  :-  latent13_2(A,C),latent24_2(C,B).
p454(A,B)  :-  latent16_2(A,C),latent50_2(C,B).
p681(A,B)  :-  latent50_2(A,C),latent13_2(C,B).
p490(A,B)  :-  latent50_2(A,C),latent33_3(C,B).
p1677(A,B)  :-  latent20_2(A,C),latent33_3(C,B).
