latent88_3(A,B)  :-  latent3_2(A,C1_0_2),latent3_2(C1_0_2,C2_0),latent5_3(C2_0,B).
...
latent97_3(A,B)  :-  latent8_3(A,C2_0),latent3_2(C2_0,C3_0),latent1_2(C3_0,B).
latent6_2(A,C1_0)  :-  right(A,C),right(C,C1_0).
latent66_2(A,C3_0)  :-  latent8_3(A,C2_0),latent5_3(C2_0,C3_0).
latent8_3(C,B)  :-  right(C,C1_0),place1(C1_0,C2_0),place1(C2_0,B).
latent112_2(A,C1_0)  :-  latent3_2(A,C1_0_1),latent8_3(C1_0_1,C1_0).
...
p26(A,B)  :-  latent112_2(A,C1_0),latent13_2(C1_0,B).
...
p46(A,B)  :-  latent105_2(A,C),latent24_2(C,B).
p270(A,B)  :-  latent30_2(A,C),latent66_2(C,B).
