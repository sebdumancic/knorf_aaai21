...
latent64_3(A,B)  :-  latent7_2(A,C1_0_1),latent10_3(C1_0_1,C2_0),latent2_2(C2_0,B).
latent82_3(C1_0_1,B)  :-  latent5_3(C1_0_1,C1_0),latent1_2(C1_0,C3_0),latent2_2(C3_0,B).
latent9_3(C,B)  :-  right(C,C1_0),right(C1_0,C2_0),place1(C2_0,B).
latent47_3(A,B)  :-  latent1_2(A,C1_0_1),latent3_2(C1_0_1,C1_0),latent5_3(C1_0,B).
...
p34(A,B)  :-  latent24_2(A,C),latent58_2(C,B).
p37(A,B)  :-  latent114_2(A,C1_0),latent15_2(C1_0,B).
p798(A,B)  :-  latent56_2(A,C),latent18_2(C,B).
p1116(A,B)  :-  latent43_2(A,C1_0),latent15_2(C1_0,B).
p303(A,B)  :-  latent29_2(A,C1_0_1),latent29_2(C1_0_1,C1_0),latent29_2(C1_0,B).
