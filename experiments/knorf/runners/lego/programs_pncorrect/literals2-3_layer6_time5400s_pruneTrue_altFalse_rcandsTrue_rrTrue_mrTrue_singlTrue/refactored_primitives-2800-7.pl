...
latent62_3(A,B)  :-  latent3_2(A,C1_0_1),latent7_3(C1_0_1,C2_0),latent2_2(C2_0,B).
...
latent58_3(A,B)  :-  latent1_2(A,C),latent5_3(C,C3_0),latent1_2(C3_0,B).
...
latent71_2(C1_0_1,C5_0)  :-  latent2_2(C1_0_1,C),latent6_2(C,C5_0).
latent2_2(A,B)  :-  place1(A,C),place1(C,B).
latent76_2(C1_0_1,C3_0)  :-  latent9_3(C1_0_1,C1_0),latent1_2(C1_0,C3_0).
latent33_3(A,B)  :-  latent1_2(A,C),latent1_2(C,C1_0),latent2_2(C1_0,B).
latent17_2(A,B)  :-  latent1_2(A,C),latent2_2(C,B).
latent26_2(A,B)  :-  latent1_2(A,C1_0_1),latent9_3(C1_0_1,B).
...
p1586(A,B)  :-  latent18_2(A,C),latent21_2(C,B).
p11(A,B)  :-  latent76_2(A,C1_0),latent17_2(C1_0,B).
p45(A,B)  :-  latent26_2(A,C),latent12_2(C,B).
p74(A,B)  :-  latent16_2(A,C),latent76_2(C,B).
p148(A,B)  :-  latent39_2(A,C2_0),latent76_2(C2_0,B).
...
p157(A,B)  :-  latent71_2(A,C1_0),latent17_2(C1_0,B).
p211(A,B)  :-  latent26_2(A,C),latent33_3(C,B).
p810(A,B)  :-  latent18_2(A,C),latent82_2(C,B).
